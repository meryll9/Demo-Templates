									...
									<div class="top-cart-items">
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="{{asset('ecommerce/images/shop/small/1.jpg')}}" alt="Blue Round-Neck Tshirt" /></a>
											</div>
										...
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="{{asset('ecommerce/images/shop/small/6.jpg')}}" alt="Light Blue Denim Dress" /></a>
											</div>
											<div class="top-cart-item-desc">
												<div class="top-cart-item-desc-title">
						...
						<nav class="primary-menu style-ecommerce menu-spacing-margin">
							...
							<ul class="menu-container">
								...
								<li class="menu-item mega-menu"><a class="menu-link" href="#"><div>Men</div></a>
									<div class="mega-menu-content mega-menu-style-2" style="background-image: url({{asset('/ecommerce/images/shop/shop-menu.jpg')}}); background-repeat: no-repeat; background-position: right bottom;">
										<div class="container">
											<div class="row">
														...
														<div class="widget">
															...
															<div class="portfolio-item">
																<div class="portfolio-image">
																	<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/1-1.jpg')}}" alt="Grey Bag"></a>
																	<div class="product-cart"><a href="#"><i class="icon-shopping-cart"></i></a></div>
																	<div class="product-quickview"><a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Available Sizes: S | M | L"><i class="icon-info"></i></a></div>
																</div>
															...
															<div class="posts-sm row col-mb-30" id="recent-shop-list-sidebar">
																	...
																	<div class="grid-inner row g-0">
																		<div class="col-auto">
																			<div class="entry-image">
																				<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/2-1.jpg')}}" alt="Image"></a>
																			</div>
																		</div>
																		<div class="col ps-3">
																...
																<div class="entry col-12">
																	<div class="grid-inner row g-0">
																		<div class="col-auto">
																			<div class="entry-image">
																				<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/3-1.jpg')}}" alt="Image"></a>
																			</div>
																		</div>
																		<div class="col ps-3">
																			<div class="entry-title">
																...
																<div class="entry col-12">
																	<div class="grid-inner row g-0">
																		<div class="col-auto">
																			<div class="entry-image">
																				<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/4-1.jpg')}}" alt="Image"></a>
																			</div>
																		</div>
																		<div class="col ps-3">
																			<div class="entry-title">
			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="container">
							<div class="slider-caption" style="margin-top: -30px;">
								<div class="emphasis-title mb-0">
									<h2 class="bottommargin fw-bold" style="max-width: 600px; font-size: 80px; font-family: 'Montserrat'; line-height: 1.2;">{{ env('APP_TAGLINE') }}</h2>
						...
						<div class="swiper-slide-bg" style="background: #FFF url({{asset('/ecommerce/demos/ecommerce/images/slider/1.jpg')}}) no-repeat center right; background-size: auto 100%;"></div>
					</div>
					<div class="swiper-slide">
						<div class="container">
							<div class="slider-caption" style="margin-top: -30px;">
								<div class="emphasis-title mb-0">
									<h2 class="bottommargin fw-bold" style="max-width: 600px; font-size: 80px; font-family: 'Montserrat'; line-height: 1.2;">We Create<br>diff. Designs</h2>
						...
						<div class="swiper-slide-bg" style="background: #FFF url({{asset('/ecommerce/demos/ecommerce/images/slider/2.jpg')}}) no-repeat center right; background-size: auto 100%;"></div>
					</div>
					<div class="swiper-slide">
						<div class="container">
							<div class="slider-caption" style="margin-top: -30px;">
								<div class="emphasis-title mb-0">
									<h2 class="bottommargin fw-bold" style="max-width: 600px; font-size: 80px; font-family: 'Montserrat'; line-height: 1.2;">We Create<br>diff. Layouts</h2>
						...
						<div class="swiper-slide-bg" style="background: #FFF url({{asset('/ecommerce/demos/ecommerce/images/slider/3.jpg')}}) no-repeat center right; background-size: auto 100%;"></div>
					</div>
					<div class="swiper-slide">
						<div class="container">
							<div class="slider-caption" style="margin-top: -30px;">
								<div class="emphasis-title mb-0">
									<h2 class="bottommargin fw-bold" style="max-width: 600px; font-size: 80px; font-family: 'Montserrat'; line-height: 1.2;">We Create<br>diff. Mindset</h2>
						...
						<div class="swiper-slide-bg" style="background: #FFF url({{asset('/ecommerce/demos/ecommerce/images/slider/4.jpg')}}) no-repeat center right; background-size: auto 100%;"></div>
					</div>
					<div class="swiper-slide">
						<div class="container">
							<div class="slider-caption" style="margin-top: -30px;">
								<div class="emphasis-title mb-0">
									<h2 class="bottommargin fw-bold" style="max-width: 600px; font-size: 80px; font-family: 'Montserrat'; line-height: 1.2;">We Create<br>your Website</h2>
						...
						<div class="swiper-slide-bg" style="background: #FFF url({{asset('/ecommerce/demos/ecommerce/images/slider/5.jpg')}}) no-repeat center right; background-size: auto 100%;"></div>
					</div>
					<div class="swiper-slide">
						<div class="container">
							<div class="slider-caption" style="margin-top: -30px;">
								<div class="emphasis-title mb-0">
									<h2 class="bottommargin fw-bold" style="max-width: 600px; font-size: 80px; font-family: 'Montserrat'; line-height: 1.2;">We Create<br>your Home</h2>
						...
						<div class="swiper-slide-bg" style="background: #FFF url({{asset('/ecommerce/demos/ecommerce/images/slider/6.jpg')}}) no-repeat center right; background-size: auto 100%;"></div>
					</div>
				</div>
			...
			<div class="content-wrap py-0">
				...
				<div class="container clearfix">
					...
					<div class="row ecommerce-categories clearfix" style="padding: 20px 0 0;">
						<div class="col-lg-7">
							<a href="#" style="background: url({{asset('/ecommerce/demos/ecommerce/images/types/1.jpg')}}) no-repeat center center; background-size: cover;">
						...
						<div class="col-lg-5">
							<a href="#" style="background: url({{asset('/ecommerce/demos/ecommerce/images/types/3.jpg')}}) no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url({{asset('/ecommerce/demos/ecommerce/images/types/5.jpg')}}) no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url({{asset('/ecommerce/demos/ecommerce/images/types/6.jpg')}}) no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url({{asset('/ecommerce/demos/ecommerce/images/types/8.jpg')}}) no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
						...
						<div class="col-lg-5">
							<a href="#" style="background: url({{asset('/ecommerce/demos/ecommerce/images/types/7.jpg')}}) no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
						...
						<div class="col-lg-7">
							<a href="#" style="background: url({{asset('/ecommerce/demos/ecommerce/images/types/9.jpg')}}) no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
										...
										<div class="fslider" data-pagi="false" data-animation="fade" data-slideshow="false">
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide"><a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/1-1.jpg')}}" alt="Grey Bag"></a></div>
													<div class="slide"><a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/1-2.jpg')}}" alt="Grey Bag"></a></div>
													<div class="slide"><a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/1-3.jpg')}}" alt="Grey Bag"></a></div>
												</div>
											</div>
										</div>
										<div class="product-cart"><a href="#"><i class="icon-shopping-cart"></i></a></div>
								...
								<div class="portfolio-item">
									<div class="portfolio-image clearfix">
										<div class="fslider" data-pagi="false" data-animation="fade" data-slideshow="false">
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide"><a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/4-1.jpg')}}" alt="Grey Bag"></a></div>
													<div class="slide"><a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/4-2.jpg')}}" alt="Grey Bag"></a></div>
												</div>
											</div>
										</div>
										<div class="product-cart"><a href="#"><i class="icon-shopping-cart"></i></a></div>
								...
								<div class="portfolio-item">
									<div class="portfolio-image clearfix">
										<div class="fslider" data-pagi="false" data-animation="fade" data-slideshow="false">
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide"><a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/2-1.jpg')}}" alt="Office Bag"></a></div>
													<div class="slide"><a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/2-2.jpg')}}" alt="Office Bag"></a></div>
												</div>
											</div>
										</div>
										<div class="product-cart"><a href="#"><i class="icon-shopping-cart"></i></a></div>
										<div class="product-quickview"><a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Available Sizes: L"><i class="icon-info"></i></a></div>
									</div>
									<div class="portfolio-desc pb-0-content-between">
										<div>
								...
								<div class="portfolio-item">
									<div class="portfolio-image clearfix">
										<div class="fslider" data-pagi="false" data-animation="fade" data-slideshow="false">
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide"><a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/3-1.jpg')}}" alt="Men Bag"></a></div>
													<div class="slide"><a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/3-2.jpg')}}" alt="Men Bag"></a></div>
													<div class="slide"><a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/items/3-3.jpg')}}" alt="Men Bag"></a></div>
												</div>
											</div>
										</div>
						...
						<div class="row clearfix">
							<div class="col-lg-5">
								<div id="oc-images" class="owl-carousel image-carousel carousel-widget custom-js">
									...
									<div class="oc-item">
										<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/featured/1.jpg')}}" alt="Image 1"></a>
									</div>
									<div class="oc-item">
										<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/featured/2.jpg')}}" alt="Image 2"></a>
									</div>
									<div class="oc-item">
										<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/featured/3.jpg')}}" alt="Image 3"></a>
									</div>
									<div class="oc-item">
										<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/featured/4.jpg')}}" alt="Image 4"></a>
									</div>
									<div class="oc-item">
										<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/featured/5.jpg')}}" alt="Image 5"></a>
									</div>
									<div class="oc-item">
										<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/featured/6.jpg')}}" alt="Image 6"></a>
									</div>
							...
							<div class="col-lg-5 offset-lg-1">
								<div class="featured-item topmargin">
									<div class="item-title">
										<div class="before-heading fw-semibold ls5"><a href="#" style="color: #aab7bd !important;">Leather Bags <i class="icon-angle-right"></i></a></div>
				...
				<div class="row align-items-stretch bottommargin clearfix">
					<div class="col-md-6" style="background: url({{asset('/ecommerce/demos/ecommerce/images/sections/1.jpg')}}) center 45% no-repeat; background-size: cover; padding: 0 0 500px;">
						<div class="section-content topmargin-sm">
							...
							<a class="more-link text-uppercase fw-medium" style="font-family: 'Montserrat';">Go To Shop <i class="icon-line-arrow-right"></i></a>
						</div>
					</div>
					<div class="col-md-6" style="background: url({{asset('/ecommerce/demos/ecommerce/images/sections/3.jpg')}}) center center no-repeat; background-size: cover; padding: 0 0 500px;">
						<div class="section-content topmargin-sm">
					...
					<div class="row col-mb-50">
						<div class="col-lg-2 col-md-4 col-6 offset-lg-1">
							<div class="feature-box fbox-center">
								...
								<div class="fbox-image imagescalein">
									<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/icons/2.png')}}" alt="Image"></a>
								</div>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-6">
							<div class="feature-box fbox-center">
								...
								<div class="fbox-image imagescalein">
									<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/icons/3.png')}}" alt="Image"></a>
								</div>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-6">
							<div class="feature-box fbox-center">
								...
								<div class="fbox-image imagescalein">
									<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/icons/4.png')}}" alt="Image"></a>
								</div>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-6">
							<div class="feature-box fbox-center">
								...
								<div class="fbox-image imagescalein">
									<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/icons/5.png')}}" alt="Image"></a>
								</div>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-6">
							<div class="feature-box fbox-center">
								...
								<div class="fbox-image imagescalein">
									<a href="#"><img src="{{asset('ecommerce/demos/ecommerce/images/icons/6.png')}}" alt="Image"></a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row payments-info">
							...
							<div class="col-lg-6">
								<ul class="payment-cards clearfix" style="margin-top: 5px;">
									...
									<li><img src="{{asset('ecommerce/demos/xmas/images/cards/mc.svg')}}" alt="Master Card"></li>
									<li><img src="{{asset('ecommerce/demos/xmas/images/cards/ae.svg')}}" alt="American Express"></li>
									...
									<li><img src="{{asset('ecommerce/demos/xmas/images/cards/2co.svg')}}" alt="2CheckOut"></li>
									<li><img src="{{asset('ecommerce/demos/xmas/images/cards/wu.svg')}}" alt="Western Union"></li>
								</ul>
							</div>
						</div>
					</div>
							...
							<div class="widget subscribe-widget mt-0 clearfix">
								...
								<form id="widget-subscribe-form" action="include/subscribe.php" method="post" class="mb-0">
									<div class="input-group input-group-lg mx-auto">
										...
										<button class="button button-black fw-light button-dark ls2 text-uppercase" type="submit">Subscribe</button>
									</div>
								</form>
							</div>
