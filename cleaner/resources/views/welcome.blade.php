...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
				...
				<div class="row justify-content-between">
					<div class="col-12 col-md-auto">
						...
						<div class="top-links">
							<ul class="top-links-container">
								...
								<li class="top-links-item"><a href="login-register.html"><img src="{{asset('cleaner/demos/seo/images/flags/eng.png')}}" alt="Lang">English</a>
									<ul class="top-links-sub-menu">
										<li class="top-links-item"><a href="#"><img src="{{asset('cleaner/demos/seo/images/flags/fre.png')}}" alt="Lang">French</a></li>
										<li class="top-links-item"><a href="#"><img src="{{asset('cleaner/demos/seo/images/flags/ara.png')}}" alt="Lang">Arabic</a></li>
										<li class="top-links-item"><a href="#"><img src="{{asset('cleaner/demos/seo/images/flags/tha.png')}}" alt="Lang">Thai</a></li>
									</ul>
								</li>
							</ul>
						</div><!-- .top-links end -->
					...
					<div class="col-12 col-md-auto">
						...
						<ul id="top-social">
							...
							<li><a href="tel:+91.11.85412542" class="si-call"><span class="ts-icon"><i class="icon-call"></i></span><span class="ts-text">+1.111.222.333</span></a></li>
							<li><a href="mailto:noreply@canvas.com" class="si-email3"><span class="ts-icon"><i class="icon-envelope-alt"></i></span><span class="ts-text">noreply@canvas.com</span></a></li>
						</ul><!-- #top-social end -->
				...
				<div class="container-fluid pe-0">
					<div class="header-row">
						...
						<div class="header-misc">
							<a href="#section-price" data-scrollto="#section-price" data-offset="60" class="button button-light text-dark fw-semibold"><i class="icon-dollar-sign"></i> Cost Calculate</a>
						</div>
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element" style="background: url({{asset('/cleaner/demos/cleaner/images/hero.jpg')}}) center center no-repeat; background-size: cover; height: 700px">
									...
									<form id="form-cleaning" name="form-cleaning" action="include/form.php" method="post" class="row form-cleaning mb-0">
										...
										<div class="col-sm-6">
											<div class="input-group form-group">
												<span class="input-group-text bg-color text-white"><img src="{{asset('cleaner/demos/cleaner/images/icons/cleaner2.svg')}}" alt="" width="20"></span>
										...
										<div class="col-sm-6">
											<div class="input-group form-group">
												<span class="input-group-text bg-color text-white"><i class="icon-line2-calendar"></i></span>
		...
		<section id="content">
			...
			<div class="content-wrap pt-4 pb-0">
				...
				<div class="container">
					...
					<div class="row justify-content-center col-mb-50">
						<div class="col-md-4">
							<div class="feature-box mx-0 fbox-small fbox-center border-0">
								<div class="fbox-img position-relative">
									<img src="{{asset('cleaner/demos/cleaner/images/icons/book.svg')}}" alt="Book Icon" height="160">
								</div>
								<h2 class="topmargin-sm h5 mb-3 nott fw-semibold ls0"><span>1.</span> Book your Cleaner &amp; Time</h2>
						...
						<div class="col-md-4">
							<div class="feature-box mx-0 fbox-small fbox-center border-0">
								<div class="fbox-img position-relative">
									<img src="{{asset('cleaner/demos/cleaner/images/icons/confirm3.svg')}}" alt="Confirm Icon" height="160">
								</div>
						...
						<div class="col-md-4">
							<div class="feature-box mx-0 fbox-small fbox-center border-0">
								<div class="fbox-img position-relative">
									<img src="{{asset('cleaner/demos/cleaner/images/icons/enjoy.svg')}}" alt="Relax Icon" height="160">
								</div>
					...
					<div class="row col-mb-50 mt-3">
						...
						<div class="col-lg-4 col-md-6 pb-0">
							...
							<div class="feature-box fbox-plain bottommargin">
								<div class="fbox-icon">
									<img src="{{asset('cleaner/demos/cleaner/images/icons/cleaner-man.svg')}}" alt="Cleaner Icon">
								</div>
							...
							<div class="feature-box fbox-plain bottommargin">
								<div class="fbox-icon">
									<img src="{{asset('cleaner/demos/cleaner/images/icons/cleaning-man.svg')}}" alt="Cleaner Icon">
								</div>
								<div class="fbox-content">
							...
							<div class="feature-box fbox-plain bottommargin">
								<div class="fbox-icon">
									<img src="{{asset('cleaner/demos/cleaner/images/icons/guarantee.svg')}}" alt="Cleaner Icon">
								</div>
								<div class="fbox-content">
						...
						<div class="col-lg-4 col-md-6">
							...
							<div class="feature-box fbox-plain bottommargin">
								<div class="fbox-icon">
									<img src="{{asset('cleaner/demos/cleaner/images/icons/product.svg')}}" alt="Cleaner Icon">
								</div>
								<div class="fbox-content">
									...
									<div class="col-lg-8">
										...
										<div class="row">
											...
											<div class="col-12 form-group mb-4">
												<label class="mb-3">Others Requirment: <small class="nott ls0 text-black-50">(Select Multiples)*</small></label><br>
												<div class="btn-group w-100" role="group">
													...
													<label for="clean-form-others-clean-garden" class="btn btn-outline-secondary px-4 fw-semibold ls0 nott">Clean Garden</label>
													...
													<label for="clean-form-others-play-room" class="btn btn-outline-secondary px-4 fw-semibold ls0 nott">Play Room</label>
													...
													<label for="clean-form-others-garage" class="btn btn-outline-secondary px-4 fw-semibold ls0 nott">Garage</label>
													...
													<label for="clean-form-others-gym" class="btn btn-outline-secondary px-4 fw-semibold ls0 nott">Gym</label>
												</div>
											</div>
											...
											<div class="col-12">
												<label for="clean-form-message">Additional Message <small class="nott ls0 text-black-50">(Optional):</small></label>
									...
									<div class="col-lg-4 mt-4 mt-md-0">
										<div class="card text-center border-0 shadow-sm">
											...
											<div class="card-body py-4">
												...
												<button type="submit" name="clean-form-submit" class="button button-rounded button-light button-large second-bg-color text-dark w-100 ls0 m-0">Book Now</button>
											</div>
										</div>
										...
										<p class="fw-semibold">Want to know more? <a href="#"><u>See the full FAQs</u></a> <i class="icon-caret-right1 color"></i></p>
									</div>
								</div>
							</form>
						</div>
				...
				<div class="section m-0 dark" style="background: linear-gradient(rgba(51,94,238,0.8), rgba(51,94,238,0.8)), url({{asset('/cleaner/demos/cleaner/images/section2.jpg')}}) center center no-repeat; background-size: cover; padding: 80px 0 230px">
					<div class="container">
						<div class="heading-block center mx-auto" style="max-width: 700px">
					...
					<div class="container">
						<div id="cleaner-carousel" class="owl-carousel carousel-widget" data-margin="30" data-nav="true" data-pagi="true" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="4" data-items-xl="4">
							<div class="card border-0 shadow-sm">
								<img src="{{asset('cleaner/demos/cleaner/images/cleaners/1.jpg')}}" class="card-img-top" alt="...">
							...
							<div class="card border-0 shadow-sm">
								<img src="{{asset('cleaner/demos/cleaner/images/cleaners/2.jpg')}}" class="card-img-top" alt="...">
								<div class="card-body second-bg-color rounded-bottom p-4">
							...
							<div class="card border-0 shadow-sm">
								<img src="{{asset('cleaner/demos/cleaner/images/cleaners/3.jpg')}}" class="card-img-top" alt="...">
								<div class="card-body second-bg-color rounded-bottom p-4">
							...
							<div class="card border-0 shadow-sm">
								<img src="{{asset('cleaner/demos/cleaner/images/cleaners/4.jpg')}}" class="card-img-top" alt="...">
								<div class="card-body second-bg-color rounded-bottom p-4">
							...
							<div class="card border-0 shadow-sm">
								<img src="{{asset('cleaner/demos/cleaner/images/cleaners/5.jpg')}}" class="card-img-top" alt="...">
								<div class="card-body second-bg-color rounded-bottom p-4">
							...
							<div class="card border-0 shadow-sm">
								<img src="{{asset('cleaner/demos/cleaner/images/cleaners/6.jpg')}}" class="card-img-top" alt="...">
								<div class="card-body second-bg-color rounded-bottom p-4">
					...
					<div class="container">
						<div class="row justify-content-between align-items-center">
							...
							<div class="col-md-5 center">
								<img src="{{asset('cleaner/demos/cleaner/images/icons/reviews.svg')}}" alt="Review Image" width="400">
								<div class="row mt-5">
									<div class="col-6">
							...
							<div class="col-lg-6 col-md-7">
								...
								<div id="oc-testi" class="owl-carousel testimonials-carousel carousel-widget" data-margin="10" data-nav="false" data-pagi="true" data-items="1" data-autoplay="5000" data-loop="true">
									<div class="oc-item">
										<div class="testimonial bg-transparent p-4 shadow-sm">
											<div class="testi-image">
												<a href="#"><img src="{{asset('cleaner/images/testimonials/1.jpg')}}" alt="Customer Testimonails"></a>
											</div>
									...
									<div class="oc-item">
										<div class="testimonial bg-transparent p-4 shadow-sm">
											<div class="testi-image">
												<a href="#"><img src="{{asset('cleaner/images/testimonials/2.jpg')}}" alt="Customer Testimonails"></a>
											</div>
											<div class="testi-content">
				...
				<div class="section center mb-0" style="padding: 120px 0; background-color: rgba(51,94,238,0.08);">
					<div class="container" style="max-width: 700px">
						<img src="{{asset('cleaner/demos/cleaner/images/icons/apply.svg')}}" alt="Apply Icon" height="200" class="mb-4">
				...
				<div class="footer-widgets-wrap">
					...
					<div class="row">
						<div class="col-6 col-lg-4">
							<img class="mb-5" src="{{asset('cleaner/demos/bike/images/logo-foo.png')}}" alt="" width="123">
							...
							<div>
								...
								<a href="#" class="social-icon me-2 si-light si-rounded si-small si-youtube">
