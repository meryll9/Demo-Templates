                            ...
                            <div class="row align-items-center mt-5">
                                <div class="col-xl-6 pe-0 pe-xl-5 col-md-5 col-sm-11 col-12 mb-5 mb-lg-0">
                                    <div class="heading-block border-bottom-0 mb-4">
                                        <div class="before-heading mb-2">02 February 2021 <span
                                                class="badge bg-secondary ms-1">Featured</span></div>
                                        <h2 class="fw-bold ls0 nott">{{ env('APP_TAGLINE') }}</h2>
                                    </div>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda praesentium eius,
                                        similique reprehenderit ab voluptatibus eaque. Nobis maxime recusandae aliquid, id
                                        impedit aperiam dolore quas, illo eum quam. Architecto, reiciendis.</p>
                                    <div
                                        class="article-info bottommargin-sm d-flex align-items-center justify-content-between">
                                        <div class="rating-stars ms-1"><i class="icon-star3"></i><i
                                                class="icon-star3"></i><i class="icon-star3"></i><i
                                                class="icon-star3"></i><i class="icon-star-half-full"></i></div>
                                        <h5 class="mb-0">by: <a href="#">Samuel Serif</a></h5>
                                        <span class="article-price fw-bold ms-1"><del>$50.00</del> $42.00</span>
                                    </div>
                                    <a href="#" class="button button-large nott ms-0"><i class="icon-shopping-cart1"></i>
                                        Add to Cart</a>
                                </div>
                                <div class="col-xl-2 col-md-3 col-4 parallax" data-0="transform: translateY(0px);"
                                    data-600="transform: translateY(-30px);">
                                    <img src="{{ asset('articles/demos/articles/images/articles/1/1.png') }}" alt="Image"
                                        class="rounded faster" data-animate="fadeInLeft">
                                    <div class="card mt-3 d-none d-sm-block faster" data-animate="fadeInLeft"
                                        data-delay="100">
                                ...
                                <div class="col-xl-2 col-md-2 col-4 p-0 parallax" data-0="transform: translateY(0);"
                                    ...
                                    <img src="{{ asset('articles/demos/articles/images/articles/1/4.png') }}" alt="Image"
                                        class="faster rounded" data-animate="fadeInLeft" data-delay="200">
                                    <img src="{{ asset('articles/demos/articles/images/articles/1/2.png') }}" alt="Image"
                                        class="faster rounded mt-3" data-animate="fadeInLeft" data-delay="300">
                                </div>
                                <div class="col-xl-2 col-md-2 col-4 parallax" data-0="transform: translateY(0px);"
                                    data-600="transform: translateY(-20px);">
                                    <img src="{{ asset('articles/demos/articles/images/articles/1/3.png') }}" alt="Image"
                                        class="faster rounded" data-animate="fadeInLeft" data-delay="400">
                                    <img src="{{ asset('articles/demos/articles/images/articles/1/5.png') }}" alt="Image"
                                        class="faster rounded mt-3" data-animate="fadeInLeft" data-delay="500">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="row align-items-center mt-5">
                                <div class="col-xl-6 pe-0 pe-xl-5 col-md-6 col-sm-11 col-12 mb-5 mb-lg-0">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quam ipsa harum obcaecati,
                                        et quo facilis itaque minima tempore voluptates suscipit.</p>
                                    <div
                                        class="article-info bottommargin-sm d-flex align-items-center justify-content-between">
                                        <div class="rating-stars ms-1"><i class="icon-star3"></i><i
                                                class="icon-star3"></i><i class="icon-star3"></i><i
                                ...
                                <div class="col-xl-3 col-md-3 col-6 parallax" data-0="transform: translateY(0px);"
                                    ...
                                    <img src="{{ asset('articles/demos/articles/images/articles/2/1.png') }}" alt="Image"
                                        class="rounded" data-animate="faster fadeInLeft">
                                ...
                                <div class="col-xl-3 col-md-3 col-6 p-0 parallax" data-0="transform: translateY(0);"
                                    ...
                                    <img src="{{ asset('articles/demos/articles/images/articles/2/2.png') }}" alt="Image"
                                        class="rounded" data-animate="faster fadeInLeft" data-delay="200">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="content">
        ...
        <div class="content-wrap pb-0 clearfix">
                    ...
                    <div class="row justify-content-start justify-content-sm-center justify-content-md-start">
                        <div class="col-lg-4 col-md-6">
                            <div class="heading-block services-info pe-1">
                                <h2 class="fw-normal ls0 nott font-primary">Our Services</h2>
                                    ...
                                    <div class="feature-box media-box">
                                        <div class="fbox-icon position-relative mb-4" style="width: auto;height: 50px">
                                            <div class="d-flex align-items-center">
                                                <svg width="32" height="32" viewBox="0 0 512.00096 512.00096"
                                                    xmlns="https://www.w3.org/2000/svg">
                                                    <path
                                                ...
                                                <svg width="32" height="32" class="ms-3" viewBox="0 0 512 512"
                                                    xmlns="https://www.w3.org/2000/svg">
                                                    <path
                                        ...
                                        <div class="fbox-content">
                                            <h3 class="fw-normal nott ls0">On Social Networks.</h3>
                                            <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing
                                                elit. Eligendi rem, facilis nobis voluptatum.</p>
                                            <a href="#" class="btn btn-link font-body mt-3 p-0">Read More..</a>
                                        </div>
            ...
            <div class="section m-0 section-scroller" style="padding: 100px 0">
                <div class="container center">
                    ...
                    <div class="heading-block border-bottom-0 mx-auto" style="max-width: 820px">
                        <h2 class="nott ls0 fw-normal">Rapidiously pontificate tactical information visa installed base
                            platforms.</h2>
                        <a href="demo-articles-books.html" class="button button-large nott px-5 ms-0 mt-4 clearfix">View
                            All</a>
                    </div>
                </div>
                    ...
                    <div class="swiper-container swiper-parent swiper-scroller">
                        <div class="swiper-wrapper h-auto">
                            ...
                            <div class="swiper-slide">
                                <div class="row m-auto align-items-center">
                                    <div class="col-md-6 p-0">
                                        <img src="{{ asset('articles/demos/articles/images/articles/1/1.png') }}"
                                            alt="Image">
                                    ...
                                    <div class="col-md-6 p-0">
                                        <div class="card">
                                            <div class="card-body py-4">
                                                ...
                                                <p class="mb-3 d-none d-sm-block">Proactively empower flexible partnerships
                                                    rather than ethical products. Assertively cultivate 2.0 ROI before
                                                    standardized processes.</p>
                                                <div class="article-info mb-3 d-flex align-items-center">
                                                    <div class="rating-stars me-3"><i class="icon-star3"></i><i
                                                            class="icon-star3"></i><i class="icon-star3"></i><i
                                                            class="icon-star3"></i><i class="icon-star-half-full"></i>
                                                    </div>
                                                    <h5>by: <a href="#">Samuel Serif</a></h5>
                                                </div>
                                                <span class="article-price fw-bold ms-1 clearfix"><del>$50.00</del>
                                                    $42.00</span>
                                                <a href="#"
                                                    class="button button-small button-dark ls0 shadow-none nott ms-0 mt-4 clearfix"><i
                                                        class="icon-shopping-cart1"></i>Add to Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="row m-auto align-items-center">
                                    <div class="col-md-6 p-0">
                                        <img src="{{ asset('articles/demos/articles/images/articles/2/1.png') }}"
                                            alt="Image">
                                        <div class="sale-flash badge bg-color text-light p-2">Sale!</div>
                                    </div>
                                    <div class="col-md-6 p-0">
                                        <div class="card">
                                            <div class="card-body py-4">
                                                ...
                                                <p class="mb-3 d-none d-sm-block">Continually impact viral web-readiness
                                                    before client-focused value. Phosfluor brand global action items via
                                                    principle-centered ideas.</p>
                                                <div class="article-info mb-3 d-flex align-items-center">
                                                    <div class="rating-stars me-3"><i class="icon-star3"></i><i
                                                            class="icon-star3"></i><i class="icon-star3"></i><i
                                                            class="icon-star3"></i><i class="icon-star-empty"></i>
                                                    </div>
                                                    <h5>by: <a href="#">Parsley Montana</a></h5>
                                                </div>
                                                <span class="article-price fw-bold ms-1 clearfix"><del>$39.99</del>
                                                    $29.99</span>
                                                <a href="#"
                                                    class="button button-small button-dark ls0 shadow-none nott ms-0 mt-4 clearfix"><i
                                                        class="icon-shopping-cart1"></i>Add to Cart</a>
                            ...
                            <div class="swiper-slide">
                                <div class="row m-auto align-items-center justify-content-center">
                                    <div class="col-md-6 p-0">
                                        <img src="{{ asset('articles/demos/articles/images/articles/3/1.png') }}"
                                            alt="Image">
                                    </div>
                                    <div class="col-md-6 p-0">
                                        <div class="card">
                            ...
                            <div class="swiper-slide">
                                <div class="row m-auto align-items-center">
                                    <div class="col-md-6 p-0">
                                        <img src="{{ asset('articles/demos/articles/images/articles/4/1.png') }}"
                                            alt="Image">
                                    </div>
                                    <div class="col-md-6 p-0">
                                        <div class="card">
                                    ...
                                    <div class="col-md-6 p-0">
                                        <div class="card">
                                            <div class="card-body py-4">
                                                ...
                                                <span class="article-price fw-bold ms-1 clearfix"><del>$60.00</del>
                                                    $49.99</span>
                                                <a href="#"
                                                    class="button button-small button-dark ls0 shadow-none nott ms-0 mt-4 clearfix"><i
                                                        class="icon-shopping-cart1"></i>Add to Cart</a>
                            ...
                            <div class="swiper-slide">
                                <div class="row m-auto align-items-center">
                                    <div class="col-md-6 p-0">
                                        <img src="{{ asset('articles/demos/articles/images/articles/6/1.png') }}"
                                            alt="Image">
                                    </div>
                                    <div class="col-md-6 p-0">
                                        <div class="card">
            ...
            <div class="section section-about m-0"
                style="padding: 120px 0; background: url({{ asset('/articles/demos/articles/images/dots-1.png') }}) 100% 0 no-repeat / 40%;">
                <div class="container">
                    <div class="row">
                        <div class="col-md-5">
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('articles/demos/articles/images/author.jpg') }}" alt="Image">
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6 mt-3 mt-sm-0">
                            ...
                            <p class="mb-0">Progressively strategize just in time scenarios and compelling
                        ...
                        <div class="col-lg-5 mt-5 mt-lg-0">
                            ...
                            <div id="oc-images" class="owl-carousel image-carousel carousel-widget" data-margin="20"
                                ...
                                <div class="oc-item">
                                    <a href="#"><img src="{{ asset('articles/demos/articles/images/articles/1/1.png') }}"
                                            alt="Image 1"></a>
                                </div>
                                <div class="oc-item">
                                    <a href="#"><img src="{{ asset('articles/demos/articles/images/articles/1/2.png') }}"
                                            alt="Image 2"></a>
                                </div>
                                <div class="oc-item">
                                    <a href="#"><img src="{{ asset('articles/demos/articles/images/articles/2/1.png') }}"
                                            alt="Image 3"></a>
                                </div>
                                <div class="oc-item">
                                    <a href="#"><img src="{{ asset('articles/demos/articles/images/articles/4/1.png') }}"
                                            alt="Image 4"></a>
                                </div>
                                <div class="oc-item">
                                    <a href="#"><img src="{{ asset('articles/demos/articles/images/articles/6/1.png') }}"
                                            alt="Image 5"></a>
                                </div>
                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-6">
                            ...
                            <p>Progressively strategize just in time scenarios and compelling results. Intrinsicly parallel
                                ...
                                change.</p>
                            <div>
                                <a href="#"><img src="{{ asset('articles/demos/articles/images/appstore.png') }}"
                                        alt="Image" height="54" class="mt-3"></a>
                                <a href="#"><img src="{{ asset('articles/demos/articles/images/googleplay.png') }}"
                        ...
                        <div class="col-lg-6 col-md-7 col-sm-6 mt-5 mt-sm-0">
                            <div class="d-none d-lg-flex">
                                <img src="{{ asset('articles/demos/articles/images/iphone-1.png') }}"
                                    class="fast" alt="Image" style="height: 600px" data-animate="fadeInDown">
                                <img src="{{ asset('articles/demos/articles/images/iphone-2.png') }}"
