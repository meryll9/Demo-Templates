	...
	<div id="wrapper" class="clearfix">
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="demo-articles.html" class="standard-logo" data-dark-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
							<a href="demo-articles.html" class="retina-logo" data-dark-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								...
								<li class="menu-item"><a href="demo-articles-books.html" class="menu-link ls0"><div>Articles</div></a>
									<ul class="sub-menu-container">
										<li class="menu-item"><a href="demo-articles-single.html" class="menu-link ls0"><div>Single</div></a></li>
									</ul>
								</li>
								...
								<div class="row align-items-center mt-5">
									<div class="col-xl-6 pe-0 pe-xl-5 col-md-5 col-sm-11 col-12 mb-5 mb-lg-0">
										...
										<div class="article-info bottommargin-sm d-flex align-items-center justify-content-between">
											<div class="rating-stars ms-1"><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star-half-full"></i></div>
											<h5 class="mb-0">by: <a href="#">Samuel Serif</a></h5>
											<span class="article-price fw-bold ms-1"><del>$50.00</del> $42.00</span>
										</div>
										<a href="#" class="button button-large nott ms-0"><i class="icon-shopping-cart1"></i> Add to Cart</a>
									</div>
									<div class="col-xl-2 col-md-3 col-4 parallax" data-0="transform: translateY(0px);" data-600="transform: translateY(-30px);">
										<img src="{{asset('articles/demos/articles/images/articles/1/1.png')}}" alt="Image" class="rounded faster" data-animate="fadeInLeft">
									...
									<div class="col-xl-2 col-md-2 col-4 p-0 parallax" data-0="transform: translateY(0);" data-600="transform: translateY(20px);">
										<img src="{{asset('articles/demos/articles/images/articles/1/4.png')}}" alt="Image" class="faster rounded" data-animate="fadeInLeft" data-delay="200">
										<img src="{{asset('articles/demos/articles/images/articles/1/2.png')}}" alt="Image" class="faster rounded mt-3" data-animate="fadeInLeft" data-delay="300">
									</div>
									<div class="col-xl-2 col-md-2 col-4 parallax" data-0="transform: translateY(0px);" data-600="transform: translateY(-20px);">
										<img src="{{asset('articles/demos/articles/images/articles/1/3.png')}}" alt="Image" class="faster rounded" data-animate="fadeInLeft" data-delay="400">
										<img src="{{asset('articles/demos/articles/images/articles/1/5.png')}}" alt="Image" class="faster rounded mt-3" data-animate="fadeInLeft" data-delay="500">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="container">
								<div class="row align-items-center mt-5">
									...
									<div class="col-xl-3 col-md-3 col-6 parallax" data-0="transform: translateY(0px);" data-600="transform: translateY(-30px);">
										<img src="{{asset('articles/demos/articles/images/articles/2/1.png')}}" alt="Image" class="rounded" data-animate="faster fadeInLeft">
									...
									<div class="col-xl-3 col-md-3 col-6 p-0 parallax" data-0="transform: translateY(0);" data-600="transform: translateY(40px);">
										<img src="{{asset('articles/demos/articles/images/articles/2/2.png')}}" alt="Image" class="rounded" data-animate="faster fadeInLeft" data-delay="200">
									</div>
								</div>
							</div>
						</div>
		...
		<section id="content">
			...
			<div class="content-wrap pb-0 clearfix">
							...
							<div class="swiper-wrapper h-auto">
								...
								<div class="swiper-slide">
									<div class="row m-auto align-items-center justify-content-center">
										<div class="col-md-6 p-0">
											<img src="{{asset('articles/demos/articles/images/articles/3/1.png')}}" alt="Image">
										</div>
										<div class="col-md-6 p-0">
											<div class="card">
												<div class="card-body py-4">
								...
								<div class="swiper-slide">
									<div class="row m-auto align-items-center">
										<div class="col-md-6 p-0">
											<img src="{{asset('articles/demos/articles/images/articles/4/1.png')}}" alt="Image">
										</div>
										<div class="col-md-6 p-0">
											<div class="card">
												<div class="card-body py-4">
								...
								<div class="swiper-slide">
									<div class="row m-auto align-items-center">
										<div class="col-md-6 p-0">
											<img src="{{asset('articles/demos/articles/images/articles/6/1.png')}}" alt="Image">
										</div>
										<div class="col-md-6 p-0">
											<div class="card">
												<div class="card-body py-4">
				...
				<div class="section section-about m-0" style="padding: 120px 0; background: url({{asset('/articles/demos/articles/images/dots-1.png')}}) 100% 0 no-repeat / 40%;">
					<div class="container">
						<div class="row">
							<div class="col-md-5">
						...
						<div class="row align-items-center">
							...
							<div class="col-lg-5 mt-5 mt-lg-0">
								...
								<div id="oc-images" class="owl-carousel image-carousel carousel-widget" data-margin="20" data-nav="true" data-pagi="true" data-items-xs="2" data-items-sm="3" data-items-md="3" data-items-lg="2" data-items-xl="2">
									...
									<div class="oc-item">
										<a href="#"><img src="{{asset('articles/demos/articles/images/articles/6/1.png')}}" alt="Image 5"></a>
									</div>
					...
					<div class="container">
						<div class="row align-items-center justify-content-between">
							...
							<div class="col-lg-5 col-md-5 col-sm-6">
								...
								<div>
									<a href="#"><img src="{{asset('articles/demos/articles/images/appstore.png')}}" alt="Image" height="54" class="mt-3"></a>
									<a href="#"><img src="{{asset('articles/demos/articles/images/googleplay.png')}}" alt="Image"  class="ms-xl-3 ms-lg-1 mt-3 ms-0 " height="54"></a>
								</div>
							</div>

							<div class="col-lg-6 col-md-7 col-sm-6 mt-5 mt-sm-0">
								<div class="d-none d-lg-flex">
									<img src="{{asset('articles/demos/articles/images/iphone-1.png')}}" class="fast" alt="Image" style="height: 600px" data-animate="fadeInDown">
									<img src="{{asset('articles/demos/articles/images/iphone-2.png')}}" class="fast" alt="Image" style="height: 600px" data-animate="fadeInUp">
								</div>
								<img src="{{asset('articles/demos/articles/images/iphone.png')}}" alt="Image" class="d-block d-lg-none px-5 px-sm-0 p-md-5">
							</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="widget clearfix">
							...
							<div class="d-flex align-items-center mb-4">
								<img src="{{asset('articles/demos/articles/images/logo-footer.jpg')}}" height="40" alt="Image">
							...
							<div class="posts-sm row col-mb-30" id="post-list-footer">
									...
									<div class="grid-inner row align-items-center g-0">
										<div class="col-auto">
											<div class="entry-image">
												<a href="#"><img src="{{asset('articles/demos/articles/images/authors/1.jpg')}}" alt="Author"></a>
											</div>
										</div>
										<div class="col ps-3">
								...
								<div class="entry col-12">
									<div class="grid-inner row align-items-center g-0">
										<div class="col-auto">
											<div class="entry-image">
												<a href="#"><img src="{{asset('articles/demos/articles/images/authors/2.jpg')}}" alt="Author"></a>
											</div>
										</div>
										<div class="col ps-3">
											<div class="entry-title">
								...
								<div class="entry col-12">
									<div class="grid-inner row align-items-center g-0">
										<div class="col-auto">
											<div class="entry-image">
												<a href="#"><img src="{{asset('articles/demos/articles/images/authors/3.jpg')}}" alt="Author"></a>
											</div>
										</div>
										<div class="col ps-3">
											<div class="entry-title">
