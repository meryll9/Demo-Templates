                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide dark">
                        ...
                        <div class="swiper-slide-bg"
                            style="background-image: url({{ asset('/store/demos/store/images/slider/1.jpg') }});"></div>
                    </div>
                    <div class="swiper-slide dark">
                        <div class="container">
                            <div class="slider-caption">
                        ...
                        <div class="swiper-slide-bg"
                            style="background-image: linear-gradient(to bottom, rgba(0,0,0,.1), rgba(0,0,0,.6)), url({{ asset('/store/demos/store/images/slider/2.jpg') }});">
                        </div>
                    </div>
                    <div class="swiper-slide dark">
                        <div class="container">
                        ...
                        <div class="swiper-slide-bg"
                            style="background-image: linear-gradient(to bottom, rgba(0,0,0,.2), rgba(0,0,0,.3)), url({{ asset('/store/demos/store/images/slider/3.jpg') }});">
                        </div>
                    </div>
                </div>
        ...
        <div class="content-wrap pb-0">
                ...
                <div class="row mt-2">
                    <div class="col-md-4 mb-5">
                        <div class="card cat-card rounded-0 border-0 dark">
                            <img src="{{ asset('store/demos/store/images/cat/outerwear.jpg') }}" class="card-img rounded-0"
                                alt="...">
                            <div class="d-flex align-items-start flex-column card-img-overlay p-4">
                                ...
                                <p>This is a wider card as a natural lead-in to additional content. This content is a little
                                    bit longer.</p>
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card cat-card rounded-0 border-0 dark">
                            <img src="{{ asset('store/demos/store/images/cat/footwear.jpg') }}" class="card-img rounded-0"
                                alt="...">
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card cat-card rounded-0 border-0 dark">
                            <img src="{{ asset('store/demos/store/images/cat/workout.jpg') }}" class="card-img rounded-0"
                                alt="...">
                            <div class="d-flex align-items-start flex-column card-img-overlay bg p-4">
                                        ...
                                        <div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
                                            <div class="flexslider">
                                                <div class="slider-wrap">
                                                    <div class="slide">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/3-1.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                    <div class="slide">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/3-2.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                    <div class="slide">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/3-3.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                    <div class="slide">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/3-4.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
                                            <div class="flexslider">
                                                <div class="slider-wrap">
                                                    <div class="slide">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/4-1.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                    <div class="slide">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/4-2.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
                                            <div class="flexslider">
                                                <div class="slider-wrap">
                                                    <div class="slide">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/5-1.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                    <div class="slide">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/5-2.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                </div>
                                            </div>
            ...
            ============================================= -->
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="product">
                                        ...
                                        <div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
                                            <div class="flexslider">
                                                <div class="slider-wrap">
                                                    <div class="slide">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/6-1.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                    <div class="slide">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/6-2.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="product-desc">
                                        <div class="product-title">
                                            <h3><a href="demo-store-product-single.html">Men White Escaper SL Running Sports
                                                    Shoes</a></h3>
            ...
            ============================================= -->
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="product">
                                    <div class="product-image position-relative">
                                        <div class="fslider" data-arrows="false" data-pagi="false" data-speed="400"
                                            ...
                                            <div class="flexslider">
                                                <div class="slider-wrap">
                                                    <div class="slide"
                                                        data-thumb="{{ asset('store/demos/store/images/product/7-1.jpg') }}">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/7-1.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                    <div class="slide"
                                                        data-thumb="{{ asset('store/demos/store/images/product/7-2.jpg') }}">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/7-2.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                    <div class="slide"
                                                        data-thumb="{{ asset('store/demos/store/images/product/7-3.jpg') }}">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/7-3.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="product-desc">
                                        <div class="product-title">
                                            <h3><a href="demo-store-product-single.html">The Cotton Weave Shirtdress</a>
                                            </h3>
                            ...
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="product">
                                    <div class="product-image">
                                        <a href="demo-store-product-single.html"><img
                                                src="{{ asset('store/demos/store/images/product/8-1.jpg') }}"
                                                alt="Morning Dew"></a>
                                        <a href="demo-store-product-single.html"><img
                                                src="{{ asset('store/demos/store/images/product/8-2.jpg') }}"
                                                alt="Morning Dew"></a>
                                        <a href="#" class="cart-btn button button-white button-light"><i
                                                class="icon-line-plus"></i>Add to Cart</a>
                                    </div>
                                        ...
                                        <div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
                                            <div class="flexslider">
                                                <div class="slider-wrap">
                                                    <div class="slide">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/9-1.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                    <div class="slide">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/9-2.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                    <div class="slide">
                                                        <a href="demo-store-product-single.html"><img
                                                                src="{{ asset('store/demos/store/images/product/9-3.jpg') }}"
                                                                alt="Morning Dew"></a>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="container-fluid mt-5">
                <div class="row">
                    <div class="col-md-6 mb-5">
                        <img src="{{ asset('store/demos/store/images/others/travel.jpg') }}" alt="image"
                            class="mb-4">
                    ...
                    <div class="col-md-6 mb-5">
                        <img src="{{ asset('store/demos/store/images/others/store.jpg') }}" alt="image"
                            class="mb-4">
                        ...
                        <p class="mb-3"><i class="icon-map-marker-alt"></i> <strong>Headquarters: </strong><a
                                href="#" class="text-black-50 under btn-link"> 795 Folsom Ave, Suite 600 San Francisco, CA
                                94107</a></p>
            ...
            <div class="section m-0 border-0" style="padding: 120px 0;">
                <div class="video-wrap" style="z-index: 0">
                    <video poster="{{ asset('store/one-page/images/page/portrait/video-poster.jpg') }}" preload="auto" loop
                        autoplay muted>
                ...
                <div class="emphasis-title widget subscribe-widget mx-auto center px-4" data-loader="button"
                    ...
                    <p class="mb-5 text-white-50 lead" data-delay="100">Subscribe to Our Newsletter to get Important News,
                    ...
                    <form id="widget-subscribe-form-2" action="include/subscribe.php" method="post"
                        ...
                        <input type="email" id="widget-subscribe-form-2-email" name="widget-subscribe-form-email"
                            class="form-control required email rounded-0 border-0" placeholder="Enter your Email Address">

                        <button class="btn btn-dark bg-color rounded-0 text-uppercase fw-bold" type="submit"
                            style="font-size: 16px">Subscribe Now</button>
                    </form>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <p>Synergistically repurpose ethical value and backend paradigms. Holisticly architect effective
                                expertise for installed base e-markets.</p>
                        </div>
                        <div class="col-md-3 col-sm-6">
