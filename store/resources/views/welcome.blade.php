									...
									<div class="top-cart-items">
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="{{asset('store/demos/shop/images/items/featured/5.jpg')}}" alt="Blue Shoulder Bag" /></a>
											</div>
										...
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#" class="fw-normal"><img src="{{asset('store/demos/shop/images/items/featured/1.jpg')}}" alt="Leather Bag" /></a>
											</div>
											<div class="top-cart-item-desc">
												<div class="top-cart-item-desc-title">
											...
											<div class="row">
												...
												<ul class="mega-menu-column sub-menu-container col-lg-3 border-start-0">
													<li class="card p-0 bg-transparent border-0">
														<img class="card-img-top" src="{{asset('store/demos/store/images/others/menu.jpg')}}" alt="image cap">
						...
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption">
									<h2 data-animate="fadeInUp">{{ env('APP_TAGLINE') }}</h2>
							...
							<div class="swiper-slide-bg" style="background-image: url({{asset('/store/demos/store/images/slider/1.jpg')}});"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption">
							...
							<div class="swiper-slide-bg" style="background-image: linear-gradient(to bottom, rgba(0,0,0,.1), rgba(0,0,0,.6)), url({{asset('/store/demos/store/images/slider/2.jpg')}});"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption">
							...
							<div class="swiper-slide-bg" style="background-image: linear-gradient(to bottom, rgba(0,0,0,.2), rgba(0,0,0,.3)), url({{asset('/store/demos/store/images/slider/3.jpg')}});"></div>
						</div>
					</div>
					...
					<div class="row mt-2">
						<div class="col-md-4 mb-5">
							<div class="card cat-card rounded-0 border-0 dark">
								<img src="{{asset('store/demos/store/images/cat/outerwear.jpg')}}" class="card-img rounded-0" alt="...">
						...
						<div class="col-md-4 mb-5">
							<div class="card cat-card rounded-0 border-0 dark">
								<img src="{{asset('store/demos/store/images/cat/footwear.jpg')}}" class="card-img rounded-0" alt="...">
						...
						<div class="col-md-4 mb-5">
							<div class="card cat-card rounded-0 border-0 dark">
								<img src="{{asset('store/demos/store/images/cat/workout.jpg')}}" class="card-img rounded-0" alt="...">
								<div class="d-flex align-items-start flex-column card-img-overlay bg p-4">
											...
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/1-1.jpg')}}" alt="Black Shoe"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/1-2.jpg')}}" alt="Black Shoe"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/2-1.jpg')}}" alt="Sports Shoe"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/2-2.jpg')}}" alt="Sports Shoe"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/3-1.jpg')}}" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/3-2.jpg')}}" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/3-3.jpg')}}" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/3-4.jpg')}}" alt="Morning Dew"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/4-1.jpg')}}" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/4-2.jpg')}}" alt="Morning Dew"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/5-1.jpg')}}" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/5-2.jpg')}}" alt="Morning Dew"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/6-1.jpg')}}" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/6-2.jpg')}}" alt="Morning Dew"></a>
														</div>
													</div>
												</div>
											</div>
									...
									<div class="product">
										<div class="product-image position-relative">
											<div class="fslider" data-arrows="false" data-pagi="false" data-speed="400" data-pause="6000" data-thumbs="true">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide" data-thumb="{{asset('store/demos/store/images/product/7-1.jpg')}}">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/7-1.jpg')}}" alt="Morning Dew"></a>
														</div>
														<div class="slide" data-thumb="{{asset('store/demos/store/images/product/7-2.jpg')}}">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/7-2.jpg')}}" alt="Morning Dew"></a>
														</div>
														<div class="slide" data-thumb="{{asset('store/demos/store/images/product/7-3.jpg')}}">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/7-3.jpg')}}" alt="Morning Dew"></a>
														</div>
													</div>
												</div>
											</div>
								...
								<div class="col-lg-4 col-md-6 mb-4">
									<div class="product">
										<div class="product-image">
											<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/8-1.jpg')}}" alt="Morning Dew"></a>
											<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/8-2.jpg')}}" alt="Morning Dew"></a>
											<a href="#" class="cart-btn button button-white button-light"><i class="icon-line-plus"></i>Add to Cart</a>
										</div>
										<div class="product-desc">
											<div class="product-title">
										...
										<div class="product-image">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/9-1.jpg')}}" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/9-2.jpg')}}" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.html"><img src="{{asset('store/demos/store/images/product/9-3.jpg')}}" alt="Morning Dew"></a>
														</div>
													</div>
												</div>
											</div>
				...
				<div class="container-fluid mt-5">
					<div class="row">
						<div class="col-md-6 mb-5">
							<img src="{{asset('store/demos/store/images/others/travel.jpg')}}" alt="image" class="mb-4">
						...
						<div class="col-md-6 mb-5">
							<img src="{{asset('store/demos/store/images/others/store.jpg')}}" alt="image" class="mb-4">
							...
							<a href="#" class="btn p-0 fw-semibold"><u>Visit Our Store</u> <i class="icon-line-arrow-right position-relative ms-1" style="top: 2px"></i></a>
						</div>
					</div>
				</div>
					...
					<div class="row justify-content-between align-items-center">
						...
						<div class="col-md-6 d-md-flex flex-md-column align-items-md-end mt-4 mt-md-0">
							<ul class="list-unstyled d-flex flex-row mb-2 clearfix">
								<li class="me-2"><img src="{{asset('store/demos/xmas/images/cards/visa.svg')}}" alt="Visa" width="34"></li>
								<li class="me-2"><img src="{{asset('store/demos/xmas/images/cards/mc.svg')}}" alt="Master Card" width="34"></li>
								<li class="me-2"><img src="{{asset('store/demos/xmas/images/cards/ae.svg')}}" alt="American Express" width="34"></li>
								<li class="me-2"><img src="{{asset('store/demos/xmas/images/cards/pp.svg')}}" alt="PayPal" width="34"></li>
								<li class="me-2"><img src="{{asset('store/demos/xmas/images/cards/sk.svg')}}" alt="Skrill" width="34"></li>
								<li class="me-2"><img src="{{asset('store/demos/xmas/images/cards/2co.svg')}}" alt="2CheckOut" width="34"></li>
								<li class="me-2"><img src="{{asset('store/demos/xmas/images/cards/wu.svg')}}" alt="Western Union" width="34"></li>
							</ul>
