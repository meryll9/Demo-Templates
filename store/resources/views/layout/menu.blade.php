...
<nav class="primary-menu with-arrows">
    ...
    <ul class="not-dark menu-container">
        ...
        <li class="menu-item mega-menu"><a class="menu-link" href="men">
                <div>Men</div>
            </a>
                        ...
                        <ul class="mega-menu-column sub-menu-container col-lg-3 border-start-0">
                            <li class="card p-0 bg-transparent border-0">
                                <img class="card-img-top"
                                    src="{{ asset('store/demos/store/images/others/menu.jpg') }}" alt="image cap">
                                <a href="#" class="btn btn-link text-start fw-medium ps-0 bg-transparent"><u>Editor's
                                        Pick</u></a>
                            </li>
                        </ul>
                    </div>
        ...
        <li class="menu-item"><a class="menu-link" href="men">
                <div>Women</div>
            </a></li>
