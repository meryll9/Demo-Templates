				...
				<div class="fslider h-100 position-absolute dark" data-speed="1500" data-autoplay="true" data-pause="6000" data-animation="fade" data-arrows="false" data-pagi="false" data-hover="false" data-touch="false">
					<div class="flexslider">
						<div class="slider-wrap">
							<div class="slide" style="background: url({{asset('/headphones/demos/headphones/images/slider/1.jpg')}}) center center; background-size: cover;">
										...
										<div class="row justify-content-center">
											<div class="col-md-7">
												<div class="heading-block border-bottom-0 parallax mb-0" data-0="opacity: 1;margin-top:0px" data-800="opacity: 0.2;margin-top:150px">
													...
													<a href="#" class="button button-border button-circle button-fill fill-from-bottom button-white button-light nott fw-normal"><span>View Details</span></a>
												</div>
											</div>
							...
							<div class="slide h-100" style="background: url({{asset('/headphones/demos/headphones/images/slider/2.jpg')}}) center center; background-size: cover;">
								<div class="vertical-middle">
									<div class="container">
										<div class="row justify-content-center">
											<div class="col-md-7">
							...
							<div class="slide h-100" style="background: url({{asset('/headphones/demos/headphones/images/slider/3.jpg')}}) center center; background-size: cover;">
								<div class="vertical-middle">
									<div class="container">
										<div class="row justify-content-center">
											<div class="col-md-7">
						...
						<div class="row clearfix">
							...
							<div class="col-sm-4 col-12 product showcase-section clearfix">
								<div class="showcase-target-images">
									<img class="showcase-target" alt="Image" id="product-1-black" src="{{asset('headphones/demos/headphones/images/products/1/black.png')}}">
									<img class="showcase-target" alt="Image" id="product-1-red" src="{{asset('headphones/demos/headphones/images/products/1/red.png')}}">
									<img class="showcase-target" alt="Image" id="product-1-blue" src="{{asset('headphones/demos/headphones/images/products/1/blue.png')}}">
								</div>
							...
							<div class="col-sm-4 col-12 product showcase-section clearfix">
								<div class="showcase-target-images">
									<a href="#"><img class="showcase-target" alt="Image" id="product-2-black" src="{{asset('headphones/demos/headphones/images/products/2/black.png')}}"></a>
									<a href="#"><img class="showcase-target" alt="Image" id="product-2-pink" src="{{asset('headphones/demos/headphones/images/products/2/pink.png')}}"></a>
								</div>
							...
							<div class="col-sm-4 col-12 product showcase-section border-0 clearfix">
								<div class="showcase-target-images">
									<a href="#"><img class="showcase-target" alt="Image" id="product-3-black" src="{{asset('headphones/demos/headphones/images/products/3/black.png')}}"></a>
									<a href="#"><img class="showcase-target" alt="Image" id="product-3-red" src="{{asset('headphones/demos/headphones/images/products/3/red.png')}}"></a>
									<a href="#"><img class="showcase-target" alt="Image" id="product-3-blue" src="{{asset('headphones/demos/headphones/images/products/3/blue.png')}}"></a>
									<a href="#"><img class="showcase-target" alt="Image" id="product-3-white" src="{{asset('headphones/demos/headphones/images/products/3/white.png')}}"></a>
								</div>
								<div class="product-desc list-inline center">
									<ul class="mb-0">
					...
					<div class="container">
						<div class="row align-items-center justify-content-center">
							...
							<div class="col-12 col-md-auto text-center mt-4 mt-md-0">
								<a href="#" class="button button-border button-circle button-fill fill-from-bottom button-white button-light nott fw-normal mx-0 ms-md-5"><span>Shop Now</span></a>
							</div>
						</div>
					</div>
					...
					<div class="container clearfix">
						...
						<div class="section-product-content edge-underline" data-bottom-top="transform: translateY(0px);" data-top-bottom="transform: translateY(-100px);">
							...
							<div class="row justify-content-center clearfix">
								...
								<div class="col-6 align-items-center">
									<a href="#" class="button button-border button-circle button-fill fill-from-bottom button-dark button-black nott fw-normal m-0"><span>Buy Now</span></a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row col-mb-50 mb-0 mt-5">
						...
						<div class="col-md-4">
							<div class="feature-box fbox-plain flex-column fbox-sm">
								<div class="fbox-icon mb-3">
									<a href="#">
										<img src="{{asset('headphones/demos/headphones/images/wifi.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image">
									</a>
								</div>
								<div class="fbox-content">
						...
						<div class="col-md-4">
							<div class="feature-box fbox-plain flex-column fbox-sm">
								<div class="fbox-icon mb-3">
									<a href="#">
										<img src="{{asset('headphones/demos/headphones/images/battery.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image">
									</a>
								</div>
								<div class="fbox-content">
						...
						<div class="col-md-4">
							<div class="feature-box fbox-plain flex-column fbox-sm">
								<div class="fbox-icon mb-3">
									<a href="#">
										<img src="{{asset('headphones/demos/headphones/images/headset.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image">
									</a>
								</div>
								<div class="fbox-content">
						...
						<div class="col-md-4">
							<div class="feature-box fbox-plain flex-column fbox-sm">
								<div class="fbox-icon mb-3">
									<a href="#">
										<img src="{{asset('headphones/demos/headphones/images/play-button.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image">
									</a>
								</div>
								<div class="fbox-content">
						...
						<div class="col-md-4">
							<div class="feature-box fbox-plain flex-column fbox-sm">
								<div class="fbox-icon mb-3">
									<a href="#">
										<img src="{{asset('headphones/demos/headphones/images/microphone.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image">
									</a>
								</div>
								<div class="fbox-content">
						...
						<div class="col-md-4">
							<div class="feature-box fbox-plain flex-column fbox-sm">
								<div class="fbox-icon mb-3">
									<a href="#">
										<img src="{{asset('headphones/demos/headphones/images/connected.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image">
									</a>
								</div>
								<div class="fbox-content">
						...
						<div class="col-md-3 mb-2 mb-md-auto overflow-hidden text-overlay-wrap">
							...
							<div class="explore-text-overlay">
								<div class="vertical-middle dark center">
									<div>
										<a href="#" class="button button-border button-circle button-fill fill-from-bottom button-white button-light nott fw-normal m-0"><span>Shop Now</span></a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row topmargin-lg center clearfix">
						<div class="section-contact col-lg-4 col-md-6 bottommargin">
							<div class="p-5">
								...
								<a href="#" class="button button-border button-circle button-fill fill-from-bottom button-dark button-black nott ls0 ms-0 mt-4"><span>Find Store</span></a>
							</div>
						</div>
						...
						<div class="section-contact col-lg-4 col-md-6 bottommargin">
							<div class="p-5">
								...
								<a href="#" class="button button-border button-circle button-fill fill-from-bottom button-dark button-black nott ls0 ms-0 mt-4"><span>SignUp Now</span></a>
							</div>
						</div>
						...
						<div class="section-contact col-lg-4 col-md-6 bottommargin">
							<div class="p-5">
								...
								<a href="#" class="button button-border button-circle button-fill fill-from-bottom button-dark button-black nott ls0 ms-0 mt-4"><span>Contact Us</span></a>
							</div>
						</div>
					</div>
				</div><!-- Container End -->
					...
					<div class="container">
						<div class="row justify-content-between align-items-center">
							...
							<div class="col-sm-6 mt-4 mt-sm-0 d-flex align-items-center justify-content-center justify-content-sm-end">
								<a href="#" class="px-2"><img src="{{asset('headphones/demos/headphones/images/logos/fedex.svg')}}" alt="Image" height="30"></a>
								<a href="#" class="px-2"><img src="{{asset('headphones/demos/headphones/images/logos/dhl.svg')}}" alt="Image" height="30"></a>
								<a href="#" class="px-2"><img src="{{asset('headphones/demos/headphones/images/logos/lbc.svg')}}" alt="Image" height="40"></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="footer-widgets-wrap">
					...
					<div class="row">
						<div class="col-6 col-sm">
							<img class="mb-2" src="{{asset('headphones/demos/headphones/images/footer-logo.png')}}" alt="Image" width="130">
