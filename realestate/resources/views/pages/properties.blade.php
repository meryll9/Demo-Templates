...
@section('content')
    ...
    <section id="slider" class="slider-element dark parallax include-header include-topbar"
        style="background-size: cover; height: 550px; background-image: url({{ asset('/realestate/demos/real-estate/images/single-condo.jpg')}}"
        ...
        <div class="container clearfix" style="z-index: 2;">
            <div class="real-estate-info-wrap">
                <div class="heading-block mb-0 border-bottom-0 d-md-flex d-block align-items-center justify-content-between">
                    <h2 class="me-auto">Luxury Modern Condo Apartment / <span class="h5 text-info">Apartments</span>
                    </h2>
                    <div class="d-flex flex-shrink-1" data-lightbox="gallery">
                        <a href="{{ asset('realestate/demos/real-estate/images/hero/4.jpg')}}"
                            class="button button-color button-rounded nott m-0 fw-medium align-self-end"
                            data-lightbox="gallery-item"><i class="icon-picture"></i> View Gallery</a>
                        <a href="{{ asset('realestate/demos/real-estate/images/hero/2.jpg')}}" class="d-none"
                            data-lightbox="gallery-item"></a>
                        <a href="{{ asset('realestate/demos/real-estate/images/hero/3.jpg')}}" class="d-none"
                            data-lightbox="gallery-item"></a>
                        <a href="https://www.youtube.com/watch?v=GU58qaKmZhQ" data-lightbox="iframe"
                            class="button button-color button-rounded nott fw-medium align-self-end my-0 ms-2"><i
                                class="icon-play"></i> Play Video</a>
                    </div>
                </div>
                ...
                <div class="container clearfix">
                    <div class="row">
                        <div class="col-md-2 col-6 center">
                            <img src="{{ asset('realestate/demos/real-estate/images/user.jpg')}}" alt="Image" class="img-circle"
                                style="width: 60px; height: 60px;">
                            <h5 class="my-2"><a href="#">P. Robert/<span class="text-muted fw-normal"
                                        style="font-family: 'Roboto'">Host</span></a></h5>
                        </div>
                        <div class="col-md-2 col-6 center">
            ...
            <div class="container clearfix">
                ...
                <div class="row gutter-40 col-mb-80">
                    <div class="postcontent col-lg-9">
                        <p>The interior of the house is focused around a large central hallway serving as the main avenue of
                            traffic and entrance area to the adjacent rooms. The hallway flows into a large, wide staircase
                            that provides the main means of egress. <br><br>On the south side of the hall is the large front
                            parlor. This room contains original wallpaper including ceiling panels of small birds and orange
                            flowers with vibrant leaves of green and yellow set upon a light blue background. The main body
                            of the wallpaper is shades.</p>
                        ...
                        <div class="row clearfix">
                            <div class="col-md-4">
                                <ul class="iconlist">
                                    ...
                                    <li class="mb-1"><i class="icon-realestate-air-conditioning"></i>Air
                                        Conditioning</li>
                            ...
                            <div class="col-md-4">
                                <ul class="iconlist">
                                    ...
                                    <li class="mb-1"><i class="icon-realestate-vacuum-cleaner"></i>Microwave
                                    </li>
                        ...
                        <p class="mt-3">Put this magnificent property on the top of your list, oozing quality
                            from the moment you enter through the unique brick portico into the Tuscan style courtyard with
                            Mural and vertical garden.. *Floors of European oak and parquetry *Award winning kitchen with
                            limed solid American oak, bevelled glass cabinets, polished marble bench tops and separate
                            scullery *Bi folds doors open out to the sun filled courtyard *Elegant lounge which also
                            includes a drop down screen for a home theatre *Guest bedroom or an ideal home office Throughout
                            this incredible residence you will find a vast array of imported features. Doors and fittings
                            from France, stained glass windows from Europe. Wine cellar under the staircase. Upper level:
                            Elegant master bedroom with balcony, ensuite with Emperador Scuro marble bench tops, mirrors
                            with bevelled glass and American cherry frames. A most spacious dressing room...every woman's
                            dream! Many fixtures have been especially commissioned, including the stand alone bath in the
                            second bathroom, light switches and power points, door hardware is all imported from France.
                            Even the grandchildren are catered for with their own space built into the roof area. An ideal
                            cubby! The home has another two bedrooms with built in robes. *Quality fixtures and fittings
                            *Reverse cycle air conditioning *Security alarm and intercom Designed by Award winner Peter
                            Fryer this landmark Centro residence will impress and delight...a viewing is a must! Contact
                            Susan Taylor on 0417 771 112 or Trevor Neil 0438 354 556 your private viewing.</p>
                            ...
                            <ol class="commentlist border-bottom-0 clearfix">
                                ...
                                <li class="comment even thread-even depth-1" id="li-comment-1">
                                    ...
                                    <div id="comment-1" class="comment-wrap clearfix">
                                        ...
                                        <div class="comment-meta">
                                            ...
                                            <div class="comment-author vcard">
                                                ...
                                                <span class="comment-avatar clearfix">
                                                    <img alt='Image' src="{{ asset('realestate/demos/real-estate/images/user.jpg')}}"
                                        ...
                                        <div class="comment-content clearfix">
                                            ...
                                            <div class="comment-author">Max Conversion<span><a href="#"
                                                        title="Permalink to this comment">October 31, 2021 at 1:10
                                                        am</a></span></div>

                                            <p>Canvas is an extremely beautiful and well coded and robust template. I can
                                                pretty much customize to meet any of my needs as a designer. Thank you guys
                                                so much for doing this. Please keep adding more stunning themes and
                                                animations. You're making the web a much more beautiful place.</p>

                                            <div
                                                style="position: absolute; top: 0; left: auto; right: 40px; color: #FEC42D;">
                                                <i class="icon-star3"></i> <i class="icon-star3"></i> <i
                                                    class="icon-star3"></i> <i class="icon-star3"></i> <i
                                                    class="icon-star3"></i></div>
                                            ...
                                            <div id="comment-3" class="comment-wrap clearfix">
                                                ...
                                                <div class="comment-content clearfix">
                                                    ...
                                                    <div class="comment-author"><a href='#' rel='external nofollow'
                                                            class='url'>P. Robert</a><span><a href="#"
                                                                title="Permalink to this comment">October 31, 2021 at 1:16
                                                                am</a></span></div>
                                    ...
                                    <div id="comment-2" class="comment-wrap clearfix">
                                        ...
                                        <div class="comment-content clearfix">
                                            <div class="comment-author"><a href='https://themeforest.net/user/semicolonweb'
                                                    rel='external nofollow' class='url'>Hilary Ouse</a><span><a href="#"
                                                        title="Permalink to this comment">June 21, 2021 at 1:03
                                                        am</a></span></div>

                                            <p>I don't think I'll be using any other templates from now on. It's perfect.
                                                Great, fast responsive support. Super flexible, easy to customize. One
                                                warning. If you don't know any code it's not for you. If you know your code
                                                then this is SOOO good :) Thank you SemiColon team. Most excellent job.</p>

                                            <div
                                                style="position: absolute; top: 0; left: auto; right: 40px; color: #FEC42D;">
                                                <i class="icon-star3"></i> <i class="icon-star3"></i> <i
                                                    class="icon-star3"></i> <i class="icon-star3"></i> <i
                                                    class="icon-star-half-full"></i></div>
                                            <a class='comment-reply-link' href='#'><i class="icon-reply"></i></a>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                ...
                                <li class="comment byuser comment-author-_smcl_admin even thread-odd thread-alt depth-1"
                                    ...
                                    <div id="comment-3" class="comment-wrap clearfix">
                                        ...
                                        <div class="comment-content clearfix">
                                            <div class="comment-author"><a href='https://themeforest.net/user/semicolonweb'
                                                    rel='external nofollow' class='url'>AL3XL</a><span><a href="#"
                                                        title="Permalink to this comment">April 25, 2021 at 1:03
                                                        am</a></span></div>

                                            <p>Awesome quality, highly structured. The detailed documentation is included,
                                                but it is all clear from just looking into the code. Comes with free
                                                updates. There is an invite--only support forum for customers. This purchase
                                                makes perfect sense to save you an immense amount of time. Thank you.</p>
                    ...
                    <div class="sidebar sticky-sidebar-wrap col-lg-3">
                        <div class="sidebar-widgets-wrap">
                            <div class="sticky-sidebar">
                                    ...
                                    <div class="card bg-light">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="quick-contact-form" name="quick-contact-form"
                                                action="include/form.php" method="post" class="quick-contact-form mb-0">
                                                ...
                                                <input type="number"
                                                    class="required sm-form-control number input-block-level"
                                                    id="quick-contact-form-number" name="quick-contact-form-number" value=""
                                                ...
                                                <button type="submit" id="quick-contact-form-submit"
                                                    ...
                                                    class="button  button-rounded w-100 m-0" value="submit">Book
                                                    Now</button>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="widget clearfix">
                                    <h4>Video</h4>
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/GU58qaKmZhQ"
                    ...
                    <div class="real-estate-item col-md-6 col-xl-4">
                        <div class="real-estate-item-image">
                            ...
                            <div class="real-estate-item-info clearfix" data-lightbox="gallery">
                                <a href="demos/real-estate/images/items/1.jpg')}}" data-bs-toggle="tooltip" title="Images"
                                    data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
                                <a href="demos/real-estate/images/items/3.jpg')}}" class="d-none"
                                    data-lightbox="gallery-item"></a>
