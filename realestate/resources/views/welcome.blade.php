...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Real Estate Demo | WSI CMS</title>
...
<body class="stretched side-push-panel">
	...
	<div id="wrapper" class="clearfix">
			...
			<div class="container">
				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-auto">
						...
						<div class="top-links">
							<ul class="top-links-container">
								<li class="top-links-item d-md-none d-lg-block"><a href="#"><i class="icon-call"></i> +1800-123-7890</a></li>
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="index.html" data-dark-logo="{{env('APP_LOGO')}}" class="standard-logo"><img src="{{env('APP_LOGO')}}" alt="Canvas Logo"></a>
							<a href="index.html" data-dark-logo="{{env('APP_LOGO')}}" class="retina-logo"><img src="{{env('APP_LOGO')}}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								<li class="menu-item current"><a class="menu-link" href="demo-real-estate.html"><div>Home</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-real-estate-about-us.html"><div>About Us</div></a></li>
								<li class="menu-item"><a class="menu-link" href="#"><div>Properties</div></a>
									<ul class="sub-menu-container">
										<li class="menu-item"><a class="menu-link" href="demo-real-estate-single-property.html"><div>Condo Apartments</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-real-estate-single-property.html"><div>Luxury Villas</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-real-estate-single-property.html"><div>Premium Estates</div></a></li>
									</ul>
								</li>
								<li class="menu-item"><a class="menu-link" href="demo-real-estate-builders.html"><div>Builders</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-real-estate-services.html"><div>Services</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-real-estate-listing.html"><div>Listing</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-real-estate-contact.html"><div>Contact</div></a></li>
							</ul>
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element min-vh-60 min-vh-md-100 include-header include-topbar" style="background: url({{ asset('realestate/demos/real-estate/images/hero/1.jpg')}}"}}) center center no-repeat; background-size: cover;">
			...
			<div class="content-wrap">
				<div class="container">
					...
					<div class="row real-estate-properties clearfix">
						...
						<div class="col-lg-7">
							<a href="#" style="background: url({{ asset('realestate/demos/real-estate/images/cities/4.jpg')}}" no-repeat bottom center; background-size: cover;">
						...
						<div class="col-lg-5">
							<a href="#" style="background: url({{ asset('realestate/demos/real-estate/images/cities/2.jpg')}}" no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url({{ asset('realestate/demos/real-estate/images/cities/3.jpg')}}" no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url({{ asset('realestate/demos/real-estate/images/cities/1.jpg')}}" no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url({{ asset('realestate/demos/real-estate/images/cities/5.jpg')}}" no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
					...
					<div class="row col-mb-50">
						...
						<div class="col-md-4">
							...
							<ul class="clients-grid grid-2 mb-0">
								<li class="grid-item" style="padding: 20px;"><a href="#" class="op-09"><img src="{{ asset('realestate/demos/real-estate/images/builders/1.png')}}" alt="Clients"></a></li>
								<li class="grid-item" style="padding: 20px;"><a href="#" class="op-09"><img src="{{ asset('realestate/demos/real-estate/images/builders/2.png')}}" alt="Clients"></a></li>
								<li class="grid-item" style="padding: 20px;"><a href="#" class="op-09"><img src="{{ asset('realestate/demos/real-estate/images/builders/3.png')}}" alt="Clients"></a></li>
								<li class="grid-item" style="padding: 20px;"><a href="#" class="op-09"><img src="{{ asset('realestate/demos/real-estate/images/builders/4.png')}}" alt="Clients"></a></li>
							</ul>
					...
					<div class="row col-mb-50">
						<div class="col-lg-5 order-last order-lg-first">
							...
							<div class="widget clearfix">
								...
								<img src="{{ asset('realestate/demos/real-estate/images/logo@2x.png')}}" style="position: relative; opacity: 0.85; left: -10px; max-height: 80px; margin-bottom: 20px;" alt="Footer Logo">
