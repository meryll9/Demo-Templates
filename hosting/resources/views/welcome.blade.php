...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
														...
														<div class="widget">
															<div class="feature-box not-dark fbox-center mb-0">
																<div class="fbox-icon mb-4">
																	<img src="{{asset('hosting/demos/hosting/images/svg/web.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image" style="width: 52px;">
																</div>
												...
												<ul class="sub-menu-container mega-menu-column col-lg-3">
													<li class="menu-item">
														<div class="widget">
															<div class="feature-box not-dark fbox-center mb-0">
																<div class="fbox-icon mb-4">
																	<img src="{{asset('hosting/demos/hosting/images/svg/cloud.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image" style="width: 52px;">
																</div>
																<div class="fbox-content">
												...
												<ul class="sub-menu-container mega-menu-column col-lg-3">
													<li class="menu-item">
														<div class="widget">
															<div class="feature-box not-dark fbox-center mb-0">
																<div class="fbox-icon mb-4">
																	<img src="{{asset('hosting/demos/hosting/images/svg/dedicated.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image" style="width: 52px;">
																</div>
																<div class="fbox-content">
												...
												<ul class="sub-menu-container mega-menu-column col-lg-3">
													<li class="menu-item">
														<div class="widget">
															<div class="feature-box not-dark fbox-center mb-0">
																<div class="fbox-icon mb-4">
																	<img src="{{asset('hosting/demos/hosting/images/svg/shared.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image" style="width: 52px;">
																</div>
																<div class="fbox-content">
		...
		<section id="slider" class="slider-element bg-angle include-header">
			...
			============================================= -->
			<img class="img-map parallax position-absolute" src="{{asset('hosting/demos/hosting/images/svg/map-light.svg')}}" alt="Image" data-0="opacity: 0.05;margin-top:0px" data-800="opacity: 0.5;margin-top:150px">
				...
				<div class="row justify-content-between align-items-center">
					<div class="col-md-5">
						<div class="slider-title">
							<h2 class="text-white text-rotater mb-3" data-separator="," data-rotate="fadeIn" data-speed="3500">{{ env('APP_TAGLINE') }}<br> <span class="t-rotate text-white">{{ env('APP_TAGLINE') }}</span> {{ env('APP_TAGLINE') }}</h2>
						...
						<a href="#" class="button bg-white text-dark button-light button-rounded button-large color ms-0">Create Account <i class="icon-line-arrow-right fw-semibold"></i></a>
					</div>
		...
		<section id="content">
			<div class="content-wrap py-0">
								...
								<div class="row align-items-center clearfix">
									...
									<div class="col-lg-4 col-sm-6">
										<ul class="iconlist m-0">
											<li><img src="{{asset('hosting/demos/hosting/images/svg/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Assertively Fabricate.</li>
											<li class="pt-3"><img src="{{asset('hosting/demos/hosting/images/svg/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Distinctively disseminate.</li>
											<li class="pt-3"><img src="{{asset('hosting/demos/hosting/images/svg/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Appropriately predominate.</li>
										</ul>
									</div>
									<div class="col-lg-4 col-sm-6">
										<ul class="iconlist m-0">
											<li class="pt-3 pt-lg-0"><img src="{{asset('hosting/demos/hosting/images/svg/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Competently facilitate synergist</li>
											<li class="pt-3"><img src="{{asset('hosting/demos/hosting/images/svg/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Front-end leadership skills.</li>
											<li class="pt-3"><img src="{{asset('hosting/demos/hosting/images/svg/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Infomediaries with front-end</li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="row col-mb-50 mb-0 mt-4">
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								<div class="fbox-icon">
									<img src="{{asset('hosting/demos/hosting/images/svg/web.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image" style="height: 52px;">
								</div>
								<div class="fbox-content">
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								<div class="fbox-icon">
									<img src="{{asset('hosting/demos/hosting/images/svg/cloud.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image" style="height: 52px;">
								</div>
								<div class="fbox-content">
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								<div class="fbox-icon">
									<img src="{{asset('hosting/demos/hosting/images/svg/dedicated.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image" style="height: 52px;">
								</div>
								<div class="fbox-content">
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								<div class="fbox-icon">
									<img src="{{asset('hosting/demos/hosting/images/svg/shared.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image" style="height: 52px;">
								</div>
								<div class="fbox-content">
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								<div class="fbox-icon">
									<img src="{{asset('hosting/demos/hosting/images/svg/domain.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image" style="height: 52px;">
								</div>
								<div class="fbox-content">
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								<div class="fbox-icon">
									<img src="{{asset('hosting/demos/hosting/images/svg/activation.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image" style="height: 52px;">
								</div>
								<div class="fbox-content">
				...
				<!-- Domain Section
				============================================= -->
				<div class="section section-domain mt-4 mb-3" style="background: #F5F5F5 url({{asset('/hosting/demos/hosting/images/pattern-dark.png')}}) repeat center center;">
					<div class="container">
						<div class="row justify-content-between align-items-center">
							<div class="col-md-5">
				...
				<div class="section m-0 bg-transparent">
					<div class="container clearfix">
						...
						<div class="row">
								...
								<div class="row">
									<div class="col-6">
										<ul class="iconlist ms-0">
											<li><img src="{{asset('hosting/demos/hosting/images/flags/uk.png')}}" alt="Image"><a href="#">United Kingdom</a></li>
											<li><img src="{{asset('hosting/demos/hosting/images/flags/us.png')}}" alt="Image"><a href="#">USA</a></li>
											<li><img src="{{asset('hosting/demos/hosting/images/flags/br.png')}}" alt="Image"><a href="#">Brazil</a></li>
											<li><img src="{{asset('hosting/demos/hosting/images/flags/sa.png')}}" alt="Image"><a href="#">South Africa</a></li>
											<li><img src="{{asset('hosting/demos/hosting/images/flags/in.png')}}" alt="Image"><a href="#">India</a></li>
										</ul>
									</div>
									<div class="col-6">
										<ul class="iconlist ms-0">
											<li><img src="{{asset('hosting/demos/hosting/images/flags/si.png')}}" alt="Image"><a href="#">Singapore</a></li>
											<li><img src="{{asset('hosting/demos/hosting/images/flags/ja.png')}}" alt="Image"><a href="#">Japan</a></li>
											<li><img src="{{asset('hosting/demos/hosting/images/flags/au.png')}}" alt="Image"><a href="#">Australia</a></li>
											<li><img src="{{asset('hosting/demos/hosting/images/flags/ca.png')}}" alt="Image"><a href="#">Canada</a></li>
							...
							<img src="{{asset('hosting/demos/hosting/images/svg/map.png')}}" class="img-responsive" alt="Image">
				...
				<!-- Pricing Section
				============================================= -->
				<div class="section bg-angle mt-0" style="background: #F9F9F9 url({{asset('/hosting/demos/hosting/images/pattern-dark.png')}}) repeat center center; padding: 80px 0">
					<div class="container clearfix">
							...
							<div class="col-lg-4 col-md-4 mt-4 mt-md-0">
								<div class="card text-center">
									...
									<div class="card-body py-4">
										...
										<a href="#" class="button button-rounded button-large ls0 fw-normal m-0 nott">Order Now</a>
									</div>
								</div>
							</div>
						...
						<div class="col-md-12">
							...
							<div class="row col-mb-30">
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										<div class="fbox-media">
											<img src="{{asset('hosting/demos/hosting/images/svg/balancing.svg')}}" style="width: 42px;" alt="Image">
										</div>
										<div class="fbox-content px-0">
											...
											<a href="#" class="btn btn-link mt-3 fw-normal color p-0" style="font-size: 16px;">$15/month for Load Balancing <i class="icon-line-arrow-right position-relative" style="top: 2px"></i></a>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										<div class="fbox-media">
											<img src="{{asset('hosting/demos/hosting/images/svg/location.svg')}}" style="width: 42px;" alt="Image">
										</div>
										<div class="fbox-content px-0">
											...
											<a href="#" class="btn btn-link mt-3 fw-normal color p-0" style="font-size: 16px;">$5/month for Location <i class="icon-line-arrow-right position-relative" style="top: 2px"></i></a>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										<div class="fbox-media">
											<img src="{{asset('hosting/demos/hosting/images/svg/ssl.svg')}}" style="width: 42px;" alt="Image">
										</div>
										<div class="fbox-content px-0">
											...
											<a href="#" class="btn btn-link mt-3 fw-normal color p-0" style="font-size: 16px;">$7/month for SSL Certificate <i class="icon-line-arrow-right position-relative" style="top: 2px"></i></a>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										<div class="fbox-media">
											<img src="{{asset('hosting/demos/hosting/images/svg/team.svg')}}" style="width: 42px;" alt="Image">
										</div>
										<div class="fbox-content px-0">
											...
											<a href="#" class="btn btn-link mt-3 fw-normal color p-0" style="font-size: 16px;">$4/month for Team <i class="icon-line-arrow-right position-relative" style="top: 2px"></i></a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="container">
						...
						<div id="oc-testimonials" class="owl-carousel center testimonials-carousel testimonial-full carousel-widget mt-5" data-margin="0" data-items-xs="1" data-items-sm="1" data-items-md="1" data-items-lg="2" data-items-xl="3" data-center="true" data-loop="true" data-autoplay="4000" data-speed="500">
							...
							<div class="oc-item">
								<div class="testimonial p-4 border-0 shadow-none">
									<div class="testi-image">
										<a href="#"><img src="{{asset('hosting/demos/hosting/images/users/1.jpg')}}" alt="Customer Testimonails"></a>
									</div>
									...
									<div class="testi-content">
										<p class="font-body fst-normal">Incidunt deleniti blanditiis quas aperiam recusandae consequatur ullam quibusdam cum libero illo rerum repellendus!</p>
							...
							<div class="oc-item">
								<div class="testimonial p-4 border-0 shadow-none">
									<div class="testi-image">
										<a href="#"><img src="{{asset('hosting/demos/hosting/images/users/2.jpg')}}" alt="Customer Testimonails"></a>
									</div>
									...
									<div class="testi-content">
										<p class="font-body fst-normal">Natus voluptatum enim quod necessitatibus quis expedita harum provident eos obcaecati id culpa corporis molestias.</p>
										<div class="testi-meta">
											Collis Ta'eed
							...
							<div class="oc-item">
								<div class="testimonial p-4 border-0 shadow-none">
									<div class="testi-image">
										<a href="#"><img src="{{asset('hosting/demos/hosting/images/users/5.jpg')}}" alt="Customer Testimonails"></a>
									</div>
									...
									<div class="testi-content">
										<p class="fst-normal font-body">Fugit officia dolor sed harum excepturi ex iusto magnam asperiores molestiae qui natus obcaecati facere sint amet.</p>
										<div class="testi-meta">
											Mary Jane
							...
							<div class="oc-item">
								<div class="testimonial p-4 border-0 shadow-none">
									<div class="testi-image">
										<a href="#"><img src="{{asset('hosting/demos/hosting/images/users/4.jpg')}}" alt="Customer Testimonails"></a>
									</div>
									<ul class="list-unstyled ms-0 mt-4 mb-2"><li class="color"><i class="icon-star3"></i> <i class="icon-star3"></i> <i class="icon-star3"></i> <i class="icon-star3"></i> <i class="icon-star3"></i></li></ul>
									<div class="testi-content">
										<p class="fst-normal font-body">Similique fugit repellendus expedita excepturi iure perferendis provident quia eaque. Repellendus, vero numquam?</p>
										<div class="testi-meta">
											Steve Jobs
											<span>Apple Inc.</span>
										</div>
							...
							<div class="oc-item">
								<div class="testimonial p-4 border-0 shadow-none">
									<div class="testi-image">
										<a href="#"><img src="{{asset('hosting/demos/hosting/images/users/3.jpg')}}" alt="Customer Testimonails"></a>
									</div>
									<ul class="list-unstyled ms-0 mt-4 mb-2"><li class="color"><i class="icon-star3"></i> <i class="icon-star3"></i> <i class="icon-star3"></i> <i class="icon-star3"></i> <i class="icon-star-empty"></i></li></ul>
									<div class="testi-content">
										<p class="fst-normal font-body">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus, perspiciatis illum totam dolore deleniti labore.</p>
										<div class="testi-meta">
											Jamie Morrison
											<span>Adobe Inc.</span>
										</div>
				...
				<div class="section mt-3 mb-4 pt-0 bg-transparent">
					<div class="container clearfix">
						<div class="mx-auto" style="max-width: 1000px">
							...
							<!-- Clients Images -->
							<div class="row clearfix">
								<div class="col-sm-3 col-6 center"><a href="#"><img src="{{asset('hosting/demos/hosting/images/clients/1.png')}}" alt="Image" class="clients"></a></div>
								<div class="col-sm-3 col-6 center"><a href="#"><img src="{{asset('hosting/demos/hosting/images/clients/2.png')}}" alt="Image" class="clients"></a></div>
								<div class="col-sm-3 col-6 center"><a href="#"><img src="{{asset('hosting/demos/hosting/images/clients/3.png')}}" alt="Image" class="clients mt-5 mt-sm-0"></a></div>
								<div class="col-sm-3 col-6 center"><a href="#"><img src="{{asset('hosting/demos/hosting/images/clients/4.png')}}" alt="Image" class="clients mt-5 mt-sm-0"></a></div>
								<div class="col-sm-3 col-6 center"><a href="#"><img src="{{asset('hosting/demos/hosting/images/clients/5.png')}}" alt="Image" class="clients mt-5"></a></div>
								<div class="col-sm-3 col-6 center"><a href="#"><img src="{{asset('hosting/demos/hosting/images/clients/6.png')}}" alt="Image" class="clients mt-5"></a></div>
								<div class="col-sm-3 col-6 center"><a href="#"><img src="{{asset('hosting/demos/hosting/images/clients/7.png')}}" alt="Image" class="clients mt-5"></a></div>
								<div class="col-sm-3 col-6 center"><a href="#"><img src="{{asset('hosting/demos/hosting/images/clients/8.png')}}" alt="Image" class="clients mt-5"></a></div>
								<div class="col-sm-3 col-6 center"><a href="#"><img src="{{asset('hosting/demos/hosting/images/clients/9.png')}}" alt="Image" class="clients mt-5"></a></div>
								<div class="col-sm-3 col-6 center"><a href="#"><img src="{{asset('hosting/demos/hosting/images/clients/10.png')}}" alt="Image" class="clients mt-5"></a></div>
								<div class="col-sm-3 col-6 center"><a href="#"><img src="{{asset('hosting/demos/hosting/images/clients/11.png')}}" alt="Image" class="clients mt-5"></a></div>
								<div class="col-sm-3 col-6 center"><a href="#"><img src="{{asset('hosting/demos/hosting/images/clients/12.png')}}" alt="Image" class="clients mt-5"></a></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="section bg-color dark m-0">
					<div class="container">
						<div class="row center justify-content-center">
							...
							<div class="col-md-8">
								<a href="#" class="button center bg-white color button-light button-rounded button-large ms-0">Sign Up for free</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6 mb-0 mb-sm-4 mb-md-0">
							...
							<div class="widget clearfix">
								...
								<div style="background: url({{asset('/hosting/images/world-map.png')}}) no-repeat left center; background-size: auto 100%;">
									<address>
						...
						<div class="col-md-3 col-6 mt-5 mt-sm-0">
							...
							<div class="widget clearfix">
								...
								<ul class="list-unstyled iconlist">
									<li><i class="icon-facebook"></i><a href="https://facebook.com/semicolonweb" target="_blank"> Facebook</a></li>
									<li><i class="icon-twitter"></i><a href="https://twitter.com/__semicolon" target="_blank"> Twitter</a></li>
									<li><i class="icon-instagram"></i><a href="https://instagram.com/semicolonweb" target="_blank"> Instagram</a></li>
									<li><i class="icon-youtube"></i><a href="https://www.youtube.com/user/shank20121/videos" target="_blank"> YouTube</a></li>
