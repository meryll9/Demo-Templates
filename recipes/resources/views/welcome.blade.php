...
<head>
	...
	<link rel="stylesheet" href="{{asset('recipes/css/bootstrap.css')}}" type="text/css" />
	<link rel="stylesheet" href="{{asset('recipes/style.css')}}" type="text/css" />
	<link rel="stylesheet" href="{{asset('recipes/css/dark.css')}}" type="text/css" />

	<link rel="stylesheet" href="{{asset('recipes/css/font-icons.css')}}" type="text/css" />
	<link rel="stylesheet" href="{{asset('recipes/css/animate.css')}}" type="text/css" />
	<link rel="stylesheet" href="{{asset('recipes/css/magnific-popup.css')}}" type="text/css" />

	<link rel="stylesheet" href="{{asset('recipes/css/custom.css')}}" type="text/css" />
	<meta name="viewport" content="width=device-width, initial-scale=1" />

	<!-- SLIDER REVOLUTION 5.x CSS SETTINGS -->
	<link rel="stylesheet" type="text/css" href="{{asset('recipes/include/rs-plugin/css/settings.css')}}" media="screen" />
	<link rel="stylesheet" type="text/css" href="{{asset('recipes/include/rs-plugin/css/layers.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('recipes/include/rs-plugin/css/navigation.css')}}">

	<!-- ADD-ONS CSS FILES -->
	<link rel="stylesheet" type="text/css" href="{{asset('recipes/include/rs-plugin/css/addons/revolution.addon.liquideffect.css')}}">

	<!--  Recipes Demo Specific Stylesheet -->
	<link rel="stylesheet" href="{{asset('recipes/css/colors.php?color=267DF4')}}" type="text/css" /> <!-- Theme Color -->
	<link rel="stylesheet" href="{{asset('recipes/demos/recipes/css/fonts.css')}}" type="text/css" /> <!-- Theme Font -->
	<link rel="stylesheet" href="{{asset('recipes/demos/recipes/recipes.css')}}" type="text/css" /> <!-- Theme Custom CSS -->
...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
			...
			<div class="slider-inner">
				...
				<div id="rev_slider_2_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="distortion-addon" data-source="gallery" style="background:#000000;padding:0px;">
					...
					<div id="rev_slider_2_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.8.1">
						<ul>
							<!-- SLIDE  -->
							<li  data-index="rs-7" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('recipes/demos/recipes/images/slider/1/100x50-bg.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="" data-liquideffect='{"image":"demos/recipes/images/slider/fibers_small.jpg')}}","imagesize":"external","autoplay":true,"scalex":4,"scaley":4,"speedx":0.5,"speedy":-0.5,"rotationx":0,"rotationy":0,"rotation":0,"transtime":2000,"easing":"Power3.easeOut","transcross":false,"transpower":false,"transitionx":0,"transitiony":0,"transpeedx":0,"transpeedy":0,"transrotx":0,"transroty":0,"transrot":0}'>
								<!-- MAIN IMAGE -->
								<img src="{{asset('recipes/demos/recipes/images/slider/dummy.png')}}"  alt="Image" data-duration="4000" data-lazyload="{{asset('recipes/demos/recipes/images/slider/1/bg.jpg')}}" data-bgposition="center center"  data-bgfit="cover" data-bgparallax="4" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->
								...
								<h3 class="tp-caption font-primary"
									...
									style="z-index: 7; white-space: nowrap; font-size: 54px; line-height: 54px; letter-spacing: 0px; color:#FFF">{{ env('APP_TAGLINE') }}</h3>
								...
								<div class="tp-caption"
									...
									style="z-index: 6;">
									<div class="rs-looped rs-rotate"  data-easing="Linear.easeNone" data-startdeg="0" data-enddeg="180" data-speed="40" data-origin="50% 50%"><img src="{{asset('recipes/demos/recipes/images/slider/dummy.png')}}" alt="Image" data-ww="['530px','400px','200px','200px']" data-hh="['530px','400px','200px','200px']" data-lazyload="{{asset('recipes/demos/recipes/images/slider/1/1.png')}}" data-no-retina> </div>
								</div>
								...
								<div class="tp-caption slider-features tp-resizeme"
									...
									<ul class="list-unstyled dark">
										<li class="d-inline-block">
											<img src="{{asset('recipes/demos/recipes/images/icons/timer.svg')}}" alt="Timer" width="30">
											<h4>40 Mins</h4>
										</li>

										<li class="d-inline-block">
											<img src="{{asset('recipes/demos/recipes/images/icons/ingredients.svg')}}" alt="ingredients" width="30">
											<h4>9 Ingredients</h4>
										</li>

										<li class="d-inline-block">
											<img src="{{asset('recipes/demos/recipes/images/icons/kcal.svg')}}" alt="kcal" width="30">
											<h4>600 Kcal</h4>
										</li>
									</ul>
								</div>
							...
							<li data-index="rs-8" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('recipes/demos/recipes/images/slider/1/100x50-bg.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="" data-liquideffect='{"image":"demos/recipes/images/slider/fibers_small.jpg')}}","imagesize":"external","autoplay":true,"scalex":4,"scaley":4,"speedx":0.5,"speedy":-0.5,"rotationx":0,"rotationy":0,"rotation":0,"transtime":2000,"easing":"Power3.easeOut","transcross":false,"transpower":false,"transitionx":0,"transitiony":0,"transpeedx":0,"transpeedy":0,"transrotx":0,"transroty":0,"transrot":0}'>
								<!-- MAIN IMAGE -->
								<img src="{{asset('recipes/demos/recipes/images/slider/dummy.png')}}"  alt="Image" data-duration="4000" data-lazyload="{{asset('recipes/demos/recipes/images/slider/2/bg.jpg')}}" data-bgposition="center center"  data-bgparallax="4" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->
								...
								<div class="tp-caption tp-resizeme"
									...
									style="z-index: 6;">
									<div class="rs-looped rs-rotate"  data-easing="Linear.easeNone" data-startdeg="0" data-enddeg="180" data-speed="40" data-origin="50% 50%"><img src="{{asset('recipes/demos/recipes/images/slider/dummy.png')}}" alt="Image" data-ww="['602px','500px','300px','200px']" data-hh="['602px','500px','300px','200px']" data-lazyload="{{asset('recipes/demos/recipes/images/slider/2/1.png')}}" data-no-retina> </div>
								</div>
								...
								<div class="tp-caption slider-features tp-resizeme"
									...
									<ul class="list-unstyled">
										<li class="d-inline-block">
											<img src="{{asset('recipes/demos/recipes/images/icons/timer-dark.svg')}}" alt="Timer" width="30">
											<h4>37 Mins</h4>
										</li>

										<li class="d-inline-block">
											<img src="{{asset('recipes/demos/recipes/images/icons/ingredients-dark.svg')}}" alt="ingredients" width="30">
											<h4>11 Ingredients</h4>
										</li>

										<li class="d-inline-block">
											<img src="{{asset('recipes/demos/recipes/images/icons/kcal-dark.svg')}}" alt="kcal" width="30">
											<h4>450 Kcal</h4>
										</li>
									</ul>
								</div>
		...
		<section id="content">
			<div class="content-wrap pb-0" style="overflow: visible;">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 offset-md-2 center">
								...
								<img src="{{asset('recipes/demos/barber/images/about/sign.png')}}" alt="Sign" width="150" class="mt-3">
							</div>
							<div class="col-12 mt-5 mb-3">
								<h3 class="center">Browse by Category</h3>

								<div class="recipe-categories justify-content-center">
									<a href="demos/recipes/recipes.html" data-animate="fadeInUp" class="recipe-category" style="background-image: url({{asset('/recipes/demos/recipes/images/categories/bf.jpg')}});">
										<div class="recipe-category-inner">
											<div class="recipe-category-icon"><img src="{{asset('recipes/demos/recipes/images/icons/bf.svg')}}" alt="Breakfast"></div>
											<div class="recipe-category-info">Breakfast</div>
										</div>
									</a>

									<a href="demos/recipes/recipes.html" data-animate="fadeInUp" data-delay="100" class="recipe-category" style="background-image: url({{asset('/recipes/demos/recipes/images/categories/lunch.jpg')}});">
										<div class="recipe-category-inner">
											<div class="recipe-category-icon"><img src="{{asset('recipes/demos/recipes/images/icons/lunch.svg')}}" alt="Lunch"></div>
											<div class="recipe-category-info">Lunch</div>
										</div>
									</a>

									<a href="demos/recipes/recipes.html" data-animate="fadeInUp" data-delay="200" class="recipe-category" style="background-image: url({{asset('/recipes/demos/recipes/images/categories/dinner.jpg')}});">
										<div class="recipe-category-inner">
											<div class="recipe-category-icon"><img src="{{asset('recipes/demos/recipes/images/icons/dinner.svg')}}" alt="Dinner"></div>
											<div class="recipe-category-info">Dinner</div>
										</div>
									</a>

									<a href="demos/recipes/recipes.html" data-animate="fadeInUp" data-delay="300" class="recipe-category" style="background-image: url({{asset('/recipes/demos/recipes/images/categories/desserts.jpg')}});">
										<div class="recipe-category-inner">
											<div class="recipe-category-icon"><img src="{{asset('recipes/demos/recipes/images/icons/desserts.svg')}}" alt="Desserts"></div>
											<div class="recipe-category-info">Desserts</div>
										</div>
									</a>

									<a href="demos/recipes/recipes.html" data-animate="fadeInUp" data-delay="400" class="recipe-category" style="background-image: url({{asset('/recipes/demos/recipes/images/categories/veg.jpg')}});">
										<div class="recipe-category-inner">
											<div class="recipe-category-icon"><img src="{{asset('recipes/demos/recipes/images/icons/vegan.svg')}}" alt="Vegan"></div>
											<div class="recipe-category-info">Vegan</div>
										</div>
									</a>

									<a href="demos/recipes/recipes.html" data-animate="fadeInUp" data-delay="500" class="recipe-category" style="background-image: url({{asset('/recipes/demos/recipes/images/categories/seafood.jpg')}});">
										<div class="recipe-category-inner">
											<div class="recipe-category-icon"><img src="{{asset('recipes/demos/recipes/images/icons/seafood.svg')}}" alt="Seafood"></div>
											<div class="recipe-category-info">Seafood</div>
										</div>
									</a>

									<a href="demos/recipes/recipes.html" data-animate="fadeInUp" data-delay="600" class="recipe-category" style="background-image: url({{asset('/recipes/demos/recipes/images/categories/drinks.jpg')}});">
										<div class="recipe-category-inner">
											<div class="recipe-category-icon"><img src="{{asset('recipes/demos/recipes/images/icons/drinks.svg')}}" alt="Beverages"></div>
				...
				<div class="section recipe-items p-0" style="overflow: visible;background-color: #f9f9f9">
					<div class="row align-items-stretch align-content-stretch g-0">
						<div class="col-lg-4 dark">
							<div class="position-sticky min-vh-60 min-vh-md-100 d-flex flex-column align-items-center center justify-content-center" style="top:0; background: linear-gradient(rgba(0,0,0,.3), rgba(0,0,0,.5)), url({{asset('/recipes/demos/recipes/images/popular/side-bg.jpg')}}) center center / cover;">
					...
					<div class="container">
						...
						<div id="recipes-carousel" class="owl-carousel carousel-widget" data-margin="0" data-nav="true" data-pagi="false" data-items="1">
							<div class="row g-0 align-items-stretch rounded shadow">
								<div class="col-lg-5 rounded-start" style="background: url({{asset('/recipes/demos/recipes/images/recipe-week.jpg')}}) no-repeat center center / cover; min-height: 300px">
							...
							<div class="row g-0 align-items-stretch rounded shadow">
								<div class="col-lg-5 rounded-start dark" style="background: url({{asset('/recipes/demos/recipes/images/recipe-week-2.jpg')}}) no-repeat center center / cover; min-height: 300px">
									<a href="https://www.youtube.com/watch?v=P3Huse9K6Xs" data-lightbox="iframe" class="play-video stretched-link">
										<i class="icon-play"></i>
									</a>
								</div>
						...
						<div class="row clearfix">
							<div class="col-md-4 mt-4">
								<div class="card border-0 shadow-sm">
									<img src="{{asset('recipes/demos/recipes/images/blog/piping-bag.jpg')}}" class="card-img-top" alt="Image">
							...
							<div class="col-md-4 mt-4">
								<div class="card border-0 shadow-sm">
									<img src="{{asset('recipes/demos/recipes/images/blog/healthy-food.jpg')}}" class="card-img-top" alt="Image">
									<div class="card-body" style="padding: 40px">
							...
							<div class="col-md-4 mt-4">
								<div class="card border-0 shadow-sm">
									<img src="{{asset('recipes/demos/recipes/images/blog/meal-prep.jpg')}}" class="card-img-top" alt="Image">
									<div class="card-body" style="padding: 40px">
				...
				<div class="section m-0" style="background: url({{asset('/recipes/demos/recipes/images/subscribe-bg.jpg')}}) no-repeat center center / cover; min-height: 300px; padding: 120px 0">
					<div class="container">
						<div class="row">
							<div class="col-sm-6 mt-4 mt-sm-0 subscribe-widget" data-loader="button">
								<img src="{{asset('recipes/demos/recipes/images/icons/email.svg')}}" alt="Enmail Icon" width="60" class="mb-4">
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-6 pe-4">
							<div class="widget clearfix">
								...
								<a href="#"><img src="{{asset('recipes/demos/articles/images/appstore.png')}}" alt="App Link"></a>
								<a href="#"><img src="{{asset('recipes/demos/articles/images/googleplay.png')}}" alt="App Link" class="mt-2"></a>
	...
	<!-- JavaScripts
	============================================= -->
	<script src="{{asset('recipes/js/jquery.js')}}"></script>
	<script src="{{asset('recipes/js/plugins.min.js')}}"></script>

	<!-- SLIDER REVOLUTION 5.x SCRIPTS  -->
	<script src="{{asset('recipes/include/rs-plugin/js/jquery.themepunch.tools.min.js')}}"></script>
	<script src="{{asset('recipes/include/rs-plugin/js/jquery.themepunch.revolution.min.js')}}"></script>

	<!-- ADD-ONS JS FILES -->
	<script src="{{asset('recipes/include/rs-plugin/js/pixi.min.js')}}"></script>
	<script src="{{asset('recipes/include/rs-plugin/js/addons/revolution.addon.liquideffect.min.js')}}"></script>

	<!-- SLIDER REVOLUTION EXTENSIONS  -->
	<script src="{{asset('recipes/include/rs-plugin/js/extensions/revolution.extension.actions.min.js')}}"></script>
	<script src="{{asset('recipes/include/rs-plugin/js/extensions/revolution.extension.carousel.min.js')}}"></script>
	<script src="{{asset('recipes/include/rs-plugin/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
	<script src="{{asset('recipes/include/rs-plugin/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
	<script src="{{asset('recipes/include/rs-plugin/js/extensions/revolution.extension.migration.min.js')}}"></script>
	<script src="{{asset('recipes/include/rs-plugin/js/extensions/revolution.extension.navigation.min.js')}}"></script>
	<script src="{{asset('recipes/include/rs-plugin/js/extensions/revolution.extension.parallax.min.js')}}"></script>
	<script src="{{asset('recipes/include/rs-plugin/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
	<script src="{{asset('recipes/include/rs-plugin/js/extensions/revolution.extension.video.min.js')}}"></script>

	<!-- Footer Scripts
	============================================= -->
	<script src="{{asset('recipes/js/functions.js')}}"></script>
