...
@section('content')
    ...
    <section id="slider" class="slider-element dark parallax include-header"
        style="background: #111 url({{asset('/recipes/demos/recipes/images/recipe-single.jpg')}}) center center / cover; padding: 230px 0;"
                    ...
                    <ul class="list-unstyled row g-0 align-items-center overflow-hidden col-mb-50 mt-5">
                        <li class="col-6 col-lg text-center text-lg-start">
                            <div class="grid-inner px-5">
                                <img src="{{asset('recipes/demos/recipes/images/icons/level.svg')}}" alt="Level" width="30">
                        ...
                        <li class="col-6 col-lg text-center text-lg-start">
                            <div class="grid-inner px-5">
                                <img src="{{asset('recipes/demos/recipes/images/icons/star.svg')}}" alt="Reviews" width="30">
                    ...
                    <div class="card-body px-4">
                        <div class="row align-items-center justify-content-between py-3">
                            ...
                            <div class="col-12 text-center col-xl-auto mt-5 mt-xl-0">
                                <a href="#" class="button button-circle m-0"><i class="icon-line-cloud-download"></i>
                                    Download</a>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-between mt-5 mb-4 clearfix">
                            <div class="col-lg-4">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <a href="javascript:window.print()" id="print-button"
                                        class="social-icon si-small si-colored si-print" title="Print">
                            ...
                            <div class="col-lg-8 mt-5 mt-lg-0">
                                ...
                                <ol class="list-unstyled list-preparation">
                                    <li>Place frozen tater tots on a baking sheet and bake at 450˚F (230˚C) for 20 minutes,
                                        or until crispy. Set aside.</li>
                                    <li>In a large bowl, toss chicken thighs with 1 tablespoon whole grain mustard, salt,
                                        pepper, and 1 tablespoon olive oil.</li>
                                    <li>In a cast iron skillet, cook on high heat until there is a nice brown sear on the
                                        surface of the chicken, and the inside is no longer pink.</li>
                                    ...
                                    <li>Pour the dressing on the chicken and tots. Top with onion, then cheddar and monterey
                                        jack cheese.</li>
                                    <li>Broil from 5-10 minutes, or until cheese is melted.</li>
                                    <li>Load the dish with tomatoes, avocados, sour cream, and scallions. Serve immediately.
                                    </li>
                                    <li>Enjoy!</li>
                                </ol>
                                        ...
                                        <li class="comment even thread-even depth-1" id="li-comment-1">
                                            ...
                                            <div id="comment-1" class="comment-wrap clearfix">
                                                ...
                                                <div class="comment-meta">
                                                    ...
                                                    <div class="comment-author vcard">
                                                        ...
                                                        <span class="comment-avatar clearfix">
                                                            <img alt='Image' src="{{asset('recipes/demos/articles/images/authors/2.jpg')}}"
                                                ...
                                                <div class="comment-content clearfix">
                                                    ...
                                                    <div class="comment-author">Gunther David<span><a href="#"
                                                                title="Permalink to this comment">April 24, 2012 at 10:46
                                                                am</a></span>
                                                        <small class="comment-ratings text-muted mt-2"><i
                                                                class="icon-star3"></i><i class="icon-star3"></i><i
                                                                class="icon-star3"></i><i class="icon-star3"></i><i
                                                                class="icon-star3"></i> </small>
                                                    </div>
                                                    ...
                                                    <div id="comment-3" class="comment-wrap clearfix">
                                                        ...
                                                        <div class="comment-content clearfix">
                                                            ...
                                                            <div class="comment-author"><a href='#' rel='external nofollow'
                                                                    class='url'>SemiColon</a> (Author)<span><a href="#"
                                            ...
                                            <div id="comment-2" class="comment-wrap clearfix">
                                                ...
                                                <div class="comment-meta">
                                                    ...
                                                    <div class="comment-author vcard">
                                                        ...
                                                        <span class="comment-avatar clearfix">
                                                            <img alt='Image' src="{{asset('recipes/demos/articles/images/authors/1.jpg')}}"
                                                ...
                                                <div class="comment-content clearfix">
                                                    ...
                                                    <div class="comment-author"><a
                                                            ...
                                                            rel='external nofollow' class='url'>John Doe</a><span><a
                                                                href="#" title="Permalink to this comment">April 25, 2012 at
                                                                1:03 am</a></span><small
                                                            class="comment-ratings text-muted mt-2"><i
                                                                class="icon-star3"></i><i
                                                                class="icon-star3"></i><i
                                                                class="icon-star3"></i><i
                                                                class="icon-star3"></i><i class="icon-star-half2"></i>
                                                        </small></div>
                                        ...
                                        <form class="row" action="#" method="post" id="commentform">
                                            ...
                                            <div class="col-12 form-group">
                                                <button name="submit" type="submit" id="submit-button" tabindex="5"
                                                    value="Submit" class="button button-circle button-large mt-3">Submit a
                                                    Review</button>
                                            </div>
                        ...
                        <div class="col-md-3 col-sm-6 bg-white" style="border-left: 1px solid #EEE">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title"><a href="#" class="stretched-link">Baked Salmon with
                                            Sweet-Potatoes</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 bg-white">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title"><a href="#" class="stretched-link">A Kollam Grilled Cheese
                                            with Vegetables</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 bg-white">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title"><a href="#" class="stretched-link">Pumpkin Bars with Cream
                                            Cheese Frosting</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 bg-white">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title"><a href="#" class="stretched-link">The Best Homemade Pizza
                                            Recipes</a></h3>
