            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-6 pe-4">
                    <div class="widget clearfix">
                        ...
                        <a href="#"><img src="{{ asset('recipes/demos/articles/images/appstore.png') }}"
                                alt="App Link"></a>
                        <a href="#"><img src="{{ asset('recipes/demos/articles/images/googleplay.png') }}"
                                alt="App Link" class="mt-2"></a>
