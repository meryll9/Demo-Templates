    ...
    <div class="content-wrap pt-3 pb-0">
        ...
        <div class="section bg-transparent py-2">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h2 class="display-4 fw-semibold ls--2">{{ env('APP_TAGLINE') }} <span class="text-rotater"
                                data-separator="|" data-rotate="fadeIn" data-speed="2000">
                                <span class="t-rotate">{{ env('APP_TAGLINE') }}</span>
                            </span></h2>
                    </div>
                    <div class="col-md-5">
                        <p class="lead text-muted">
                            Collaboratively coordinate adaptive synergy with compelling "outside the box" thinking.
                            Continually recaptiualize user friendly sources whereas leveraged.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="overflow-hidden parallax d-flex align-items-center" data-bottom-top="background-position:0px 200px;"
            ...
            style="background-image: url({{ asset('/coworking/demos/coworking/images/hero.jpg') }}); background-size: cover; height: 600px; width: 100%;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <h2 class="text-white">The Center is a network of 9 workspaces, from 200 to 3,700 sqft,
                            Build and Designed to support Personal and Businesses in the Creative World.</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-4 mt-3 mt-md-0">
                        <div class="feature-box fbox-plain fbox-sm fbox-dark mb-0">
                            ...
                            <div class="fbox-content">
                                ...
                                <p class="text-white mb-0">24x7 available, Anytime & anywhere, we're always available
                                    for You.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mt-3 mt-md-0">
                        <div class="feature-box fbox-plain fbox-sm fbox-dark mb-0">
                            ...
                            <div class="fbox-content">
                                ...
                                <p class="text-white mb-0">Intrinsicly evisculate quality vectors befor high-impact
                                    schemas.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container clearfix">
                <div class="row align-items-md-center mb-5">
                    <div class="col-md-6 pe-5">
                        ...
                        <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda
                            praesentium eius, similique reprehenderit ab voluptatibus eaque.</p>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow-sm border-light">
                            <img src="{{ asset('coworking/demos/coworking/images/features/3.jpg') }}"
                                alt="Featured image 1" class="card-img-top">
                            <div class="card-body">
                        ...
                        <div class="card shadow-sm border-light mt-4">
                            <img src="{{ asset('coworking/demos/coworking/images/features/2.jpg') }}"
                                alt="Featured image 2" class="card-img-top">
                            <div class="card-body">
                                <h5 class="card-title fw-semibold color">Private Rooms</h5>
                                <p class="card-text">Some quick example text. similique reprehenderit ab
                    ...
                    <div class="col-md-3 col-sm-6 ps-sm-3 mt-3 mt-sm-0">
                        <div class="card shadow-sm border-light">
                            <img src="{{ asset('coworking/demos/coworking/images/features/1.jpg') }}"
      ...
      ============================================= -->
                        ...
                        <div id="price-carousel" class="owl-carousel carousel-widget" data-margin="30" data-nav="false"
                            ...
                            <div class="price-list shadow-sm card border-0 rounded">
                                <div class="position-relative">
                                    <img src="{{ asset('coworking/demos/coworking/images/membership/1-day.jpg') }}"
                            ...
                            <div class="price-list shadow-sm card border-0 rounded">
                                <div class="position-relative">
                                    <img src="{{ asset('coworking/demos/coworking/images/membership/share.jpg') }}"
                                        alt="Featured image 1" class="card-img-top rounded-top">
                                    <div
                                        class="card-img-overlay dark d-flex justify-content-center flex-column p-0 center">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush mb-4">
                                        <li class="list-group-item ps-0"><i class="icon-line-check pe-3 color"></i>
                                            8am to 8pm Access</li>
                                        <li class="list-group-item ps-0"><i class="icon-line-check pe-3 color"></i>
                                            100 hours of Superfast Wi-Fi</li>
                                        <li class="list-group-item ps-0"><i class="icon-line-check pe-3 color"></i>
                                            Lockers Access</li>
                                        <li class="list-group-item ps-0 text-black-50"><i
                            ...
                            <div class="price-list shadow-sm card border-0 rounded">
                                <div class="position-relative">
                                    <img src="{{ asset('coworking/demos/coworking/images/membership/flexible.jpg') }}"
                                        alt="Featured image 1" class="card-img-top rounded-top">
                                    <div
                                        class="card-img-overlay dark d-flex justify-content-center flex-column p-0 center">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush mb-4">
                                        <li class="list-group-item ps-0"><i class="icon-line-check pe-3 color"></i>
                                            200 hours of WIFI per Month</li>
                                        <li class="list-group-item ps-0"><i class="icon-line-check pe-3 color"></i>
                                            Lockers Access</li>
                            ...
                            <div class="price-list shadow-sm card border-0 rounded">
                                <div class="position-relative">
                                    <img src="{{ asset('coworking/demos/coworking/images/membership/private.jpg') }}"
                                        alt="Featured image 1" class="card-img-top rounded-top">
                                    <div
                                        class="card-img-overlay dark d-flex justify-content-center flex-column p-0 center">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush mb-4">
                                        ...
                                        <li class="list-group-item ps-0"><i class="icon-line-check pe-3 color"></i>
                                            500 hours of WIFI per Month</li>
                                        <li class="list-group-item ps-0"><i class="icon-line-check pe-3 color"></i>
            ...
            <div id="image-carousel" class="owl-carousel carousel-widget" data-margin="24" data-nav="true"
                    ...
                    <div class="carousel-column-container">
                        <ul class="carousel-column column-1">
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/1.jpg')}}" data-lightbox="gallery-item"
                                    class="item"
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/1.jpg') }});"></a>
                            </li>
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/2.jpg')}}" data-lightbox="gallery-item"
                                    class="item"
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/2.jpg') }});"></a>
                            </li>
                        </ul>
                        <ul class="carousel-column column-2">
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/3.jpg')}}" data-lightbox="gallery-item"
                                    class="item"
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/3.jpg') }}); min-height: 300px"></a>
                            </li>
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/4.jpg')}}" data-lightbox="gallery-item"
                                    class="item"
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/4.jpg') }}); min-height: 280px"></a>
                            </li>
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/5.jpg')}}" data-lightbox="gallery-item"
                                    class="item"
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/5.jpg') }}); min-height: 200px"></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="slide slide--2">
                    <div class="carousel-column-container">
                        <ul class="carousel-column column-1">
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/6.jpg')}}" data-lightbox="gallery-item"
                                    class="item"
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/6.jpg') }}); min-height: 324px"></a>
                            </li>
                            <li class="carousel-grid-item">
                                <div class="item bg-color d-flex align-items-center px-4" style="min-height: 480px">
                                    <blockquote class="blockquote border-0 mb-0">
                                        <p class="mb-3 text-white">"The Spirit of CoWorking Allows You to Find
                                            CoWorkers Who're Worth Working with."</p>
                                        <footer class="blockquote-footer text-white-50 fst-italic">Cynthia Chiam
                                        </footer>
                                    </blockquote>
                                </div>
                            </li>
                        ...
                        <ul class="carousel-column column-2">
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/8.jpg')}}" data-lightbox="gallery-item"
                                    class="item"
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/8.jpg') }});"></a>
                            </li>
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/9.jpg')}}" data-lightbox="gallery-item"
                                    class="item"
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/9.jpg') }});"></a>
                            </li>
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/10.jpg')}}" data-lightbox="gallery-item"
                                    class="item"
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/10.jpg') }});"></a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <ul class="carousel-column column-1">
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/11.jpg')}}" data-lightbox="gallery-item"
                                    ...
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/11.jpg') }}); min-height: 350px">
                                    <blockquote class="blockquote border-0 mb-0">
                                        <p class="mb-3 text-white">"I Belive in Collaboration Rather Than Competition"
                                        </p>
                                        <footer class="blockquote-footer text-white-50 fst-italic">Cynthia Chiam
                                        </footer>
                                    </blockquote>
                            ...
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/12.jpg')}}" data-lightbox="gallery-item"
                                    class="item"
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/12.jpg') }}); min-height: 453px"></a>
                            </li>
                        </ul>
                        <ul class="carousel-column column-2">
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/13.jpg')}}" data-lightbox="gallery-item"
                                    class="item"
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/13.jpg') }});"></a>
                            </li>
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/14.jpg')}}" data-lightbox="gallery-item"
                                    class="item"
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/14.jpg') }});"></a>
                            </li>
                            <li class="carousel-grid-item">
                                <a href="demos/coworking/images/gallery/15.jpg')}}" data-lightbox="gallery-item"
                                    class="item"
                                    style="background-image: url({{ asset('/coworking/demos/coworking/images/gallery/15.jpg') }});"></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-8 col-md-10 offset-lg-2 offset-md-1 bottommargin-lg">
                        <a href="https://www.youtube.com/watch?v=P3Huse9K6Xs" data-lightbox="iframe"
                            class="play-video position-relative"><img
                                src="{{ asset('coworking/demos/coworking/images/video-bg.jpg') }}" alt="Video Image"
                    ...
                    <div class="col-lg-5 col-md-6 mt-0 mt-md-4">
                        <div class="feature-box fbox-plain fbox-sm">
                            ...
                            <div class="fbox-content">
                                ...
                                <p>Quickly impact virtual testing procedures vis-a-vis viral e-commerce. Completely
                        ...
                        <div class="feature-box fbox-plain fbox-sm">
                            ...
                            <div class="fbox-content">
                                <h3>24x7 Access</h3>
                                <p>Authoritatively create one-to-one relationships for B2B "outside the box" thinking.
                                    Dramatically seize.</p>
                            </div>
                        </div>
                        ...
                        <div class="feature-box fbox-plain fbox-sm mb-0">
                            ...
                            <div class="fbox-content">
                                ...
                                <p>Proactively evolve user-centric paradigms rather than exceptional core.
                                    Authoritatively brand unique.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-6 mt-5 mt-md-0">
                        ...
                        <p class="text-muted mb-5" style="font-size: 18px;">Enthusiastically embrace diverse e-markets
                            after sustainable applications. Collaboratively impact intermandated systems vis-a-vis
                            progressive information.</p>
                        <div class="d-flex">
                            <a href="demo-coworking-single.html"
                                class="button button-rounded button-xlarge d-block flex-fill m-0 center nott fw-semibold ls0">Sign
                                Up</a>
                            <a href="demo-coworking-contact.html"
                                class="button button-rounded button-xlarge d-block flex-fill button-border m-0 ms-3 center nott fw-semibold ls0">Contact
                                Us</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="section p-0 bg-transparent clearfix">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-3">
                                <div class="counter color fw-semibold"><span data-from="2" data-to="100"
            ...
            <div id="locations-carousel" class="owl-carousel carousel-widget owl-carousel-full clearfix"
                    ...
                    <div class="masonry-thumbs grid-container grid-5" data-big="2" data-lightbox="gallery">
                        <a class="grid-item" href="demos/coworking/images/location/thumbs/full/1.jpg')}}"
                            data-lightbox="gallery-item"><img class="op-ts h-op-09"
                                src="{{ asset('coworking/demos/coworking/images/location/thumbs/1.jpg') }}"
                                alt="Gallery Thumb 1"></a>
                        <div class="grid-item"><iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.835253572242!2d144.95373531531297!3d-37.817327679751735!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad65d4c2b349649%3A0xb6899234e561db11!2sEnvato!5e0!3m2!1sen!2sin!4v1554124945593!5m2!1sen!2sin"
                                width="500" height="334" allowfullscreen style="border:0;"></iframe></div>
                        <a class="grid-item" href="demos/coworking/images/location/thumbs/full/2.jpg')}}"
                            data-lightbox="gallery-item"><img class="op-ts h-op-09"
                                src="{{ asset('coworking/demos/coworking/images/location/thumbs/2.jpg') }}"
                                alt="Gallery Thumb 12"></a>
                        <a class="grid-item" href="demos/coworking/images/location/thumbs/full/3.jpg')}}"
                            data-lightbox="gallery-item"><img class="op-ts h-op-09"
                                src="{{ asset('coworking/demos/coworking/images/location/thumbs/3.jpg') }}"
                                alt="Gallery Thumb 3"></a>
                        <a class="grid-item" href="demos/coworking/images/location/thumbs/full/4.jpg')}}"
                            data-lightbox="gallery-item"><img class="op-ts h-op-09"
                                src="{{ asset('coworking/demos/coworking/images/location/thumbs/4.jpg') }}"
                                alt="Gallery Thumb 4"></a>
                        <a class="grid-item" href="demos/coworking/images/location/thumbs/full/5.jpg')}}"
                            data-lightbox="gallery-item"><img class="op-ts h-op-09"
                                src="{{ asset('coworking/demos/coworking/images/location/thumbs/5.jpg') }}"
                                alt="Gallery Thumb 5"></a>
                        <a class="grid-item" href="demos/coworking/images/location/thumbs/full/6.jpg')}}"
                            data-lightbox="gallery-item"><img class="op-ts h-op-09"
                                src="{{ asset('coworking/demos/coworking/images/location/thumbs/6.jpg') }}"
                                alt="Gallery Thumb 6"></a>
                        <a class="grid-item" href="demos/coworking/images/location/thumbs/full/7.jpg')}}"
                            data-lightbox="gallery-item"><img class="op-ts h-op-09"
                                src="{{ asset('coworking/demos/coworking/images/location/thumbs/7.jpg') }}"
                                alt="Gallery Thumb 7"></a>
                        <a class="grid-item" href="demos/coworking/images/location/thumbs/full/8.jpg')}}"
                            data-lightbox="gallery-item"><img class="op-ts h-op-09"
                                src="{{ asset('coworking/demos/coworking/images/location/thumbs/8.jpg') }}"
                                alt="Gallery Thumb 13"></a>
                        <a class="grid-item" href="demos/coworking/images/location/thumbs/full/9.jpg')}}"
                            data-lightbox="gallery-item"><img class="op-ts h-op-09"
                                src="{{ asset('coworking/demos/coworking/images/location/thumbs/9.jpg') }}"
                                alt="Gallery Thumb 6"></a>
                        <a class="grid-item" href="demos/coworking/images/location/thumbs/full/10.jpg')}}"
                            data-lightbox="gallery-item"><img class="op-ts h-op-09"
                                src="{{ asset('coworking/demos/coworking/images/location/thumbs/10.jpg') }}"
                                alt="Gallery Thumb 7"></a>
                        <a class="grid-item" href="demos/coworking/images/location/thumbs/full/11.jpg')}}"
                            data-lightbox="gallery-item"><img class="op-ts h-op-09"
                                src="{{ asset('coworking/demos/coworking/images/location/thumbs/11.jpg') }}"
                                alt="Gallery Thumb 12"></a>
                    </div>
                    <div class="container">
                            ...
                            <div class="card-body">
                                ...
                                <div style="font-size: 16px;">
                                    ...
                                    <div class="mb-4" style="font-size: 15px;">
                                        ...
                                        <a href="tel:+(61)3-222-333-44"
                                            class="text-dark d-block mb-1">+(61)3-222-333-44</a>
                                        <a href="tel:+(61)3-234-532-45" class="text-dark">+(61)3-234-532-45</a>
                                    </div>

                                    <a href="mailto:noreply@canvas.com"
                                        class="button button-rounded m-0 nott fw-semibold ls0">Email Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow bg-white">
                            <div class="card-body">
                                ...
                                <div style="font-size: 16px;">
                                    ...
                                    <div class="mb-4" style="font-size: 15px;">
                                        <small class="text-black-50 d-block mb-2">Phone Number:</small>
                                        <a href="tel:+(61)2-222-333-44"
                                            class="text-dark d-block mb-1">+(61)2-222-333-44</a>
                ...
                <div>
                    <img src="{{ asset('coworking/demos/coworking/images/location/perth.jpg') }}" alt="Perth">
                    <div class="container">
                        <div class="card shadow bg-white">
                            <div class="card-body">
                                ...
                                <div style="font-size: 16px;">
                                    ...
                                    <div class="mb-4" style="font-size: 15px;">
                                        <small class="text-black-50 d-block mb-2">Phone Number:</small>
                                        <a href="tel:+(61)8-222-333-44"
                                            class="text-dark d-block mb-1">+(61)8-222-333-44</a>
                                        <a href="tel:+(61)8-234-532-45" class="text-dark">+(61)8-234-532-45</a>
                                    </div>

                                    <div class="d-flex">
                                        <a href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d54159.94533455547!2d115.81934154447853!3d-31.96098939372422!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2a32a525098d1f2f%3A0xec4a7b90626730e7!2sKings+Park+and+Botanic+Garden!5e0!3m2!1sen!2sin!4v1554279269646!5m2!1sen!2sin"
                                            data-lightbox="iframe"
                                            class="button button-rounded button-border m-0 nott fw-medium ls0">View
                                            Map</a>
                                        <a href="mailto:noreply@canvas.com"
                                            class="button button-rounded m-0 nott fw-semibold ls0 ms-2">Email Us</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row col-mb-30 posts-md">
                        ...
                        <article class="entry">
                            ...
                            <div class="entry-content">
                                <p>Synergistically expedite focused experiences through orthogonal "outside the box"
                                    thinking. Collaboratively reconceptualize e-commerce via effective applications.
                                    Enthusiastically conceptualize go forward functionalities vis-a-vis sticky
                                    partnerships. Distinctively underwhelm premier scenarios without synergistic best
                                    practices. Globally target cross-platform.</p>
                            </div>
                            <div class="author-meta d-flex align-items-center">
                                <div class="author-image">
                                    <img src="{{ asset('coworking/demos/articles/images/authors/1.jpg') }}"
                    ...
                    <div class="col-md-4">
                        <article class="entry">
                            ...
                            <div class="entry-content">
                                <p>Pellentesque hic illo beatae rhoncus sint, quis, fugiat imperdiet unde architecto
                                    magna dui hymenaeos autem lorem eligendi.</p>
                            </div>
                            <div class="author-meta d-flex align-items-center">
                                <div class="author-image">
                                    <img src="{{ asset('coworking/demos/articles/images/authors/2.jpg') }}"
                                        alt="Author Image" class="rounded-circle">
                                </div>
                    ...
                    <div class="col-md-4">
                        <article class="entry">
                            ...
                            <div class="author-meta d-flex align-items-center">
                                <div class="author-image">
                                    <img src="{{ asset('coworking/demos/articles/images/authors/3.jpg') }}"
                                        alt="Author Image" class="rounded-circle">
                                </div>
                                <div class="entry-meta no-separator mb-0">
                                    <ul class="flex-column mb-0">
        ...
        <div class="section mb-0 pb-0 bg-theme-light clearfix" style="padding-top: 120px;">
            ...
            <img src="{{ asset('coworking/demos/coworking/images/footer-bg.jpg') }}" alt="Footer Image"
                class="footer-img">
        </div>
    </div>
</section><!-- #content end -->
