			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="index.html" class="standard-logo" data-sticky-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
							<a href="index.html" class="retina-logo" data-sticky-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								...
								<li class="menu-item"><a class="menu-link" href="demo-coworking-about.html"><div>About Us</div></a></li>
			...
			<div class="content-wrap pt-3 pb-0">
				...
				<div class="section bg-transparent py-2">
					<div class="container">
						<div class="row">
							<div class="col-md-7">
								<h2 class="display-4 fw-semibold ls--2">{{ env('APP_TAGLINE') }} <span class="text-rotater" data-separator="|" data-rotate="fadeIn" data-speed="2000">
				...
				<div class="overflow-hidden parallax d-flex align-items-center" data-bottom-top="background-position:0px 200px;" data-top-bottom="background-position:0px -400px;" style="background-image: url({{asset('/coworking/demos/coworking/images/hero.jpg')}}); background-size: cover; height: 600px; width: 100%;">
					<div class="container">
						<div class="row">
							<div class="col-lg-6">
						...
						<div class="row align-items-md-center mb-5">
							...
							<div class="col-md-3 col-sm-6">
								<div class="card shadow-sm border-light">
									<img src="{{asset('coworking/demos/coworking/images/features/3.jpg')}}" alt="Featured image 1" class="card-img-top">
									<div class="card-body">
								...
								<div class="card shadow-sm border-light mt-4">
									<img src="{{asset('coworking/demos/coworking/images/features/2.jpg')}}" alt="Featured image 2" class="card-img-top">
									<div class="card-body">
							...
							<div class="col-md-3 col-sm-6 ps-sm-3 mt-3 mt-sm-0">
								<div class="card shadow-sm border-light">
									<img src="{{asset('coworking/demos/coworking/images/features/1.jpg')}}" alt="Featured image 3" class="card-img-top">
									<div class="card-body">
								...
								<div id="price-carousel" class="owl-carousel carousel-widget" data-margin="30" data-nav="false" data-pagi="true" data-items-xs="1" data-items-sm="1" data-items-md="2" data-items-lg="3" data-items-xl="3">
									...
									<div class="price-list shadow-sm card border-0 rounded">
										<div class="position-relative">
											<img src="{{asset('coworking/demos/coworking/images/membership/1-day.jpg')}}" alt="Featured image 1" class="card-img-top rounded-top">
									...
									<div class="price-list shadow-sm card border-0 rounded">
										<div class="position-relative">
											<img src="{{asset('coworking/demos/coworking/images/membership/share.jpg')}}" alt="Featured image 1" class="card-img-top rounded-top">
											<div class="card-img-overlay dark d-flex justify-content-center flex-column p-0 center">
									...
									<div class="price-list shadow-sm card border-0 rounded">
										<div class="position-relative">
											<img src="{{asset('coworking/demos/coworking/images/membership/flexible.jpg')}}" alt="Featured image 1" class="card-img-top rounded-top">
											<div class="card-img-overlay dark d-flex justify-content-center flex-column p-0 center">
									...
									<div class="price-list shadow-sm card border-0 rounded">
										<div class="position-relative">
											<img src="{{asset('coworking/demos/coworking/images/membership/private.jpg')}}" alt="Featured image 1" class="card-img-top rounded-top">
											<div class="card-img-overlay dark d-flex justify-content-center flex-column p-0 center">
					...
					<div id="image-carousel" class="owl-carousel carousel-widget" data-margin="24" data-nav="true" data-pagi="true" data-items-xs="1" data-items-sm="1" data-items-md="1" data-items-lg="2" data-items-xl="2" style="padding: 0 20px" data-lightbox="gallery">
							...
							<div class="carousel-column-container">
								<ul class="carousel-column column-1">
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/1.jpg')}}" data-lightbox="gallery-item" class="item" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/1.jpg')}});"></a>
									</li>
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/2.jpg')}}" data-lightbox="gallery-item" class="item" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/2.jpg')}});"></a>
									</li>
								</ul>
								<ul class="carousel-column column-2">
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/3.jpg')}}" data-lightbox="gallery-item" class="item" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/3.jpg')}}); min-height: 300px"></a>
									</li>
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/4.jpg')}}" data-lightbox="gallery-item" class="item" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/4.jpg')}}); min-height: 280px"></a>
									</li>
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/5.jpg')}}" data-lightbox="gallery-item" class="item" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/5.jpg')}}); min-height: 200px"></a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="slide slide--2">
							<div class="carousel-column-container">
								<ul class="carousel-column column-1">
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/6.jpg')}}" data-lightbox="gallery-item" class="item" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/6.jpg')}}); min-height: 324px"></a>
									</li>
									<li class="carousel-grid-item">
								...
								<ul class="carousel-column column-2">
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/8.jpg')}}" data-lightbox="gallery-item" class="item" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/8.jpg')}});"></a>
									</li>
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/9.jpg')}}" data-lightbox="gallery-item" class="item" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/9.jpg')}});"></a>
									</li>
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/10.jpg')}}" data-lightbox="gallery-item" class="item" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/10.jpg')}});"></a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="slide slide--3">
							<div class="carousel-column-container">
								<ul class="carousel-column column-1">
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/11.jpg')}}" data-lightbox="gallery-item" class="item bg-color d-flex align-items-center px-4 img-overlay" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/11.jpg')}}); min-height: 350px">
											<blockquote class="blockquote border-0 mb-0">
									...
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/12.jpg')}}" data-lightbox="gallery-item" class="item" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/12.jpg')}}); min-height: 453px"></a>
									</li>
								</ul>
								<ul class="carousel-column column-2">
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/13.jpg')}}" data-lightbox="gallery-item" class="item" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/13.jpg')}});"></a>
									</li>
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/14.jpg')}}" data-lightbox="gallery-item" class="item" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/14.jpg')}});"></a>
									</li>
									<li class="carousel-grid-item">
										<a href="demos/coworking/images/gallery/15.jpg')}}" data-lightbox="gallery-item" class="item" style="background-image: url({{asset('/coworking/demos/coworking/images/gallery/15.jpg')}});"></a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="container">
						<div class="row justify-content-between align-items-center">
							<div class="col-lg-8 col-md-10 offset-lg-2 offset-md-1 bottommargin-lg">
								<a href="https://www.youtube.com/watch?v=P3Huse9K6Xs" data-lightbox="iframe" class="play-video position-relative"><img src="{{asset('coworking/demos/coworking/images/video-bg.jpg')}}" alt="Video Image" class="rounded-3 shadow-lg">
									<i class="icon-play"></i>
								</a>
							</div>
					...
					<div id="locations-carousel" class="owl-carousel carousel-widget owl-carousel-full clearfix" data-animate-in="fadeIn" data-animate-out="fadeOut" data-speed="200" data-margin="0" data-nav="true" data-pagi="true" data-items="1">
						<div>
							<div class="masonry-thumbs grid-container grid-5" data-big="2" data-lightbox="gallery">
								<a class="grid-item" href="demos/coworking/images/location/thumbs/full/1.jpg')}}" data-lightbox="gallery-item"><img class="op-ts h-op-09" src="{{asset('coworking/demos/coworking/images/location/thumbs/1.jpg')}}" alt="Gallery Thumb 1"></a>
								...
								<a class="grid-item" href="demos/coworking/images/location/thumbs/full/2.jpg')}}" data-lightbox="gallery-item"><img class="op-ts h-op-09" src="{{asset('coworking/demos/coworking/images/location/thumbs/2.jpg')}}" alt="Gallery Thumb 12"></a>
								<a class="grid-item" href="demos/coworking/images/location/thumbs/full/3.jpg')}}" data-lightbox="gallery-item"><img class="op-ts h-op-09" src="{{asset('coworking/demos/coworking/images/location/thumbs/3.jpg')}}" alt="Gallery Thumb 3"></a>
								<a class="grid-item" href="demos/coworking/images/location/thumbs/full/4.jpg')}}" data-lightbox="gallery-item"><img class="op-ts h-op-09" src="{{asset('coworking/demos/coworking/images/location/thumbs/4.jpg')}}" alt="Gallery Thumb 4"></a>
								<a class="grid-item" href="demos/coworking/images/location/thumbs/full/5.jpg')}}" data-lightbox="gallery-item"><img class="op-ts h-op-09" src="{{asset('coworking/demos/coworking/images/location/thumbs/5.jpg')}}" alt="Gallery Thumb 5"></a>
								<a class="grid-item" href="demos/coworking/images/location/thumbs/full/6.jpg')}}" data-lightbox="gallery-item"><img class="op-ts h-op-09" src="{{asset('coworking/demos/coworking/images/location/thumbs/6.jpg')}}" alt="Gallery Thumb 6"></a>
								<a class="grid-item" href="demos/coworking/images/location/thumbs/full/7.jpg')}}" data-lightbox="gallery-item"><img class="op-ts h-op-09" src="{{asset('coworking/demos/coworking/images/location/thumbs/7.jpg')}}" alt="Gallery Thumb 7"></a>
								<a class="grid-item" href="demos/coworking/images/location/thumbs/full/8.jpg')}}" data-lightbox="gallery-item"><img class="op-ts h-op-09" src="{{asset('coworking/demos/coworking/images/location/thumbs/8.jpg')}}" alt="Gallery Thumb 13"></a>
								<a class="grid-item" href="demos/coworking/images/location/thumbs/full/9.jpg')}}" data-lightbox="gallery-item"><img class="op-ts h-op-09" src="{{asset('coworking/demos/coworking/images/location/thumbs/9.jpg')}}" alt="Gallery Thumb 6"></a>
								<a class="grid-item" href="demos/coworking/images/location/thumbs/full/10.jpg')}}" data-lightbox="gallery-item"><img class="op-ts h-op-09" src="{{asset('coworking/demos/coworking/images/location/thumbs/10.jpg')}}" alt="Gallery Thumb 7"></a>
								<a class="grid-item" href="demos/coworking/images/location/thumbs/full/11.jpg')}}" data-lightbox="gallery-item"><img class="op-ts h-op-09" src="{{asset('coworking/demos/coworking/images/location/thumbs/11.jpg')}}" alt="Gallery Thumb 12"></a>
							</div>
							<div class="container">
						...
						<div class="row col-mb-30 posts-md">
								...
								<article class="entry">
									...
									<div class="author-meta d-flex align-items-center">
										<div class="author-image">
											<img src="{{asset('coworking/demos/articles/images/authors/1.jpg')}}" alt="Author Image" class="rounded-circle">
										</div>
							...
							<div class="col-md-4">
								<article class="entry">
									...
									<div class="author-meta d-flex align-items-center">
										<div class="author-image">
											<img src="{{asset('coworking/demos/articles/images/authors/2.jpg')}}" alt="Author Image" class="rounded-circle">
										</div>
							...
							<div class="col-md-4">
								<article class="entry">
									...
									<div class="author-meta d-flex align-items-center">
										<div class="author-image">
											<img src="{{asset('coworking/demos/articles/images/authors/3.jpg')}}" alt="Author Image" class="rounded-circle">
										</div>
										<div class="entry-meta no-separator mb-0">
											<ul class="flex-column mb-0">
												<li class="mb-1"><span>By</span> <a href="#">Hanson Deck</a></li>
			...
			<div class="container">
				...
				<div class="footer-widgets-wrap dark pb-5 clearfix">
					...
					<div class="row">
						...
						<div class="row">
							<div class="col-sm-3">
								<a href="index.html"><img src="{{asset('coworking/demos/coworking/images/logo-footer.png')}}" alt="Logo Footer" class="mb-4" height="20"></a>
