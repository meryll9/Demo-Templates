...
<body class="stretched" data-loader-html="<div><img src='{{asset('demos/photographer/images/icons/loader.svg')}}' alt='Loader'></div>">
	...
	<div id="wrapper" class="clearfix">
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						<a href="demo-photography.html"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo" height="100"></a>
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element min-vh-60 min-vh-md-100 include-header" style="background: url({{asset('/photographer/demos/photographer/images/dots-1.png')}}) 100% 0 no-repeat; background-size: 60% auto">
						...
						<div class="row align-items-center col-mb-50">
							<div class="col-md-6">
								<div class="py-5 py-md-0">
									...
									<h5 class="fw-light ls1" style="opacity: .7">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga quasi quo ea magnam dignissimos quis obcaecati aut in.</h5>
									<div class="d-flex align-items-center mt-5">
										<a href="#" class="button button-change button-rounded overflow-hidden nott button-large fw-normal mx-0 px-5">
											<span><i class="icon-line2-envelope fw-semibold"></i> Email Me Here</span>
										</a>
										<a href="https://facebook.com/semicolonweb" target="_blank" class="d-none d-sm-inline-block my-0 me-0 ms-4 social-icon si-small si-borderless si-facebook">
											<i class="icon-facebook"></i>
											<i class="icon-facebook"></i>
										</a>
										<a href="https://facebook.com/semicolonweb" target="_blank" class="d-none d-sm-inline-block my-0 me-0 ms-3 social-icon si-small si-borderless si-twitter">
							...
							<div class="col-md-6 ps-md-5 ps-lg-0">
								<div class="row align-items-stretch">
									<div class="col-lg-6 col-md-12 rounded col-6 d-none d-sm-flex" style="background: url({{asset('/photographer/demos/photographer/images/1.jpg')}}) center center no-repeat; background-size: cover;">
									</div>
									...
									<div class="col-lg-6 col-md-12 gradient-border shadow-sm col-sm-6 col-12 max-height" style="background-color: #FFF;">
										<div class="feature-box flex-column px-3 py-4 fbox-sm">
											<div class="fbox-media">
												<img src="{{asset('photographer/demos/photographer/images/icons/instagram.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image" style="height: 48px;">
											</div>
											<div class="fbox-content">
												<div class="d-block" style="margin: 90px auto"></div>
												<p class="mb-0 fw-normal">View My Stories</p>
												<h3 class="fw-medium mt-1 mb-0 d-flex align-self-end"><a href="https://instagram.com/semicolonweb" target="_blank" class="text-dark">Instagram <i class="icon-line-arrow-right fw-semibold position-relative" style="top: 2px"></i></a></h3>
											</div>
										</div>
									</div>
								</div>
		...
		<section id="content">
			...
			<div class="content-wrap pt-0">
					...
					<div class="container">
						<div class="row align-items-center justify-content-between">
							...
							<div class="col-lg-4 parallax" data-bottom-top="margin-top:-50px" data-top-bottom="margin-top:50px">
								...
								<h2 class="fw-bold ls0 mb-4" style="font-size: 38px;">I have been taking photographs for the last 7 years.</h2>
								...
								<div class="row">
									<div class="col-sm-6">
										...
										<div class="flip-card">
												...
												<div class="flip-card-inner">
													<div class="feature-box media-box fbox-sm">
														<div class="fbox-icon position-relative mb-4">
															<a href="#">
																<img src="{{asset('photographer/demos/photographer/images/icons/camera1-dark.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image">
															</a>
														</div>
														<div class="fbox-content">
											...
											<div class="flip-card-back dark" style="background-image: url({{asset('/photographer/demos/photographer/images/features/1-1.jpg')}})">
												<div class="flip-card-inner mt-3">
													...
													<a href="#" class="button button-change overflow-hidden rounded nott fw-light m-0">
									...
									<div class="col-sm-6 mb-5">
										...
										<div class="flip-card">
											<div class="flip-card-front no-after" style="background-color: #F9F9F9">
												<div class="flip-card-inner">
													<div class="feature-box media-box fbox-sm">
														<div class="fbox-icon position-relative mb-4">
															<a href="#">
																<img src="{{asset('photographer/demos/photographer/images/icons/travel-dark.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image">
															</a>
														</div>
														<div class="fbox-content">
											...
											<div class="flip-card-back dark" style="background-image: url({{asset('/photographer/demos/photographer/images/features/2.jpg')}})">
												<div class="flip-card-inner mt-3">
													<h4 class="mb-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias cum repellat velit.</h4>
													<a href="#" class="button button-change overflow-hidden rounded nott fw-light m-0">
														<span>View Photos</span>
									...
									<div class="col-sm-6 mb-5">
										...
										<div class="flip-card">
											<div class="flip-card-front no-after" style="background-color: #F9F9F9">
												<div class="flip-card-inner">
													<div class="feature-box media-box fbox-sm">
														<div class="fbox-icon position-relative mb-4">
															<a href="#">
																<img src="{{asset('photographer/demos/photographer/images/icons/wedding-dark.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image">
															</a>
														</div>
														<div class="fbox-content">
											...
											<div class="flip-card-back dark" style="background-image: url({{asset('/photographer/demos/photographer/images/features/3.jpg')}})">
												<div class="flip-card-inner mt-3">
													<h4 class="mb-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias cum repellat velit.</h4>
													<a href="#" class="button button-change overflow-hidden rounded nott fw-light m-0">
														<span>View Photos</span>
									...
									<div class="col-sm-6">
										...
										<div class="flip-card">
											<div class="flip-card-front no-after" style="background-color: #F9F9F9">
												<div class="flip-card-inner">
													<div class="feature-box media-box fbox-sm">
														<div class="fbox-icon position-relative mb-4">
															<a href="#">
																<img src="{{asset('photographer/demos/photographer/images/icons/camera2-dark.svg')}}" class="rounded-0 bg-transparent text-start" alt="Image">
															</a>
														</div>
														<div class="fbox-content">
											...
											<div class="flip-card-back dark" style="background-image: url({{asset('/photographer/demos/photographer/images/features/4.jpg')}})">
												<div class="flip-card-inner mt-3">
													<h4 class="mb-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias cum repellat velit.</h4>
													<a href="#" class="button button-change overflow-hidden rounded nott fw-light m-0">
														<span>View Photos</span>
						...
						<div class="row grid-container gutter-30" style="overflow: visible;">
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/1.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/1.jpg')}}" alt="Image"></a>
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/2.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/2.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
										<small class="text-light ls1 fw-light">Travel</small>
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/3.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/3.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
										<small class="text-light ls1 fw-light">Travel</small>
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/4.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/4.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/5.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/5.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
										<small class="text-light ls1 fw-light">Wedding</small>
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/6.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/6.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
										<small class="text-light ls1 fw-light">Travel</small>
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/7.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/7.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/8.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/8.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
										<small class="text-light ls1 fw-light">Candid</small>
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/9.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/9.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/10.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/10.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/11.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/11.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/12.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/12.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/13.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/13.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
										<small class="text-light ls1 fw-light">Travel</small>
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/14.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/14.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
							...
							<div class="col-lg-4 col-sm-6 rounded img-hover-wrap">
								<div class="img-hover-card">
									<a href="demos/photographer/images/album/15.jpg')}}" data-lightbox="image"><img src="{{asset('photographer/demos/photographer/images/album/15.jpg')}}" alt="Image"></a>
									<div class="img-hover-detail">
										<small class="text-light ls1 fw-light">Candid</small>
										<h3 class="img-hover-title"><a href="#">Street Picture</a></h3>
										<div class="img-link"><a href="#"><i class="icon-line-arrow-right"></i></a></div>
				...
				<!-- Counter Section
				============================================= -->
				<div class="section" style="background: #FFF url({{asset('/photographer/demos/photographer/images/dots.png')}}) 170% 0% no-repeat; background-size: 60% auto">
							...
							<div class="col-md-10 offset-md-1">
								<div class="row">
									...
									<div class="col-md-3 col-6">
										<a href="#"><img class="p-4" src="{{asset('photographer/demos/photographer/images/clients/light/1.png')}}" alt="clients"></a>
									</div>
									<!-- Client
									============================================= -->
									<div class="col-md-3 col-6">
										<a href="#"><img class="p-4" src="{{asset('photographer/demos/photographer/images/clients/light/2.png')}}" alt="clients"></a>
									</div>
									<!-- Client
									============================================= -->
									<div class="col-md-3 col-6">
										<a href="#"><img class="p-4" src="{{asset('photographer/demos/photographer/images/clients/light/3.png')}}" alt="clients"></a>
									</div>
									<!-- Client
									============================================= -->
									<div class="col-md-3 col-6">
										<a href="#"><img class="p-4" src="{{asset('photographer/demos/photographer/images/clients/light/4.png')}}" alt="clients"></a>
									</div>
									<!-- Client
									============================================= -->
									<div class="col-md-3 col-6">
										<a href="#"><img class="p-4" src="{{asset('photographer/demos/photographer/images/clients/light/5.png')}}" alt="clients"></a>
									</div>
									<!-- Client
									============================================= -->
									<div class="col-md-3 col-6">
										<a href="#"><img class="p-4" src="{{asset('photographer/demos/photographer/images/clients/light/6.png')}}" alt="clients"></a>
									</div>
									<!-- Client
									============================================= -->
									<div class="col-md-3 col-6">
										<a href="#"><img class="p-4" src="{{asset('photographer/demos/photographer/images/clients/light/7.png')}}" alt="clients"></a>
									</div>
									<!-- Client
									============================================= -->
									<div class="col-md-3 col-6">
										<a href="#"><img class="p-4" src="{{asset('photographer/demos/photographer/images/clients/light/8.png')}}" alt="clients"></a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row clearfix">
							...
							<div class="col-lg-4 col-md-6 mt-3">
								<div class="card shadow-sm d-flex align-items-end flex-column p-3" style="height: 450px; background-color: #FFF; border: 1px solid #FFF">
									...
									<div class="mt-auto">
										<div class="card-body">
											<img src="{{asset('photographer/demos/photographer/images/icons/shutter.svg')}}" width="40" alt="Image" class="mb-4">
							...
							<div class="col-lg-4 col-md-6 mt-3">
								<div class="card shadow-sm d-flex align-items-end flex-column p-3" style="height: 450px; background-color: #FFF; border: 1px solid #FFF">
									...
									<div class="mt-auto">
										<div class="card-body">
											<img src="{{asset('photographer/demos/photographer/images/icons/video-camera.svg')}}" width="40" alt="Image" class="mb-4">
									...
									<div class="mt-auto">
										<div class="card-body">
											<div class="d-flex align-items-center mb-4">
												<span><img src="{{asset('photographer/demos/photographer/images/icons/lr.svg')}}" width="35" alt="Image"></span>
												<span class="px-3 h6 m-0 fw-light">&amp;</span>
												<span><img src="{{asset('photographer/demos/photographer/images/icons/psd.svg')}}" width="35" alt="Image"></span>
											</div>
						...
						<div class="row justify-content-between mt-5">
							...
							<div class="col-md-6">
								...
								<div class="d-flex align-items-center mt-4">
									<a href="#" class="button button-change button-large button-rounded nott fw-light m-0 overflow-hidden">
										<span><i class="icon-line2-envelope"></i> Contact Us</span>
									</a>
									<a href="https://facebook.com/semicolonweb" target="_blank" class="my-0 me-0 ms-3 social-icon inline-block si-small si-borderless si-facebook">
										<i class="icon-facebook"></i>
										<i class="icon-facebook"></i>
									</a>
									<a href="https://twitter.com/__semicolon" target="_blank" class="my-0 me-0 ms-2 social-icon inline-block si-small si-borderless si-twitter">
										<i class="icon-twitter"></i>
										<i class="icon-twitter"></i>
									</a>
									<a href="https://instagram.com/semicolonweb" target="_blank" class="my-0 me-0 ms-2 social-icon inline-block si-small si-borderless si-instagram">
