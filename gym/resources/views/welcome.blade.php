	...
	<div id="wrapper" class="clearfix">
					...
					<div class="header-row justify-content-lg-between">
						...
						<nav class="primary-menu not-dark">
							...
							<ul class="menu-container border-end-0">
								...
								<li class="menu-item"><a class="menu-link" href="index.html"><div>About</div></a>
									<ul class="sub-menu-container">
										<li class="current menu-item"><a class="menu-link" href="index.html"><div>Home</div></a></li>
										<li class="menu-item"><a class="menu-link" href="index.html"><div>About</div></a></li>
										<li class="menu-item"><a class="menu-link" href="index.html"><div>Classes</div></a></li>
										<li class="menu-item"><a class="menu-link" href="index.html"><div>Gallery</div></a></li>
										<li class="menu-item"><a class="menu-link" href="index.html"><div>Pricing</div></a></li>
										<li class="menu-item"><a class="menu-link" href="index.html"><div>Contact</div></a></li>
									</ul>
								</li>
								<li class="menu-item"><a class="menu-link" href="index.html"><div>Classes</div></a></li>
								<li class="menu-item"><a class="menu-link" href="index.html"><div>Gallery</div></a></li>
				...
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
									...
									<div class="d-md-flex mx-auto d-none categories-lists mt-5" style="width: 60%;">
										<div class="me-auto">
											<span class="list-group-item h6 fw-light text-white py-2 px-1 bg-transparent border-0"><i class="icon-line-plus me-2"></i>No Monthly Commitment</span>
											<span class="list-group-item h6 fw-light text-white py-2 px-1 bg-transparent border-0"><i class="icon-line-plus me-2"></i>Locker Facility</span>
											<span class="list-group-item h6 fw-light text-white py-2 px-1 bg-transparent border-0"><i class="icon-line-plus me-2"></i>1 Day Free Pass</span>
											<span class="list-group-item h6 fw-light text-white py-2 px-1 bg-transparent border-0"><i class="icon-line-plus me-2"></i>Sauna &amp; Steam Available</span>
										</div>
										<div>
											<span class="list-group-item h6 fw-light text-white py-2 px-1 bg-transparent border-0"><i class="icon-line-plus me-2"></i>1 User Valid</span>
											<span class="list-group-item h6 fw-light text-white py-2 px-1 bg-transparent border-0"><i class="icon-line-plus me-2"></i>Shower Room</span>
											<span class="list-group-item h6 fw-light text-white py-2 px-1 bg-transparent border-0"><i class="icon-line-plus me-2"></i>Free WiFi Access</span>
										</div>
									</div>
									<div class="d-flex justify-content-center align-items-center mx-auto categories-lists mt-4">
										<div class="d-flex fw-semibold ms-2 mb-0 p-2 h5 text-dark center justify-content-center align-items-center" style="background:  url({{asset('/gym/demos/gym/images/brush.png')}})no-repeat center center / cover; width: 180px; height: 50px"><span class="align-self-center">$19.99/m</span></div>
										<a href="#" class="button button-rounded button-large nott ms-4 align-self-center">Reserve Now</a>
									</div>
								</div>
							</div>
							...
							<div class="swiper-slide-bg" style="background-image:  url({{asset('/gym/demos/gym/images/slider/1.jpg')}});"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
									...
									<div class="d-md-flex mx-auto d-none categories-lists mt-5" style="width: 60%;">
										<div class="me-auto">
											<span class="list-group-item h6 fw-light text-white py-2 px-1 bg-transparent border-0"><i class="icon-line-plus me-2"></i>3 Months Contact</span>
											<span class="list-group-item h6 fw-light text-white py-2 px-1 bg-transparent border-0"><i class="icon-line-plus me-2"></i>Locker Facility</span>
											<span class="list-group-item h6 fw-light text-white py-2 px-1 bg-transparent border-0"><i class="icon-line-plus me-2"></i>1 Day Free Pass</span>
											<span class="list-group-item h6 fw-light text-white py-2 px-1 bg-transparent border-0"><i class="icon-line-plus me-2"></i>Steam Available</span>
										</div>
										<div>
											<span class="list-group-item h6 fw-light text-white py-2 px-1 bg-transparent border-0"><i class="icon-line-plus me-2"></i>1 User Valid</span>
											<span class="list-group-item h6 fw-light text-white py-2 px-1 bg-transparent border-0"><i class="icon-line-plus me-2"></i>Shower Room</span>
						...
						<div class="swiper-slide dark">
							...
							<div class="swiper-slide-bg" style="background-image:  url({{asset('/gym/demos/gym/images/slider/3.jpg')}});"></div>
						</div>
					</div>
					<!-- Slider Arrows
					============================================= -->
		...
		<section id="content">
			<div class="content-wrap pt-0">
				...
				<div class="section m-0" style="background:  url({{asset('/gym/demos/gym/images/section/bg-1.jpg')}}) center bottom no-repeat; background-size: cover; padding: 80px 0 180px;">
					...
					<div class="container clearfix">
						...
						<div class="row col-mb-50 mb-0">
							<div class="col-md-4 col-sm-6">
								...
								<div class="feature-box fbox-dark fbox-effect flex-md-row-reverse text-md-end mt-5" data-animate="fadeIn">
									<div class="fbox-icon">
								...
								<div class="feature-box fbox-dark fbox-effect flex-md-row-reverse text-md-end mt-5" data-animate="fadeIn" data-delay="200">
									<div class="fbox-icon">
								...
								<div class="feature-box fbox-dark fbox-effect flex-md-row-reverse text-md-end mt-5" data-animate="fadeIn" data-delay="400">
									<div class="fbox-icon">
				...
				<div class="section m-0">
					<div class="container clearfix">
						<div class="mx-auto center" style="max-width: 900px;">
							...
							<span style="font-size: 16px;" class="fw-light text-capitalize ls1 mt-0">When the Gym Becomes your Second Home.</span>
						</div>
					</div>
				</div>
				<div class="masonry-thumbs grid-container grid-4" data-lightbox="gallery">
					<a class="grid-item" href="{{asset('gym/demos/gym/images/gallery/1.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('gym/demos/gym/images/gallery/1.jpg')}}" alt="Gallery Thumb 1"><i class="icon-resize-full"></i></a>
					<a class="grid-item" href="{{asset('gym/demos/gym/images/gallery/2.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('gym/demos/gym/images/gallery/2.jpg')}}" alt="Gallery Thumb 2"><i class="icon-resize-full"></i></a>
					<a class="grid-item" href="{{asset('gym/demos/gym/images/gallery/3.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('gym/demos/gym/images/gallery/3.jpg')}}" alt="Gallery Thumb 3"><i class="icon-resize-full"></i></a>
					<a class="grid-item" href="{{asset('gym/demos/gym/images/gallery/4.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('gym/demos/gym/images/gallery/4.jpg')}}" alt="Gallery Thumb 4"><i class="icon-resize-full"></i></a>
					<a class="grid-item" href="{{asset('gym/demos/gym/images/gallery/5.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('gym/demos/gym/images/gallery/5.jpg')}}" alt="Gallery Thumb 5"><i class="icon-resize-full"></i></a>
					<a class="grid-item" href="{{asset('gym/demos/gym/images/gallery/6.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('gym/demos/gym/images/gallery/6.jpg')}}" alt="Gallery Thumb 6"><i class="icon-resize-full"></i></a>
					<a class="grid-item" href="{{asset('gym/demos/gym/images/gallery/7.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('gym/demos/gym/images/gallery/7.jpg')}}" alt="Gallery Thumb 7"><i class="icon-resize-full"></i></a>
					<a class="grid-item" href="{{asset('gym/demos/gym/images/gallery/8.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('gym/demos/gym/images/gallery/8.jpg')}}" alt="Gallery Thumb 9"><i class="icon-resize-full"></i></a>
				</div>
				...
				<div class="row dark align-items-stretch bottommargin clearfix">
					<div class="col-sm-6" style="background:  url({{asset('/gym/demos/gym/images/section/2.jpg')}}) center left no-repeat; background-size: cover; padding: 80px;">
						<div class="d-flex align-items-start flex-column" style="height: 400px;">
							...
							<a class="button button-border-icon px-0 mx-0" href="https://www.youtube.com/watch?v=zBrAbpOt-WY" data-lightbox="iframe"><i class="icon-play"></i><span>Play Video</span></a>
						</div>
					</div>
					<div class="col-sm-6" style="background:  url({{asset('/gym/demos/gym/images/section/3.jpg')}}) center center no-repeat; background-size: cover; padding: 80px;">
						<div class="d-flex align-items-start flex-column" style="height: 400px;">
							<div class="mb-auto heading-block border-bottom-0">
							...
							<a class="button button-border-icon px-0 mx-0" href="https://www.youtube.com/watch?v=2uL0ayEbQ5c" data-lightbox="iframe"><i class="icon-play"></i><span>Play Video</span></a>
						</div>
					</div>
				</div>
				...
				<div class="container clearfix">
					<div class="heading-block border-bottom-0 center">
						...
						<span style="font-size: 16px;" class="fw-light text-capitalize ls1 mt-0">Get Started within 5 Minutes.</span>
					</div>
				</div>
				...
				<div class="section m-0 p-0" style="background:  url({{asset('/gym/demos/gym/images/section/bg-2.jpg')}}) center center no-repeat; background-size: cover;">
					<div class="section m-0" style="background: rgba(0,0,0,0.3);">
						<div class="container clearfix">
							<div class="heading-block dark border-bottom-0 mb-0 center">
								...
								<span style="font-size: 16px;" class="fw-light text-capitalize ls1">Efficiently network state of the art markets for scalable applications. Professionally engineer business e-tailers for resource sucking e-commerce.</span>
							</div>
						</div>
					</div>
							...
							<div id="pricing-switch" class="pricing row col-mb-30">
								...
								<div class="col-lg-4 col-md-6">
									...
									<div class="pricing-box text-center">
										...
										<div class="pricing-action">
											<a href="#" data-pricing-plan="Starter Plan" class="button button-large button-dark button-rounded text-capitalize button-circle ls0">Get Free Trail</a>
										</div>
									</div>
								...
								<div class="col-lg-4 col-md-6">
									...
									<div class="pricing-box price-best text-center">
										...
										<div class="pricing-action">
											<div class="pts-switch-content-left"><a href="#" data-pricing-plan="Professional Monthly Plan" class="button button-large button-circle button-dark text-capitalize ls0">Get Started</a></div>
											<div class="pts-switch-content-right"><a href="#" data-pricing-plan="Professional Yearly Plan" class="button button-large button-circle button-dark text-capitalize ls0">Get Started</a></div>
										</div>
									</div>
								...
								<div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
									...
									<div class="pricing-box text-center">
										...
										<div class="pricing-action">
											<div class="pts-switch-content-left"><a href="#" data-pricing-plan="Business Monthly Plan" class="button button-large button-circle button-dark text-capitalize ls0">Get Started</a></div>
											<div class="pts-switch-content-right"><a href="#" data-pricing-plan="Business Yearly Plan" class="button button-large button-circle button-dark text-capitalize ls0">Get Started</a></div>
										</div>
									</div>
		...
		<!-- Footer
		============================================= -->
		<footer id="footer" class="border-0" style="background:  url({{asset('/gym/demos/gym/images/section/1.jpg')}}) center bottom no-repeat; background-size: cover;">
