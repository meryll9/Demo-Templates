...
@section('content')
    ...
    <section id="slider" class="slider-element min-vh-60 min-vh-md-100 include-header"
        style="background: linear-gradient(rgba(0,0,0,.3), rgba(0,0,0,.8)), url({{ asset('/conference/demos/conference/images/hero-2.jpg') }}) no-repeat center center / cover;">
                    ...
                    <div class="row justify-content-between mt-5 col-mb-50">
                        ...
                        <div class="col-lg-6 d-flex align-items-lg-end flex-column parallax text-start text-lg-end mb-5 mb-lg-0"
                            ...
                            <div class="mt-auto">
                                ...
                                <a href="#section-tickets" class="button button-xxlarge button-white button-gradient m-0"
                ...
                <div class="container clearfix">
                    ...
                    <div class="row justify-content-around dark">
                        <div class="col-md-6">
                            ...
                            <p class="text-white-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi, vel
                                omnis repellendus mollitia, explicabo, maiores quisquam numquam quia reiciendis sit,
                                accusantium atque ex animi perspiciatis ab odit earum assumenda aliquid.</p>
                            <p class="text-white-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi, vel
                                omnis repellendus mollitia, explicabo, maiores quisquam numquam quia reiciendis sit,
                                accusantium atque ex animi perspiciatis ab odit earum assumenda aliquid.</p>
                            <div class="row mt-5">
                            ...
                            <div class="about-img position-relative">
                                <div class="my-3 my-lg-0">
                                    <div class="gradient-bg"><img
                                            src="{{ asset('conference/demos/conference/images/about/2.jpg') }}"
                                            alt="About Image"></div>
                                </div>
                                <div data-0="top: 160px" data-end="top: 120px">
                                    <div class="gradient-bg"><img
                                            src="{{ asset('conference/demos/conference/images/about/1.jpg') }}"
                                            alt="About Image"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mx-auto dark" style="max-width: 1000px;">
                        ...
                        <a href="#" class="team joinspeaker col-lg-4 col-sm-6 mb-5">
                            <div class="team-image gradient-bg">
                                <img src="{{ asset('conference/demos/conference/images/speakers/blank.jpg') }}"
                                    alt="John Doe">
                            ...
                            <div class="tab-container mt-5">
                                <div class="tab-content clearfix" id="tabs-1">
                                    <dl class="row dark mb-0">
                                        ...
                                        <dd class="col-sm-9">
                                            <div class="schedule-desc">Web Accessible Designs<small>- Will Barrow</small>
                                            </div>
                                        </dd>
                                ...
                                <div class="tab-content clearfix" id="tabs-2">
                                    <dl class="row dark mb-0">
                                        ...
                                        <dd class="col-sm-9">
                                            <div class="schedule-desc">Why Should I Choose Customer Support<small>- Indigo
                                                    Violet</small></div>
                                        </dd>
        ...
        ============================================= -->
            <div id="section-tickets" class="section page-section bg-transparent pt-0 clearfix">
                ...
                <div class="position-relative">
                    ...
                    <div class="dotted-bg"
                        style="background: url({{ asset('/conference/demos/conference/images/dotted-bg.svg') }}) repeat center center / contain; min-height: 75%">
                    </div>
                </div>
                ...
                <div class="container topmargin-lg">
                    <div class="mx-auto dark center" style="max-width: 850px">
                        ...
                        <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat nesciunt
                            sint voluptatibus quibusdam veritatis quos dolorum quasi minus, rerum? Officia explicabo hic
                            porro voluptatem ducimus dolor, dolore et. Magni, quidem?</p>
                        <a href="#"
                    ...
                    <div class="mx-auto schedule-wrap center dark rounded shadow-lg"
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/cnn.svg') }}"
                                        alt="Brands"></a></div>
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/github.svg') }}"
                                        alt="Brands"></a></div>
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/google.svg') }}"
                                        alt="Brands"></a></div>
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/paypal.svg') }}"
                                        alt="Brands"></a></div>
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/vimeo.svg') }}"
                                        alt="Brands"></a></div>
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/slack.svg') }}"
                                        alt="Brands"></a></div>
                        </div>
                        <div class="line"></div>
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/linkedin.svg') }}"
                                        alt="Brands"></a></div>
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/nat-geo.svg') }}"
                                        alt="Brands"></a></div>
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/jetblue.svg') }}"
                                        alt="Brands"></a></div>
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/zillow.svg') }}"
                                        alt="Brands"></a></div>
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/amazon.svg') }}"
                                        alt="Brands"></a></div>
                        </div>
                        <div class="line"></div>
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/ps.svg') }}"
                                        alt="Brands"></a></div>
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/skype.svg') }}"
                                        alt="Brands"></a></div>
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/jetblue.svg') }}"
                                        alt="Brands"></a></div>
                            <div class="flex-fill p-3"><a href="#"><img
                                        src="{{ asset('conference/demos/conference/images/sponcors/netflix.svg') }}"
                                        alt="Brands"></a></div>
                        </div>
                        <div class="line"></div>
                        <h3 class="gradient-text">Calling all Sponsors!!! Help us to make Our Event a Blast!</h3>
                        <p class="mx-auto text-muted" style="max-width: 600px">Lorem ipsum dolor sit amet, consectetur
                            adipisicing elit. Fugiat nesciunt sint voluptatibus quibusdam veritatis quos dolorum quasi
                            minus, rerum? Officia explicabo hic porro voluptatem ducimus dolor, dolore et. Magni, quidem?
                        </p>
                        <a href="#" class="button button-xlarge button-white button-gradient mt-4">Sponsor Us?</a>
                    </div>
                </div>
                <div class="dotted-bg"
                    style="background: url({{ asset('/conference/demos/conference/images/dotted-bg.svg') }}) repeat center center / contain; min-height: 25%; top: 90%; right: 0; left: auto; width: 50%">
                </div>
            ...
            <div id="section-location" class="section page-section bg-transparent p-0 mb-0 clearfix"
                ...
                <div class="position-relative">
                    <div class="w-100 parallax vh-100" style="top: 0; min-height: 400px"
                        data-top-top="transform: translateY(100px);" data-top-center="transform: translateY(0px);">
                        <div class="gmap h-100" data-address="795 Folsom Ave, CA" data-maptype="ROADMAP" data-zoom="13"
                            data-scrollwheel="false"
                            data-markers='[{ address: "795 Folsom Ave, CA", html: "795 Folsom Ave, CA", icon: { image: "demos/conference/images/map-marker.svg'
                            )}}", iconsize: [44, 44], iconanchor: [14,44] } }]'
                            ...
                            <div class="row justify-content-between dark">
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="masonry-thumbs grid-container grid-3" data-lightbox="gallery">
                                        <a class="grid-item"
                                            href="{{ asset('conference/demos/conference/images/venue/full/1.jpg') }}"
                                            data-lightbox="gallery-item"><img
                                                src="{{ asset('conference/demos/conference/images/venue/1.jpg') }}"
                                                alt="Gallery Thumb 1"></a>
                                        <a class="grid-item"
                                            href="{{ asset('conference/demos/conference/images/venue/full/2.jpg') }}"
                                            data-lightbox="gallery-item"><img
                                                src="{{ asset('conference/demos/conference/images/venue/2.jpg') }}"
                                                alt="Gallery Thumb 2"></a>
                                        <a class="grid-item"
                                            href="{{ asset('conference/demos/conference/images/venue/full/3.jpg') }}"
                                            data-lightbox="gallery-item"><img
                                                src="{{ asset('conference/demos/conference/images/venue/3.jpg') }}"
                                                alt="Gallery Thumb 3"></a>
                                        <a class="grid-item"
                                            href="{{ asset('conference/demos/conference/images/venue/full/4.jpg') }}"
                                            data-lightbox="gallery-item"><img
                                                src="{{ asset('conference/demos/conference/images/venue/4.jpg') }}"
                                                alt="Gallery Thumb 4"></a>
                                        <a class="grid-item"
                                            href="{{ asset('conference/demos/conference/images/venue/full/5.jpg') }}"
                                            data-lightbox="gallery-item"><img
                                                src="{{ asset('conference/demos/conference/images/venue/5.jpg') }}"
                                                alt="Gallery Thumb 5"></a>
                                        <a class="grid-item"
                                            href="{{ asset('conference/demos/conference/images/venue/full/6.jpg') }}"
                                            data-lightbox="gallery-item"><img
                                                src="{{ asset('conference/demos/conference/images/venue/6.jpg') }}"
                                                alt="Gallery Thumb 6"></a>
                                        <a class="grid-item"
                                            href="{{ asset('conference/demos/conference/images/venue/full/7.jpg') }}"
                                            data-lightbox="gallery-item"><img
                                                src="{{ asset('conference/demos/conference/images/venue/7.jpg') }}"
                                                alt="Gallery Thumb 7"></a>
                                        <a class="grid-item"
                                            href="{{ asset('conference/demos/conference/images/venue/full/8.jpg') }}"
                                            data-lightbox="gallery-item"><img
                                                src="{{ asset('conference/demos/conference/images/venue/8.jpg') }}"
                                                alt="Gallery Thumb 9"></a>
                                        <a class="grid-item"
                                            href="{{ asset('conference/demos/conference/images/venue/full/9.jpg') }}"
                                            data-lightbox="gallery-item"><img
                                                src="{{ asset('conference/demos/conference/images/venue/9.jpg') }}"
            ...
            <div class="section bg-transparent m-0 clearfix">
                ...
                <div class="container">
                    <div class="mx-auto dark center" style="max-width: 850px">
                        ...
                        <p class="lead text-white-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat
                            nesciunt sint voluptatibus quibusdam veritatis quos dolorum quasi minus, rerum? Officia
                            explicabo hic porro voluptatem ducimus dolor, dolore et. Magni, quidem?</p>
                    </div>
                    <div class="clear"></div>
