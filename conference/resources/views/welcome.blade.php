...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div id="logo" class="me-lg-0">
							<a href="#" data-scrollto="#slider" class="standard-logo" data-dark-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
							<a href="#" data-scrollto="#slider" class="retina-logo" data-dark-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
		...
		<!-- Hero/Slider
		============================================= -->
		<section id="slider" class="slider-element min-vh-60 min-vh-md-100 include-header" style="background: linear-gradient(rgba(0,0,0,.3), rgba(0,0,0,.8)), url({{asset('/conference/demos/conference/images/hero-2.jpg')}}) no-repeat center center / cover;">
					...
					<div class="container dark py-5 py-md-0">
						<div class="row justify-content-between mt-5 col-mb-50">
							<div class="col-lg-6 parallax" data-0="transform: translateY(0px); opacity: 1" data-300="transform: translateY(50px); opacity: 0">
								...
								<h2 class="fw-bold display-2 mb-0">{{ env('APP_TAGLINE') }}</h2>
							</div>
			...
			<div class="content-wrap pt-0" style="overflow: visible;">
						...
						<div class="row justify-content-around dark">
							...
							<div class="col-md-5">
								<div class="about-img position-relative">
									<div class="my-3 my-lg-0"><div class="gradient-bg"><img src="{{asset('conference/demos/conference/images/about/2.jpg')}}" alt="About Image"></div></div>
									<div data-0="top: 160px" data-end="top: 120px"><div class="gradient-bg"><img src="{{asset('conference/demos/conference/images/about/1.jpg')}}" alt="About Image"></div></div>
								</div>
							</div>
						</div>
						...
						<div class="row mx-auto dark"  style="max-width: 1000px;">
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('conference/demos/conference/images/speakers/1.jpg')}}" alt="John Doe">
								</div>
								<div class="team-desc">
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('conference/demos/conference/images/speakers/2.jpg')}}" alt="John Doe">
								</div>
								<div class="team-desc">
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('conference/demos/conference/images/speakers/3.jpg')}}" alt="John Doe">
								</div>
								<div class="team-desc">
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('conference/demos/conference/images/speakers/4.jpg')}}" alt="John Doe">
								</div>
								<div class="team-desc">
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('conference/demos/conference/images/speakers/5.jpg')}}" alt="John Doe">
								</div>
								<div class="team-desc">
									<div class="team-title"><h4 class="gradient-text">Gunther Beard</h4><span>Software Designer</span></div>
								</div>
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('conference/demos/conference/images/speakers/6.jpg')}}" alt="John Doe">
								</div>
								<div class="team-desc">
									<div class="team-title"><h4 class="gradient-text">Desmond Eagle </h4><span>Canvas Business</span></div>
								</div>
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('conference/demos/conference/images/speakers/7.jpg')}}" alt="John Doe">
								</div>
								<div class="team-desc">
									<div class="team-title"><h4 class="gradient-text">Will Barrow</h4><span>Cloud Management</span></div>
								</div>
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('conference/demos/conference/images/speakers/8.jpg')}}" alt="John Doe">
								</div>
								<div class="team-desc">
							...
							<a href="#" class="team joinspeaker col-lg-4 col-sm-6 mb-5">
								<div class="team-image gradient-bg">
									<img src="{{asset('conference/demos/conference/images/speakers/blank.jpg')}}" alt="John Doe">
				...
				<div id="section-tickets" class="section page-section bg-transparent pt-0 clearfix">
					...
					<div class="position-relative">
						...
						<div class="dotted-bg" style="background: url({{asset('/conference/demos/conference/images/dotted-bg.svg')}}) repeat center center / contain; min-height: 75%"></div>
					</div>
				...
				<div id="section-sponsors" class="section page-section bg-transparent pt-0 topmargin-lg clearfix">
					<div class="container">
						...
						<div class="mx-auto schedule-wrap center dark rounded shadow-lg" style="max-width: 1050px; background-color: #000">
							...
							<div class="d-flex flex-wrap align-items-center">
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/cnn.svg')}}" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/github.svg')}}" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/google.svg')}}" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/paypal.svg')}}" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/vimeo.svg')}}" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/slack.svg')}}" alt="Brands"></a></div>
							</div>
							<div class="line"></div>
							<h4 class="font-body mb-5">Silver Sponsors</h4>
							<div class="d-flex flex-wrap align-items-center">
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/linkedin.svg')}}" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/nat-geo.svg')}}" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/jetblue.svg')}}" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/zillow.svg')}}" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/amazon.svg')}}" alt="Brands"></a></div>
							</div>
							<div class="line"></div>
							<h4 class="font-body mb-5">Partners</h4>
							<div class="d-flex flex-wrap align-items-center">
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/ps.svg')}}" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/skype.svg')}}" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/jetblue.svg')}}" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('conference/demos/conference/images/sponcors/netflix.svg')}}" alt="Brands"></a></div>
							</div>
							<div class="line"></div>
					...
					<div class="dotted-bg" style="background: url({{asset('/conference/demos/conference/images/dotted-bg.svg')}}) repeat center center / contain; min-height: 25%; top: 90%; right: 0; left: auto; width: 50%"></div>
								...
								<div class="row justify-content-between dark">
									<div class="col-md-4 mb-4">
										...
										<div class="masonry-thumbs grid-container grid-3" data-lightbox="gallery">
											<a class="grid-item" href="{{asset('conference/demos/conference/images/venue/full/1.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('conference/demos/conference/images/venue/1.jpg')}}" alt="Gallery Thumb 1"></a>
											<a class="grid-item" href="{{asset('conference/demos/conference/images/venue/full/2.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('conference/demos/conference/images/venue/2.jpg')}}" alt="Gallery Thumb 2"></a>
											<a class="grid-item" href="{{asset('conference/demos/conference/images/venue/full/3.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('conference/demos/conference/images/venue/3.jpg')}}" alt="Gallery Thumb 3"></a>
											<a class="grid-item" href="{{asset('conference/demos/conference/images/venue/full/4.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('conference/demos/conference/images/venue/4.jpg')}}" alt="Gallery Thumb 4"></a>
											<a class="grid-item" href="{{asset('conference/demos/conference/images/venue/full/5.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('conference/demos/conference/images/venue/5.jpg')}}" alt="Gallery Thumb 5"></a>
											<a class="grid-item" href="{{asset('conference/demos/conference/images/venue/full/6.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('conference/demos/conference/images/venue/6.jpg')}}" alt="Gallery Thumb 6"></a>
											<a class="grid-item" href="{{asset('conference/demos/conference/images/venue/full/7.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('conference/demos/conference/images/venue/7.jpg')}}" alt="Gallery Thumb 7"></a>
											<a class="grid-item" href="{{asset('conference/demos/conference/images/venue/full/8.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('conference/demos/conference/images/venue/8.jpg')}}" alt="Gallery Thumb 9"></a>
											<a class="grid-item" href="{{asset('conference/demos/conference/images/venue/full/9.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('conference/demos/conference/images/venue/9.jpg')}}" alt="Gallery Thumb 10"></a>
										</div>
									</div>
							...
							<div class="widget clearfix">
								<div class="row clearfix">
									<div class="col-lg-8 bottommargin-sm clearfix" style="color:#888;">
										<img src="{{asset('conference/demos/app-landing/images/logo-dark@2x.png')}}" alt="Canvas Logo" style="display: block;" height="100">
