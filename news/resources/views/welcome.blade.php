			...
			<div class="container">
				<div class="header-row justify-content-between">
					...
					<div id="logo" class="col-auto ms-auto ms-mb-0 me-mb-0 order-md-2">
						<a href="demo-news.html" class="standard-logo"><img class="mx-auto" src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
						<a href="demo-news.html" class="retina-logo"><img class="mx-auto" src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
					...
					<div class="header-row justify-content-between flex-row-reverse flex-lg-row">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
															...
															<div class="tab-pane show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
																<div class="row justify-content-around posts-md">
																	<div class="col-4">
																		<div class="entry">
																			<div class="entry-image mb-3">
																				<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/1.jpg')}}" alt="Image 3"></a>
																				<div class="entry-categories"><a href="demo-news-category.html" class="bg-lifestyle">Gym</a></div>
																			</div>
																	...
																	<div class="col-4">
																		<div class="entry">
																			<div class="entry-image mb-3">
																				<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/meditation.jpg')}}" alt="Image 3"></a>
																				<div class="entry-categories"><a href="demo-news-category.html" class="bg-lifestyle">Meditation</a></div>
																			</div>
																			<div class="entry-title title-xs nott">
																	...
																	<div class="col-4">
																		<div class="entry">
																			<div class="entry-image mb-3">
																				<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/3.jpg')}}" alt="Image 3"></a>
																				<div class="entry-categories"><a href="demo-blog-categories.html" class="bg-lifestyle">Yoga</a></div>
																			</div>
																			<div class="entry-title title-xs nott">
															...
															<div class="tab-pane" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
																<div class="row justify-content-around posts-md">
																	<div class="col-4">
																		<div class="entry">
																			<div class="entry-image mb-3">
																				<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/2.jpg')}}" alt="Image 3"></a>
																				<div class="entry-categories"><a href="demo-news-category.html" class="bg-lifestyle">Music</a></div>
																			</div>
																			<div class="entry-title title-xs nott">
																				<h3 class="mb-1"><a href="demo-news-single.html">A Surprising Tool to Help You Lifestyle</a></h3>
																			</div>
																	...
																	<div class="col-4">
																		<div class="entry">
																			<div class="entry-image mb-3">
																				<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/party.jpg')}}" alt="Image 3"></a>
																				<div class="entry-categories"><a href="demo-news-category.html" class="bg-lifestyle">Party</a></div>
																			</div>
																			<div class="entry-title title-xs nott">
																				<h3 class="mb-1"><a href="demo-news-category.html">Toyotas next minivan will let you.</a></h3>
																			</div>
																			<div class="entry-meta">
																				<ul>
																					<li>John Doe</li>
																	...
																	<div class="col-4">
																		<div class="entry">
																			<div class="entry-image mb-3">
																				<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/movies.jpg')}}" alt="Image 3"></a>
																				<div class="entry-categories"><a href="demo-news-category.html" class="bg-lifestyle">Movies</a></div>
																			</div>
																			<div class="entry-title title-xs nott">
																				<h3 class="mb-1"><a href="demo-news-single.html">Lifestyle Your Way to Success</a></h3>
																			</div>
															...
															<div class="tab-pane" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
																<div class="row justify-content-around posts-md">
																	<div class="col-4">
																		<div class="entry">
																			<div class="entry-image mb-3">
																				<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/author.jpg')}}" alt="Image 3"></a>
																				<div class="entry-categories"><a href="demo-news-category.html" class="bg-lifestyle">Author</a></div>
																			</div>
																			<div class="entry-title title-xs nott">
																				<h3 class="mb-1"><a href="demo-news-single.html">A Surprising Tool to Help You Lifestyle</a></h3>
																			</div>
																	...
																	<div class="col-4">
																		<div class="entry">
																			<div class="entry-image mb-3">
																				<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/painter.jpg')}}" alt="Image 3"></a>
																	...
																	<div class="col-4">
																		<div class="entry">
																			<div class="entry-image mb-3">
																				<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/book.jpg')}}" alt="Image 3"></a>
															...
															<div class="tab-pane" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
																<div class="row justify-content-around posts-md">
																	<div class="col-4">
																		<div class="entry">
																			<div class="entry-image mb-3">
																				<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/recipes-1.jpg')}}" alt="Image 3"></a>
																	...
																	<div class="col-4">
																		<div class="entry">
																			<div class="entry-image mb-3">
																				<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/recipes-2.jpg')}}" alt="Image 3"></a>
																				<div class="entry-categories"><a href="demo-news-category.html" class="bg-lifestyle">Recipes</a></div>
																			</div>
																			<div class="entry-title title-xs nott">
																				<h3 class="mb-1"><a href="demo-news-single.html">Toyotas next minivan will let you.</a></h3>
																	...
																	<div class="col-4">
																		<div class="entry">
																			<div class="entry-image mb-3">
																				<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/chef.jpg')}}" alt="Image 3"></a>
								...
								<li class="menu-item menu-color-market  mega-menu mega-menu-small"><a class="menu-link" href="demo-news-category.html"><div>More</div></a>
				...
				<div id="rev_slider_19_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.1">
					<ul>	<!-- SLIDE  -->
						...
						<li data-index="rs-49" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('news/demos/news/images/carousel/thumbs/2.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="The sky was cloudless" data-param1="Market" data-param2="Sep 12, 2021" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
							<!-- MAIN IMAGE -->
							<img src="{{asset('news/include/rs-plugin/demos/assets/images/dummy.png')}}"  alt="Image"  data-lazyload="{{asset('news/demos/news/images/carousel/2.jpg')}}" data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-blurstart="0" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
							<!-- LAYERS -->
						...
						<li data-index="rs-50" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('news/demos/news/images/carousel/thumbs/3.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="The History Of Fashion" data-param1="Fashion" data-param2="Sep 03, 2021" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
							<!-- MAIN IMAGE -->
							<img src="{{asset('news/include/rs-plugin/demos/assets/images/dummy.png')}}"  alt="Image"  data-lazyload="{{asset('news/demos/news/images/carousel/3.jpg')}}" data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-blurstart="0" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
							<!-- LAYERS -->
						...
						<li data-index="rs-51" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('news/demos/news/images/carousel/thumbs/4.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Things That Make You Love" data-param1="Lifestyle" data-param2="Jul 30, 2021" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
							<!-- MAIN IMAGE -->
							<img src="{{asset('news/include/rs-plugin/demos/assets/images/dummy.png')}}"  alt="Image"  data-lazyload="{{asset('news/demos/news/images/carousel/4.jpg')}}" data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-blurstart="0" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
							<!-- LAYERS -->
						...
						<li data-index="rs-52" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="{{asset('news/demos/news/images/carousel/thumbs/5.jpg')}}" data-rotate="0" data-saveperformance="off" data-title="Real Madrid vs Chelsea Highlights" data-param1="YouTube Video" data-param2="Apr 04, 2021" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
							...
							<!-- MAIN IMAGE -->
							<img src="{{asset('news/include/rs-plugin/demos/assets/images/dummy.png')}}" alt="Image" data-lazyload="{{asset('news/demos/news/images/carousel/5.jpg')}}" data-bgposition="center center" data-bgfit="cover" class="rev-slidebg" data-no-retina>
						...
						<li data-index="rs-53" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="{{asset('news/demos/news/images/carousel/thumbs/6.jpg')}}" data-rotate="0" data-saveperformance="off" data-title="How To Have A Fantastic Tech" data-param1="Tech" data-param2="Mar 11, 2021" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
							<!-- MAIN IMAGE -->
							<img src="{{asset('news/include/rs-plugin/demos/assets/images/dummy.png')}}" alt="Image" data-lazyload="{{asset('news/demos/news/images/carousel/6.jpg')}}" data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-blurstart="0" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
				...
				<div class="container clearfix">
					...
					<div class="row clearfix">
						...
						<div class="col-lg-8">
											...
											<div class="posts-md">
												<div class="entry">
													<div class="entry-image">
														<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/travel/3.jpg')}}" alt="Image 3"></a>
											...
											<div class="posts-sm row col-mb-30">
												<div class="entry col-12">
													<div class="grid-inner row align-items-center g-0">
														<div class="col-auto">
															<div class="entry-image">
																<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/travel/small/1.jpg')}}" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
												...
												<div class="entry col-12">
													<div class="grid-inner row align-items-center g-0">
														<div class="col-auto">
															<div class="entry-image">
																<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/travel/small/2.jpg')}}" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
															<div class="entry-title">
												...
												<div class="entry col-12">
													<div class="grid-inner row align-items-center g-0">
														<div class="col-auto">
															<div class="entry-image">
																<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/travel/small/4.jpg')}}" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
															<div class="entry-title">
												...
												<div class="entry col-12">
													<div class="grid-inner row align-items-center g-0">
														<div class="col-auto">
															<div class="entry-image">
																<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/fashion/small/2.jpg')}}" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
															<div class="entry-title">
												...
												<div class="entry col-12">
													<div class="grid-inner row align-items-center g-0">
														<div class="col-auto">
															<div class="entry-image">
																<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/market/small/3.jpg')}}" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
															<div class="entry-title">
									...
									<div class="row col-mb-30 mb-0">
										<div class="col-lg-6">
											...
											<div class="posts-md">
												<div class="entry">
													<div class="entry-image">
														<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/food/1.jpg')}}" alt="Image 3"></a>
														<div class="entry-categories "><a href="#" class="bg-food">Food</a></div>
													</div>
													<div class="entry-title nott">
														<h3 class="mb-2"><a href="demo-news-single.html">The Secret To Food eat lunch Is Revealed</a></h3>
													</div>
													<div class="entry-meta">
														<ul>
															<li><span>by</span> <a href="#">John Doe</a></li>
											...
											<div class="posts-sm row col-mb-30">
												<div class="entry col-12">
													<div class="grid-inner row align-items-center g-0">
														<div class="col-auto">
															<div class="entry-image">
																<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/food/small/2.jpg')}}" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
															<div class="entry-title">
																<h4 class="fw-semibold"><a href="demo-news-single.html">How To Turn Food eat lunch Into Success</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
																	<li><span>by</span> <a href="#">John Doe</a></li>
												...
												<div class="entry col-12">
													<div class="grid-inner row align-items-center g-0">
														<div class="col-auto">
															<div class="entry-image">
																<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/food/small/3.jpg')}}" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
															<div class="entry-title">
												...
												<div class="entry col-12">
													<div class="grid-inner row align-items-center g-0">
														<div class="col-auto">
															<div class="entry-image">
																<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/food/small/4.jpg')}}" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
															<div class="entry-title">
																<h4 class="fw-semibold"><a href="demo-news-single.html">Use Food to make Someone fall in Love With You</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
																	<li><span>by</span> <a href="#">John Doe</a></li>
												...
												<div class="entry col-12">
													<div class="grid-inner row align-items-center g-0">
														<div class="col-auto">
															<div class="entry-image">
																<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/small/1.jpg')}}" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
															<div class="entry-title">
																<h4 class="fw-semibold"><a href="demo-news-single.html">3 Ways To Have (A) More Appealing food</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
																	<li><span>by</span> <a href="#">John Doe</a></li>
												...
												<div class="entry col-12">
													<div class="grid-inner row align-items-center g-0">
														<div class="col-auto">
															<div class="entry-image">
																<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/small/2.jpg')}}" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
															<div class="entry-title">
																<h4 class="fw-semibold"><a href="demo-news-single.html">Lifestyle Your Way to Success</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
																	<li><span>by</span> <a href="#">John Doe</a></li>
									...
									<div class="row col-mb-30 mb-0">
										<div class="col-lg-6">
											...
											<div class="posts-md">
												<div class="entry">
													<div class="entry-image">
														<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/fashion/1.jpg')}}" alt="Image 3"></a>
														<div class="entry-categories"><a href="demo-news-category.html" class="bg-fashion">Fashion</a></div>
													</div>
													<div class="entry-title nott">
														<h3 class="mb-2"><a href="demo-news-single.html">The Biggest Lie In Fashion</a></h3>
													</div>
													<div class="entry-meta">
														<ul>
															<li><span>by</span> <a href="#">John Doe</a></li>
											...
											<div class="posts-sm row col-mb-30">
												<div class="entry col-12">
													<div class="grid-inner row align-items-center no-gutter">
														...
														<div class="col ps-3">
															<div class="entry-title">
																<h4 class="fw-semibold"><a href="demo-news-single.html">Top 10 Tips To Grow Your Fashion</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
																	<li><span>by</span> <a href="#">John Doe</a></li>
												...
												<div class="entry col-12">
													<div class="grid-inner row align-items-center no-gutter">
														<div class="col-auto">
															<div class="entry-image">
																<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/fashion/small/3.jpg')}}" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
															<div class="entry-title">
																<h4 class="fw-semibold"><a href="demo-news-single.html">4 Ways You Can Grow Your Creativity Using Fashion</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
																	<li><span>by</span> <a href="#">John Doe</a></li>
												...
												<div class="entry col-12">
													<div class="grid-inner row align-items-center no-gutter">
														<div class="col-auto">
															<div class="entry-image">
																<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/fashion/small/4.jpg')}}" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
															<div class="entry-title">
																<h4 class="fw-semibold"><a href="demo-news-single.html">5 Best Ways To Sell Fashion</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
																	<li><span>by</span> <a href="#">John Doe</a></li>
												...
												<div class="entry col-12">
													<div class="grid-inner row align-items-center no-gutter">
														...
														<div class="col ps-3">
															<div class="entry-title">
																<h4 class="fw-semibold"><a href="demo-news-single.html">What Make Fashion Don't Want You To Know</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
																	<li><span>by</span> <a href="#">John Doe</a></li>
												...
												<div class="entry col-12">
													<div class="grid-inner row align-items-center no-gutter">
														<div class="col-auto">
															<div class="entry-image">
																<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/small/3.jpg')}}" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
															<div class="entry-title">
																<h4 class="fw-semibold"><a href="demo-news-single.html">Best Fashion Android/iPhone Apps</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
																	<li><span>by</span> <a href="#">John Doe</a></li>
							...
							<!-- Ad
							============================================= -->
							<a href="https://themeforest.net/item/canvas-the-multipurpose-html5-template/9228123"><img src="{{asset('news/demos/news/images/ad/728x90.jpg')}}" width="728" alt="Ad" class="aligncenter mb-5"></a>
							...
							<div class="row col-mb-50 mb-0">
									...
									<div class="posts-md">
										<div class="entry">
											...
											<div class="entry-title title-sm nott">
												<h3 class="mb-2"><a href="demo-news-single.html">Death, lifestyle And Taxes</a></h3>
											</div>
											<div class="entry-meta">
												<ul>
													<li><span>by</span> <a href="#">John Doe</a></li>
								...
								<div class="col-md-6 mt-4">
									...
									<div class="posts-md">
										<div class="entry">
											<div class="entry-image">
												<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/fashion/1.jpg')}}" alt="Image"></a>
												<div class="entry-categories"><a href="demo-news-category.html" class="bg-fashion">Fashion</a></div>
											</div>
											<div class="entry-title title-sm nott">
												<h3 class="mb-2"><a href="demo-news-single.html">The Ultimate Guide To Fashion</a></h3>
											</div>
											<div class="entry-meta">
												<ul>
													<li><span>by</span> <a href="#">John Doe</a></li>
							...
							<div class="posts-sm row col-mb-30">
								<div class="entry col-md-6">
									...
									<div class="grid-inner row align-items-center no-gutter">
										<div class="col-auto">
											<div class="entry-image">
												<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/market/small/1.jpg')}}" alt="Image"></a>
											</div>
										</div>
										<div class="col ps-3">
											<div class="entry-title">
												<h4 class="fw-medium"><a href="demo-news-single.html">How To Save Money with market?</a></h4>
											</div>
											<div class="entry-meta">
												<ul>
													<li><span>by</span> <a href="#">John Doe</a></li>
								...
								<div class="entry col-md-6">
									...
									<div class="grid-inner row align-items-center no-gutter">
										<div class="col-auto">
											<div class="entry-image">
												<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/market/small/2.jpg')}}" alt="Image"></a>
											</div>
										</div>
										<div class="col ps-3">
											<div class="entry-title">
												<h4 class="fw-medium"><a href="demo-news-single.html">Now You Can Have Your market Done Safely</a></h4>
											</div>
											<div class="entry-meta">
												<ul>
													<li><span>by</span> <a href="#">John Doe</a></li>
								...
								<div class="entry col-md-6">
									...
									<div class="grid-inner row align-items-center no-gutter">
										<div class="col-auto">
											<div class="entry-image">
												<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/sports/small/1.jpg')}}" alt="Image"></a>
											</div>
										</div>
										<div class="col ps-3">
											<div class="entry-title">
												<h4 class="fw-medium"><a href="demo-news-single.html">Understanding the Iberostar hotel rebanding</a></h4>
											</div>
											<div class="entry-meta">
												<ul>
													<li><span>by</span> <a href="#">John Doe</a></li>
								...
								<div class="entry col-md-6">
									...
									<div class="grid-inner row align-items-center no-gutter">
										<div class="col-auto">
											<div class="entry-image">
												<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/sports/small/2.jpg')}}" alt="Image"></a>
											</div>
										</div>
										<div class="col ps-3">
											<div class="entry-title">
												<h4 class="fw-medium"><a href="demo-news-single.html">4 new cruise ships for Carnival in 2021</a></h4>
											</div>
											<div class="entry-meta">
												<ul>
													<li><span>by</span> <a href="#">John Doe</a></li>
							...
							<div class="sticky-sidebar">
								...
								<div class="widget clearfix">
									...
									<div class="row center mt-4 clearfix">
										<div class="col-3">
											<a href="https://facebook.com/semicolonweb" target="_blank" class="social-icon si-dark float-none m-auto si-colored si-facebook">
												<i class="icon-facebook"></i>
												<i class="icon-facebook"></i>
											</a>
										...
										<div class="col-3">
											<a href="https://twitter.com/__semicolon" target="_blank" class="social-icon si-dark float-none m-auto si-colored si-twitter">
												<i class="icon-twitter"></i>
												<i class="icon-twitter"></i>
											</a>
											<div class="counter mt-2 counter-inherit">
										...
										<div class="col-3">
											<a href="https://instagram.com/semicolonweb" target="_blank" class="social-icon si-dark float-none m-auto si-colored si-instagram">
												<i class="icon-instagram"></i>
												<i class="icon-instagram"></i>
											</a>
											<div class="counter mt-2 counter-inherit">
										...
										<div class="col-3">
											<a href="https://themeforest.net/item/canvas-the-multipurpose-html5-template/9228123" target="_blank" class="social-icon si-dark float-none m-auto si-colored si-rss">
												<i class="icon-rss"></i>
												<i class="icon-rss"></i>
											</a>
											<div class="counter mt-2 counter-inherit">
										...
										<div class="col-3 mt-3">
											<a href="https://themeforest.net/item/canvas-the-multipurpose-html5-template/9228123" target="_blank" class="social-icon si-dark float-none m-auto si-colored si-pinterest">
										...
										<div class="col-3 mt-3">
											<a href="https://www.youtube.com/semicolonweb" target="_blank" class="social-icon si-dark float-none m-auto si-colored si-youtube">
										...
										<div class="col-3 mt-3">
											<a href="https://themeforest.net/user/semiColonWeb/follow" target="_blank" class="social-icon si-dark float-none m-auto si-colored si-spotify">
												<i><img src="{{asset('news/demos/news/images/envato.svg')}}" width="20" height="20" alt="Image" style="margin-bottom: 3px"></i>
												<i><img src="{{asset('news/demos/news/images/envato.svg')}}" width="20" height="20" alt="Image" style="margin-bottom: 3px"></i>
											</a>
											<div class="counter mt-2 counter-inherit">
										...
										<div class="col-3 mt-3">
											<a href="https://www.youtube.com/semicolonweb" target="_blank" class="social-icon si-dark float-none m-auto si-colored si-vimeo">
								...
								<div class="widget clearfix">
									<div class="card">
										<div class="card-body">
											...
											<button class="btn btn-lg bg-color text-white w-100 text-uppercase ls1" type="submit">Sign in</button>
											<div class="center"><small class="mt-5 text-muted fst-italic">We also Hate Spam</small></div>
										</form>
										</div>
									</div>
								</div>
								...
								============================================= -->
								<div class="widget clearfix">
									<a href="https://themeforest.net/item/canvas-the-multipurpose-html5-template/9228123"><img src="{{asset('news/demos/news/images/ad/336x280.jpg')}}" alt="Ad" class="img-responsive aligncenter"></a>
								</div>
							</div>
						</div> <!-- Sidebar End -->
					</div>
				...
				<div class="section bg-transparent m-0">
					<div class="container clearfix">
						...
						<div id="oc-news" class="owl-carousel fixed-nav top-nav carousel-widget posts-md customjs">
							<!-- Post Article -->
							<div class="entry mb-0" style="background: url({{asset('/news/demos/news/images/posts/fashion/1.jpg')}}) center center; background-size: cover; height: 400px;">
							...
							<!-- Post Article -->
							<div class="entry mb-0" style="background: url({{asset('/news/demos/news/images/posts/sports/1.jpg')}}) center center; background-size: cover; height: 400px;">
								<div class="bg-overlay">
									<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-end justify-content-start p-4">
										<div class="position-relative w-100">
							...
							<!-- Post Article -->
							<div class="entry mb-0" style="background: url({{asset('/news/demos/news/images/posts/food/1.jpg')}}) center center; background-size: cover; height: 400px;">
								<div class="bg-overlay">
									<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-end justify-content-start p-4">
										<div class="position-relative w-100">
							...
							<!-- Post Article -->
							<div class="entry mb-0" style="background: url({{asset('/news/demos/news/images/posts/market/1.jpg')}}) center center; background-size: cover; height: 400px;">
								<div class="bg-overlay">
									<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-end justify-content-start p-4">
										<div class="position-relative w-100">
								...
								<div class="fslider flex-thumb-grid grid-8 mt-4" data-pagi="false" data-speed="650" data-pause="3500" data-animation="fade" data-arrows="true" data-thumbs="true">
									<div class="flexslider">
										<div class="slider-wrap">
											<div class="slide" data-thumb="{{asset('news/demos/news/images/posts/travel/thumbs/1.jpg')}}">
												<!-- Post Article -->
												<div class="entry mb-0">
													<img src="{{asset('news/demos/news/images/posts/travel/1.jpg')}}" alt="Image">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-end justify-content-start p-4">
															<div class="position-relative w-100">
																<div class="entry-categories"><a href="demo-news-category.html" class="bg-travel">Travel</a></div>
																<div class="entry-title nott">
																	<h3 class="fw-semibold mb-2 ls0"><a href="#" class="text-light">Open The Gates For Travel By Using These 3 Tips</a></h3>
																</div>
																<div class="entry-meta no-separator">
																	<ul>
																		<li><span>by</span> <a href="#">John Doe</a></li>
											...
											<div class="slide" data-thumb="{{asset('news/demos/news/images/posts/food/thumbs/2.jpg')}}">
												<!-- Post Article -->
												<div class="entry mb-0">
													<img src="{{asset('news/demos/news/images/posts/food/2.jpg')}}" alt="Image">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-end justify-content-start p-4">
															<div class="position-relative w-100">
																<div class="entry-categories"><a href="demo-news-category.html" class="bg-food">Food</a></div>
																<div class="entry-title nott">
																	<h3 class="fw-semibold mb-2 ls0"><a href="#" class="text-light">The Biggest Lie In food</a></h3>
																</div>
																<div class="entry-meta no-separator">
																	<ul>
																		<li><span>by</span> <a href="#">John Doe</a></li>
											...
											<div class="slide" data-thumb="{{asset('news/demos/news/images/posts/market/thumbs/3.jpg')}}">
												<!-- Post Article -->
												<div class="entry mb-0">
													<img src="{{asset('news/demos/news/images/posts/market/3.jpg')}}" alt="Image">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-end justify-content-start p-4">
															<div class="position-relative w-100">
																<div class="entry-categories"><a href="demo-news-category.html" class="bg-market">Market</a></div>
																<div class="entry-title nott">
																	<h3 class="fw-semibold mb-2 ls0"><a href="#" class="text-light">How To Turn Your business From Zero To Hero</a></h3>
																</div>
																<div class="entry-meta no-separator">
																	<ul>
																		<li><span>by</span> <a href="#">John Doe</a></li>
											...
											<div class="slide" data-thumb="{{asset('news/demos/news/images/posts/sports/thumbs/4.jpg')}}">
												<!-- Post Article -->
												<div class="entry mb-0">
													<img src="{{asset('news/demos/news/images/posts/sports/4.jpg')}}" alt="Image">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-end justify-content-start p-4">
															<div class="position-relative w-100">
																<div class="entry-categories"><a href="demo-news-category.html" class="bg-sports">Sports</a></div>
																<div class="entry-title nott">
																	<h3 class="fw-semibold mb-2 ls0"><a href="#" class="text-light">The Shutdown That Ended Before</a></h3>
																</div>
																<div class="entry-meta no-separator">
																	<ul>
																		<li><span>by</span> <a href="#">John Doe</a></li>
											...
											<div class="slide" data-thumb="{{asset('news/demos/news/images/posts/lifestyle/thumbs/2.jpg')}}">
												<!-- Post Article -->
												<div class="entry mb-0">
													<img src="{{asset('news/demos/news/images/posts/lifestyle/2.jpg')}}" alt="Image">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-end justify-content-start p-4">
															<div class="position-relative w-100">
																<div class="entry-categories"><a href="demo-news-category.html" class="bg-lifestyle">lifestyle</a></div>
																<div class="entry-title nott">
																	<h3 class="fw-semibold mb-2 ls0"><a href="#" class="text-light">Death, lifestyle And Taxes</a></h3>
																</div>
																<div class="entry-meta no-separator">
																	<ul>
																		<li><span>by</span> <a href="#">John Doe</a></li>
											...
											<div class="slide" data-thumb="{{asset('news/demos/news/images/posts/fashion/thumbs/4.jpg')}}">
												<!-- Post Article -->
												<div class="entry mb-0">
													<img src="{{asset('news/demos/news/images/posts/fashion/4.jpg')}}" alt="Image">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-end justify-content-start p-4">
															<div class="position-relative w-100">
																<div class="entry-categories"><a href="demo-news-category.html" class="bg-fashion">Fashion</a></div>
											...
											<div class="slide" data-thumb="{{asset('news/demos/news/images/posts/travel/thumbs/3.jpg')}}">
												<!-- Post Article -->
												<div class="entry mb-0">
													<img src="{{asset('news/demos/news/images/posts/travel/3.jpg')}}" alt="Image">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-end justify-content-start p-4">
															<div class="position-relative w-100">
																<div class="entry-categories"><a href="demo-news-category.html" class="bg-travel">Travel</a></div>
																<div class="entry-title nott">
																	<h3 class="fw-semibold mb-2 ls0"><a href="#" class="text-light">5 Things To Do Immediately About Travel</a></h3>
																</div>
																<div class="entry-meta no-separator">
																	<ul>
																		<li><span>by</span> <a href="#">John Doe</a></li>
											...
											<div class="slide" data-thumb="{{asset('news/demos/news/images/posts/travel/thumbs/4.jpg')}}">
												<!-- Post Article -->
												<div class="entry mb-0">
													<img src="{{asset('news/demos/news/images/posts/travel/4.jpg')}}" alt="Image">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-end justify-content-start p-4">
															<div class="position-relative w-100">
																<div class="entry-categories"><a href="demo-news-category.html" class="bg-travel">Travel</a></div>
																<div class="entry-title nott">
																	<h3 class="fw-semibold mb-2 ls0"><a href="#" class="text-light">Learn Exactly How We Made Travel</a></h3>
																</div>
																<div class="entry-meta no-separator">
																	<ul>
																		<li><span>by</span> <a href="#">John Doe</a></li>
							...
							<div class="mt-5">
								...
								<div class="row col-mb-50 mb-0">
										...
										<div class="grid-inner row">
											<div class="col-md-5">
												<div class="entry-image mb-0">
													<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/sports/2.jpg')}}" alt="Image"></a>
													<div class="entry-categories"><a href="demo-news-category.html" class="bg-sports">sports</a></div>
												</div>
											</div>
											<div class="col-md-7">
												<div class="entry-title title-sm mt-3 mt-md-0">
													<h3 class="mb-2"><a href="demo-news-single.html">Papers: Real Madrid plot Pogba bid</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
														<li><span>by</span> <a href="#">John Doe</a></li>
									...
									<div class="entry col-12 mb-0">
										<div class="grid-inner row">
											...
											<div class="col-md-7">
												<div class="entry-title title-sm mt-3 mt-md-0">
													<h3 class="mb-2"><a href="demo-news-single.html">Toyotas next minivan will let you shout at your kids without turning around</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
														<li><span>by</span> <a href="#">John Doe</a></li>
											...
											<div class="col-md-5">
												<div class="entry-image mb-0 clearfix">
													<div class="portfolio-single-image masonry-thumbs grid-container grid-4" data-big="3" data-lightbox="gallery">
														<a class="grid-item" href="{{asset('news/demos/news/images/posts/travel/2.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('news/demos/news/images/posts/travel/thumbs/2.jpg')}}" alt="Image"></a>
														<a class="grid-item" href="{{asset('news/demos/news/images/posts/sports/1.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('news/demos/news/images/posts/sports/thumbs/1.jpg')}}" alt="Image"></a>
														<a class="grid-item" href="{{asset('news/demos/news/images/posts/fashion/4.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('news/demos/news/images/posts/fashion/thumbs/4.jpg')}}" alt="Image"></a>
														<a class="grid-item" href="{{asset('news/demos/news/images/posts/sports/2.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('news/demos/news/images/posts/sports/thumbs/2.jpg')}}" alt="Image"></a>
														<a class="grid-item" href="{{asset('news/demos/news/images/posts/market/1.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('news/demos/news/images/posts/market/thumbs/1.jpg')}}" alt="Image"></a>
														<a class="grid-item" href="{{asset('news/demos/news/images/posts/food/1.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('news/demos/news/images/posts/food/thumbs/1.jpg')}}" alt="Image"></a>
														<a class="grid-item" href="{{asset('news/demos/news/images/posts/market/2.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('news/demos/news/images/posts/market/thumbs/2.jpg')}}" alt="Image"></a>
														<a class="grid-item" href="{{asset('news/demos/news/images/posts/food/3.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('news/demos/news/images/posts/food/thumbs/3.jpg')}}" alt="Image"></a>
														<a class="grid-item" href="{{asset('news/demos/news/images/posts/market/3.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('news/demos/news/images/posts/market/thumbs/3.jpg')}}" alt="Image"></a>
													</div>
												</div>
											</div>
											<div class="col-md-7">
												...
												<div class="entry-image mb-0">
													<div class="fslider" data-arrows="false" data-speed="400" data-pause="4000">
														<div class="flexslider">
															<div class="slider-wrap">
																<div class="slide">
																	<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/food/4.jpg')}}" alt="Image 1"></a>
																</div>
																<div class="slide">
																	<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/fashion/4.jpg')}}" alt="Image 2"></a>
																</div>
																<div class="slide">
																	<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/travel/3.jpg')}}" alt="Image 2"></a>
																</div>
															</div>
														</div>
													</div>
								...
								<div class="row col-mb-50 infinity-wrapper">
									...
									<div class="col-md-6">
										<div class="card border">
											<div class="card-header p-3 ps-4 bg-transparent">
												<h4 class="ls1 mb-0 text-uppercase fw-bold" style="font-size: 110%;">Recently Movies</h4>
											</div>
											<div class="card-body">
														...
														<div class="posts-sm row col-mb-30">
															<div class="entry col-12">
																<div class="grid-inner row align-items-center g-0">
																	<div class="col-auto">
																		<div class="entry-image">
																			<a href="#"><img src="{{asset('news/images/magazine/small/movie/3.jpg')}}" alt="Image"></a>
																		</div>
																	</div>
																	<div class="col ps-3">
																		<div class="entry-title">
																			<h4><a href="demo-news-single.html">The Purge: Anarchy</a></h4>
																		</div>
																		<div class="entry-meta no-separator">
																			<ul>
															...
															<div class="entry col-12">
																<div class="grid-inner row align-items-center g-0">
																	<div class="col-auto">
																		<div class="entry-image">
																			<a href="#"><img src="{{asset('news/images/magazine/small/movie/4.jpg')}}" alt="Image"></a>
																		</div>
																	</div>
																	<div class="col ps-3">
																		<div class="entry-title">
																			<h4><a href="demo-news-single.html">Planes: Fire And Rescue</a></h4>
																		</div>
																		<div class="entry-meta no-separator">
																			<ul>
															...
															<div class="entry col-12">
																<div class="grid-inner row align-items-center g-0">
																	<div class="col-auto">
																		<div class="entry-image">
																			<a href="#"><img src="{{asset('news/images/magazine/small/movie/5.jpg')}}" alt="Image"></a>
																		</div>
																	</div>
																	<div class="col ps-3">
																		<div class="entry-title">
																			<h4><a href="demo-news-single.html">Sex Tape</a></h4>
																		</div>
																		<div class="entry-meta no-separator">
																			<ul>
															...
															<div class="entry col-12">
																<div class="grid-inner row align-items-center g-0">
																	<div class="col-auto">
																		<div class="entry-image">
																			<a href="#"><img src="{{asset('news/images/magazine/small/movie/6.jpg')}}" alt="Image"></a>
																		</div>
																	</div>
																	<div class="col ps-3">
																		<div class="entry-title">
																			<h4><a href="demo-news-single.html">Transformers: Age of Extinction</a></h4>
																		</div>
																		<div class="entry-meta no-separator">
																			<ul>
															...
															<div class="entry col-12">
																<div class="grid-inner row align-items-center g-0">
																	<div class="col-auto">
																		<div class="entry-image">
																			<a href="#"><img src="{{asset('news/images/magazine/small/movie/7.jpg')}}" alt="Image"></a>
																		</div>
																	</div>
																	<div class="col ps-3">
																		<div class="entry-title">
																			<h4><a href="demo-news-single.html">How to Train Your Dragon 2</a></h4>
																		</div>
																		<div class="entry-meta no-separator">
																			<ul>
											...
											<a href="#" class="card-footer ls1 text-uppercase fw-bold text-white w-100 border-top-0 bg-sports text-center">Show all</a>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="card border">
											<div class="card-header p-3 ps-4 bg-transparent">
												<h4 class="ls1 mb-0 text-uppercase fw-bold" style="font-size: 110%;">Opinion Polls</h4>
											</div>
											<div class="card-body">
												<div class="scroll-wrap" style="height: 400px;">
													<div class="scroll">
														...
														<div class="posts-sm row col-mb-30">
															<div class="entry col-12">
																<div class="entry-title">
																	<h4><a href="demo-news-single.html">Who do you think is responsible for shooting down Malaysia Airlines flight MH17?</a></h4>
																</div>
																<div class="entry-meta">
																	<ul>
															...
															<div class="entry col-12">
																<div class="entry-title">
																	<h4><a href="demo-news-single.html">Maradona says Messi didn't deserve Golden Ball?</a></h4>
																</div>
																<div class="entry-meta">
																	<ul>
															...
															<div class="entry col-12">
																<div class="entry-title">
																	<h4><a href="demo-news-single.html">Palestinian president says Israel is carrying out a genocide in Gaza?</a></h4>
																</div>
																<div class="entry-meta">
																	<ul>
															...
															<div class="entry col-12">
																<div class="entry-title">
																	<h4><a href="demo-news-single.html">Can Brazil progress in the World Cup without Neymar?</a></h4>
																</div>
																<div class="entry-meta">
																	<ul>
											...
											<a href="#" class="card-footer ls1 text-uppercase fw-bold text-white w-100 bg-market border-top-0 text-center">Show all</a>
										</div>
									</div>
									...
									<div class="col-md-6">
										...
										<div class="posts-md">
											<div class="entry">
												<div class="entry-image">
													<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/lifestyle/4.jpg')}}" alt="Image 3"></a>
													<div class="entry-categories"><a href="demo-news-category.html" class="bg-lifestyle">lifestyle</a></div>
												</div>
												<div class="entry-title title-sm nott">
													<h3 class="mb-2"><a href="demo-news-single.html">6 lessons my mother taught me that nobody else could have</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
														<li><span>by</span> <a href="#">John Doe</a></li>
									...
									<div class="col-md-6">
										...
										<div class="posts-md">
											<div class="entry">
												<div class="entry-image">
													<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/travel/4.jpg')}}" alt="Image"></a>
													<div class="entry-categories"><a href="demo-news-category.html" class="bg-travel">Travel</a></div>
												</div>
												<div class="entry-title title-sm nott">
													<h3 class="mb-2"><a href="demo-news-single.html">How To Make More Travel By Doing Less</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
														<li><span>by</span> <a href="#">John Doe</a></li>
								...
								<div class="row mt-5">
									<div class="col-md-12 text-center">
										...
										============================================= -->
										<a href="demo-news-2.html" class="mt-4 button button-dark bg-dark button-rounded ls1 text-uppercase load-next-portfolio">Load more...</a>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-4 sticky-sidebar-wrap mt-5 mt-lg-0">
							<div class="sticky-sidebar">
								...
								<div class="widget widget_links clearfix">
									...
									<div class="line line-xs line-sports"></div>
									<ul>
										<li class="d-flex align-items-center"><a href="demo-news-category.html" class="flex-fill">World</a><span class="badge text-light bg-sports">14</span></li>
										<li class="d-flex align-items-center"><a href="demo-news-category.html" class="flex-fill">Technology</a><span class="badge text-light bg-travel">21</span></li>
										<li class="d-flex align-items-center"><a href="demo-news-category.html" class="flex-fill">Entertainment</a><span class="badge text-light bg-info">32</span></li>
										<li class="d-flex align-items-center"><a href="demo-news-category.html" class="flex-fill">Sports</a><span class="badge text-light bg-fashion">52</span></li>
										<li class="d-flex align-items-center"><a href="demo-news-category.html" class="flex-fill">Media</a><span class="badge text-light bg-success">14</span></li>
										<li class="d-flex align-items-center"><a href="demo-news-category.html" class="flex-fill">Politics</a><span class="badge text-light bg-travel">91</span></li>
										<li class="d-flex align-items-center"><a href="demo-news-category.html" class="flex-fill">Business</a><span class="badge text-light bg-market">32</span></li>
									</ul>
								</div>
									...
									<div class="posts-sm row col-mb-30">
										...
										<div class="entry col-12">
											<div class="grid-inner row align-items-center g-0">
												<div class="col-auto">
													<div class="entry-image">
														<a href="demo-news-single.html"><img src="{{asset('news/demos/news/images/posts/travel/small/3.jpg')}}" alt="Image"></a>
													</div>
												</div>
												<div class="col ps-3">
													<div class="entry-title">
								...
								<div id="instagram" class="widget clearfix">
									...
									<div id="instagram-photos" class="instagram-photos masonry-thumbs grid-container mt-2 grid-3" data-user="blog.canvastemplate" data-count="9"></div>
								</div>
							</div>
