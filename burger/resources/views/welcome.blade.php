...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="index.html" class="standard-logo" data-dark-logo="{{ env('APP_LOGO') }}" data-sticky-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
							<a href="index.html" class="retina-logo" data-dark-logo="{{ env('APP_LOGO') }}" data-sticky-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element min-vh-100 page-section slide-img include-header" data-animate="img-to-right" style="background: url({{asset('/burger/demos/burger/images/hero.jpg')}}) center center no-repeat; background-size: cover;">
		...
		<section id="content" class="dark-color">
			<div style="position: absolute; top: -13px; left: 0; width: 100%;height: 30px; background: url({{asset('/burger/demos/burger/images/svg/brush.svg')}}) no-repeat top center / 110% auto; z-index: 2;"></div>
			<div class="content-wrap p-0">

				<div id="story" class="page-section">

					<div class="section my-0" style="background: #F0ECE7 url({{asset('/burger/demos/burger/images/icon-bg.png')}}) repeat center center;">
						<div class="container">
							<div class="center bottommargin mx-auto" style="max-width: 700px">
								...
								<div class="card mx-auto my-5 slide-img border-0" style="max-width: 450px" data-animate="img-to-left">
									<img src="{{asset('burger/demos/burger/images/others/chef.jpg')}}" class="card-img" alt="...">
					...
					<div class="section m-0 p-0">
						<div class="row align-items-stretch clearfix">
							...
							<div class="item-categories overflow-hidden col-md-4 dark col-padding position-relative" style="background-color: #0A0A0A;">
								<div class="cat-img"><img  data-animate="fadeInRight" src="{{asset('burger/demos/burger/images/cat/1.png')}}" alt="Category Image"></div>
								<div class="cat-text">
							...
							<div class="item-categories overflow-hidden col-md-4 dark col-padding position-relative" style="background-color: #1B1B1B;">
								<div class="cat-img"><img  data-animate="fadeInRight" src="{{asset('burger/demos/burger/images/cat/3.png')}}" alt="Category Image"></div>
								<div class="cat-text">
							...
							<div class="item-categories overflow-hidden col-md-4 dark col-padding position-relative" style="background-color: #262626;">
								<div class="cat-img"><img  data-animate="fadeInRight" src="{{asset('burger/demos/burger/images/cat/4.png')}}" alt="Category Image"></div>
								<div class="cat-text">
				...
				<div id="menu" class="page-section">
					<div class="section mb-0" style="background: linear-gradient(to bottom, #101010, transparent, #101010), url({{asset('/burger/demos/burger/images/others/section-2.jpg')}}) no-repeat center top / cover;">
						...
						<div class="container">
							<div class="row align-items-center">
								<div class="col-md-5 dark order-2 order-md-1">
									<div class="bottommargin">
										...
										<div class="d-flex align-items-center dotted-bg">
											<img src="{{asset('burger/demos/burger/images/svg/burger.svg')}}" alt="" width="60">
								...
								<div class="col-md-6 center order-1 order-md-2" data-animate="zoomIn faster">
									<img src="{{asset('burger/demos/burger/images/others/burger.png')}}" alt="Image" class="parallax price-img mb-5 mb-md-0" data-top-bottom="transform:translateY(-30px)" data-bottom-top="transform:translateY(140px)">
								</div>
							</div>
						</div>
					...
					<div id="menu-snacks" class="section m-0" style="background: linear-gradient(to bottom, #101010, rgba(16,16,16,0.3),#101010), url({{asset('/burger/demos/burger/images/others/section-5.jpg')}}) no-repeat center top / cover;">

						<div class="container">
							<div class="row align-items-center">
								<div class="col-md-6 offset-md-1" data-animate="zoomIn faster">
									<img src="{{asset('burger/demos/burger/images/others/snacks.png')}}" alt="" class="parallax price-img mb-5 mb-md-0" data-top-bottom="transform:translateY(-30px)" data-bottom-top="transform:translateY(140px)">
								</div>
								...
								<div class="col-md-5 dark">
									<div class="bottommargin">
										...
										<div class="d-flex align-items-center dotted-bg">
											<img src="{{asset('burger/demos/burger/images/svg/snacks.svg')}}" alt="" width="70">
									...
									<div class="price-menu-warp img-hover-block" data-img="{{asset('burger/demos/burger/images/menu-items/snacks/chicken-wrap.jpeg')}}">
										<div class="price-header">
					...
					<div id="menu-beverages" class="section mt-0" style="background: linear-gradient(to bottom, #101010, rgba(16,16,16,0.3),#101010), url({{asset('/burger/demos/burger/images/others/section-4.jpg')}}) no-repeat center top / cover;">
						...
						<div class="container">
							<div class="row align-items-center">
								...
								<div class="col-md-6 offset-md-1 center order-1 order-md-2" data-animate="zoomIn faster">
									<img src="{{asset('burger/demos/burger/images/others/beverage-2.png')}}" alt="" class="parallax price-img mb-5 mb-md-0" data-top-bottom="transform:translateY(-30px)" data-bottom-top="transform:translateY(140px)">
								</div>
							</div>
						</div>
				...
				<div class="section dark my-0" style="padding: 60px 0 120px; background: linear-gradient(to bottom, #101010, transparent), url({{asset('/burger/demos/burger/images/icon-bg-white.png')}}) repeat center center;">
				...
				<div id="contact" class="section page-section dark m-0 pb-0 pb-md-5 slide-img" data-animate="img-to-left" style="background: #101010 url({{asset('/burger/demos/burger/images/icon-bg-white.png')}}) repeat center center;">
		...
		<!-- Footer
		============================================= -->
		<footer id="footer" class="dark noborder parallax pt-3" style="background-image: url({{asset('/burger/demos/burger/images/others/footer.jpg')}});" data-top-bottom="background-position:100% -300px" data-bottom-top="background-position: 100% 300px">
			<div class="container">
					...
					<div class="row col-mb-50">
						<div class="col-lg-8">
							...
							<div class="widget">
								...
								<img src="{{asset('burger/demos/burger/images/footer-logo.png')}}" alt="" height="40" class="alignleft" style=" padding-right: 18px; border-right: 1px solid #4A4A4A;">
							...
							<div class="row col-mb-30">
								...
								<div class="col-md-12 col-lg-4">
									<div class="widget">
										...
										<h4 class="fw-bold">Download App</h4>
										<a href="#"><img src="{{asset('burger/demos/articles/images/appstore.png')}}" alt="App Link" height="50"></a>
										<a href="#"><img src="{{asset('burger/demos/articles/images/googleplay.png')}}" alt="App Link" class="mt-2" height="50"></a>
