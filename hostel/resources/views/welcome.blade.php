...
<body class="stretched">
	...
	<div id="wrapper">
				...
				<div class="container-fluid pe-0">
					<div class="header-row">
						...
						<div class="header-misc">
							<a href="demo-hostel-tour.html" class="button fw-semibold">Book Now</a>
						</div>
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container border-end-0 me-0">
								<li class="menu-item current">
									<a class="menu-link" href="demo-hostel.html"><div>Home</div></a>
								</li>

								<li class="menu-item">
									<a class="menu-link" href="demo-hostel-about.html"><div>About Us</div></a>
								</li>

								<li class="menu-item">
									<a class="menu-link" href="demo-hostel-tour.html"><div>Tour</div></a>
									<ul class="sub-menu-container">
										<li class="menu-item">
											<a class="menu-link" href="demo-hostel-single.html"><div>Single</div></a>
										</li>
									</ul>
								</li>

								<li class="menu-item">
									<a class="menu-link" href="demo-hostel-contact.html"><div>Contact Us</div></a>
								</li>
							</ul>
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element" style="background: linear-gradient(to right, rgba(0,0,0, 0.4) 20%, transparent 100%), url({{asset('/hostel/demos/hostel/images/hero1.jpg')}}) no-repeat center center / cover;">
			...
			<div class="content-wrap pb-0">
				...
				<div class="container">
					<div class="row topmargin">
						<div class="col-md-5 offset-md-1">
							<h3 class="text-dark"><i class="icon-line-circle-check color me-1 position-relative" style="top: 2px"></i> Why do you choose Canvas?</h3>
						...
						<div class="col-md-5 ps-md-5">
							<h3 class="text-dark"><i class="icon-line-circle-check color me-1 position-relative" style="top: 2px"></i> How we do</h3>
					...
					<div class="row align-items-center">
						<div class="col-lg-4 col-md-7 offset-lg-1 mb-5 mb-lg-0">
							...
							<div class="row justify-content-end align-items-center mt-4">
								<div class="col text-end"><img src="{{asset('hostel/demos/conference/images/sponcors/amazon.svg')}}" alt="Image" width="80"></div>
								<div class="col text-end"><img src="{{asset('hostel/demos/conference/images/sponcors/google.svg')}}" alt="Image" width="80"></div>
								<div class="col text-end"><img src="{{asset('hostel/demos/conference/images/sponcors/linkedin.svg')}}" alt="Image" width="80"></div>
							</div>
						</div>
				...
				<div class="section center studio-tab mb-0" style="background-color: #D6EBEE">
					<div class="container mx-auto" style="max-width: 800px">
						...
						<div class="tab-content mb-5">
								...
								<div class="fslider" data-smooth-height="false" data-pagi="false" data-arrows="false" data-thumbs="true">
									<div class="flexslider">
										<div class="slider-wrap">
											<div class="slide" data-thumb="{{asset('hostel/demos/hostel/images/studios/1/thumbs/1.jpg')}}"><img src="{{asset('hostel/demos/hostel/images/studios/1/1.jpg')}}" alt="Lobby"></div>
											<div class="slide" data-thumb="{{asset('hostel/demos/hostel/images/studios/1/thumbs/2.jpg')}}"><img src="{{asset('hostel/demos/hostel/images/studios/1/2.jpg')}}" alt="Lobby"></div>
											<div class="slide" data-thumb="{{asset('hostel/demos/hostel/images/studios/1/thumbs/3.jpg')}}"><img src="{{asset('hostel/demos/hostel/images/studios/1/3.jpg')}}" alt="Lobby"></div>
										</div>
									</div>
								</div>
							</div>
							<div class="tab-pane" id="studio-deluxe-twin-room" role="tabpanel" aria-labelledby="studio-deluxe-twin-room-tab">
								<div class="fslider" data-smooth-height="false" data-pagi="false" data-arrows="false" data-thumbs="true">
									<div class="flexslider">
										<div class="slider-wrap">
											<div class="slide" data-thumb="{{asset('hostel/demos/hostel/images/studios/2/thumbs/1.jpg')}}"><img src="{{asset('hostel/demos/hostel/images/studios/2/1.jpg')}}" alt="Deluxe Twin Room"></div>
											<div class="slide" data-thumb="{{asset('hostel/demos/hostel/images/studios/2/thumbs/2.jpg')}}"><img src="{{asset('hostel/demos/hostel/images/studios/2/2.jpg')}}" alt="Deluxe Twin Room"></div>
											<div class="slide" data-thumb="{{asset('hostel/demos/hostel/images/studios/2/thumbs/3.jpg')}}"><img src="{{asset('hostel/demos/hostel/images/studios/2/3.jpg')}}" alt="Deluxe Twin Room"></div>
										</div>
									</div>
								</div>
							</div>
							<div class="tab-pane" id="studio-dormitory-room" role="tabpanel" aria-labelledby="studio-dormitory-room-tab">
								<div class="fslider" data-smooth-height="false" data-pagi="false" data-arrows="false" data-thumbs="true">
									<div class="flexslider">
										<div class="slider-wrap">
											<div class="slide" data-thumb="{{asset('hostel/demos/hostel/images/studios/3/thumbs/1.jpg')}}"><img src="{{asset('hostel/demos/hostel/images/studios/3/1.jpg')}}" alt="Dormitory Room"></div>
											<div class="slide" data-thumb="{{asset('hostel/demos/hostel/images/studios/3/thumbs/2.jpg')}}"><img src="{{asset('hostel/demos/hostel/images/studios/3/2.jpg')}}" alt="Dormitory Room"></div>
											<div class="slide" data-thumb="{{asset('hostel/demos/hostel/images/studios/3/thumbs/3.jpg')}}"><img src="{{asset('hostel/demos/hostel/images/studios/3/3.jpg')}}" alt="Dormitory Room"></div>
										</div>
									</div>
								</div>
							</div>
							<div class="tab-pane" id="studio-4-mixed-bed" role="tabpanel" aria-labelledby="studio-4-mixed-bed-tab">
								<div class="fslider" data-smooth-height="false" data-pagi="false" data-arrows="false" data-thumbs="true">
									<div class="flexslider">
										<div class="slider-wrap">
											<div class="slide" data-thumb="{{asset('hostel/demos/hostel/images/studios/4/thumbs/1.jpg')}}"><img src="{{asset('hostel/demos/hostel/images/studios/4/1.jpg')}}" alt="4 Bed Mixed"></div>
											<div class="slide" data-thumb="{{asset('hostel/demos/hostel/images/studios/4/thumbs/2.jpg')}}"><img src="{{asset('hostel/demos/hostel/images/studios/4/2.jpg')}}" alt="4 Bed Mixed"></div>
										</div>
									</div>
								</div>
							</div>
						...
						<a href="demo-hostel-single.html" class="button button-large bg-color nott fw-semibold ls0">View Full Gallery</a>
								...
								<div class="row">
									<div class="col-6">
										<ul class="list-group list-group-flush">
											...
											<li class="list-group-item ps-0"><i class="icon-line2-cup me-2"></i>Breakfast Included</li>
									...
									<div class="col-6">
										<ul class="list-group list-group-flush">
											<li class="list-group-item ps-0"><i class="icon-line2-lock me-2"></i>Lockers Available</li>
											<li class="list-group-item ps-0"><i class="icon-line2-social-dropbox me-2"></i>Laundry Available</li>
											<li class="list-group-item ps-0"><i class="icon-line2-game-controller me-2"></i>Other Aminities</li>
										</ul>
									</div>
								</div>
				...
				<div class="section m-0 center dark parallax" style="background: url({{asset('/hostel/demos/hostel/images/hero.jpg')}}) center center / cover; padding: 170px 0;">
					<div class="container">
						...
						<div class="col-lg-4 col-md-4 text-md-end">
							<div class="widget">
								<div>
									...
									<h3 class="mb-3"><a href="tel:111223344" class="text-dark"><i class="icon-line2-earphones-alt me-1"></i> +00-22-33-44</a></h3>
									<div class="d-flex justify-content-md-end">
										...
										<a href="#" class="social-icon si-small si-pinterest" title="pinterest">
											<i class="icon-pinterest"></i>
											<i class="icon-pinterest"></i>
										</a>
				...
				<div class="container">
					...
					<div class="row justify-content-between align-items-center">
						<div class="col-md-6 text-black-50">
							Copyrights &copy; 2019 All Rights Reserved by Canvas Inc.
						</div>
