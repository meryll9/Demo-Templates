...
@section('content')
    <!-- Slider
        ============================================= -->
        <section id="slider" class="slider-element dark min-vh-100 include-header" style="background-image: url({{asset('/landing/demos/landing/images/hero/1.svg')}});">
                    ...
                    <div class="container">
                        <div class="row align-items-lg-center g-0">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <h2 class="display-3 fw-bold text-white">{{ env('APP_TAGLINE') }}</h2>
                                <p class="lead mb-4 fw-normal">Best Wallet App for your upcoming Projects.</p>
                                <div>
                                    <a href="#" class="btn mt-2 text-dark bg-white rounded-3 px-4 py-3 nott ls0 shadow-sm"><i class="icon-apple1 me-2"></i>Get it on the App Store</a>
                                    <a href="#" class="ms-0 ms-lg-2 mt-2 btn text-dark bg-white rounded-3 px-4 py-3 nott ls0 shadow-sm"><i class="icon-google-play me-2"></i>Get it on Play Store</a>
                                </div>
                                <p class="text-white-50 text-uppercase mt-2 ls1 fw-medium"><small>Sign up &amp; Get 30 Days Free trail</small></p>
                            </div>
                            ...
                            <div class="col-lg-5 col-md-6 align-self-lg-end">
                                <div class="slide-imgs">
                                    <img src="{{asset('landing/demos/landing/images/hero/1-2.png')}}" alt="Image" class="card-img">
                                    <img src="{{asset('landing/demos/landing/images/hero/1-1.png')}}" alt="Image" class="iphone-img">
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8 col-md-7 d-flex align-items-lg-center flex-row">
                                <div class="col"><img src="{{asset('landing/demos/conference/images/sponcors/amazon.svg')}}" alt="Clients"></div>
                                <div class="col"><img src="{{asset('landing/demos/conference/images/sponcors/netflix.svg')}}" alt="Clients"></div>
                                <div class="col"><img src="{{asset('landing/demos/conference/images/sponcors/google.svg')}}" alt="Clients"></div>
                                <div class="col"><img src="{{asset('landing/demos/conference/images/sponcors/linkedin.svg')}}" alt="Clients"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="content-wrap pb-0">
        ...
        <div class="container">
            <div class="mx-auto center mt-4 bottommargin heading-block" style="max-width: 640px;">
                ...
                <h2 class="nott mb-4">Powerful &amp; Best Features for Canvas App</h2>
                <p class="lead fw-normal font-primary mb-5">Dynamically underwhelm end-to-end experiences for premier
                    methodologies. Objectively benchmark front-end bandwidth vis-a-vis flexible e-services. Globally
                    drive business convergence without backward-compatible markets.</p>
            </div>
                    ...
                    <div class="col-md-5 bottommargin-lg">
                        <div class="feature-box media-box">
                            ...
                            <div class="fbox-content">
                                ...
                                <div class="lead fw-normal text-black-50">Appropriately reconceptualize timely
                                    convergence through resource maximizing collaboration and idea-sharing. Globally
                                    coordinate cross-platform products via interoperable models.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5 bottommargin-lg">
                        <div class="feature-box media-box">
                            ...
                            <div class="fbox-content">
                                ...
                                <div class="lead fw-normal text-black-50"> Rapidiously actualize wireless benefits
                                    before resource-leveling quality vectors. Dramatically innovate progressive
                                    convergence without tactical schemas. Competently unleash distributed users whereas.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5 bottommargin-lg">
                        <div class="feature-box media-box">
                            ...
                            <div class="fbox-content">
                                ...
                                <div class="lead fw-normal text-black-50">Appropriately redefine market positioning
                                    leadership skills whereas client-based "outside the box" thinking. Monotonectally
                                    engage next-generation leadership skills without one-to-one testing procedures.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5 bottommargin-lg">
                        <div class="feature-box media-box">
                            ...
                            <div class="fbox-content">
                                ...
                                <div class="lead fw-normal text-black-50">Compellingly evisculate impactful e-services
                                    for extensible resources. Interactively grow timely e-commerce rather than optimal
                                    expertise. Uniquely optimize impactful experiences rather than cooperative.</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-stretch align-content-stretch g-0 topmargin">
            ...
            <div class="col-md-6 order-md-2"
                style="background: url({{ asset('/landing/demos/landing/images/section/1.jpg') }}) center center / cover; min-height: 300px">
            </div>

            <div class="col-md-6 bg-color dark order-md-1">
                <div class="section-features">
                    <h2 class="mb-3 h4 fw-semibold">Intrinsicly synergistic benefits.</h2>
                    <p class="h6 fw-normal mb-5"> Enthusiastically morph unique web-readiness via impactful platforms.
                        Intrinsicly matrix premium expertise for diverse expertise. Intrinsicly drive collaborative
                        bandwidth for accurate testing.</p>

                    <h2 class="mb-3 h4 fw-semibold">Appropriately target customers.</h2>
                    <p class="h6 fw-normal">Energistically incentivize front-end web services via enabled
                        collaboration and idea-sharing. Conveniently whiteboard effective niche markets before flexible
                        ROI.</p>
                    <p class="h6 fw-normal mb-5">Phosfluorescently build turnkey convergence without goal-oriented
                        systems.</p>

                    <h2 class="mb-3 h4 fw-semibold">Completely exploit focused.</h2>
                    <p class="h6 fw-normal mb-0">Continually enable leveraged users after functional web-readiness.
                        Interactively conceptualize accurate resources whereas distinctive e-markets.</p>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 col-md-6 mb-4 mb-md-0">
                        <img src="{{ asset('landing/demos/landing/images/section/2.jpg') }}" alt="Image">
                    </div>
                    ...
                    <div class="col-md-6 offset-lg-1">
                        ...
                        <p class="fw-normal lead">Enthusiastically morph unique web-readiness via impactful platforms.
                            Intrinsicly matrix premium expertise for diverse expertise. Intrinsicly drive collaborative
                            bandwidth for accurate testing.</p>
                                ...
                                <div class="progress">
                                    <div class="progress-percent">
                                        <div class="counter counter-inherit counter-instant"><span data-from="0"
                                                data-to="60" data-refresh-interval="30" data-speed="1500"></span>%
                                            Optimized</div>
                                    </div>
                                </div>
                            </li>
        ...
        <div class="section m-0" style="padding: 100px 0; background-color: rgba(61,128,228,0.05)">
            ...
            <div class="container clearfix">
                ...
                <div class="heading-block mx-auto center" style="max-width: 500px">
                    ...
                    <p class="h6 fw-normal text-black-50">Recusandae ducimus, sequi, sapiente possimus optio impedit
                        efficient services. Completely promote.</p>
                </div>
            ...
            <div class="owl-carousel owl-carousel-full image-carousel carousel-widget" data-margin="40"
                ...
                <div class="oc-item">
                    <a href="demos/landing/images/carousel/1.png')}}" data-lightbox="image">
                        <img src="{{ asset('landing/demos/landing/images/carousel/1.png') }}" alt="Image 1">
                    </a>
                </div>
                <div class="oc-item">
                    <a href="demos/landing/images/carousel/2.png')}}" data-lightbox="image">
                        <img src="{{ asset('landing/demos/landing/images/carousel/2.png') }}" alt="Image 2">
                    </a>
                </div>
                <div class="oc-item">
                    <a href="demos/landing/images/carousel/3.png')}}" data-lightbox="image">
                        <img src="{{ asset('landing/demos/landing/images/carousel/3.png') }}" alt="Image 3">
                    </a>
                </div>
                <div class="oc-item">
                    <a href="demos/landing/images/carousel/4.png')}}" data-lightbox="image">
                        <img src="{{ asset('landing/demos/landing/images/carousel/4.png') }}" alt="Image 4">
                    </a>
                </div>
                <div class="oc-item">
                    <a href="demos/landing/images/carousel/5.png')}}" data-lightbox="image">
                        <img src="{{ asset('landing/demos/landing/images/carousel/5.png') }}" alt="Image 5">
                    </a>
                </div>
                <div class="oc-item">
                    <a href="demos/landing/images/carousel/6.png')}}" data-lightbox="image">
                        <img src="{{ asset('landing/demos/landing/images/carousel/6.png') }}" alt="Image 6">
                    </a>
                </div>
                <div class="oc-item">
                    <a href="demos/landing/images/carousel/7.png')}}" data-lightbox="image">
                        <img src="{{ asset('landing/demos/landing/images/carousel/7.png') }}" alt="Image 7">
                    </a>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 pricing-table">
                                <div class="card shadow"
                                    style="background-image: url({{ asset('/landing/demos/landing/images/section/pricing-bg-light.svg') }}); background-position: 0 100%; background-size: 100% 290px;">
            ...
            <div class="container clearfix">
                <div class="row">
                    <div class="col-lg-6 mb-5">
                        ...
                        <p class="fw-normal mb-2 h6 text-muted">Enthusiastically morph unique web-readiness via
                            impactful platforms. Intrinsicly matrix premium expertise for diverse expertise. Intrinsicly
                            drive collaborative bandwidth for accurate testing.</p>
                    ...
                    <div class="col-lg-5 d-flex align-items-end">
                        <div class="device-video-wrap">
                            ...
                            <video poster="{{ asset('landing/images/videos/deskwork.jpg') }}" preload="auto" loop
                                autoplay muted>
                                <source src="{{ asset('landing/demos/landing/images/form-video.mp4') }}"
                                    type='video/mp4' />
                            </video>
                        </div>
                    </div>
        ...
        <div class="section m-0 bg-color"
            ...
            <div class="container dark dotted-bg bottommargin-lg">
                <div class="fslider testimonial testimonial-full center bg-transparent border-0 shadow-none p-0"
                    data-animation="fade" data-pagi="false">
                    <div class="flexslider">
                        <div class="slider-wrap d-flex align-items-center">
                            <div class="slide">
                                <img src="{{ asset('landing/demos/landing/images/clients/skype.svg') }}"
                                    alt="Customer Testimonials">
                                <div class="testi-content">
                                    <p>Completely restore optimal human capital with economically sound infomediaries.
                                        Authoritatively extend end-to-end content with covalent relationships.</p>
                            ...
                            <div class="slide">
                                <img src="{{ asset('landing/demos/landing/images/clients/netflix.svg') }}"
                                    alt="Customer Testimonials">
                                <div class="testi-content">
                                    <p>Dynamically supply cross functional process improvements whereas enterprise-wide
                                        ROI. Distinctively streamline cost effective data and multifunctional
                                        functionalities.</p>
                                    <div class="testi-meta mt-4">
                                        Collis Ta'eed
                            ...
                            <div class="slide">
                                <img src="{{ asset('landing/demos/landing/images/clients/nat-geo.svg') }}"
                                    alt="Customer Testimonials">
                                <div class="testi-content">
                                    <p> Globally implement strategic resources via ethical markets. Interactively drive
                                        highly efficient potentialities before economically sound applications
                                        communicate solutions.</p>
                                    <div class="testi-meta mt-4">
                                        John Doe
                                        <span>XYZ Inc.</span>
                                    </div>
                                    ...
                                    <form class="row mb-0" id="landing-enquiry" action="include/form.php"
                                        ...
                                        <div class="col-12 form-group mb-4">
                                            ...
                                            <div class="input-group input-group-lg">
                                                <select class="custom-select required" name="landing-enquiry-idd"
                                                    id="landing-enquiry-idd" style="max-width: 80px;">
