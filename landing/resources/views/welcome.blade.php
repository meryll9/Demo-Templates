				...
				<div class="container">
					<div class="header-row">
						...
						<div id="logo" class="border-end-0">
							<a href="demo-landing.html" class="standard-logo" data-dark-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
							<a href="demo-landing.html" class="retina-logo" data-dark-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
		...
		<section id="content">
			<div class="content-wrap pb-0">
				...
				<div class="row align-items-stretch align-content-stretch g-0 topmargin">
					...
					<div class="col-md-6 order-md-2" style="background: url({{asset('/landing/demos/landing/images/section/1.jpg')}}) center center / cover; min-height: 300px"></div>
					...
					<div class="container">
						<div class="row align-items-center">
							...
							<div class="col-md-6 offset-lg-1">
								...
								<a href="#" class="btn text-white bg-color rounded-3 px-4 py-3 fw-semibold text-uppercase shadow-sm">Learn More <i class="icon-line-arrow-right ms-1"></i></a>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="col-lg-7 col-md-6">
								<div class="row">
									<div class="col-lg-6 pricing-table">
										<div class="card shadow" style="background-image: url({{asset('/landing/demos/landing/images/section/pricing-bg-light.svg')}}); background-position: 0 100%; background-size: 100% 290px;">
									...
									<div class="col-lg-6 pricing-table mt-4 mt-lg-0">
										<div class="card shadow" style="background-image: url({{asset('/landing/demos/landing/images/section/pricing-bg.svg')}});">
						...
						<div class="row">
							...
							<div class="col-lg-5 d-flex align-items-end">
								<div class="device-video-wrap">
									...
									<video poster="{{asset('landing/images/videos/deskwork.jpg')}}" preload="auto" loop autoplay muted>
						...
						<div class="fslider testimonial testimonial-full center bg-transparent border-0 shadow-none p-0" data-animation="fade" data-pagi="false">
							<div class="flexslider">
								<div class="slider-wrap d-flex align-items-center">
									<div class="slide">
										<img src="{{asset('landing/demos/landing/images/clients/skype.svg')}}" alt="Customer Testimonials">
										<div class="testi-content">
											<p>Completely restore optimal human capital with economically sound infomediaries. Authoritatively extend end-to-end content with covalent relationships.</p>
									...
									<div class="slide">
										<img src="{{asset('landing/demos/landing/images/clients/netflix.svg')}}" alt="Customer Testimonials">
										<div class="testi-content">
											<p>Dynamically supply cross functional process improvements whereas enterprise-wide ROI. Distinctively streamline cost effective data and multifunctional functionalities.</p>
											<div class="testi-meta mt-4">
												Collis Ta'eed
									...
									<div class="slide">
										<img src="{{asset('landing/demos/landing/images/clients/nat-geo.svg')}}" alt="Customer Testimonials">
										<div class="testi-content">
											<p> Globally implement strategic resources via ethical markets. Interactively drive highly efficient potentialities before economically sound applications communicate solutions.</p>
											<div class="testi-meta mt-4">
												John Doe
												<span>XYZ Inc.</span>
											</div>
											...
											<form class="row mb-0" id="landing-enquiry" action="include/form.php" method="post" enctype="multipart/form-data">
												...
												<div class="col-12 form-group mb-4">
													...
													<div class="input-group input-group-lg">
														<select class="custom-select required" name="landing-enquiry-idd" id="landing-enquiry-idd" style="max-width: 80px;">
					...
					<div class="row mx-auto">
						...
						<div class="col-md-8">
							...
							<div class="row align-items-center">
								...
								<div class="col-md-4 mt-3 mt-md-0">
									...
									<a href="#" class="social-icon si-small si-colored si-android" title="Android">
						...
						<div class="col-md-4 mt-4 mt-md-0">
							<div class="widget">
								...
								<h4 class="ls0 ls0">From the Blog</h4>

								<article class="entry">
									<div class="entry-image mb-3">
										<a href="demos/news/news-single.html"><img src="{{asset('landing/demos/landing/images/blog-img.jpg')}}" alt="Image 3"></a>
									</div>
									<div class="entry-title title-xs">
										<h3 class="mb-2"><a href="demos/news/news-single.html">A Surprising Tool to Help you Lifestyle</a></h3>
									</div>
				...
				<div class="container">
					...
					<div class="row col-mb-30">
						...
						<div class="col-md-6 text-center text-md-end">
							<a href="#" class="btn color bg-white rounded px-3 py-2 nott ls0 shadow-sm"><i class="icon-apple1 me-2"></i>App Store</a>
							<a href="#" class="btn color bg-white rounded px-3 py-2 nott ls0 shadow-sm ms-2"><i class="icon-google-play me-2"></i>Play Store</a>
						</div>
					</div>
