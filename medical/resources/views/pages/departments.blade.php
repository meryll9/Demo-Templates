                    ...
                    <div class="tab-container">
                        <div class="tab-content" id="tabs-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <img src="{{asset('medical/demos/medical/images/section-bg.jpg')}}" alt="Image">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content" id="tabs-2">
                            ...
                            <div class="row col-mb-50 mb-0">
                                <div class="col-lg-6">
                                    ...
                                    <div class="team team-list row align-items-center">
                                        <div class="team-image col-sm-6">
                                            <img src="{{asset('medical/demos/medical/images/doctors/1.jpg')}}" alt="John Doe">
                                        </div>
                                        <div class="team-desc col-sm-6">
                                            ...
                                            <div class="team-content">
                                                <p>Carbon emissions reductions giving, legitimize amplify non-partisan Aga
                                                    Khan.</p>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="team team-list row align-items-center">
                                        <div class="team-image col-sm-6">
                                            <img src="{{asset('medical/demos/medical/images/doctors/4.jpg')}}" alt="Nix Maxwell">
                                        </div>
                                        <div class="team-desc col-sm-6">
                                            <div class="team-title">
                                            ...
                                            <div class="team-content">
                                                <p>Eradicate invest honesty human rights accessibility theory of social
                                                    change.</p>
                                            </div>
                                    ...
                                    <div class="masonry-thumbs grid-container grid-4" data-big="4" data-lightbox="gallery">
                                        <a class="grid-item" href="{{asset('medical/demos/medical/images/gallery/1.jpg')}}"
                                            data-lightbox="gallery-item"><img
                                                src="{{asset('medical/demos/medical/images/gallery/thumbs/1.jpg')}}" alt="Gallery Thumb 1"></a>
                                        <a class="grid-item" href="{{asset('medical/demos/medical/images/gallery/2.jpg')}}"
                                            data-lightbox="gallery-item"><img
                                                src="{{asset('medical/demos/medical/images/gallery/thumbs/2.jpg')}}" alt="Gallery Thumb 2"></a>
                                        <a class="grid-item" href="{{asset('medical/demos/medical/images/gallery/3.jpg')}}"
                                            data-lightbox="gallery-item"><img
                                                src="{{asset('medical/demos/medical/images/gallery/thumbs/3.jpg')}}" alt="Gallery Thumb 3"></a>
                                        <a class="grid-item" href="{{asset('medical/demos/medical/images/gallery/4.jpg')}}"
                                            data-lightbox="gallery-item"><img
                                                src="{{asset('medical/demos/medical/images/gallery/thumbs/4.jpg')}}" alt="Gallery Thumb 4"></a>
                                        <a class="grid-item" href="{{asset('medical/demos/medical/images/gallery/5.jpg')}}"
                                            data-lightbox="gallery-item"><img
                                                src="{{asset('medical/demos/medical/images/gallery/thumbs/5.jpg')}}" alt="Gallery Thumb 5"></a>
                                        <a class="grid-item" href="{{asset('medical/demos/medical/images/gallery/6.jpg')}}"
                                            data-lightbox="gallery-item"><img
                                                src="{{asset('medical/demos/medical/images/gallery/thumbs/6.jpg')}}" alt="Gallery Thumb 6"></a>
                                        <a class="grid-item" href="{{asset('medical/demos/medical/images/gallery/7.jpg')}}"
                                            data-lightbox="gallery-item"><img
                                                src="{{asset('medical/demos/medical/images/gallery/thumbs/7.jpg')}}" alt="Gallery Thumb 7"></a>
                                        <a class="grid-item" href="{{asset('medical/demos/medical/images/gallery/9.jpg')}}"
                                            data-lightbox="gallery-item"><img
                                                src="{{asset('medical/demos/medical/images/gallery/thumbs/9.jpg')}}" alt="Gallery Thumb 9"></a>
                                        <a class="grid-item" href="{{asset('medical/demos/medical/images/gallery/10.jpg')}}"
                                            data-lightbox="gallery-item"><img
                                                src="{{asset('medical/demos/medical/images/gallery/thumbs/10.jpg')}}" alt="Gallery Thumb 10"></a>
                                        <a class="grid-item" href="{{asset('medical/demos/medical/images/gallery/11.jpg')}}"
                                            data-lightbox="gallery-item"><img
                                                src="{{asset('medical/demos/medical/images/gallery/thumbs/11.jpg')}}" alt="Gallery Thumb 11"></a>
                                        <a class="grid-item" href="{{asset('medical/demos/medical/images/gallery/12.jpg')}}"
                                            data-lightbox="gallery-item"><img
                                                src="{{asset('medical/demos/medical/images/gallery/thumbs/12.jpg')}}" alt="Gallery Thumb 12"></a>
                                        <a class="grid-item" href="{{asset('medical/demos/medical/images/gallery/13.jpg')}}"
                                            data-lightbox="gallery-item"><img
                                                src="{{asset('medical/demos/medical/images/gallery/thumbs/13.jpg')}}" alt="Gallery Thumb 13"></a>
                                        <a class="grid-item" href="{{asset('medical/demos/medical/images/gallery/14.jpg')}}"
                                            data-lightbox="gallery-item"><img
                                                src="{{asset('medical/demos/medical/images/gallery/thumbs/14.jpg')}}" alt="Gallery Thumb 14"></a>
                                    </div>
                                </div>
                                <div class="col-lg-5">
                                    ...
                                    <div class="feature-box fbox-plain mb-4">
                                        ...
                                        <div class="fbox-content">
                                            ...
                                            <p>Looks beautiful &amp; ultra-sharp on Retina Screen Displays. Retina Icons,
                                                Fonts &amp; all others graphics are optimized.</p>
                                        </div>
                                    </div>
                                    <div class="feature-box fbox-plain mb-4">
                                        <div class="fbox-icon">
                                ...
                                <div class="col-md-4">
                                    <div class="accordion">
                                        ...
                                        <div class="accordion-content">Integer posuere erat a ante venenatis dapibus
                                            posuere velit aliquet. Duis mollis, est non commodo luctus. Aenean lacinia
