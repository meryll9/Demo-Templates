                            ...
                            <div class="team-desc col-md">
                                ...
                                <div class="team-content">
                                    <p>Carbon emissions reductions giving, legitimize amplify non-partisan Aga Khan. Policy
                                        dialogue assessment free-speech cornerstone disruptor empower.</p>
                                </div>
                    ...
                    <div class="col-12">
                        <div class="team team-list row align-items-center">
                            ...
                            <div class="team-desc col-md">
                                ...
                                <div class="team-content">
                                    <p>Carbon emissions reductions giving, legitimize amplify non-partisan Aga Khan. Policy
                                        dialogue assessment expert free-speech reductions cornerstone disruptor.</p>
                                </div>
                                <a href="#" class="social-icon si-rounded si-small si-facebook">
                                    <i class="icon-facebook"></i>
                                    <i class="icon-facebook"></i>
                    ...
                    <div class="col-12">
                        <div class="team team-list row align-items-center">
                            ...
                            <div class="team-desc col-md">
                                ...
                                <div class="team-content">
                                    <p>Carbon emissions reductions giving, legitimize amplify non-partisan Aga Khan. Policy
                                        dialogue assessment expert free-speech cornerstone disruptor empower.</p>
                                </div>
                                <a href="#" class="social-icon si-rounded si-small si-twitter">
                                    <i class="icon-twitter"></i>
                                    <i class="icon-twitter"></i>
                    ...
                    <div class="col-12">
                        <div class="team team-list row align-items-center">
                            ...
                            <div class="team-desc col-md">
                                ...
                                <div class="team-content">
                                    <p>Emissions reductions giving, legitimize amplify non-partisan Aga Khan. Policy
                                        dialogue assessment expert free-speech cornerstone disruptor empower.</p>
                                </div>
                                <a href="#" class="social-icon si-rounded si-small si-facebook">
                                    <i class="icon-facebook"></i>
                    ...
                    <div class="col-12">
                        <div class="team team-list row align-items-center">
                            ...
                            <div class="team-desc col-md">
                                ...
                                <div class="team-content">
                                    <p>Carbon emissions amplify non-partisan Aga Khan. Policy dialogue assessment expert
                                        free-speech cornerstone disruptor empower.</p>
                                </div>
                                <a href="#" class="social-icon si-rounded si-small si-facebook">
                                    <i class="icon-facebook"></i>
                                    <i class="icon-facebook"></i>
                    ...
                    <div class="col-12">
                        <div class="team team-list row align-items-center">
                            ...
                            <div class="team-desc col-md">
                                ...
                                <div class="team-content">
                                    <p>Carbon emissions reductions giving, non-partisan Aga Khan. Policy dialogue assessment
                                        expert free-speech cornerstone disruptor empower.</p>
                                </div>
                                <a href="#" class="social-icon si-rounded si-small si-facebook">
                                    <i class="icon-facebook"></i>
                                    <i class="icon-facebook"></i>
