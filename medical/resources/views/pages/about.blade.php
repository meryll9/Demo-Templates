        ...
        <div class="fslider" data-arrows="false" data-pagi="false" data-animation="fade" data-hover="false">
            <div class="flexslider">
                ...
                <div class="slider-wrap">
                    <div class="slide"><img src="{{asset('medical/demos/medical/images/about-us/page-title/1.jpg')}}"
                            alt="Page Title Image"></div>
                    <div class="slide"><img src="{{asset('medical/demos/medical/images/about-us/page-title/2.jpg')}}"
                            alt="Page Title Image"></div>
                    <div class="slide"><img src="{{asset('medical/demos/medical/images/about-us/page-title/3.jpg')}}"
                            alt="Page Title Image"></div>
                    <div class="slide"><img src="{{asset('medical/demos/medical/images/about-us/page-title/4.jpg')}}"
                            alt="Page Title Image"></div>
                </div>
        ...
        <div class="content-wrap">
            ...
            <div class="row counters clearfix mb-0 topmargin-sm align-items-stretch">
                ...
                <div class="col-lg-3 col-md-6 dark text-center min-vh-40"
                    style="background: url({{asset('/medical/demos/medical/images/about-us/counters/1.jpg')}}) no-repeat center center; background-size: cover;">
                    <div class="bg-overlay">
                        ...
                        <div class="bg-overlay-bg op-ts op-1" data-hover-animate="op-0" data-hover-animate-out="op-1"
                            style="background-color: rgba(229, 57, 53, 0.8);"></div>
                    </div>
                </div>

                <div class="col-lg-3 col-md-6 dark text-center min-vh-40"
                    style="background: url({{asset('/medical/demos/medical/images/about-us/counters/2.jpg')}}) no-repeat center center; background-size: cover;">
                    <div class="bg-overlay">
                        <div class="bg-overlay-content dark">
                            <div>
                        ...
                        <div class="bg-overlay-bg op-ts op-1" data-hover-animate="op-0" data-hover-animate-out="op-1"
                            style="background-color: rgba(211, 47, 47, 0.8);"></div>
                    </div>
                </div>

                <div class="col-lg-3 col-md-6 dark text-center min-vh-40"
                    style="background: url({{asset('/medical/demos/medical/images/about-us/counters/3.jpg')}}) no-repeat center center; background-size: cover;">
                    <div class="bg-overlay">
                        <div class="bg-overlay-content dark">
                            <div>
                                <i class="i-plain i-xlarge mx-auto icon-medical-i-social-services"></i>
                                <div class="counter counter-lined"><span data-from="20" data-to="408"
                                        data-refresh-interval="25" data-speed="3500"></span>K</div>
                                <h5>Satisfied Customers</h5>
                            </div>
                        </div>
                        <div class="bg-overlay-bg op-ts op-1" data-hover-animate="op-0" data-hover-animate-out="op-1"
                            style="background-color: rgba(198, 40, 40, 0.8);"></div>
                    </div>
                </div>

                <div class="col-lg-3 col-md-6 dark text-center min-vh-40"
                    style="background: url({{asset('/medical/demos/medical/images/about-us/counters/4.jpg')}}) no-repeat center center; background-size: cover;">
                    <div class="bg-overlay">
                        <div class="bg-overlay-content dark">
                            <div>
                                <i class="i-plain i-xlarge mx-auto icon-medical-i-ambulance"></i>
                                <div class="counter counter-lined"><span data-from="60" data-to="140"
                                        data-refresh-interval="20" data-speed="2700"></span></div>
                                <h5>Ambulance Available</h5>
                            </div>
                        </div>
                        <div class="bg-overlay-bg op-ts op-1" data-hover-animate="op-0" data-hover-animate-out="op-1"
                            style="background-color: rgba(183, 28, 28, 0.8);"></div>
                    </div>
                </div>
            ...
            <div class="section mt-0"
                style="background: #FFF url({{asset('/medical/demos/medical/images/about-us/1.jpg')}}) right center no-repeat / cover;">
                ...
                <div class="container clearfix">
                    ...
                    <div class="row justify-content-between">
                        <div class="col-lg-6" data-lightbox="gallery">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consectetur necessitatibus placeat
                                numquam enim adipisci nostrum facilis distinctio modi, cupiditate laborum ea eius
                                repellendus? Obcaecati saepe numquam pariatur aliquid, aspernatur necessitatibus dolores
                                harum quos eum esse, laudantium odit alias, iste dolorem!</p>
                            <div class="feature-box fbox-plain fbox-sm mb-4">
                                ...
                                <div class="fbox-content">
                                    <p class="mt-0">Powerful Layout with Responsive functionality that can be
            ...
            <div class="container clearfix">
                ...
                <div id="oc-team" class="owl-carousel team-carousel carousel-widget" data-margin="30" data-nav="true"
                    data-pagi="true" data-items-xs="1" data-items-sm="2" data-items-lg="3" data-items-xl="4">
