							...
							<ul class="top-links-container">
								<li class="top-links-item"><a href="#">EN</a>
									<ul class="top-links-sub-menu">
										<li class="top-links-item"><a href="#"><img src="{{asset('medical/images/icons/flags/french.png')}}" alt="French"> FR</a></li>
										<li class="top-links-item"><a href="#"><img src="{{asset('medical/images/icons/flags/italian.png')}}" alt="Italian"> IT</a></li>
										<li class="top-links-item"><a href="#"><img src="{{asset('medical/images/icons/flags/german.png')}}" alt="German"> DE</a></li>
									</ul>
								</li>
						...
						<div class="swiper-slide">
							<div class="container">
								<div class="slider-caption slider-caption-right" style="max-width: 700px;">
									<div>
										<h2 data-animate="flipInX">{{ env('APP_TAGLINE') }}<span>.</span></h2>
							...
							<div class="swiper-slide-bg" style="background-image: url({{asset('/medical/demos/medical/images/slider/1.jpg')}});"></div>
						</div>
						<div class="swiper-slide">
							<div class="container">
								<div class="slider-caption">
									<div>
										<h2 data-animate="zoomIn">{{ env('APP_TAGLINE') }}.</h2>
							...
							<div class="swiper-slide-bg" style="background-image: url({{asset('/medical/demos/medical/images/slider/2.jpg')}});"></div>
						</div>
					</div>
		...
		<section id="content">
			<div class="content-wrap">
				...
				<div class="section row p-0 align-items-stretch dark topmargin-sm">
					<div class="col-lg-5" style="background: url({{asset('/medical/demos/medical/images/section-bg.jpg')}}) center center no-repeat; background-size: cover; min-height: 250px;">
						<div>&nbsp;</div>
					</div>
						...
						<div class="col-md-5">
							...
							<ul class="testimonials-grid grid-1">
								<li class="grid-item pt-0">
									<div class="testimonial">
										<div class="testi-image">
											<a href="#"><img src="{{asset('medical/images/testimonials/1.jpg')}}" alt="Customer Testimonails"></a>
										</div>
								...
								<li class="grid-item pb-0">
									<div class="testimonial">
										<div class="testi-image">
											<a href="#"><img src="{{asset('medical/images/testimonials/2.jpg')}}" alt="Customer Testimonails"></a>
										</div>
										<div class="testi-content">
