            ...
            <div class="swiper-container swiper-parent">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide hero-diagonal dark bg-color"
                        style="background: linear-gradient(to right, rgba(0,0,0,0), rgba(0,0,0, 0.1)), url({{ asset('/yoga/demos/yoga/images/slider/hero-1.jpg') }}) no-repeat center right / auto 100%;">
                        <div class="container" style="z-index: 2;">
                            <div class="row h-100 align-items-center py-5">
                                <div class="col-md-6">
                                    <div class="heading-block border-bottom-0 bottommargin-sm">
                                        <h5 class="text-uppercase ls4 fw-light mb-2 text-white-50" data-animate="fadeInUp"
                                            data-delay="100">Yoga &amp; Meditation</h5>
                                        <h2 class="fw-bold nott ls0" data-animate="fadeInUp" data-delay="200"
                                            style="font-size: 46px;">{{ env('APP_TAGLINE') }}</h2>
                                    </div>
                                    <p class="mb-5 fw-normal lead" data-animate="fadeInUp" data-delay="400"
                                        style="line-height: 1.6;">Monotonectally pursue intuitive catalysts for change for
                                        extensible materials. Intrinsicly fabricate principle-centered web-readiness with
                                        virtual.</p>
                    ...
                    <!-- Slide 2 -->
                    <div class="swiper-slide hero-diagonal dark bg-color"
                        style="background: linear-gradient(to right, rgba(0,0,0,0), rgba(0,0,0, 0.1)), url({{ asset('/yoga/demos/yoga/images/slider/hero-2.jpg') }}) no-repeat bottom right / auto 100%;">
                        <div class="container" style="z-index: 2;">
                            <div class="row h-100 align-items-center py-5">
                                <div class="col-md-6">
                                    <div class="heading-block border-bottom-0 bottommargin-sm">
                                        <h5 class="text-uppercase ls4 fw-light mb-2 text-white-50" data-animate="fadeInUp"
                                            data-delay="100">Yoga &amp; Meditation</h5>
                                        <h2 class="fw-bold nott ls0" data-animate="fadeInUp" data-delay="200"
                                            style="font-size: 42px;">Yoga is the perfect opportunity to be curious about who
                                            you are.</h2>
                                    </div>
                                    <p class="mb-5 fw-normal lead" data-animate="fadeInUp" data-delay="400"
                                        style="line-height: 1.6;">Monotonectally pursue intuitive catalysts for change for
        ...
        <div class="content-wrap pt-0" style="overflow: visible">
            ...
            <div class="position-relative">
                        ...
                        <div class="col-lg-5 py-5">
                            <div class="heading-block border-bottom-0 bottommargin-sm">
                                <div class="fancy-title title-border mb-3">
                                    <h5 class="fw-normal color font-body">About Us</h5>
                                </div>
                                <h3 class="fw-bold nott" style="font-size: 42px; letter-spacing: -1px;">What is
                                    <span>Canvas</span> Yoga?</h3>
                            </div>
                ...
                <div class="section-img"
                    style="background: radial-gradient(ellipse at center, rgba(255,221,148,.7),rgba(255,221,148,1)), url({{ asset('/yoga/demos/yoga/images/yoga-about.jpg') }}) no-repeat center center / cover">
                    <img class="section-img-sm" src="{{ asset('yoga/demos/yoga/images/yoga-about-sm.jpg') }}"
                        alt="Section Img">
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4">
                            <div class="card" style="border-top-color: #9DC3E2;">
                                <div class="card-body">
                                    <img src="{{ asset('yoga/demos/yoga/images/yoga-icons/color/svg/asana_lotus_col.svg') }}"
                                        alt="Yoga Icon" class="mb-3" width="60">
                            ...
                            <div class="card topmargin" style="border-top-color: #FFB5CC;">
                                <div class="card-body">
                                    <img src="{{ asset('yoga/demos/yoga/images/yoga-icons/color/svg/asana_cobra.svg') }}"
                                        alt="Yoga Icon" class="mb-3" width="60">
                                    <h3>30+ Yoga Poses.</h3>
                                    <p class="text-black-50">Synergistically fashion high-payoff infrastructures for
                                        client-centric interfaces. Distinctively e-enable market positioning.</p>
                        ...
                        <div class="col-md-6 col-lg-4" style="margin-top: 30px">
                            <div class="card" style="border-top-color: #F4ABEF;">
                                <div class="card-body">
                                    <img src="{{ asset('yoga/demos/yoga/images/yoga-icons/color/svg/man_well.svg') }}"
                                        alt="Yoga Icon" class="mb-3" width="60">
                            ...
                            <div class="card topmargin" style="border-top-color: #F2A490;">
                                <div class="card-body">
                                    <img src="{{ asset('yoga/demos/yoga/images/yoga-icons/color/svg/kundalini_col.svg') }}"
                                        alt="Yoga Icon" class="mb-3" width="60">
                        ...
                        <div class="col-md-6 col-lg-4" style="margin-top: 60px">
                            <div class="card" style="border-top-color: #9DD2D8;">
                                <div class="card-body">
                                    <img src="{{ asset('yoga/demos/yoga/images/yoga-icons/color/svg/lotus_col.svg') }}"
                                        alt="Yoga Icon" class="mb-3" width="60">
                            ...
                            <div class="card topmargin" style="border-top-color: #D0E6A5;">
                                <div class="card-body">
                                    <img src="{{ asset('yoga/demos/yoga/images/yoga-icons/color/svg/om_col.svg') }}"
                                        alt="Yoga Icon" class="mb-3" width="60">
                ...
                <div id="oc-teachers" class="owl-carousel owl-carousel-full image-carousel carousel-widget customjs">
                    <div class="oc-item">
                        <div class="jumbotron m-0 dark p-5 d-flex justify-content-center align-items-md-end flex-column"
                            style="background: linear-gradient(to bottom, rgba(0,0,0,0.1), rgba(0,0,0, 0.8)), url({{ asset('/yoga/demos/yoga/images/teacher/1.jpg') }}) no-repeat center center / cover;">
                                    ...
                                    <div class="testimonial bg-transparent shadow-none border-0 p-0">
                                        ...
                                        <div class="testi-content">
                                            <p>Assertively leverage existing integrated communities after turnkey quality
                                                vectors. Assertively coordinate sustainable quality.</p>
                                        </div>
                                    </div>
                    ...
                    <div class="oc-item">
                        <div class="jumbotron m-0 dark p-5 d-flex justify-content-center align-items-md-end flex-column"
                            style="background: linear-gradient(to bottom, rgba(0,0,0,0.1), rgba(0,0,0, 0.8)), url({{ asset('/yoga/demos/yoga/images/teacher/2.jpg') }}) no-repeat center center / cover;">
                            <div class="jumbotron-text mt-0 mt-md-auto row align-items-center">
                                <div class="col-md-8">
                                    <div class="testimonial bg-transparent shadow-none border-0 p-0">
                    ...
                    <div class="oc-item">
                        <div class="jumbotron m-0 dark p-5 d-flex justify-content-center align-items-md-end flex-column"
                            style="background: linear-gradient(to bottom, rgba(0,0,0,0.1), rgba(0,0,0, 0.8)), url({{ asset('/yoga/demos/yoga/images/teacher/3.jpg') }}) no-repeat center center / cover;">
                            <div class="jumbotron-text mt-0 mt-md-auto row align-items-center">
                                <div class="col-md-8">
                                    <div class="testimonial bg-transparent shadow-none border-0 p-0">
                    ...
                    <div class="oc-item">
                        <div class="jumbotron m-0 dark p-5 d-flex justify-content-center align-items-md-end flex-column"
                            style="background: linear-gradient(to bottom, rgba(0,0,0,0.1), rgba(0,0,0, 0.8)), url({{ asset('/yoga/demos/yoga/images/teacher/4.jpg') }}) no-repeat center center / cover;">
                            <div class="jumbotron-text mt-0 mt-md-auto row align-items-center">
                                <div class="col-md-8">
                                    <div class="testimonial bg-transparent shadow-none border-0 p-0">
                    ...
                    <div class="oc-item">
                        <div class="jumbotron m-0 dark p-5 d-flex justify-content-center align-items-md-end flex-column"
                            style="background: linear-gradient(to bottom, rgba(0,0,0,0.1), rgba(0,0,0, 0.8)), url({{ asset('/yoga/demos/yoga/images/teacher/5.jpg') }}) no-repeat center center / cover;">
                            <div class="jumbotron-text mt-0 mt-md-auto row align-items-center">
                                <div class="col-md-8">
                                    <div class="testimonial bg-transparent shadow-none border-0 p-0">
                        ...
                        <div class="col-lg-4 col-md-5 mt-4 mt-md-0 sticky-sidebar-wrap">
                            <div class="sticky-sidebar">
                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                    ...
                                    <a class="nav-link" id="sc-tue-tab" data-bs-toggle="pill" href="#sc-tue"
                                        role="tab" aria-controls="sc-tue" aria-selected="false">Tuesday</a>
                                    <a class="nav-link" id="sc-wed-tab" data-bs-toggle="pill" href="#sc-wed"
                                        role="tab" aria-controls="sc-wed" aria-selected="false">Wednesday</a>
                                    <a class="nav-link" id="sc-thu-tab" data-bs-toggle="pill" href="#sc-thu"
                                        role="tab" aria-controls="sc-thu" aria-selected="false">Thursday</a>
                                    <a class="nav-link" id="sc-fri-tab" data-bs-toggle="pill" href="#sc-fri"
                                        role="tab" aria-controls="sc-fri" aria-selected="false">Friday</a>
                                    <a class="nav-link" id="sc-sat-tab" data-bs-toggle="pill" href="#sc-sat"
                                        role="tab" aria-controls="sc-sat" aria-selected="false">Saturday</a>
                                    ...
                                    <dl class="row g-0 table mb-0">
                                        ...
                                        <dd class="col-sm-9 d-flex justify-content-between align-items-center">
                                            <div class="schedule-desc font-primary">Namaste Yoga<small>- Ruby Vov
                                                    Rails</small></div>
                                            <a href="#"><img
                                                    src="{{ asset('yoga/demos/yoga/images/teacher/thumbs/1.jpg') }}" alt=""
                                        ...
                                        <dd class="col-sm-9 d-flex justify-content-between align-items-center">
                                            <div class="schedule-desc font-primary">Vrikshasana (Tree Pose)<small>- Thodore
                                                    Handle</small></div>
                                            <a href="#"><img
                                                    src="{{ asset('yoga/demos/yoga/images/teacher/thumbs/2.jpg') }}" alt=""
                                                    class="schedule-teacher"></a>
                                        </dd>
                                        ...
                                        <dd class="col-sm-9 d-flex justify-content-between align-items-center">
                                            <div class="schedule-desc font-primary">Naukasana (Boat Pose)<small>- Norman
                                                    Gordon</small></div>
                                            <a href="#"><img
                                                    src="{{ asset('yoga/demos/yoga/images/teacher/thumbs/3.jpg') }}" alt=""
                                                    class="schedule-teacher"></a>
                                        </dd>
                                        ...
                                        <dd class="col-sm-9 d-flex justify-content-between align-items-center">
                                            <div class="schedule-desc font-primary">Paschimottanasana<small>- Jason
                                                    Response</small></div>
                                            <a href="#"><img
                                                    src="{{ asset('yoga/demos/yoga/images/teacher/thumbs/4.jpg') }}" alt=""
                                                    class="schedule-teacher"></a>
                                        </dd>
                                        ...
                                        <dd class="col-sm-9 d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="#"><img
                                                    src="{{ asset('yoga/demos/yoga/images/teacher/thumbs/5.jpg') }}" alt=""
                                                    class="schedule-teacher"></a>
                                        </dd>
            ...
            <div class="section section-price bg-transparent">
                <div class="container">
                    <div class="d-flex justify-content-between align-items-center bottommargin-lg">
                        ...
                        <img src="{{ asset('yoga/demos/yoga/images/yoga-img.svg') }}" alt="Yoga Image"
                        ...
                        <div class="col-md-4 mb-5">
                            <div class="card pricing border-0 shadow text-center">
                                <div class="card-body rounded pt-5 pb-0">
                                    <img src="{{ asset('yoga/demos/yoga/images/yoga-icons/color/svg/mudra_surya.svg') }}"
                    ...
                    <div class="center text-title">
                        <h3><img src="{{ asset('yoga/demos/yoga/images/yoga-icons/outlined/svg/sahasara.svg') }}" alt=""
                                width="20" height="20">Additional Features For Annual Subscriber</h3>
                    </div>
            ...
            <div class="section bg-transparent border-top mb-0">
                <div class="container">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="heading-block border-bottom-0 mb-0" style="max-width: 700px">
                            <div class="fancy-title title-border mb-3">
                                <h5 class="fw-normal color font-body text-uppercase ls1">Beautiful Captured</h5>
                            </div>
                        ...
                        <img src="{{ asset('yoga/demos/yoga/images/yoga-2.svg') }}" alt="Yoga Image"
                            class="d-none d-sm-flex" width="300">
                    </div>
                </div>
            </div>
            <div class="section p-0 m-0">
                <div class="masonry-thumbs grid-container grid-2 grid-sm-3 grid-md-4" data-lightbox="gallery">
                    <a class="grid-item" href="{{ asset('yoga/demos/yoga/images/gallery/1.jpg') }}"
                        data-lightbox="gallery-item"><img src="{{ asset('yoga/demos/yoga/images/gallery/1.jpg') }}"
                            alt="Gallery Thumb 1"></a>
                    <a class="grid-item" href="{{ asset('yoga/demos/yoga/images/gallery/2.jpg') }}"
                        data-lightbox="gallery-item"><img src="{{ asset('yoga/demos/yoga/images/gallery/2.jpg') }}"
                            alt="Gallery Thumb 2"></a>
                    <a class="grid-item" href="{{ asset('yoga/demos/yoga/images/gallery/3.jpg') }}"
                        data-lightbox="gallery-item"><img src="{{ asset('yoga/demos/yoga/images/gallery/3.jpg') }}"
                            alt="Gallery Thumb 3"></a>
                    <a class="grid-item" href="{{ asset('yoga/demos/yoga/images/gallery/4.jpg') }}"
                        data-lightbox="gallery-item"><img src="{{ asset('yoga/demos/yoga/images/gallery/4.jpg') }}"
                            alt="Gallery Thumb 4"></a>
                    <a class="grid-item" href="{{ asset('yoga/demos/yoga/images/gallery/5.jpg') }}"
                        data-lightbox="gallery-item"><img src="{{ asset('yoga/demos/yoga/images/gallery/5.jpg') }}"
                            alt="Gallery Thumb 5"></a>
                    <a class="grid-item" href="{{ asset('yoga/demos/yoga/images/gallery/6.jpg') }}"
                        data-lightbox="gallery-item"><img src="{{ asset('yoga/demos/yoga/images/gallery/6.jpg') }}"
                            alt="Gallery Thumb 6"></a>
                    <a class="grid-item" href="{{ asset('yoga/demos/yoga/images/gallery/7.jpg') }}"
                        data-lightbox="gallery-item"><img src="{{ asset('yoga/demos/yoga/images/gallery/7.jpg') }}"
                            alt="Gallery Thumb 7"></a>
                    <a class="grid-item" href="{{ asset('yoga/demos/yoga/images/gallery/8.jpg') }}"
                        data-lightbox="gallery-item"><img src="{{ asset('yoga/demos/yoga/images/gallery/8.jpg') }}"
                            alt="Gallery Thumb 8"></a>
                    <a class="grid-item" href="{{ asset('yoga/demos/yoga/images/gallery/9.jpg') }}"
                        data-lightbox="gallery-item"><img src="{{ asset('yoga/demos/yoga/images/gallery/9.jpg') }}"
                            alt="Gallery Thumb 9"></a>
                    <a class="grid-item" href="{{ asset('yoga/demos/yoga/images/gallery/10.jpg') }}"
                        data-lightbox="gallery-item"><img src="{{ asset('yoga/demos/yoga/images/gallery/10.jpg') }}"
                            alt="Gallery Thumb 10"></a>
                    <a class="grid-item" href="{{ asset('yoga/demos/yoga/images/gallery/11.jpg') }}"
                        data-lightbox="gallery-item"><img src="{{ asset('yoga/demos/yoga/images/gallery/11.jpg') }}"
                            alt="Gallery Thumb 11"></a>
                    <a class="grid-item" href="{{ asset('yoga/demos/yoga/images/gallery/12.jpg') }}"
                        data-lightbox="gallery-item"><img src="{{ asset('yoga/demos/yoga/images/gallery/12.jpg') }}"
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="heading-block border-bottom-0 bottommargin-sm">
                                <div class="fancy-title title-border mb-3">
                                    <h5 class="fw-normal color font-body text-uppercase ls1">Yoga Poses</h5>
                                </div>
                                <h2 class="fw-bold nott" style="font-size: 42px; letter-spacing: -1px;">Check out some of
                                    our Yoga Poses Videos.</h2>
                            </div>
                            <p class="mb-5 lead mb-0" style="line-height: 1.7;">Monotonectally pursue intuitive catalysts
                                for change for extensible materials. Intrinsicly fabricate principle-centered web-readiness
                                with virtual.</p>
                        </div>
                    </div>
                </div>
