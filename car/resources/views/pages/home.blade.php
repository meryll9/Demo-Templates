...
@section('content')
    <!-- Slider
      ============================================= -->
    <section id="slider" class="slider-element swiper_wrapper min-vh-60 min-vh-md-100" data-dots="true" data-loop="true"
        data-grab="false">
                        ...
                        <div class="slider-caption top-left">
                            <div>
                                ...
                                <a href="demos/car/car-single.html"
                                    class="button button-rounded button-border button-white button-light nott">View
                                    Details</a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide-bg"
                        style="background-image: url({{ asset('/car/demos/car/images/hero-slider/4.jpg') }});"></div>
                </div>
                <div class="swiper-slide dark">
                    <div class="container">
                    ...
                    <div class="swiper-slide-bg"
                        style="background-image: url({{ asset('/car/demos/car/images/hero-slider/2.jpg') }});"></div>
                </div>
                <div class="swiper-slide dark">
                    <div class="container">
                    ...
                    <div class="swiper-slide-bg"
                        style="background-image: url({{ asset('/car/demos/car/images/hero-slider/3.jpg') }});"></div>
                </div>
            </div>
    ...
    <section id="content" class="clearfix">
        ...
        <div class="content-wrap pb-0" style="padding-top: 1px">
            ...
            <!-- Masonry Thums
        ============================================= -->
            <div class="row m-0 dark" data-height-xs="500" data-height-sm="500" data-height-md="350" data-height-lg="350"
                data-height-xl="350">
                <a href="demos/car/car-single.html" class="col-md-4 image_fade border-right"
                    style="background: url({{ asset('/car/demos/car/images/categories/1.jpg') }}) no-repeat center center / cover;">
                ...
                <a href="demos/car/car-accessories.html" class="col-md-4 image_fade p-0 border-right"
                    style="background: url({{ asset('/car/demos/car/images/categories/2.jpg') }}) no-repeat center center / cover;">
                    <div class="bg-overlay">
                        <div class="bg-overlay-content text-overlay-mask dark align-items-end justify-content-start">
                            <div class="portfolio-desc py-0">
                ...
                <a href="demos/car/car-contact.html" class="col-md-4 image_fade p-0"
                    style="background: url({{ asset('/car/demos/car/images/categories/3.jpg') }}) no-repeat center center / cover;">
                    <div class="bg-overlay">
                        <div class="bg-overlay-content text-overlay-mask dark align-items-end justify-content-start">
                            <div class="portfolio-desc py-0">
                                <h3>Our Stores</h3>
        ...
        ============================================= -->
            <div class="section mt-0 clearfix" style="padding: 100px 0">
                <div class="running-car mt-6">
                    <img class="car" src="{{ asset('car/demos/car/images/moving-car/car.jpg') }}" alt="Image">
                    <img class="wheel" src="{{ asset('car/demos/car/images/moving-car/car-tier.png') }}"
                        alt="Image">
                </div>
                <div class="container clearfix">
                    <div class="row clearfix" style="position: relative;">
                        <div class="col-lg-6 offset-lg-6">
                            ...
                            <p>Assertively iterate enterprise-wide portals through synergistic products. Efficiently build
                                adaptive schemas after transparent quality vectors. Phosfluorescently optimize competitive
                                resources after extensive convergence. Rapidiously optimize high-quality meta-services via
                                distributed architectures. Credibly deliver 24/365.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row clearfix topmargin bottommargin">
                    ...
                    <div class="col-lg-4 col-md-6 topmargin bottommargin-sm">
                        ...
                        <div class="heading-block border-bottom-0">
                            <h2 class="nott ls0" style="font-size: 44px; line-height: 1.2">Explore the New Mercedec
                                Benz</h2>
                        </div>
                        <span style="color: #BBB;">Eum nihil pretium quas aliqua, laboris ipsam diam congue natoque mollitia
                            occaecati! Cubilia pede, numquam fringilla proident dis? Molestias repellat.<br><br>Quas
                            perferendis urna, officiis necessitatibus deserunt recusandae urna ullamco hac do beatae cubilia
                            iste dolorum, facilisi? Sit, hic, varius! Sollicitudin.<br><br>Nostrum feugiat beatae proident
                            porro eleifend adipiscing nostrud aliquid sit.</span>
                        <div class="clear"></div>
                        <a href="demos/car/car-single.html"
                            class="button button-rounded button-black button-dark ms-0 topmargin-sm clearfix">Know More</a>

                    </div>

                    <div class="col-lg-4 d-md-none d-lg-block center">
                        <img src="{{ asset('car/demos/car/images/features/bg1.png') }}" alt="Car">
                    </div>
        ...
        ============================================= -->
            <div class="section mb-0"
                style="background: #FFF url({{ asset('/car/demos/car/images/revslider/bg.png') }}) center 70% no-repeat; background-size: 100% auto; padding: 100px 0 10px">
                <div class="container">
                    <div id="rev_slider_424_1_wrapper" class="rev_slider_wrapper my-0 p-0 fullwidthbanner-container mx-auto"
                        data-alias="image-gallery" style="max-width: 1240px;">
                        ...
                        <div id="rev_slider_424_1" class="rev_slider fullwidthabanner" style="display:none;"
                            ...
                            <ul>
                                ...
                                <li data-index="rs-1479" data-transition="slidefromleft" data-slotamount="default"
                                    ...
                                    data-thumb="{{ asset('car/demos/car/images/revslider/1.png') }}" data-rotate="0"
                                    data-saveperformance="off" data-title="BMW 3 Series Sedan" data-param1="Sedan"
                                    data-param2="" data-param3="" data-param4="" data-param5="" data-param6=""
                                    data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    <!-- MAIN IMAGE -->
                                    <img src="{{ asset('car/include/rs-plugin/demos/assets/images/dummy.png') }}"
                                        alt="Image" data-lazyload="{{ asset('car/demos/car/images/revslider/1.png') }}"
                                        data-bgposition="left center" data-bgfit="contain" data-bgrepeat="no-repeat"
                                        class="rev-slidebg" data-no-retina>
                                    <!-- LAYER NR. 2 -->
                                    <div class="tp-caption font-body ls2 text-uppercase tp-resizeme" id="slide-1479-layer-1"
                                        ...
                                        style="z-index: 6; min-width: 370px; max-width: 370px; color: #EEE; white-space: nowrap;">
                                        BMW - 3 Series </div>

                                    <!-- LAYER NR. 3 -->
                                    <div class="tp-caption font-primary text-uppercase fw-bold tp-resizeme"
                                        id="slide-1479-layer-2" data-x="['left','left','left','left']"
                                        data-hoffset="['30','30','30','30']" data-y="['top','top','top','top']"
                                        data-voffset="['30','30','92','68']" data-fontsize="['40','40','30','20']"
                                        data-lineheight="['40','40','30','20']" data-width="['500','500','400','210']"
                                        data-height="none" data-whitespace="normal" data-type="text" data-actions=''
                                        ...
                                        style="z-index: 7; color: #FFF; letter-spacing: 2px; white-space: normal;">BMW 3
                                        Series Sedan</div>

                                    <!-- LAYER NR. 4 -->
                                    <div class="tp-caption font-primary text-uppercase tp-resizeme" id="slide-1479-layer-3"
                                        data-x="['right','right','right','right']" data-hoffset="['30','30','30','30']"
                                        data-y="['top','top','top','top']" data-voffset="['115','115','215','154']"
                                        data-fontsize="['60','60','30','20']" data-lineheight="['23','23','21','20']"
                                        ...
                                        data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                        style="z-index: 8; min-width: 360px; max-width: 360px; color: #EEE; font-weight: 700; white-space: normal;">
                                        $2,300</div>
                                    ...
                                    <div class="tp-caption font-body ls0 tp-resizeme" id="slide-1479-layer-4"
                                        ...
                                        data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                        style="z-index: 8; min-width: 360px; max-width: 360px; color: #EEE; white-space: normal;">
                                ...
                                <li data-index="rs-1480" data-transition="slidefromleft" data-slotamount="default"
                                    data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                                    data-easeout="default" data-masterspeed="300"
                                    data-thumb="{{ asset('car/demos/car/images/revslider/2.png') }}" data-rotate="0"
                                    data-saveperformance="off" data-title="Audi A4 - White" data-param1="Sedan"
                                    data-param2="" data-param3="" data-param4="" data-param5="" data-param6=""
                                    data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    <!-- MAIN IMAGE -->
                                    <img src="{{ asset('car/include/rs-plugin/demos/assets/images/dummy.png') }}"
                                        alt="Image" data-lazyload="{{ asset('car/demos/car/images/revslider/2.png') }}"
                                        data-bgposition="left center" data-bgfit="contain" data-bgrepeat="no-repeat"
                                        class="rev-slidebg" data-no-retina>
                                    <!-- LAYER NR. 2 -->
                                    <div class="tp-caption font-body ls2 text-uppercase tp-resizeme" id="slide-1480-layer-1"
                                        data-x="['left','left','left','left']" data-hoffset="['30','30','30','30']"
                                        data-y="['top','top','top','top']" data-voffset="['0','0','0','90']"
                                        data-fontsize="['15','15','13','13']" data-lineheight="['15','15','13','13']"
                                        data-width="['370','370','290','210']" data-height="none" data-whitespace="nowrap"
                                    ...
                                    <!-- LAYER NR. 3 -->
                                    <div class="tp-caption font-primary text-uppercase fw-bold tp-resizeme"
                                        id="slide-1480-layer-2" data-x="['left','left','left','left']"
                                        data-hoffset="['30','30','30','30']" data-y="['top','top','top','top']"
                                        data-voffset="['30','30','92','68']" data-fontsize="['40','40','30','20']"
                                        data-lineheight="['40','40','30','20']" data-width="['500','500','400','210']"
                                        data-height="none" data-whitespace="normal" data-type="text" data-actions=''
                                        ...
                                        data-frames='[{"from":"y:20px;opacity:0;","speed":2000,"to":"o:1;","delay":600,"ease":"Power4.easeOut"},{"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]'
                                        data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                        style="z-index: 7; color: #FFF; letter-spacing: 2px; white-space: normal;">Audi A4 -
                                        Sedan</div>

                                    <!-- LAYER NR. 4 -->
                                    <div class="tp-caption font-primary text-uppercase tp-resizeme" id="slide-1480-layer-3"
                                        data-x="['right','right','right','right']" data-hoffset="['30','30','30','30']"
                                        data-y="['top','top','top','top']" data-voffset="['115','115','215','154']"
                                        data-fontsize="['60','60','30','20']" data-lineheight="['23','23','21','20']"
                                        data-width="['360','360','290','210']" data-height="none" data-whitespace="normal"
                                ...
                                <li data-index="rs-1481" data-transition="slidefromleft" data-slotamount="default"
                                    data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                                    data-easeout="default" data-masterspeed="300"
                                    data-thumb="{{ asset('car/demos/car/images/revslider/3.png') }}" data-rotate="0"
                                    data-saveperformance="off" data-title="Brand New Mustand" data-param1="Sedan"
                                    data-param2="" data-param3="" data-param4="" data-param5="" data-param6=""
                                    data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    <!-- MAIN IMAGE -->
                                    <img src="{{ asset('car/include/rs-plugin/demos/assets/images/dummy.png') }}"
                                        alt="Image" data-lazyload="{{ asset('car/demos/car/images/revslider/3.png') }}"
                                        data-bgposition="left center" data-bgfit="contain" data-bgrepeat="no-repeat"
                                        class="rev-slidebg" data-no-retina">

                                    <!-- LAYER NR. 2 -->
                                    <div class="tp-caption font-body ls2 text-uppercase tp-resizeme" id="slide-1481-layer-1"
                                        data-x="['left','left','left','left']" data-hoffset="['30','30','30','30']"
                                        data-y="['top','top','top','top']" data-voffset="['0','0','0','90']"
                                        data-fontsize="['15','15','13','13']" data-lineheight="['15','15','13','13']"
                                        data-width="['370','370','290','210']" data-height="none" data-whitespace="nowrap"
                                    ...
                                    <!-- LAYER NR. 3 -->
                                    <div class="tp-caption font-primary text-uppercase fw-bold tp-resizeme"
                                        id="slide-1481-layer-2" data-x="['left','left','left','left']"
                                        data-hoffset="['30','30','30','30']" data-y="['top','top','top','top']"
                                        data-voffset="['30','30','92','68']" data-fontsize="['40','40','30','20']"
                                        data-lineheight="['40','40','30','20']" data-width="['500','500','400','210']"
                                        data-height="none" data-whitespace="normal" data-type="text" data-actions=''
                                        ...
                                        data-frames='[{"from":"y:20px;opacity:0;","speed":2000,"to":"o:1;","delay":600,"ease":"Power4.easeOut"},{"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]'
                                        data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                        style="z-index: 7; color: #FFF; letter-spacing: 2px; white-space: normal;">Brand New
                                        Mustang</div>

                                    <!-- LAYER NR. 4 -->
                                    <div class="tp-caption font-primary text-uppercase tp-resizeme" id="slide-1481-layer-3"
                                        data-x="['right','right','right','right']" data-hoffset="['30','30','30','30']"
                                        data-y="['top','top','top','top']" data-voffset="['115','115','215','154']"
                                        data-fontsize="['60','60','30','20']" data-lineheight="['23','23','21','20']"
                                        data-width="['360','360','290','210']" data-height="none" data-whitespace="normal"
                                ...
                                <li data-index="rs-1482" data-transition="slidefromleft" data-slotamount="default"
                                    data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                                    data-easeout="default" data-masterspeed="300"
                                    data-thumb="{{ asset('car/demos/car/images/revslider/4.png') }}" data-rotate="0"
                                    data-saveperformance="off" data-title="Audi A3 Cabriolet" data-param1="Convertible"
                                    data-param2="" data-param3="" data-param4="" data-param5="" data-param6=""
                                    data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    <!-- MAIN IMAGE -->
                                    <img src="{{ asset('car/include/rs-plugin/demos/assets/images/dummy.png') }}"
                                        alt="Image" data-lazyload="{{ asset('car/demos/car/images/revslider/4.png') }}"
                                        data-bgposition="left center" data-bgfit="contain" data-bgrepeat="no-repeat"
                                        class="rev-slidebg" data-no-retina>
                                    <!-- LAYER NR. 2 -->
                                    <div class="tp-caption font-body ls2 text-uppercase tp-resizeme" id="slide-1482-layer-1"
                                        data-x="['left','left','left','left']" data-hoffset="['30','30','30','30']"
                                        ...
                                        data-responsive_offset="on"
                                        style="z-index: 6; min-width: 370px; max-width: 370px; color: #EEE; white-space: nowrap;">
                                        Audi Convertible</div>

                                    <!-- LAYER NR. 3 -->
                                    <div class="tp-caption font-primary text-uppercase fw-bold tp-resizeme"
                                        id="slide-1482-layer-2" data-x="['left','left','left','left']"
                                        data-hoffset="['30','30','30','30']" data-y="['top','top','top','top']"
                                        data-voffset="['70','70','92','68']" data-fontsize="['40','40','30','20']"
                                        data-lineheight="['40','40','30','20']" data-width="['500','500','400','210']"
                                        data-height="none" data-whitespace="normal" data-type="text" data-actions=''
                                        data-basealign="slide" data-responsive_offset="on"
                                        data-textAlign="['left','left','left','left']"
                                        data-frames='[{"from":"y:20px;opacity:0;","speed":2000,"to":"o:1;","delay":600,"ease":"Power4.easeOut"},{"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]'
                                        data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                        style="z-index: 7; color: #FFF; letter-spacing: 2px; white-space: normal;">Audi A3
                                        cabriolet</div>

                                    <!-- LAYER NR. 4 -->
                                    <div class="tp-caption font-primary text-uppercase tp-resizeme" id="slide-1482-layer-3"
                                        data-x="['right','right','right','right']" data-hoffset="['30','30','30','30']"
                                        data-y="['top','top','top','top']" data-voffset="['115','115','215','154']"
                                        data-fontsize="['60','60','30','20']" data-lineheight="['23','23','21','20']"
                                        data-width="['360','360','290','210']" data-height="none" data-whitespace="normal"
                                ...
                                <li data-index="rs-1483" data-transition="slidefromleft" data-slotamount="default"
                                    data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                                    data-easeout="default" data-masterspeed="300"
                                    data-thumb="{{ asset('car/demos/car/images/revslider/5.png') }}" data-rotate="0"
                                    data-saveperformance="off" data-title="Mercedes-Benz E-Class" data-param1="Sedan"
                                    data-param2="" data-param3="" data-param4="" data-param5="" data-param6=""
                                    data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    <!-- MAIN IMAGE -->
                                    <img src="{{ asset('car/include/rs-plugin/demos/assets/images/dummy.png') }}"
                                        alt="Image" data-lazyload="{{ asset('car/demos/car/images/revslider/5.png') }}"
                                        data-bgposition="left center" data-bgfit="contain" data-bgrepeat="no-repeat"
                                        class="rev-slidebg" data-no-retina>
                                    <!-- LAYER NR. 2 -->
                                    <div class="tp-caption font-body ls2 text-uppercase tp-resizeme" id="slide-1483-layer-1"
                                        data-x="['left','left','left','left']" data-hoffset="['30','30','30','30']"
                                        data-y="['top','top','top','top']" data-voffset="['40','40','40','90']"
                                        data-fontsize="['15','15','13','13']" data-lineheight="['15','15','13','13']"
                                        data-width="['370','370','290','210']" data-height="none" data-whitespace="nowrap"
                                    ...
                                    <!-- LAYER NR. 3 -->
                                    <div class="tp-caption font-primary text-uppercase fw-bold tp-resizeme"
                                        id="slide-1483-layer-2" data-x="['left','left','left','left']"
                                        data-hoffset="['30','30','30','30']" data-y="['top','top','top','top']"
                                        data-voffset="['70','70','92','68']" data-fontsize="['40','40','30','20']"
                                        data-lineheight="['40','40','30','20']" data-width="['500','500','400','210']"
                                        data-height="none" data-whitespace="normal" data-type="text" data-actions=''
                                        ...
                                        data-frames='[{"from":"y:20px;opacity:0;","speed":2000,"to":"o:1;","delay":600,"ease":"Power4.easeOut"},{"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]'
                                        data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                        style="z-index: 7; color: #FFF; letter-spacing: 2px; white-space: normal;">
                                        Mercedes-Benz E-Class</div>

                                    <!-- LAYER NR. 4 -->
                                    <div class="tp-caption font-primary text-uppercase tp-resizeme" id="slide-1483-layer-3"
                                        data-x="['right','right','right','right']" data-hoffset="['30','30','30','30']"
                                        data-y="['top','top','top','top']" data-voffset="['115','115','215','154']"
                                        data-fontsize="['60','60','30','20']" data-lineheight="['23','23','21','20']"
                                        data-width="['360','360','290','210']" data-height="none" data-whitespace="normal"
            ...
            <!-- 360 degree car
        ============================================= -->
            <div class="section dark mb-0 clearfix"
                style="background: #FFF url({{ asset('/car/demos/car/images/1.jpg') }}) right bottom no-repeat; background-size: cover; padding: 80px 0 40px">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-10">
                                    <div class="heading-block topmargin-sm border-0">
                                        <h3
                                            style="text-transform: none; font-size: 36px; letter-spacing: 0px; font-weight: 700;">
                                            Select other Models</h3>
                                        <span>Intrinsicly formulate plug-and-play systems with interactive communities.
                                            Quickly aggregate plug-and-play.</span>
                                    </div>
                                    <form id="login-form" name="login-form" class="row mb-0" action="#"
                                        method="post">

                                        <div class="col-12 form-group">
                                            <select class="selectpicker w-100 customjs" title="Select Brand"
                                        ...
                                        <div class="col-12 form-group">
                                            <select class="selectpicker w-100 customjs" data-size="6"
                                                data-live-search="true" title="Select Model" style="line-height: 30px;">
                                                <optgroup label="AUDI">
                                                ...
                                                <optgroup label="MERCEDES-BENZ">
                                                    ...
                                                    <option value="E-Class-Hybrid">2021 Mercedes-Benz E-Class Hybrid
                                                    </option>
                                                    <option value="Maybach-S600">2021 Mercedes-Benz Maybach S600</option>
                                                    <option value="B-Class-Electric-Drive">2021 Mercedes-Benz B-Class
                                        ...
                                        <div class="col-12 form-group">
                                            <button class="button button-rounded w-100 fw-normal m-0"
            ...
            <div class="section m-0 bg-transparent clearfix" style="padding: 100px 0;">
                <div class="container clearfix">
                    <div class="heading-block center">
                        <div class="before-heading text-uppercase ls1" style="font-size: 13px; font-style: normal;">Lorem
                    ...
                    <div id="portfolio" class="portfolio row grid-container gutter-20 col-mb-30" data-layout="fitRows">
                        ...
                        <article class="portfolio-item col-12 col-sm-6 col-lg-4 cf-sedan">
                            <div class="grid-inner">
                                <div class="portfolio-image">
                                    <a href="demos/car/car-single.html">
                                        <img src="{{ asset('car/demos/car/images/filter-cars/1.jpg') }}"
                        ...
                        <article class="portfolio-item col-12 col-sm-6 col-lg-4 cf-suv">
                            <div class="grid-inner">
                                <div class="portfolio-image">
                                    <a href="demos/car/car-single.html">
                                        <img src="{{ asset('car/demos/car/images/filter-cars/2.jpg') }}"
                                            alt="Open Imagination">
                                        <div class="filter-p-pricing">
                                            <span class="p-price fw-bold ls1">$32,568</span>
                                            <span class="p-price-msrp">MSRP : <strong>$35,698</strong></span>
                        ...
                        <article class="portfolio-item col-12 col-sm-6 col-lg-4 cf-cabriolet">
                            <div class="grid-inner">
                                <div class="portfolio-image">
                                    <a href="demos/car/car-single.html">
                                        <img src="{{ asset('car/demos/car/images/filter-cars/3.jpg') }}"
                                            alt="Open Imagination">
                                        <div class="filter-p-pricing">
                        ...
                        <article class="portfolio-item col-12 col-sm-6 col-lg-4 cf-cuv">
                            <div class="grid-inner">
                                <div class="portfolio-image">
                                    <a href="demos/car/car-single.html">
                                        <img src="{{ asset('car/demos/car/images/filter-cars/4.jpg') }}"
                                            alt="Open Imagination">
                                        <div class="filter-p-pricing">
                                            <span class="p-price fw-bold ls1">$32,568</span>
                                            <span class="p-price-msrp">MSRP : <strong>$35,698</strong></span>
                        ...
                        <article class="portfolio-item col-12 col-sm-6 col-lg-4 cf-supercar">
                            <div class="grid-inner">
                                <div class="portfolio-image">
                                    <a href="demos/car/car-single.html">
                                        <img src="{{ asset('car/demos/car/images/filter-cars/5.jpg') }}"
                                            alt="Open Imagination">
                                        <div class="filter-p-pricing">
                                            <span class="p-price fw-bold ls1">$32,568</span>
                                            <span class="p-price-msrp">MSRP : <strong>$35,698</strong></span>
                        ...
                        <article class="portfolio-item col-12 col-sm-6 col-lg-4 cf-hatchback">
                            <div class="grid-inner">
                                <div class="portfolio-image">
                                    <a href="demos/car/car-single.html">
                                        <img src="{{ asset('car/demos/car/images/filter-cars/6.jpg') }}"
                                            alt="Open Imagination">
                                        <div class="filter-p-pricing">
                                            <span class="p-price fw-bold ls1">$32,568</span>
                                            <span class="p-price-msrp">MSRP : <strong>$35,698</strong></span>
                ...
                <div class="row h-100 align-items-stretch">
                    ...
                    <div class="col-md-6 col-12 p-0 dark videoplay-on-hover">
                        <a href="demos/car/car-listing.html">
                            <div class="vertical-middle center">
                                <div class="before-heading text-uppercase ls1"
                                    style="font-size: 14px; font-style: normal; color: #EEE">Mercedes</div>
                                <h2 class="mb-0 ls1">Mercedes-AMG GT</h2>
                            </div>
                            <div class="video-wrap">
                                <video id="slide-video-1" poster="{{ asset('car/demos/car/images/videos/1.jpg') }}"
                                    preload="auto" loop muted>
                                    <source src="{{ asset('car/demos/car/images/videos/1.mp4') }}" type='video/mp4' />
                                </video>
                    ...
                    <div class="col-md-6 col-12 p-0 dark videoplay-on-hover">
                        <a href="demos/car/car-listing.html">
                            ...
                            <div class="video-wrap">
                                <video id="slide-video-2" poster="{{ asset('car/demos/car/images/videos/2.jpg') }}"
                                    preload="auto" loop muted>
                                    <source src="{{ asset('car/demos/car/images/videos/2.mp4') }}" type='video/mp4' />
                                </video>
                    ...
                    <div class="col-md-6 col-12 p-0 dark videoplay-on-hover">
                        <a href="demos/car/car-listing.html">
                            <div class="vertical-middle center">
                                <div class="before-heading uppercase ls1"
                                    style="font-size: 14px; font-style: normal; color: #EEE">BMW Auto</div>
                                <h2 class="mb-0 ls1">BMW Z4 Roadster</h2>
                            </div>
                            <div class="video-wrap">
                                <video id="slide-video-3" poster="{{ asset('car/demos/car/images/videos/3.jpg') }}"
                                    preload="auto" loop muted>
                                    <source src="{{ asset('car/demos/car/images/videos/3.mp4') }}" type='video/mp4' />
                                </video>
                                <div class="video-overlay" style="background: rgba(0,0,0,0.4);"></div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-6 col-12 p-0 dark videoplay-on-hover">
                        <a href="demos/car/car-listing.html">
                            <div class="vertical-middle center">
                                <div class="before-heading uppercase ls1"
                                    style="font-size: 14px; font-style: normal; color: #EEE">Mercedes Benz</div>
                                <h2 class="mb-0 ls1">Mercedes-COUPÉ GLE 63</h2>
                            </div>
                            <div class="video-wrap">
                                <video id="slide-video-4" poster="{{ asset('car/demos/car/images/videos/4.jpg') }}"
                                    preload="auto" loop muted>
                                    <source src="{{ asset('car/demos/car/images/videos/4.mp4') }}" type='video/mp4' />
                                </video>
                                <div class="video-overlay" style="background: rgba(0,0,0,0.3);"></div>
                            </div>
                        </a>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 center">
                            <div>
                                ...
                                <div class="counter"><span data-from="10" data-to="11365" data-refresh-interval="50"
                        ...
                        <div class="col-lg-3 col-md-6 center">
                            <div>
                                ...
                                <div class="counter"><span data-from="10" data-to="145" data-refresh-interval="50"
                        ...
                        <div class="col-lg-3 col-md-6 center">
                            <div>
                                ...
                                <div class="counter"><span data-from="10" data-to="50" data-refresh-interval="85"
                        ...
                        <div class="col-lg-3 col-md-6 center">
                            <div>
                                ...
                                <div class="counter"><span data-from="10" data-to="7664" data-refresh-interval="30"
        ...
        ============================================= -->
            <div class="section m-0 clearfix"
                style="background: #FFF url({{ asset('/car/demos/car/images/features/section-bg.jpg') }}) left bottom no-repeat; background-size: cover; padding: 140px 0">
                <div class="container clearfix">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-9">
                            <div class="heading-block">
                                <h3 style="font-size: 58px; line-height: 56px; letter-spacing: -2px">Our Fleet<br>Your Fleet
                                </h3>
                            </div>
                            <p>Assertively iterate enterprise-wide portals through synergistic products. Efficiently build
                                adaptive schemas after transparent quality vectors. Phosfluorescently optimize competitive
                                ...
                                <div class="col-md-6">
                                    <div class="feature-box fbox-plain media-box">
                                        ...
                                        <div class="fbox-content" style="margin-top: 25px">
                                            ...
                                            <p class="fw-light" style="color: #666;">Lorem ipsum dolor sit amet,
                                                consectetur adipisicing elit. Eligendi rem, facilis nobis voluptatum est
        ...
        ============================================= -->
            <div class="section m-0 clearfix"
                style="background: #FFF url({{ asset('/car/demos/car/images/footer-bg.jpg') }}) center bottom no-repeat; background-size: cover; height: 770px">
                <div class="mx-auto dark center clearfix" style="max-width: 570px">
                    <div class="heading-block dark bottommargin-sm border-0">
                        ...
                        <p style="color: #DDD; margin-top: 10px">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                            Esse ipsa necessitatibus rem facere perspiciatis neque laborum est, illum commodi sunt, nobis
                            voluptas.</p>
                    </div>
                    <a href="demos/car/car-contact.html" class="uppercase fw-bold ls2"
                        style="color: #FFF; font-size: 12px; border-bottom: 1px solid #FFF">Request a Quote</a> &rarr;
                </div>
            </div>
        </div>
    </section><!-- #content end -->
