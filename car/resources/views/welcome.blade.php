				...
				<div class="container-fluid">
					<div class="header-row flex-lg-row-reverse">
						...
						<div id="logo" class="me-lg-0 ms-lg-auto">
							<a href="demo-car.html" class="standard-logo"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
							<a href="demo-car.html" class="retina-logo"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
													...
													<li class="menu-item">
														<div class="widget text-center">
															...
															<div class="owl-carousel image-carousel carousel-widget" data-margin="20" data-nav="false" data-pagi="true" data-items-xs="1" data-items-sm="2" data-items-md="4" data-items-lg="6" data-items-xl="6">
																<div class="oc-item center"><a href="demo-car-single.html"><img src="{{asset('car/demos/car/images/mega-menu/1.png')}}" alt="Car">BMW 1 Series ActiveE</a></div>
																<div class="oc-item center"><a href="demo-car-single.html"><img src="{{asset('car/demos/car/images/mega-menu/4.png')}}" alt="Car">Mercedes-Benz S-Class</a></div>
																<div class="oc-item center"><a href="demo-car-single.html"><img src="{{asset('car/demos/car/images/mega-menu/5.png')}}" alt="Car">Gran Turismo</a></div>
																<div class="oc-item center"><a href="demo-car-single.html"><img src="{{asset('car/demos/car/images/mega-menu/6.png')}}" alt="Car">Mclaren 675LT SPIDER</a></div>
																<div class="oc-item center"><a href="demo-car-single.html"><img src="{{asset('car/demos/car/images/mega-menu/7.png')}}" alt="Car">Honda City</a></div>
																<div class="oc-item center"><a href="demo-car-single.html"><img src="{{asset('car/demos/car/images/mega-menu/8.png')}}" alt="Car">Toyota Qualis</a></div>
																<div class="oc-item center"><a href="demo-car-single.html"><img src="{{asset('car/demos/car/images/mega-menu/9.png')}}" alt="Car">Honda WR-V</a></div>
																<div class="oc-item center"><a href="demo-car-single.html"><img src="{{asset('car/demos/car/images/mega-menu/10.png')}}" alt="Car">Suzuki Breeza</a></div>
																<div class="oc-item center"><a href="demo-car-single.html"><img src="{{asset('car/demos/car/images/mega-menu/2.png')}}" alt="Car">Chevrolet Spark</a></div>
																<div class="oc-item center"><a href="demo-car-single.html"><img src="{{asset('car/demos/car/images/mega-menu/3.png')}}" alt="Car">Honda JaZZ</a></div>
			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide dark">
						...
						<div class="swiper-slide-bg" style="background-image: url({{asset('/car/demos/car/images/hero-slider/4.jpg')}});"></div>
					</div>
					<div class="swiper-slide dark">
						<div class="container">
						...
						<div class="swiper-slide-bg" style="background-image: url({{asset('/car/demos/car/images/hero-slider/2.jpg')}});"></div>
					</div>
					<div class="swiper-slide dark">
						<div class="container">
						...
						<div class="swiper-slide-bg" style="background-image: url({{asset('/car/demos/car/images/hero-slider/3.jpg')}});"></div>
					</div>
				</div>
		...
		<section id="content" class="clearfix">
			...
			<div class="content-wrap pb-0" style="padding-top: 1px">
				...
				<div class="row m-0 dark" data-height-xs="500" data-height-sm="500" data-height-md="350" data-height-lg="350" data-height-xl="350">
					<a href="demos/car/car-single.html" class="col-md-4 image_fade border-right" style="background: url({{asset('/car/demos/car/images/categories/1.jpg')}}) no-repeat center center / cover;">
					...
					<a href="demos/car/car-accessories.html" class="col-md-4 image_fade p-0 border-right" style="background: url({{asset('/car/demos/car/images/categories/2.jpg')}}) no-repeat center center / cover;">
						<div class="bg-overlay">
							<div class="bg-overlay-content text-overlay-mask dark align-items-end justify-content-start">
								<div class="portfolio-desc py-0">
					...
					<a href="demos/car/car-contact.html" class="col-md-4 image_fade p-0" style="background: url({{asset('/car/demos/car/images/categories/3.jpg')}}) no-repeat center center / cover;">
						<div class="bg-overlay">
							<div class="bg-overlay-content text-overlay-mask dark align-items-end justify-content-start">
								<div class="portfolio-desc py-0">
									<h3>Our Stores</h3>
				...
				<div class="section mt-0 clearfix" style="padding: 100px 0">
					<div class="running-car mt-6">
						...
						<img class="wheel" src="{{asset('car/demos/car/images/moving-car/car-tier.png')}}" alt="Image">
					</div>
				...
				<div class="container clearfix">
					...
					<div class="row clearfix topmargin bottommargin">
						...
						<div class="col-lg-4 col-md-6 topmargin bottommargin-sm">
							...
							<div class="clear"></div>
							<a href="demos/car/car-single.html" class="button button-rounded button-black button-dark ms-0 topmargin-sm clearfix">Know More</a>
				...
				<!-- Revolution Slider
				============================================= -->
				<div class="section mb-0" style="background: #FFF url({{asset('/car/demos/car/images/revslider/bg.png')}}) center 70% no-repeat; background-size: 100% auto; padding: 100px 0 10px">
					<div class="container">
						<div id="rev_slider_424_1_wrapper" class="rev_slider_wrapper my-0 p-0 fullwidthbanner-container mx-auto" data-alias="image-gallery" style="max-width: 1240px;">
							...
							<div id="rev_slider_424_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.2.0">
								<ul>	<!-- SLIDE  -->
									<!-- SLIDE  -->
									<li data-index="rs-1479" data-transition="slidefromleft" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('car/demos/car/images/revslider/1.png')}}"  data-rotate="0"  data-saveperformance="off"  data-title="BMW 3 Series Sedan" data-param1="Sedan" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
										<!-- MAIN IMAGE -->
										<img src="{{asset('car/include/rs-plugin/demos/assets/images/dummy.png')}}"  alt="Image"  data-lazyload="{{asset('car/demos/car/images/revslider/1.png')}}" data-bgposition="left center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
										<!-- LAYER NR. 2 -->
									...
									<!-- SLIDE  -->
									<li data-index="rs-1480" data-transition="slidefromleft" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('car/demos/car/images/revslider/2.png')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Audi A4 - White" data-param1="Sedan" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
										<!-- MAIN IMAGE -->
										<img src="{{asset('car/include/rs-plugin/demos/assets/images/dummy.png')}}"  alt="Image"  data-lazyload="{{asset('car/demos/car/images/revslider/2.png')}}" data-bgposition="left center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
										<!-- LAYER NR. 2 -->
										<div class="tp-caption font-body ls2 text-uppercase tp-resizeme"
									...
									<li data-index="rs-1481" data-transition="slidefromleft" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('car/demos/car/images/revslider/3.png')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Brand New Mustand" data-param1="Sedan" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
										<!-- MAIN IMAGE -->
										<img src="{{asset('car/include/rs-plugin/demos/assets/images/dummy.png')}}" alt="Image"  data-lazyload="{{asset('car/demos/car/images/revslider/3.png')}}" data-bgposition="left center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina">
									...
									<!-- SLIDE  -->
									<li data-index="rs-1482" data-transition="slidefromleft" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('car/demos/car/images/revslider/4.png')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Audi A3 Cabriolet" data-param1="Convertible" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
										<!-- MAIN IMAGE -->
										<img src="{{asset('car/include/rs-plugin/demos/assets/images/dummy.png')}}"  alt="Image"  data-lazyload="{{asset('car/demos/car/images/revslider/4.png')}}" data-bgposition="left center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
										<!-- LAYER NR. 2 -->
										<div class="tp-caption font-body ls2 text-uppercase tp-resizeme"
									...
									<!-- SLIDE  -->
									<li data-index="rs-1483" data-transition="slidefromleft" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('car/demos/car/images/revslider/5.png')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Mercedes-Benz E-Class" data-param1="Sedan" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
										<!-- MAIN IMAGE -->
										<img src="{{asset('car/include/rs-plugin/demos/assets/images/dummy.png')}}"  alt="Image"  data-lazyload="{{asset('car/demos/car/images/revslider/5.png')}}" data-bgposition="left center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
										<!-- LAYER NR. 2 -->
										<div class="tp-caption font-body ls2 text-uppercase tp-resizeme"
				...
				<!-- 360 degree car
				============================================= -->
				<div class="section dark mb-0 clearfix" style="background: #FFF url({{asset('/car/demos/car/images/1.jpg')}}) right bottom no-repeat; background-size: cover; padding: 80px 0 40px">
					...
					<div class="row h-100 align-items-stretch">
						...
						<div class="col-md-6 col-12 p-0 dark videoplay-on-hover">
							<a href="demos/car/car-listing.html">
								...
								<div class="video-wrap">
									<video id="slide-video-1" poster="{{asset('car/demos/car/images/videos/1.jpg')}}" preload="auto" loop muted>
						...
						<div class="col-md-6 col-12 p-0 dark videoplay-on-hover">
							<a href="demos/car/car-listing.html">
								...
								<div class="video-wrap">
									<video id="slide-video-2" poster="{{asset('car/demos/car/images/videos/2.jpg')}}" preload="auto" loop muted>
						...
						<div class="col-md-6 col-12 p-0 dark videoplay-on-hover">
							<a href="demos/car/car-listing.html">
								...
								<div class="video-wrap">
									<video id="slide-video-3" poster="{{asset('car/demos/car/images/videos/3.jpg')}}" preload="auto" loop muted>
						...
						<div class="col-md-6 col-12 p-0 dark videoplay-on-hover">
							<a href="demos/car/car-listing.html">
								...
								<div class="video-wrap">
									<video id="slide-video-4" poster="{{asset('car/demos/car/images/videos/4.jpg')}}" preload="auto" loop muted>
				...
				<!-- Featured Section
				============================================= -->
				<div class="section m-0 clearfix" style="background: #FFF url({{asset('/car/demos/car/images/features/section-bg.jpg')}}) left bottom no-repeat; background-size: cover; padding: 140px 0">
					<div class="container clearfix">
						<div class="row clearfix">
				...
				<div class="section m-0 p-0 clearfix">
					<div class="row align-items-stretch clearfix">
						<!-- Half Section 1 -->
						<div class="col-lg-6 dark bg-color" style="background: url({{asset('/car/demos/car/images/5.jpg')}}) center center no-repeat; background-size: cover;">
						...
						<!-- Half Section 2 -->
						<div class="col-lg-6 clearfix bg-color" style="background: url({{asset('/car/demos/car/images/6.jpg')}}) center center no-repeat; background-size: cover;">
							<div class="col-padding clearfix">
				...
				============================================= -->
				<div class="section m-0 clearfix" style="background: #FFF url({{asset('/car/demos/car/images/footer-bg.jpg')}}) center bottom no-repeat; background-size: cover; height: 770px">
					<div class="mx-auto dark center clearfix" style="max-width: 570px">
						...
						<a href="demos/car/car-contact.html" class="uppercase fw-bold ls2" style="color: #FFF; font-size: 12px; border-bottom: 1px solid #FFF">Request a Quote</a> &rarr;
					</div>
				</div>
			</div>
		</section><!-- #content end -->
				...
				<div class="footer-widgets-wrap">
					...
					<div class="row col-mb-50 justify-content-between">
						...
						<div class="col-lg-5 text-center text-lg-end">
							<img src="{{asset('car/demos/car/images/logo-footer.png')}}" alt="Image" height="50">
							<br>
							<div style="color: #444">
