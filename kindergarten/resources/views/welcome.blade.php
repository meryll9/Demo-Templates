...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div id="logo" class="me-lg-0 col-lg-3">
							<a href="index.html" class="standard-logo"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo" width="140"></a>
							<a href="index.html" class="retina-logo"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo" width="140"></a>
						</div><!-- #logo end -->
		...
		<section id="slider" class="slider-element include-header" style="background-color: #FDE3A1;">
			...
			<div class="position-absolute top-0 start-0 w-100 h-100" style="background: transparent url({{asset('/kindergarten/demos/kindergarten/images/hero-bg-icons.svg')}})) center center / cover; opacity: 0.04"></div>
			...
			<div class="container">
				<div class="row align-items-center min-vh-100 pt-5 pb-4">
					<div class="col-lg-6">
						...
						<h1 class="display-3 fw-bolder">{{ env('APP_TAGLINE') }} <br> Grow <span class="color">{{ env('APP_TAGLINE') }}..</span></h1>
			...
			<div class="position-relative d-none d-sm-block">
				<img src="{{asset('kindergarten/demos/kindergarten/images/fish2.png')}}" alt="Fish" class="background-img pos-right float-anim" style="top: -120px">
			</div>
		...
		<section id="content">
			<div class="content-wrap">
					...
					<div class="row col-mb-50">
							...
							<div class="row col-mb-50">
								<div class="col-md-6">
									<div class="feature-box">
										<div class="fbox-icon">
											<img src="{{asset('kindergarten/demos/kindergarten/images/icons/puzzle.svg')}}" alt="Icon" class="p-2 rounded" style="background-color: #BDE0E0">
										</div>
								...
								<div class="col-md-6">
									<div class="feature-box">
										<div class="fbox-icon mb-4">
											<img src="{{asset('kindergarten/demos/kindergarten/images/icons/meal.svg')}}" alt="Icon" class="p-2 rounded" style="background-color: #F9E8DF">
										</div>
										<div class="fbox-content">
								...
								<div class="col-md-6">
									<div class="feature-box">
										<div class="fbox-icon mb-4">
											<img src="{{asset('kindergarten/demos/kindergarten/images/icons/teacher.svg')}}" alt="Icon" class="p-2 rounded" style="background-color: #DEE6ED">
										</div>
										<div class="fbox-content">
								...
								<div class="col-md-6">
									<div class="feature-box">
										<div class="fbox-icon mb-4">
											<img src="{{asset('kindergarten/demos/kindergarten/images/icons/soap.svg')}}" alt="Icon" class="p-2 rounded" style="background-color: #d6ECCD">
										</div>
										<div class="fbox-content">
						...
						<div class="col-lg-4 mt-5 mt-lg-0">
							<div class="card border-0 p-3 rounded-6" style="background-color: #eddee6;">
								<div class="card-body">
									<img src="{{asset('kindergarten/demos/kindergarten/images/card-img.png')}}" alt="Card Image" style="margin-top: -80px;">
				...
				<div class="section py-6" style="background-color: #F6F3EE;">
					...
					<div class="position-absolute top-0 start-0 w-100 h-100" style="background: url({{asset('/kindergarten/demos/kindergarten/images/hero-bg-icons.svg')}})) center center / cover; opacity: 0.04"></div>
				...
				<div class="position-relative d-none d-sm-block">
					<img src="{{asset('kindergarten/demos/kindergarten/images/fish1.png')}}" alt="Fish" class="background-img float-anim">
				</div>
				...
				<div class="container z-2">
					<div class="row align-items-center justify-content-center col-mb-30">
						...
						<div class="col-auto">
							<img src="{{asset('kindergarten/demos/kindergarten/images/kindergarten-tv.svg')}}" alt="Image TV" class="kindergarder-mockup-tv">
								...
								<div id="kindergarten-carousel-img" class="carousel kindergarten-tv-carousel slide carousel-fade" data-bs-ride="carousel">
									<div class="carousel-inner">
										<div class="carousel-item active">
											<img class="d-block position-relative w-100" src="{{asset('kindergarten/demos/kindergarten/images/carousel/1.jpg')}}" alt="First slide" />
										</div>
										<div class="carousel-item">
											<img class="d-block position-relative w-100" src="{{asset('kindergarten/demos/kindergarten/images/carousel/2.jpg')}}" alt="Second slide" />
										</div>
										<div class="carousel-item">
											<img class="d-block position-relative w-100" src="{{asset('kindergarten/demos/kindergarten/images/carousel/3.jpg')}}" alt="Third slide" />
										</div>
									</div>
								</div>
								...
								<div class="posts-md">
									<div class="entry">
										<div class="entry-image position-relative mb-md-4">
											<a href="#">
												<img src="{{asset('kindergarten/demos/kindergarten/images/news/1.jpg')}}" alt="Image 3" class="rounded-5">
							...
							<div class="col-lg-4">
								...
								<div class="posts-md">
									<div class="entry">
										<div class="entry-image position-relative mb-md-4">
											<a href="#">
												<img src="{{asset('kindergarten/demos/kindergarten/images/news/2.jpg')}}" alt="Image 3" class="rounded-5">
												<div class="shape-divider" data-shape="wave-5" data-position="bottom" data-width="110" data-height="30" data-fill="#ECF4F1"></div>
											</a>
							...
							<div class="col-lg-4">
								...
								<div class="posts-md">
									<div class="entry">
										<div class="entry-image position-relative mb-md-4">
											<a href="#">
												<img src="{{asset('kindergarten/demos/kindergarten/images/news/3.jpg')}}" alt="Image 3" class="rounded-5">
												<div class="shape-divider" data-shape="wave-5" data-position="bottom" data-width="110" data-height="30" data-fill="#ECF4F1"></div>
											</a>
				...
				<div class="container mw-md mb-3" style="background: var(--bs-primary) url({{asset('/kindergarten/demos/kindergarten/images/subscribe-bg.svg')}}) repeat center center / cover; padding: 80px; border-radius: 2.6rem">
		...
		<footer id="footer" class="border-0" style="background-image: linear-gradient(to top, #61BFDB, #E0F2C2, #FFF);">
			...
			<div class="position-absolute top-0 start-0 w-100 h-100" style="background: transparent url({{asset('/kindergarten/demos/kindergarten/images/footer.png')}}) center bottom / cover;"></div>
