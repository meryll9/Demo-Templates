	...
	<div id="wrapper" class="clearfix">
					...
					<div class="header-row justify-content-lg-between">
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container not-dark">
								<li class="menu-item"><a class="menu-link color" href="#modal-register" data-lightbox="inline"><div><i class="icon-line2-login"></i>Login</div></a></li>
							</ul>
		...
		<section id="content">
			<div class="content-wrap py-0">
				...
				<div class="section section-curve mt-0" style="background: var(--theme1) url({{asset('/bike/demos/bike/images/hero-bike.png')}}) right 70% / cover; height: 750px;">

					<div class="container center">
						<div class="heading-block mt-4 border-bottom-0">
							<h1 class="nott fw-semibold" style="font-size: 44px; letter-spacing: -1px">{{ env('APP_TAGLINE') }}</h1>
							<small class="mb-5 h6 lead">Revolutionizing your Commute Everyday in an Eco-Friendly Way.</small>
						</div>

						<a href="#modal-register" data-lightbox="inline" class="button button-large button-rounded button-shadow">Sign Up Now</a>
				...
				<div class="container">
					<div class="card border-0 mx-auto rounded ytb-card" style="box-shadow: 0 32px 46px 2px rgba(0,0,0,0.12);">
						<div id="ytb-video" class="yt-bg-player card-img-top rounded-top" data-quality="hd1080" data-volume="80" data-autoplay="false" data-container="self" data-video="https://youtu.be/SF0DLn3hEnc">
							<div class="ytb-poster rounded-top" style="background: url({{asset('/bike/demos/bike/images/video-poster.jpg')}}) center center / cover; position: absolute; left: 0; top: 0; width: 100%; height: 100%;">
							</div>
									...
									<div class="subscribe-widget" data-loader="button">
										...
										<form id="widget-subscribe-form" action="include/subscribe.php" method="post" class="mb-0">
											...
											<div class="form-check py-3">
												...
												<label class="form-check-label nott ls0 fw-normal" for="subscribe-news">Get New Updates &amp; Announcements</label>
											</div>
											<button class="button button-shadow button-rounded m-0 nott ls0 w-100" type="submit">Subscribe</button>
										</form>
									</div>
								</div>
							</div>
					...
					<div class="row topmargin align-items-center mx-auto bottommargin-lg" style="max-width: 840px">
						...
						<div class="col-md-9">
							<div id="oc-images" class="owl-carousel image-carousel carousel-widget" data-margin="50" data-nav="true" data-pagi="false" data-items-xs="2" data-items-md="3" data-items-xl="4" data-loop="true" data-autoplay="3500">
								<div class="oc-item"><a href="#"><img src="{{asset('bike/demos/bike/images/clients/1.png')}}" alt="clients"></a></div>
								<div class="oc-item"><a href="#"><img src="{{asset('bike/demos/bike/images/clients/2.png')}}" alt="clients"></a></div>
								<div class="oc-item"><a href="#"><img src="{{asset('bike/demos/bike/images/clients/3.png')}}" alt="clients"></a></div>
								<div class="oc-item"><a href="#"><img src="{{asset('bike/demos/bike/images/clients/4.png')}}" alt="clients"></a></div>
								<div class="oc-item"><a href="#"><img src="{{asset('bike/demos/bike/images/clients/5.png')}}" alt="clients"></a></div>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="row showcase-section align-items-center justify-content-between clearfix">
							...
							<div class="col-lg-8 col-md-7">
								...
								<div id="target-2" class="showcase-target">
									<img class="rounded" src="{{asset('bike/demos/bike/images/mockups/2.jpg')}}" alt="Image">
								</div>
								<div id="target-3" class="showcase-target">
									<img class="rounded" src="{{asset('bike/demos/bike/images/mockups/3.jpg')}}" alt="Image">
								</div>
								<div id="target-4" class="showcase-target">
									<div class="rounded" style="background: url({{asset('/bike/demos/bike/images/mockups/4.jpg')}}) bottom center no-repeat; background-size: cover; min-height: 500px;">
				...
				<div class="section bg1 mt-4" style="padding: 120px 0;">
					<div class="container">
						...
						<div class="row justify-content-between">
							<div class="col-lg-6">
								<div class="media row">
								  <img class="col-sm-5 p-5 p-sm-0 pe-sm-3" src="{{asset('bike/demos/bike/images/bikes/1.png')}}" alt="Generic placeholder image" width="230">
								  <div class="col-sm-7 media-body">
								    ...
								    <a href="#" class="button button-shadow button-rounded fw-normal ls0 m-0 nott">View More</a>
								  </div>
								</div>
							</div>
							...
							<div class="col-lg-6 mt-5 mt-lg-0">
								<div class="media row">
								  <img class="col-sm-5 p-5 p-sm-0 pe-sm-3" src="{{asset('bike/demos/bike/images/bikes/2.png')}}" alt="Generic placeholder image" width="230">
								  <div class="col-sm-7 media-body">
							...
							<div class="col-lg-6 mt-5">
								<div class="media row">
								  <img class="col-sm-5 p-5 p-sm-0 pe-sm-3" src="{{asset('bike/demos/bike/images/bikes/3.png')}}" alt="Generic placeholder image" width="230">
								  <div class="col-sm-7 media-body">
							...
							<div class="col-lg-6 mt-5">
								<div class="media row">
								  <img class="col-sm-5 p-5 p-sm-0 pe-sm-3" src="{{asset('bike/demos/bike/images/bikes/4.png')}}" alt="Generic placeholder image" width="230">
								  <div class="col-sm-7 media-body">
				...
				<div class="section bg-transparent" style="padding: 80px 0">
					<div class="container">
						<div class="heading-block mx-auto border-bottom-0 center" style="max-width: 600px">
							...
							<h2 class="nott fw-semibold mb-2" style="font-size: 36px; letter-spacing: -1px"><span class="counter counter-inherit text-dark inline-block">More than <code class="color"><span data-from="0" data-to="8465" data-refresh-interval="10" data-speed="1100"></span></code>+</span> Bikes are already Rented in <span>11</span> Countries.</h2>
						...
						<ul class="skills mx-auto" style="max-width: 600px">
							<li data-percent="80">
								<div class="progress">
									<div class="progress-percent"><div class="counter counter-inherit counter-instant"><span data-from="0" data-to="8465" data-refresh-interval="10" data-speed="1100"></span></div></div>
								</div>
							</li>
						</ul>
					</div>
				...
				<div id="section-price" class="section" style="background: url({{asset('/bike/demos/bike/images/bg.png')}}) repeat-y center top; padding: 100px 0;">
					<div class="container">
						<div class="row justify-content-between">
							<div class="col-md-7">
							...
							<div class="col-lg-4 col-md-5 mt-4 mt-md-0 sticky-sidebar-wrap">
								<div class="card text-center border-0 shadow sticky-sidebar py-4">
									...
									<div class="card-body py-4">
										...
										<a href="#" class="button button-rounded button-large ls0 fw-normal ms-0 mb-2 nott">Rent Now</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="section bg-transparent clearfix">
					<div class="container clearfix">
						...
						<div class="heading-block mx-auto border-bottom-0 center clearfix" style="max-width: 600px">
							...
							<div class="center"><div class="button ls0 button-rounded button-border nott fw-normal ">View More</div></div>
						</div>
					...
					<div class="container">
						<div class="row align-items-center justify-content-between">
							...
							<div class="col-lg-6 d-inline-block d-sm-inline-flex justify-content-start justify-content-lg-end">
								<div class="button button-xlarge ls0 button-rounded button-border nott fw-normal ">Start Renting</div>
								<div class="button button-xlarge ls0 button-rounded button-shadow nott fw-normal ">Contact Us</div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="footer-widgets-wrap">
					...
					<div class="row">
						<div class="col-6 col-lg-4">
							<img class="mb-2" src="{{asset('bike/demos/bike/images/logo-foo.png')}}" alt="Image" width="123">
							...
							<div class="clear"></div>
							<div>
								<a href="#" class="social-icon me-2 si-colored si-rounded si-small si-facebook">
									<i class="icon-facebook"></i>
									<i class="icon-facebook"></i>
								</a>
								<a href="#" class="social-icon me-2 si-colored si-rounded si-small si-twitter">
									<i class="icon-twitter"></i>
									<i class="icon-twitter"></i>
								</a>
								<a href="#" class="social-icon me-2 si-colored si-rounded si-small si-youtube">
									<i class="icon-youtube"></i>
									<i class="icon-youtube"></i>
								</a>
								<a href="#" class="social-icon si-colored si-rounded si-small si-appstore">
