	...
	<div id="wrapper" class="clearfix">
		...
		<section id="slider" class="slider-element slider-parallax swiper_wrapper min-vh-60 min-vh-md-100 include-header" data-loop="true">
			...
			<div class="slider-inner">
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark">
							...
							<div class="swiper-slide-bg" style="background-image: url({{asset('/business/demos/business/images/slider/1.jpg')}});"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
							...
							<div class="swiper-slide-bg" style="background-image: url({{asset('/business/demos/business/images/slider/2.jpg')}});"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
							...
							<div class="swiper-slide-bg" style="background-image: url({{asset('/business/demos/business/images/slider/3.jpg')}});"></div>
						</div>
					</div>
					<!-- Slider Arrows
					============================================= -->
				...
				<!-- Slider Mouse Icon
				============================================= -->
				<a href="#" data-scrollto="#content" data-offset="0" class="dark one-page-arrow"><img class="infinite animated fadeInDown" src="{{asset('business/demos/business/images/mouse.svg')}}" alt="Image" ></a>
			</div>
			...
			<div class="content-wrap pb-0" style="z-index: 1;">
					...
					<div class="row clearfix">
						...
						<div class="row clearfix">
							<div class="col-lg-4 bottommargin-sm">
								<div class="feature-box media-box fbox-bg">
									<div class="fbox-media">
										<a href="#"><img src="{{asset('business/demos/business/images/featured/1.jpg')}}" alt="Featured Box Image"></a>
									</div>
									<div class="fbox-content fbox-content-lg">
										<h3 class="nott ls0 fw-semibold">Retina Ready Display<span class="subtitle font-secondary fw-light ls0">Globally parallel task premium infomediaries</span></h3>
							...
							<div class="col-lg-4 bottommargin-sm">
								<div class="feature-box media-box fbox-bg">
									<div class="fbox-media">
										<a href="#"><img src="{{asset('business/demos/business/images/featured/2.jpg')}}" alt="Featured Box Image"></a>
									</div>
									<div class="fbox-content fbox-content-lg">
										<h3 class="nott ls0 fw-semibold">Ultra Responsive Design<span class="subtitle font-secondary fw-light ls0">Energistically visualize market-driven.</span></h3>
										<a href="#" class="button-link border-0 color">Read More</a>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-4 bottommargin-sm">
								<div class="feature-box media-box fbox-bg">
									<div class="fbox-media">
										<a href="#"><img src="{{asset('business/demos/business/images/featured/3.jpg')}}" alt="Featured Box Image"></a>
									</div>
									<div class="fbox-content fbox-content-lg">
										<h3 class="nott ls0 fw-semibold">1000+ HTML Pages Included<span class="subtitle font-secondary fw-light ls0">Enthusiastically iterate enabled portals after.</span></h3>
										<a href="#" class="button-link border-0 color">Read More</a>
									</div>
								</div>
							</div>
				...
				<div class="section p-0 mt-0 bg-transparent clearfix" style="border-top: 1px solid #EEE; border-bottom: 1px solid #EEE;">
					<div class="row align-items-stretch clearfix">
						<div class="col-lg-6 center col-padding" style="background: url({{asset('/business/demos/business/images/sections/1.jpg')}}) center center no-repeat; background-size: cover;">
							<div>&nbsp;</div>
						</div>
					...
					<div id="portfolio" class="portfolio row grid-container g-0">
						...
						<article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-media pf-icons">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('business/demos/business/images/portfolio/1.jpg')}}" alt="Open Imagination">
									</a>
						...
						<article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-illustrations">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('business/demos/business/images/portfolio/2.jpg')}}" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark flex-column" data-hover-animate="fadeIn">
											<!-- Decription: Start -->
						...
						<article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-graphics pf-uielements">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('business/demos/business/images/portfolio/3.jpg')}}" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark flex-column" data-hover-animate="fadeIn">
											<!-- Decription: Start -->
									...
									<div class="fslider" data-arrows="false" data-speed="400" data-pause="4000">
										<div class="flexslider">
											<div class="slider-wrap">
												<div class="slide"><a href="#"><img src="{{asset('business/demos/business/images/portfolio/4.jpg')}}" alt="Open Imagination"></a></div>
												<div class="slide"><a href="#"><img src="{{asset('business/demos/business/images/portfolio/4-2.jpg')}}" alt="Open Imagination"></a></div>
											</div>
										</div>
									</div>
									<div class="bg-overlay">
							...
							<div class="grid-inner">
								<div class="portfolio-image">
									<div class="fslider" data-arrows="false">
										<div class="flexslider">
											<div class="slider-wrap">
												<div class="slide"><a href="#"><img src="{{asset('business/demos/business/images/portfolio/5.jpg')}}" alt="Open Imagination"></a></div>
												<div class="slide"><a href="#"><img src="{{asset('business/demos/business/images/portfolio/5-2.jpg')}}" alt="Open Imagination"></a></div>
											</div>
										</div>
									</div>
									<div class="bg-overlay">
						...
						<article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-uielements pf-icons">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('business/demos/business/images/portfolio/6.jpg')}}" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark flex-column" data-hover-animate="fadeIn">
											<!-- Decription: Start -->
						...
						<article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-uielements pf-media">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('business/demos/business/images/portfolio/7.jpg')}}" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark flex-column" data-hover-animate="fadeIn">
											<!-- Decription: Start -->
						...
						<article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-graphics">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('business/demos/business/images/portfolio/8.jpg')}}" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark flex-column" data-hover-animate="fadeIn">
											<!-- Decription: Start -->
					...
					<div class="container clearfix">
						...
						<div class="row justify-content-center col-mb-50">
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box fbox-plain">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('business/demos/business/images/icons/24help.svg')}}" alt="Image"></a>
									</div>
									<div class="fbox-content">
							...
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box fbox-plain">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('business/demos/business/images/icons/barcode.svg')}}" alt="Image"></a>
									</div>
									<div class="fbox-content">
							...
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box fbox-plain">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('business/demos/business/images/icons/buy.svg')}}" alt="Image"></a>
									</div>
									<div class="fbox-content">
							...
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box fbox-plain">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('business/demos/business/images/icons/card.svg')}}" alt="Image"></a>
									</div>
									<div class="fbox-content">
							...
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box fbox-plain">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('business/demos/business/images/icons/doc.svg')}}" alt="Image"></a>
									</div>
									<div class="fbox-content">
							...
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box fbox-plain">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('business/demos/business/images/icons/dropbox.svg')}}" alt="Image"></a>
									</div>
									<div class="fbox-content">
							...
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box fbox-plain">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('business/demos/business/images/icons/piggy-bank.svg')}}" alt="Image"></a>
									</div>
									<div class="fbox-content">
							...
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box fbox-plain">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('business/demos/business/images/icons/home.svg')}}" alt="Image"></a>
									</div>
									<div class="fbox-content">
							...
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box fbox-plain">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('business/demos/business/images/icons/offers.svg')}}" alt="Image"></a>
									</div>
									<div class="fbox-content">
						...
						<div class="row topmargin-lg clearfix">
							<div class="col-lg-6 p-0">
								...
								<a href="https://www.youtube.com/watch?v=NS0txu_Kzl8" data-lightbox="iframe">
									<img src="{{asset('business/demos/business/images/sections/video.jpg')}}" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
							...
							<div class="col-lg-6" style="padding-left: 60px;">
								...
								<h5 class="mb-0 fw-semibold">&middot; SemiColonWeb - Author, Themeforest Market. <a href="#"><img src="{{asset('business/demos/business/images/tf-logo.png')}}" height="18" alt="Image" style="margin-left: 4px"></a></h5>
				...
				<!-- Parallax Area
				============================================= -->
				<div class="section parallax topmargin-lg mb-0 border-top-0 clearfix" style="background-image: url({{asset('/business/demos/business/images/sections/2.jpg')}}); background-size: cover;" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
					<div class="container clearfix">
						...
						<div class="row">
							...
							<div class="col-lg-7 order-lg-1">
								<div style="position: relative; margin-bottom: 0;" class="overflow-hidden" data-height-xl="520" data-height-lg="520" data-height-md="520" data-height-sm="500" data-height-xs="300">
									<img class="man" src="{{asset('business/demos/business/images/sections/man.jpg')}}" style="position: absolute; top: 0; left: auto;" alt="Chrome">
								</div>
							</div>
				...
				<div class="section m-0 clearfix" style="padding: 80px 0">
					<div id="oc-clients-full" class="owl-carousel owl-carousel-full image-carousel carousel-widget" data-margin="0" data-nav="false" data-pagi="false" data-loop="true" data-autoplay="3000" data-items-xs="2" data-items-sm="3" data-items-md="5" data-items-lg="5" data-items-xl="5">
						...
						<div class="oc-item"><a href="#"><img src="{{asset('business/demos/business/images/clients/linkedin.svg')}}" style="height: 24px" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="{{asset('business/demos/business/images/clients/nat-geo.svg')}}" style="height: 24px" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="{{asset('business/demos/business/images/clients/jetblue.svg')}}" style="height: 24px" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="{{asset('business/demos/business/images/clients/zillow.svg')}}" style="height: 24px" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="{{asset('business/demos/business/images/clients/amazon.svg')}}" style="height: 24px" alt="Brands"></a></div>
			...
			<div class="container clearfix">
				...
				<div class="footer-widgets-wrap">
					...
					<div class="row col-mb-50">
						<div class="col-md-3">
							<img src="{{asset('business/demos/business/images/logo@2x.png')}}" alt="Image" height="100" style="margin-top: -30px">
						</div>
