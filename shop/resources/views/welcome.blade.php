				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div id="logo" class="me-lg-4">
							<a href="demo-shop.html" class="standard-logo"><img src="{{asset('shop/demos/shop/images/logo.png')}}" alt="Canvas Logo"></a>
							<a href="demo-shop.html" class="retina-logo"><img src="{{asset('shop/demos/shop/images/logo@2x.png')}}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
											...
											<div class="row">
												...
												<ul class="sub-menu-container mega-menu-column col-lg-3 border-start-0">
													<li class="card p-0 bg-transparent border-0">
														<img class="card-img-top" src="{{asset('shop/demos/shop/images/menu-image.jpg')}}" alt="image cap">
			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide dark">
						...
						<div class="swiper-slide-bg" style="background-image: url({{asset('/shop/demos/shop/images/slider/1.jpg')}});"></div>
					</div>
					<div class="swiper-slide dark">
						<div class="container">
							<div class="slider-caption slider-caption-center">
						...
						<div class="swiper-slide-bg" style="background-image: url({{asset('/shop/demos/shop/images/slider/3.jpg')}}); background-position: center 20%;"></div>
					</div>
					<div class="swiper-slide dark">
						<div class="container">
							<div class="slider-caption slider-caption-center">
						...
						<div class="swiper-slide-bg" style="background-image: url({{asset('/shop/demos/shop/images/slider/2.jpg')}}); background-position: center 40%;"></div>
					</div>
				</div>
			...
			<div class="content-wrap">
				<div class="container clearfix">
					...
					<div class="row shop-categories clearfix">
						<div class="col-lg-7">
							<a href="#" style="background: url({{asset('/shop/demos/shop/images/categories/2-1.jpg')}}) no-repeat right center; background-size: cover;">
						...
						<div class="col-lg-5">
							<a href="#" style="background: url({{asset('/shop/demos/shop/images/categories/1.jpg')}}) no-repeat center right; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url({{asset('/shop/demos/shop/images/categories/4.jpg')}}) no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
						...
						<div class="col-lg-4">
							<a href="#" style="background:url({{asset('/shop/demos/shop/images/categories/3.jpg')}}) no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url({{asset('/shop/demos/shop/images/categories/5.jpg')}}) no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
					...
					<div id="oc-products" class="owl-carousel products-carousel carousel-widget" data-margin="20" data-loop="true" data-autoplay="5000" data-nav="true" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="4" data-items-xl="5">
						...
						<div class="oc-item">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/featured/1.jpg')}}" alt="Round Neck T-shirts"></a>
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/featured/1-1.jpg')}}" alt="Round Neck T-shirts"></a>
						...
						<div class="oc-item">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/featured/2.jpg')}}" alt="Navy Blue Dress"></a>
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/featured/2-1.jpg')}}" alt="Navy Blue Dress"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
											<a href="demos/shop/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="oc-item">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/featured/5.jpg')}}" alt="Shoes"></a>
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/featured/5-1.jpg')}}" alt="Shoes"></a>
									<div class="bg-overlay">
									...
									<div class="fslider" data-arrows="false" data-autoplay="4500">
										<div class="flexslider">
											<div class="slider-wrap">
												<div class="slide"><a href="#"><img src="{{asset('shop/demos/shop/images/items/featured/4.jpg')}}" alt="T-shirts"></a></div>
												<div class="slide"><a href="#"><img src="{{asset('shop/demos/shop/images/items/featured/4-1.jpg')}}" alt="T-shirts"></a></div>
												<div class="slide"><a href="#"><img src="{{asset('shop/demos/shop/images/items/featured/4-2.jpg')}}" alt="T-shirts"></a></div>
												<div class="slide"><a href="#"><img src="{{asset('shop/demos/shop/images/items/featured/4-3.jpg')}}" alt="T-shirts"></a></div>
											</div>
										</div>
									</div>
									<div class="bg-overlay">
						...
						<div class="oc-item">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/featured/3.jpg')}}" alt="T-shirts"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
											<a href="demos/shop/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="row align-items-stretch">
							<div class="col-md-5">
								<div class="row">
									...
									<div class="col-6">
										<a href="demos/shop/images/sections/1-2.jpg')}}" data-lightbox="image"><img src="{{asset('shop/demos/shop/images/sections/1-2.jpg')}}" alt="Image"></a>
									</div>
									<div class="col-6">
										<a href="demos/shop/images/sections/1-3.jpg')}}" data-lightbox="image"><img src="{{asset('shop/demos/shop/images/sections/1-3.jpg')}}" alt="Image"></a>
									</div>
								</div>
							</div>
							<div class="col-md-7 min-vh-50">
								<a href="https://www.youtube.com/watch?v=bpNcuh_BnsA" data-lightbox="iframe" class="d-block position-relative h-100" style="background: url({{asset('/shop/demos/shop/images/sections/1.jpg')}}) center center no-repeat; background-size: cover;">
				...
				<div class="container clearfix">
					...
					<div class="row grid-6">
						...
						<div class="col-lg-2 col-md-3 col-6 px-2">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/1.jpg')}}" alt="Image 1"></a>
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/1-1.jpg')}}" alt="Image 1"></a>
									<div class="sale-flash badge bg-danger p-2">Sale!</div>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
						...
						<div class="col-lg-2 col-md-3 col-6 px-2">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/2.jpg')}}" alt="Image 2"></a>
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/2-1.jpg')}}" alt="Image 2"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
											<a href="demos/shop/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="col-lg-2 col-md-3 col-6 px-2">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/4.jpg')}}" alt="Image 3"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
											<a href="demos/shop/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
							...
							<div class="product">
								<div class="product-image">
									<div class="fslider" data-arrows="false" data-autoplay="4500">
										<div class="flexslider">
											<div class="slider-wrap">
												<div class="slide"><a href="#"><img src="{{asset('shop/demos/shop/images/items/new/3.jpg')}}" alt="Image 4"></a></div>
												<div class="slide"><a href="#"><img src="{{asset('shop/demos/shop/images/items/new/3-1.jpg')}}" alt="Image 4"></a></div>
											</div>
										</div>
									</div>
									<div class="bg-overlay">
						...
						<div class="col-lg-2 col-md-3 col-6 px-2">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/6.jpg')}}" alt="Image 5"></a>
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/6-1.jpg')}}" alt="Image 5"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
											<a href="demos/shop/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="col-lg-2 col-md-3 col-6 px-2">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/5.jpg')}}" alt="Image 6"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
											<a href="demos/shop/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="col-lg-2 col-md-3 col-6 px-2">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/7.jpg')}}" alt="Image 7"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
											<a href="demos/shop/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="col-lg-2 col-md-3 col-6 px-2">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/8.jpg')}}" alt="Image 8"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
											<a href="demos/shop/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="col-lg-2 col-md-3 col-6 px-2">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/9.jpg')}}" alt="Image 9"></a>
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/9-1.jpg')}}" alt="Image 3"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
											<a href="demos/shop/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="col-lg-2 col-md-3 col-6 px-2">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/10.jpg')}}" alt="Image 10"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
							...
							<div class="product">
								<div class="product-image">
									<div class="fslider" data-arrows="false" data-autoplay="4500">
										<div class="flexslider">
											<div class="slider-wrap">
												<div class="slide"><a href="#"><img src="{{asset('shop/demos/shop/images/items/new/11.jpg')}}" alt="Image 10"></a></div>
												<div class="slide"><a href="#"><img src="{{asset('shop/demos/shop/images/items/new/11-1.jpg')}}" alt="Image 10"></a></div>
											</div>
										</div>
									</div>
									<div class="bg-overlay">
						...
						<div class="col-lg-2 col-md-3 col-6 px-2">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{asset('shop/demos/shop/images/items/new/12.jpg')}}" alt="Image 6"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
											<a href="demos/shop/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="row align-items-stretch align-items-center">
									<div class="col-md-7 min-vh-50" style="background: url({{asset('/shop/demos/shop/images/sections/3.jpg')}}) center center no-repeat; background-size: cover;">
					...
					<div class="row mt-5">
						<div class="col-12">
							...
							<ul class="clients-grid grid-2 grid-sm-3 grid-md-6 grid-lg-8 mb-0">
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/1.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/2.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/3.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/4.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/5.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/6.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/7.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/8.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/9.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/10.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/11.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/12.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/13.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/14.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/15.png')}}" alt="Clients"></a></li>
								<li class="grid-item"><a href="#"><img src="{{asset('shop/images/clients/logo/16.png')}}" alt="Clients"></a></li>
							</ul>
						</div>
					</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-4 d-none d-md-flex align-items-end">
								<img src="{{asset('shop/demos/shop/images/sections/app.png')}}" alt="Image" class="mb-0">
							</div>
						</div>
					</div>
				</div>
