...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
			...
			<div class="container">
				<div class="header-row">
					...
					<div id="logo" class="ms-auto ms-md-0">
						<a href="index.html" class="standard-logo" data-dark-logo="{{ env('APP_LOGO') }}"><img class="mx-auto" src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
						<a href="index.html" class="retina-logo" data-dark-logo="{{ env('APP_LOGO') }}"><img class="mx-auto" src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
					...
					<div class="header-row justify-content-between flex-row-reverse flex-lg-row">
						...
						<nav class="primary-menu with-arrows not-dark">
							...
							<ul class="menu-container">
								<li class="menu-item current"><a class="menu-link" href="demo-movers.html"><div>Home</div></a></li>
								...
								<li class="menu-item"><a class="menu-link" href="demo-movers-rates.html"><div>Rates</div></a>
									<ul class="sub-menu-container">
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.html"><div><i class="icon-line2-home"></i>Home Moving</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.html"><div><i class="icon-building2"></i>Office Moving</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.html"><div><i class="icon-line2-globe"></i>International Moving</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.html"><div><i class="icon-paw"></i>Pet Shifting</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.html"><div><i class="icon-car"></i>Car Shifting</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.html"><div><i class="icon-truck1"></i>Hire Truck</div></a></li>
									</ul>
								</li>
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element bg-color" style="height: auto; padding: 60px 0; background: url({{asset('/movers/demos/movers/images/bg-2.png')}}) no-repeat center center / 100% 100%;">
			...
			<div class="container mt-4" style="z-index: 2">
				...
				<div class="row topmargin justify-content-center">
								...
								<div class="form-widget">
									...
									<form class="row others-moving-form position-relative mb-0" action="include/form.php" method="post" enctype="multipart/form-data">
										...
										<div class="col-12 form-group">
											<div class="input-group">
												<span class="input-group-text bg-transparent"><img src="{{asset('movers/demos/movers/images/baggage.png')}}" height="18" alt="baggage Icon"></span>
					...
					<div class="col-lg-5 d-none d-lg-flex flex-wrap justify-content-center">
						<img src="{{asset('movers/demos/movers/images/2.svg')}}" alt="Image 1" class="d-flex align-self-end ms-5 mt-3">
					</div>
				</div>
			</div>
		...
		<section id="content">
			...
			<div class="content-wrap pb-0">
				...
				<div class="section p-0 dark mb-0" style="background: linear-gradient(to right, rgba(25,102,221,0.2), rgba(25,102,221,0.5)), url({{asset('/movers/demos/movers/images/section/1.jpg')}}) no-repeat center center / cover; min-height: 400px">
					<div class="container">
						...
						<div class="row col-mb-50 col-mb-lg-80">
							<div class="col-md-4">
								<div class="feature-box media-box">
									<div class="fbox-icon position-relative mb-4" style="background-image: url({{asset('/movers/demos/movers/images/featured-img/1.jpg')}});">
							...
							<div class="col-md-4">
								<div class="feature-box media-box">
									<div class="fbox-icon position-relative mb-4" style="background-image: url({{asset('/movers/demos/movers/images/featured-img/2.jpg')}});">
							...
							<div class="col-md-4">
								<div class="feature-box media-box">
									<div class="fbox-icon position-relative mb-4" style="background-image: url({{asset('/movers/demos/movers/images/featured-img/3.jpg')}});">
						...
						<div class="map-title">
							...
							<div class="d-flex justify-content-center">
								<ul class="iconlist m-0 pe-5">
									<li><img src="{{asset('movers/demos/hosting/images/flags/uk.png')}}" alt="Country Flag"><a href="#">United Kingdom</a></li>
									<li><img src="{{asset('movers/demos/hosting/images/flags/us.png')}}" alt="Country Flag"><a href="#">USA</a></li>
									<li><img src="{{asset('movers/demos/hosting/images/flags/br.png')}}" alt="Country Flag"><a href="#">Brazil</a></li>
									<li><img src="{{asset('movers/demos/hosting/images/flags/sa.png')}}" alt="Country Flag"><a href="#">South Africa</a></li>
									<li><img src="{{asset('movers/demos/hosting/images/flags/in.png')}}" alt="Country Flag"><a href="#">India</a></li>
								</ul>
								<ul class="iconlist m-0 ps-5">
									<li><img src="{{asset('movers/demos/hosting/images/flags/si.png')}}" alt="Country Flag"><a href="#">Singapore</a></li>
									<li><img src="{{asset('movers/demos/hosting/images/flags/ja.png')}}" alt="Country Flag"><a href="#">Japan</a></li>
									<li><img src="{{asset('movers/demos/hosting/images/flags/au.png')}}" alt="Country Flag"><a href="#">Australia</a></li>
									<li><img src="{{asset('movers/demos/hosting/images/flags/ca.png')}}" alt="Country Flag"><a href="#">Canada</a></li>
										...
										<div class="testimonial bg-transparent shadow-none border-0 p-0">
											<div class="d-flex flex-row mb-4 align-items-center">
												<div class="testi-image">
													<a href="#"><img src="{{asset('movers/demos/pet/images/testimonials/1.jpg')}}" alt="Customer Testimonails"></a>
												</div>
				...
				<div class="section dark pt-0 mb-0 bg-color" style="background: url({{asset('/movers/demos/movers/images/bg-2.png')}}) no-repeat center bottom / 100%; overflow: visible">
