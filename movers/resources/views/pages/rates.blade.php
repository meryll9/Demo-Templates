...
@section('content')
    ...
    <section id="content">
        ...
        <div class="content-wrap p-0">
            ...
            <div id="slider" class="section bg-color mt-0"
                style="padding: 60px 0; background: url({{asset('/movers/demos/movers/images/bg-2.png')}}) no-repeat center center / 100% 100%;">
                            ...
                            <ul class="nav nav-tabs nav-justified flex-column border-bottom-0 flex-md-row bg-color mt-4"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link py-3 active" id="home-moving-tab" data-bs-toggle="tab"
                                        href="#home-moving" role="tab" aria-controls="home-moving" aria-selected="true">Home
                                        Moving</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link py-3" id="office-moving-tab" data-bs-toggle="tab"
                                        href="#office-moving" role="tab" aria-controls="office-moving"
                                        aria-selected="false">Office Moving</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link py-3" id="others-moving-tab" data-bs-toggle="tab"
                                        href="#others-moving" role="tab" aria-controls="others-moving"
                                        aria-selected="false">Others Service</a>
                                </li>
                            </ul>
                            <div class="tab-content rounded-bottom shadow bg-white py-4 px-5">
                                <div class="tab-pane fade show active" id="home-moving" role="tabpanel"
                                    aria-labelledby="home-moving-tab">
                                    <p class="mb-4">Shift to your new Home, So we're here. Please send us your
                                        Deatils &amp; our team will contact your email asap.</p>
                                        ...
                                        <form class="row home-moving-form position-relative mb-0" action="include/form.php"
                                            ...
                                            <div class="col-sm-6 form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="home-moving-form-location-to"
                                                        id="home-moving-form-location-to" class="form-control required"
                                                        value="" placeholder="Location To">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="home-moving-form-name"
                                                        id="home-moving-form-name" class="form-control required" value=""
                                            ...
                                            <div class="col-sm-6 form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="home-moving-form-phone"
                                                        id="home-moving-form-phone" class="form-control required" value=""
                                            ...
                                            <div class="col-12">
                                                <button type="submit" name="home-moving-form-submit"
                                                    class="btn bg-color text-white fw-medium w-100 py-2 mt-2">Contact
                                                    Us</button>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="office-moving" role="tabpanel"
                                    ...
                                    <p class="mb-4">Share your Office Shifting details by Filling out an Easy
                                        Form. Get Free Quotes from Verified Packers &amp; Movers Instantly.</p>
                                    <div class="form-widget">
                                        <div class="form-result"></div>
                                            ...
                                            <div class="col-12 form-group">
                                                <div class="input-group">
                                                    ...
                                                    <select class="required form-select" name="others-moving-form-service"
                                                        ...
                                                        <option value="" disabled selected>-- Select Your Service --
                                                        </option>
                                            ...
                                            <div class="col-sm-6 form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" name="others-moving-form-email"
                                                        id="others-moving-form-email" class="form-control required"
                                            ...
                                            <div class="col-sm-6 form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="others-moving-form-phone"
                                                        id="others-moving-form-phone" class="form-control required"
