...
@section('content')
    ...
    <section id="slider" class="slider-element bg-color"
        style="height: auto; padding: 60px 0; background: url({{ asset('/movers/demos/movers/images/bg-2.png') }}) no-repeat center center / 100% 100%;">

        <div class="container mt-4" style="z-index: 2">
            <div class="center">
                <h2 class="text-white h2 fw-semibold mb-2">{{ env('APP_TAGLINE') }}</h2>
            ...
            <div class="row topmargin justify-content-center">
                    ...
                    <ul class="nav nav-tabs nav-justified flex-column border-bottom-0 flex-md-row bg-color mt-4"
                        ...
                        <li class="nav-item">
                            <a class="nav-link py-3 active" id="home-moving-tab" data-bs-toggle="tab" href="#home-moving"
                                role="tab" aria-controls="home-moving" aria-selected="true">Home Moving</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link py-3" id="office-moving-tab" data-bs-toggle="tab" href="#office-moving"
                                role="tab" aria-controls="office-moving" aria-selected="false">Office Moving</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link py-3" id="others-moving-tab" data-bs-toggle="tab" href="#others-moving"
                                role="tab" aria-controls="others-moving" aria-selected="false">Others Service</a>
                        </li>
                    </ul>
                    <div class="tab-content rounded-bottom shadow bg-white py-4 px-5">
                        <div class="tab-pane fade show active" id="home-moving" role="tabpanel"
                            aria-labelledby="home-moving-tab">
                            <p class="mb-4">Shift to your new Home, So we're here. Please send us your Deatils
                                &amp; our team will contact your email asap.</p>
                            <div class="form-widget">
                                <div class="form-result"></div>
                                <form class="row home-moving-form position-relative mb-0" action="include/form.php"
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i
                                                    class="icon-truck1"></i></span>
                                            <input type="text" name="home-moving-form-location-from"
                                                id="home-moving-form-location-from" class="form-control required" value=""
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i
                                                    class="icon-line2-user"></i></span>
                                            <input type="text" name="home-moving-form-name" id="home-moving-form-name"
                                                class="form-control required" value="" placeholder="Your Full Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i
                                                    class="icon-line2-envelope"></i></span>
                                            <input type="email" name="home-moving-form-email" id="home-moving-form-email"
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="home-moving-form-phone" id="home-moving-form-phone"
                                                class="form-control required" value="" placeholder="Your Phone Number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 d-none">
                                        <input type="text" id="home-moving-form-botcheck" name="home-moving-form-botcheck"
                                            value="" />
                                    </div>

                                    <div class="col-12">
                                        <button type="submit" name="home-moving-form-submit"
                                            class="btn bg-color text-white fw-medium w-100 py-2 mt-2">Contact Us</button>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="office-moving" role="tabpanel" aria-labelledby="office-moving-tab">
                            <p class="mb-4">Share your Office Shifting details by Filling out an Easy Form. Get
                                Free Quotes from Verified Packers &amp; Movers Instantly.</p>
                            <div class="form-widget">
                                <div class="form-result"></div>
                                <form class="row office-moving-form position-relative mb-0" action="include/form.php"
                                    method="post" enctype="multipart/form-data">
                                    <div class="form-process">
                                        <div class="css3-spinner">
                                            <div class="css3-spinner-scaler"></div>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="office-moving-form-location-from"
                                                id="office-moving-form-location-from" class="form-control required" value=""
                                                placeholder="Location From">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="office-moving-form-location-to"
                                                id="office-moving-form-location-to" class="form-control required" value=""
                                                placeholder="Location To">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i
                                                    class="icon-line2-user"></i></span>
                                            <input type="text" name="office-moving-form-name" id="office-moving-form-name"
                                                class="form-control required" value="" placeholder="Your Full Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i
                                                    class="icon-line2-call-out"></i></span>
                                            <input type="text" name="office-moving-form-phone" id="office-moving-form-phone"
                                                class="form-control required" value="" placeholder="Your Phone Number">
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="others-moving" role="tabpanel" aria-labelledby="others-moving-tab">
                            <div class="form-widget">
                                <div class="form-result"></div>
                                <form class="row others-moving-form position-relative mb-0" action="include/form.php"
                                    method="post" enctype="multipart/form-data">
                                    <div class="form-process">
                                        <div class="css3-spinner">
                                            <div class="css3-spinner-scaler"></div>
                                    ...
                                    <div class="col-12 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><img
                                                    src="{{ asset('movers/demos/movers/images/baggage.png') }}" height="18"
                                                    alt="baggage Icon"></span>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i
                                                    class="icon-line2-social-dropbox"></i></span>
                                            <input type="text" name="others-moving-form-item" id="others-moving-form-item"
                                                class="form-control required" value="" placeholder="Your Item">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text text-muted bg-transparent"><i
                                                    class="icon-user-circle1"></i></span>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="others-moving-form-location-from"
                                                ...
                                                value="" placeholder="Location From">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="others-moving-form-location-to"
                                                id="others-moving-form-location-to" class="form-control required" value=""
                                                placeholder="Location To">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i
                                                    class="icon-line2-user"></i></span>
                                            <input type="text" name="others-moving-form-name" id="others-moving-form-name"
                                                class="form-control required" value="" placeholder="Your Full Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i
                                                    class="icon-line2-call-out"></i></span>
                                            <input type="text" name="others-moving-form-phone" id="others-moving-form-phone"
                                                class="form-control required" value="" placeholder="Your Phone Number">
                                        </div>
                                    </div>
                ...
                <div class="col-lg-5 d-none d-lg-flex flex-wrap justify-content-center">
                    <img src="{{ asset('movers/demos/movers/images/2.svg') }}" alt="Image 1"
                        class="d-flex align-self-end ms-5 mt-3">
                </div>
            </div>
        </div>
    ...
    <section id="content">
        ...
        <div class="content-wrap pb-0">
                ...
                <div class="row justify-content-center mb-5">
                    ...
                    <div class="col-lg-8">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <img src="{{ asset('movers/demos/movers/images/others/4.png') }}" alt="Image 1">
                            </div>
                            <div class="col-sm-6">
                                <h3>After you Share your Shifting details, Our Team will contact you.</h3>
                                <p class="mb-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi
                                    deserunt doloremque facilis rem, in recusandae, vel.</p>
                                <a target="_blank" href="https://icons8.com"
                                    class="color btn btn-sm p-0 btn-link"><u>illustration by Ouch.pics</u> <i
                        ...
                        <div class="row align-items-center mt-5">
                            ...
                            <div class="col-sm-6">
                                <img src="{{ asset('movers/demos/movers/images/others/2.png') }}" alt="Image 1">
                            </div>
                        </div>
                        <div class="row align-items-center mt-5">
                            <div class="col-sm-6">
                                <img src="{{ asset('movers/demos/movers/images/others/1.png') }}" alt="Image 1">
                            </div>
                            <div class="col-sm-6">
            ...
            <div class="section p-0 dark mb-0"
                style="background: linear-gradient(to right, rgba(25,102,221,0.2), rgba(25,102,221,0.5)), url({{ asset('/movers/demos/movers/images/section/1.jpg') }}) no-repeat center center / cover; min-height: 400px">
                <div class="container">
                    <div class="row justify-content-between mb-4" style="padding: 100px 0 160px;">
                        ...
                        <div class="col-lg-5 col-md-6 mb-0 mb-md-5">
                            <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Incidunt
                                distinctio dolor nemo quasi cum. A ipsam tempora voluptatem officiis! Accusantium!</p>
                            ...
                            <div class="d-flex">
                                <ul class="col-6 iconlist">
                                    <li class="my-2"><i class="icon-line-circle-check fw-light"></i> <span
                                            class="ps-2">100% Trustable</span></li>
                                    <li class="my-2"><i class="icon-line-circle-check fw-light"></i> <span
                                            class="ps-2">100% Safe &amp; Secure</span></li>
                                    <li class="my-2"><i class="icon-line-circle-check fw-light"></i> <span
                                            class="ps-2">On-Time Delivery</span></li>
                                    <li class="my-2"><i class="icon-line-circle-check fw-light"></i> <span
                                            class="ps-2">Verified Movers</span></li>
                                    <li class="my-2"><i class="icon-line-circle-check fw-light"></i> <span
                                            class="ps-2">Liecenced Company</span></li>
                                    <li class="my-2"><i class="icon-line-circle-check fw-light"></i> <span
                                            class="ps-2">No Hidden Charges</span></li>
                                    <li class="my-2"><i class="icon-line-circle-check fw-light"></i> <span
                                            class="ps-2">Live Chat</span></li>
                                </ul>
                                <ul class="col-6 iconlist">
                                    <li class="my-2"><i class="icon-line-circle-check fw-light"></i> <span
                                            class="ps-2">24x7 Support</span></li>
                                    <li class="my-2"><i class="icon-line-circle-check fw-light"></i> <span
                                            class="ps-2">No Extra Payments</span></li>
                                    <li class="my-2"><i class="icon-line-circle-check fw-light"></i> <span
                                            class="ps-2">Also Deliver on Sunday</span></li>
                                    <li class="my-2"><i class="icon-line-circle-check fw-light"></i> <span
                                    ...
                                    <li class="my-2"><i class="icon-line-circle-check fw-light"></i> <span
                                            class="ps-2">Door to Door</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="section-map clearfix bottommargin-lg topmargin-lg">
                <div class="container">
                    <img src="{{ asset('movers/demos/hosting/images/svg/map.png') }}" alt="Map Image"
                    ...
                    <div class="map-title">
                        ...
                        <div class="d-flex justify-content-center">
                            <ul class="iconlist m-0 pe-5">
                                <li><img src="{{ asset('movers/demos/hosting/images/flags/uk.png') }}"
                                        alt="Country Flag"><a href="#">United Kingdom</a></li>
                                <li><img src="{{ asset('movers/demos/hosting/images/flags/us.png') }}"
                                        alt="Country Flag"><a href="#">USA</a></li>
                                <li><img src="{{ asset('movers/demos/hosting/images/flags/br.png') }}"
                                        alt="Country Flag"><a href="#">Brazil</a></li>
                                <li><img src="{{ asset('movers/demos/hosting/images/flags/sa.png') }}"
                                        alt="Country Flag"><a href="#">South Africa</a></li>
                                <li><img src="{{ asset('movers/demos/hosting/images/flags/in.png') }}"
                                        alt="Country Flag"><a href="#">India</a></li>
                            </ul>
                            <ul class="iconlist m-0 ps-5">
                                <li><img src="{{ asset('movers/demos/hosting/images/flags/si.png') }}"
                                        alt="Country Flag"><a href="#">Singapore</a></li>
                                <li><img src="{{ asset('movers/demos/hosting/images/flags/ja.png') }}"
                                        alt="Country Flag"><a href="#">Japan</a></li>
                                <li><img src="{{ asset('movers/demos/hosting/images/flags/au.png') }}"
                                        alt="Country Flag"><a href="#">Australia</a></li>
                                <li><img src="{{ asset('movers/demos/hosting/images/flags/ca.png') }}"
                                        alt="Country Flag"><a href="#">Canada</a></li>
                ...
                <div class="container">
                    <div class="mx-auto" style="max-width: 1200px; padding: 120px 0 50px;">
                                    ...
                                    <div class="testimonial bg-transparent shadow-none border-0 p-0">
                                        <div class="d-flex flex-row mb-4 align-items-center">
                                            <div class="testi-image">
                                                <a href="#"><img
                                                        src="{{ asset('movers/demos/pet/images/testimonials/1.jpg') }}"
                        ...
                        <div class="grid-bg d-none d-md-block">
                            <img src="{{ asset('movers/demos/movers/images/dot-grid.svg') }}" alt="Dot Image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container mb-5">
                <div class="section-clients mx-auto" style="max-width: 700px">
                    <div class="center clearfix mb-4">
                        <span class="badge rounded-pill lightthemecolor color text-uppercase ls1 fw-medium py-2 px-3">We’ve
