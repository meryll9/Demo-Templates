	...
	<div id="wrapper" class="clearfix">
					...
					<div class="header-row flex-row-reverse flex-lg-row justify-content-between">
									...
									<div class="top-cart-items">
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="{{asset('course/images/shop/small/1.jpg')}}" alt="Blue Round-Neck Tshirt" /></a>
											</div>
										...
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="{{asset('course/images/shop/small/6.jpg')}}" alt="Light Blue Denim Dress" /></a>
											</div>
											<div class="top-cart-item-desc">
												<div class="top-cart-item-desc-title">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								<li class="menu-item"><a class="menu-link" href="#" class="ps-0"><div><i class="icon-line-grid"></i>All Categories</div></a>
		...
		<section id="slider" class="slider-element min-vh-75">
			<div class="slider-inner">
						...
						<div class="row justify-content-center">
							<div class="col-md-7">
								<div class="slider-title mb-5 dark clearfix">
									<h2 class="text-white text-rotater mb-2" data-separator="," data-rotate="fadeIn" data-speed="3500">{{ env('APP_TAGLINE') }} <span class="t-rotate text-white d-inline-block">Development,Photography,Teacher Training,Business,Lifestyle,Language,Health,Fitness,Music</span>.</h2>
				...
				<div class="video-wrap">
					<video id="slide-video" poster="{{asset('course/demos/course/images/video/poster.jpg')}}" preload="auto" loop autoplay muted>
						<source src="{{asset('course/demos/course/images/video/1.mp4')}}" type='video/mp4' />
					</video>
		...
		<section id="content">
			<div class="content-wrap" style="overflow: visible;">
				...
				<!-- Wave Shape Divider
				============================================= -->
				<div class="wave-bottom" style="position: absolute; top: -12px; left: 0; width: 100%; background-image: url({{asset('/course/demos/course/images/wave-3.svg')}}); height: 12px; z-index: 2; background-repeat: repeat-x; transform: rotate(180deg);"></div>
					...
					<div class="row course-categories clearfix mb-4">
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="{{asset('course/demos/course/images/categories/music.jpg')}}" alt="Card image">
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="{{asset('course/demos/course/images/categories/development.jpg')}}" alt="Card image">
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="{{asset('course/demos/course/images/categories/teacher.jpg')}}" alt="Card image">
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="{{asset('course/demos/course/images/categories/food.jpg')}}" alt="Card image">
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="{{asset('course/demos/course/images/categories/business.jpg')}}" alt="Card image">
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="{{asset('course/demos/course/images/categories/health.jpg')}}" alt="Card image">
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="{{asset('course/demos/course/images/categories/lifestyle.jpg')}}" alt="Card image">
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="{{asset('course/demos/course/images/categories/language.jpg')}}" alt="Card image">
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="{{asset('course/demos/course/images/categories/paint.jpg')}}" alt="Card image">
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="{{asset('course/demos/course/images/categories/photography.jpg')}}" alt="Card image">
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="{{asset('course/demos/course/images/categories/marketing.jpg')}}" alt="Card image">
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="{{asset('course/demos/course/images/categories/academics.jpg')}}" alt="Card image">
				...
				<!-- Section Courses
				============================================= -->
				<div class="section topmargin-lg parallax" style="padding: 80px 0 60px; background-image: url({{asset('/course/demos/course/images/icon-pattern.jpg')}}); background-size: auto; background-repeat: repeat"  data-bottom-top="background-position:0px 100px;" data-top-bottom="background-position:0px -500px;">

					<!-- Wave Shape Divider
					============================================= -->
					<div class="wave-top" style="position: absolute; top: 0; left: 0; width: 100%; background-image: url({{asset('/course/demos/course/images/wave-3.svg')}}); height: 12px; z-index: 2; background-repeat: repeat-x;"></div>
						...
						<div class="row mt-2">
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									<a href="#"><img class="card-img-top" src="{{asset('course/demos/course/images/courses/1.jpg')}}" alt="Card image cap"></a>
									<div class="card-body">
										<h4 class="card-title fw-bold mb-2"><a href="#">Spanish Language Learning For Absolute Beginners</a></h4>
										<p class="mb-2 card-title-sub text-uppercase fw-normal ls1"><a href="#" class="text-black-50">Language</a></p>
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									<a href="#"><img class="card-img-top" src="{{asset('course/demos/course/images/courses/2.jpg')}}" alt="Card image cap"></a>
									<div class="card-body">
										<h4 class="card-title fw-bold mb-2"><a href="#">Music Theory for Electronic Producers - The Complete Course!</a></h4>
										<p class="mb-2 card-title-sub text-uppercase fw-normal ls1"><a href="#" class="text-black-50">Music</a></p>
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									<a href="#"><img class="card-img-top" src="{{asset('course/demos/course/images/courses/3.jpg')}}" alt="Card image cap"></a>
									<div class="card-body">
										<h4 class="card-title fw-bold mb-2"><a href="#">Ultimate Photoshop Training: From Beginner to Pro</a></h4>
										<p class="mb-2 card-title-sub text-uppercase fw-normal ls1"><a href="#" class="text-black-50">Design Tools</a></p>
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									<a href="#"><img class="card-img-top" src="{{asset('course/demos/course/images/courses/4.jpg')}}" alt="Card image cap"></a>
									<div class="card-body">
										<h4 class="card-title fw-bold mb-2"><a href="#">Blockchain Advanced Level: Uses Beyond Bitcoin 2021</a></h4>
										<p class="mb-2 card-title-sub text-uppercase fw-normal ls1"><a href="#" class="text-black-50">Business</a></p>
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									<a href="#"><img class="card-img-top" src="{{asset('course/demos/course/images/courses/5.jpg')}}" alt="Card image cap"></a>
									<div class="card-body">
										<h4 class="card-title fw-bold mb-2"><a href="#">Cognitive Behavioural Therapy (CBT) Practitioner Certificate</a></h4>
										<p class="mb-2 card-title-sub text-uppercase fw-normal ls1"><a href="#" class="text-black-50">Health & Fitness</a></p>
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									<a href="#"><img class="card-img-top" src="{{asset('course/demos/course/images/courses/6.jpg')}}" alt="Card image cap"></a>
									<div class="card-body">
										<h4 class="card-title fw-bold mb-2"><a href="#">Masterclass: Start Your Food Business 7 courses in 1</a></h4>
										<p class="mb-2 card-title-sub text-uppercase fw-normal ls1"><a href="#" class="text-black-50">Food Recipes</a></p>
										<div class="rating-stars mb-2"><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star-half"></i> <span>4.4</span></div>
										<p class="card-text text-black-50 mb-1">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									</div>
									<div class="card-footer py-3 d-flex justify-content-between align-items-center bg-white text-muted">
					...
					============================================= -->
					<div class="wave-bottom" style="position: absolute; top: auto; bottom: 0; left: 0; width: 100%; background-image: url({{asset('/course/demos/course/images/wave-3.svg')}}); height: 12px; z-index: 2; background-repeat: repeat-x; transform: rotate(180deg);"></div>
				</div>
						...
						<div class="row">
							...
							<div class="col-lg-3 col-sm-6 mb-4">
								<div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
									<div class="fbox-icon">
										<i><img src="{{asset('course/demos/course/images/instructor/1.jpg')}}" class="border-0 bg-transparent shadow-sm" style="z-index: 2;" alt="Image"></i>
									</div>
							...
							<div class="col-lg-3 col-sm-6 mb-4">
								<div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
									<div class="fbox-icon">
										<i><img src="{{asset('course/demos/course/images/instructor/2.jpg')}}" class="border-0 bg-transparent shadow-sm" style="z-index: 2;" alt="Image"></i>
									</div>
									<div class="fbox-content">
							...
							<div class="col-lg-3 col-sm-6 mb-4">
								<div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
									<div class="fbox-icon">
										<i><img src="{{asset('course/demos/course/images/instructor/3.jpg')}}" class="border-0 bg-transparent shadow-sm" style="z-index: 2;" alt="Image"></i>
									</div>
									<div class="fbox-content">
							...
							<div class="col-lg-3 col-sm-6 mb-4">
								<div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
									<div class="fbox-icon">
										<i><img src="{{asset('course/demos/course/images/instructor/4.jpg')}}" class="border-0 bg-transparent shadow-sm" style="z-index: 2;" alt="Image"></i>
									</div>
									<div class="fbox-content">
				...
				<!-- Featues Section
				============================================= -->
				<div class="section mt-5 mb-0" style="padding: 120px 0; background-image: url({{asset('/course/demos/course/images/icon-pattern-bg.jpg')}}); background-size: auto; background-repeat: repeat">
								...
								<div class="row dark clearfix">
									...
									<div class="col-md-6">
										<div class="feature-box media-box bottommargin">
											<div class="fbox-icon">
												<a href="#">
													<i class="icon-line2-note rounded-0 bg-transparent text-start"></i>
												</a>
											</div>
											<div class="fbox-content">
									...
									<div class="col-md-6">
										<div class="feature-box media-box bottommargin">
											<div class="fbox-icon">
												<a href="#">
													<i class="icon-line2-globe rounded-0 bg-transparent text-start"></i>
												</a>
											</div>
											<div class="fbox-content">
							...
							<div class="col-lg-4">
								...
								<div class="card shadow" data-animate="shake" style="opacity: 1 !important">
									<div class="card-body">
										...
										<h4 class="card-title ls-1 mt-4 fw-bold h5">Get Your Free Online Courses!</h4>
										<h6 class="card-subtitle mb-4 fw-normal text-uppercase ls2 text-black-50">Free Registration here.</h6>
										...
										<div class="form-widget">
											...
											<form class="row mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
												...
												<div class="col-12 form-group">
													<button class="button button-rounded w-100 button-large bg-color text-white nott ls0 mx-0" type="submit" id="template-contactform-submit" name="template-contactform-submit" value="submit">Apply It Now</button>
													<br>
				...
				<!-- Promo Section
				============================================= -->
				<div class="section m-0" style="padding: 120px 0; background: #FFF url({{asset('/course/demos/course/images/instructor.jpg')}}) no-repeat left top / cover">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-5">
								...
								<a href="#" class="button button-rounded button-xlarge ls0 ls0 nott fw-normal m-0">Start Teaching</a>
							</div>
		...
		<footer id="footer" class="dark">
			<div class="container">
				...
				<div class="footer-widgets-wrap">
					...
					<div class="row">
						<div class="col-6 col-md"  style="background: url({{asset('/course/images/world-map.png')}}) no-repeat center center; background-size: 100%;">
							<img class="mb-3" src="{{asset('course/demos/course/images/logo-footer.png')}}" alt="Image" width="160">
							...
							<a href="#" class="mb-2 d-block"><i class="icon-line2-call-in me-2"></i>+1-111-222-333</a>
							<a href="#"><i class="icon-line2-envelope me-2"></i>info@canvas.com</a>
						</div>
						<div class="col-6 col-md">
							<h4 class="text-uppercase ls2 fw-normal">Best Courses</h4>
						...
						<div class="col-6 col-md mt-4 mt-md-0 mt-lg-0 mt-xl-0">
							...
							<a href="#"><img src="{{asset('course/demos/course/images/map.png')}}" alt="Image"></a>
						</div>
					</div>
