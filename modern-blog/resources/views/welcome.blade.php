			...
			<div id="header-wrap">
				<div class="container-fluid">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="index.html" class="standard-logo" data-mobile-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
							<a href="index.html" class="retina-logo" data-mobile-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
					...
					<div class="row grid-container infinity-wrapper clearfix">
						...
						<div class="col-md-6 p-3">
							<div class="entry mb-1 clearfix">
								<div class="entry-image mb-3">
									<a href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/1.jpg')}}" data-lightbox="image" style="background: url({{asset('/modernblog/demos/modern-blog/images/items/1.jpg')}}) no-repeat center center; background-size: cover; height: 278px;"></a>
								</div>
						...
						<div class="col-md-6 p-3">
							<div class="entry mb-1 clearfix">
								<div class="entry-user">
									<img src="{{asset('modernblog/demos/modern-blog/images/user/semicolonweb-logo.png')}}" alt="Image">
									<h4>SemiColoWeb Tech.<span>Themeforest.net</span></h4>
								</div>
								<div class="entry-image mb-3">
									<a href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/2.jpg')}}" data-lightbox="image" style="background: url({{asset('/modernblog/demos/modern-blog/images/items/2.jpg')}}) no-repeat center center; background-size: cover; height: 190px;">
									</a>
								</div>
								<div class="entry-title">
						...
						<div class="col-md-6 p-3">
							<div class="entry mb-1 clearfix">
								<div class="entry-image mb-3">
									<a href="#">
										<video poster="{{asset('modernblog/images/videos/explore-poster.jpg')}}" preload="auto" loop autoplay muted style="display: block; width: 100%;">
											<source src="{{asset('modernblog/images/videos/explore.mp4')}}" type='video/mp4' />
										</video>
									</a>
								</div>
								<div class="entry-title">
						...
						<div class="col-md-6 p-3">
							<div class="entry mb-1 clearfix">
								...
								<div class="entry-image mb-3">
									<a href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/3.jpg')}}" data-lightbox="image" style="background: url({{asset('/modernblog/demos/modern-blog/images/items/3.jpg')}}) no-repeat center bottom; background-size: cover; height: 210px;">
									</a>
								</div>
								<div class="entry-content">
							...
							<div class="entry mb-1 clearfix">
								<div class="entry-image mb-3">
									<div class="fslider" data-arrows="false" data-lightbox="gallery">
										<div class="flexslider">
											<div class="slider-wrap">
												<div class="slide"><a href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/4-1.jpg')}}" data-lightbox="gallery-item" style="background: url({{asset('/modernblog/demos/modern-blog/images/items/4-1.jpg')}}) no-repeat center bottom; background-size: cover; height: 278px;"></a></div>
												<div class="slide"><a href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/4-2.jpg')}}" data-lightbox="gallery-item" style="background: url({{asset('/modernblog/demos/modern-blog/images/items/4-2.jpg')}}) no-repeat center bottom; background-size: cover; height: 278px;"></a></div>
												<div class="slide"><a href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/4-3.jpg')}}" data-lightbox="gallery-item" style="background: url({{asset('/modernblog/demos/modern-blog/images/items/4-3.jpg')}}) no-repeat center bottom; background-size: cover; height: 278px;"></a></div>
											</div>
										</div>
									</div>
								</div>
						...
						<!-- ARTICLE NO. 7 -->
						<div class="col-md-6 p-3">
							<div class="entry mb-1 dark clearfix" style="background: url({{asset('/modernblog/demos/modern-blog/images/items/5.jpg')}}) no-repeat center bottom; background-size: cover; height: 525px;">
						...
						<div class="col-md-6 p-3">
							<div class="entry mb-1 clearfix">
								...
								<div class="entry-image" style="padding-left: 20px; padding-right: 20px;">
									<a href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/8.jpg')}}" data-lightbox="image" style="background: url({{asset('/modernblog/demos/modern-blog/images/items/8.jpg')}}) no-repeat center bottom; background-size: cover; height: 160px;">
									</a>
								</div>
								<div class="entry-meta no-separator nohover">
									<ul class="justify-content-between mx-0">
							...
							<div class="entry mb-1 clearfix">
								...
								<div class="entry-image">
									<div class="masonry-thumbs grid-container" data-big="2" data-lightbox="gallery">
										<a class="grid-item" href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/9-1.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('modernblog/demos/modern-blog/images/items/9-1.jpg')}}" alt="Gallery Thumb 1"></a>
										<a class="grid-item" href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/9-2.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('modernblog/demos/modern-blog/images/items/9-2.jpg')}}" alt="Gallery Thumb 2"></a>
										<a class="grid-item" href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/9-3.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('modernblog/demos/modern-blog/images/items/9-3.jpg')}}" alt="Gallery Thumb 3"></a>
										<a class="grid-item" href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/9-4.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('modernblog/demos/modern-blog/images/items/9-4.jpg')}}" alt="Gallery Thumb 4"></a>
										<a class="grid-item" href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/9-5.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('modernblog/demos/modern-blog/images/items/9-5.jpg')}}" alt="Gallery Thumb 5"></a>
										<a class="grid-item" href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/9-6.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('modernblog/demos/modern-blog/images/items/9-6.jpg')}}" alt="Gallery Thumb 6"></a>
										<a class="grid-item" href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/9-7.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('modernblog/demos/modern-blog/images/items/9-7.jpg')}}" alt="Gallery Thumb 7"></a>
										<a class="grid-item" href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/9-8.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('modernblog/demos/modern-blog/images/items/9-8.jpg')}}" alt="Gallery Thumb 9"></a>
										<a class="grid-item" href="{{asset('modernblog/demos/modern-blog/images/items/lightbox/9-9.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('modernblog/demos/modern-blog/images/items/9-9.jpg')}}" alt="Gallery Thumb 10"></a>
									</div>
								</div>
								<div class="entry-content">
				...
				<div class="section bg-white pt-4 pb-0 topmargin-sm mb-0">
					<div class="container">
						<div class="heading-block d-flex justify-content-center center border-bottom-0 mb-4">
							<img src="{{asset('modernblog/demos/modern-blog/images/instagram.png')}}" class="align-self-center" alt="Image" height="28"><h3 class="ms-2 text-capitalize ls0 align-self-center">Instagram Feed</h3>
						</div>
					</div>
