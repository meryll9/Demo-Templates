...
<footer id="footer" class="dark bg-color border-top-0"
    style="background:  url({{ asset('/covidcare/demos/covid-care/images/illustration/footer-bg.svg') }}) repeat center center / contain;">
    <div class="container">
        ...
        <div class="footer-widgets-wrap">
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 mb-3 text-center">
                    ...
                    <a href="#"
                        class="button button-light button-large rounded-pill bg-color-2 text-dark px-4 py-2 h-op-09 op-ts">Register</a>
                    <a href="#"
                        class="button button-light button-large bg-white rounded-pill color px-4 py-2 ms-2 h-op-09 op-ts">Download
                        App</a>
                </div>
