	...
	<div id="wrapper" class="clearfix">
					...
					<div class="header-row">
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								<li class="menu-item"><a class="menu-link" href="demo-covid-care.html"><div>Home</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-covid-care-about.html"><div>About Us</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-covid-care-services.html"><div>Services</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-covid-care-blog.html"><div>Blog</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-covid-care-contact.html"><div>Contact</div></a></li>
							</ul>
		...
		<section id="content">
			<div class="content-wrap">
						...
						<div class="col-xl-9 col-lg-11">
							<div class="row feature-box-border col-mb-30 justify-content-center align-items-center">
								...
								<div class="col-md-4 text-center">
									<img src="{{asset('covidcare/demos/covid-care/images/illustration/doctors.svg')}}" alt="Image" class="p-4" height="230">
								</div>
								...
								<div class="col-md-4 text-center">
									<img src="{{asset('covidcare/demos/covid-care/images/illustration/diet.jpg')}}" alt="Image" class="p-4" height="230">
								</div>
								...
								<div class="col-md-4 text-center">
									<img src="{{asset('covidcare/demos/covid-care/images/illustration/nurse.png')}}" alt="Image" class="p-4" height="230">
								</div>
								...
								<div class="col-md-4 text-center">
									<img src="{{asset('covidcare/demos/covid-care/images/illustration/delivery.svg')}}" alt="Image" class="p-4" height="230">
								</div>
								...
								<div class="col-md-4 text-center">
									<img src="{{asset('covidcare/demos/covid-care/images/illustration/support.svg')}}" alt="Image" class="p-5" height="230">
								</div>
					...
					<div class="row justify-content-between align-items-center my-6 col-mb-50">
						<div class="col-lg-5">
							...
							<div class="feature-box fbox-sm mb-4">
								...
								<div class="fbox-content">
									<h3 class="nott text-larger fw-normal mb-2">Masks, Sanitizers and Gloves will be provided.</h3>
								</div>
							</div>
							...
							<a href="#" class="color fw-bold border-bottom border-width-2 border-color me-2 text-capitalize">Learn more about our Support</a><i class="icon-chevron-right icon-stacked text-smaller color"></i>
						</div>
						<div class="col-lg-6">
							<img src="{{asset('covidcare/demos/covid-care/images/phone.jpg')}}" alt="Phone call" class="rounded">
						</div>
					</div>
					...
					<div class="row justify-content-between align-items-center my-6 col-mb-50">
						<div class="col-lg-5">
							...
							<div class="clear"></div>
								...
								<a href="#" class="color fw-bold border-bottom border-width-2 border-color me-2 text-capitalize">Learn more</a><i class="icon-chevron-right icon-stacked text-smaller color"></i>
						</div>
						<div class="col-lg-6">
				...
				============================================= -->
				<div class="section py-md-0 section-mobile bg-color-2" style="background:  url({{asset('/covidcare/demos/covid-care/images/illustration/bg-pattern.svg')}}) no-repeat center left / contain;">
					<div class="container">
						<div class="row align-items-center justify-content-between">
							...
							<div class="col-lg-5 col-md-6 py-5 py-lg-0">
								...
								<div>
									<a href="#"><img src="{{asset('covidcare/demos/articles/images/appstore.png')}}" alt="Image" height="54" class="mt-3"></a>
									<a href="#"><img src="{{asset('covidcare/demos/articles/images/googleplay.png')}}" alt="Image"  class="ms-xl-3 ms-lg-1 mt-3 ms-0 " height="54"></a>
								</div>
							</div>

							<div class="col-lg-6 col-md-6 mt-5 mt-sm-0">
								<div class="d-none d-lg-flex">
									<img src="{{asset('covidcare/demos/covid-care/images/iphone-2.png')}}" class="fast" alt="Image" style="height: 600px" data-animate="fadeInUp" data-delay="200">
									<img src="{{asset('covidcare/demos/covid-care/images/iphone-1.png')}}" class="fast" alt="Image" style="height: 600px" data-animate="fadeInUp">
								</div>
								<img src="{{asset('covidcare/demos/covid-care/images/iphone.png')}}" alt="Image" class="d-block d-lg-none px-5 px-sm-0 p-md-5">
							</div>
		...
		<!-- Footer
		============================================= -->
		<footer id="footer" class="dark bg-color border-top-0" style="background:  url({{asset('/covidcare/demos/covid-care/images/illustration/footer-bg.svg')}}) repeat center center / contain;">
			<div class="container">
