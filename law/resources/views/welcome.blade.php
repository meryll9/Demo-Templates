...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="slider" class="slider-element dark min-vh-md-100 min-vh-75 include-header">
			<div class="slider-inner" style="background-image: linear-gradient(to bottom, rgba(0,0,0,.5), rgba(0,0,0,.3)), url('law/demos/law-firm/images/hero.jpg'); background-position: 50% 0;">
				<div class="container">
		...
		<section id="content">
			<div class="content-wrap overflow-visible py-0">
					...
					<div class="row align-items-center justify-content-center mt-6 mt-lg-0 bottommargin-sm">
						<div class="col-lg-5 col-10 px-5">
							<div class="lady-justice-img position-relative">
								<img src="{{ asset('law/demos/law-firm/images/lady-justice.jpg')}}" alt="Image" class="rounded">
							</div>
						</div>
				...
				<div id="section-contact" class="section bg-color dark topmargin-lg" style="background-image: linear-gradient(to bottom, rgba(var(--themecolorrgba),.8), rgba(var(--themecolorrgba),1)), url('law/demos/law-firm/images/bg-1.jpg'); background-attachment: fixed; background-size: cover;">
											...
											<div class="card-body p-4">
												<div class="row">
													...
													<div class="d-flex align-items-center">
														<img class="rounded-circle me-3" src="{{ asset('law/demos/articles/images/authors/2.jpg')}}" width="48" height="48" alt="Customer Testimonails">
														<div>
										...
										<div class="card rounded-6 overflow-hidden">
											<div class="card-body p-4">
												<div class="row">
													...
													<div class="d-flex align-items-center">
														<img class="rounded-circle me-3" src="{{ asset('law/demos/articles/images/authors/1.jpg')}}" width="48" height="48" alt="Customer Testimonails">
														<div>
										...
										<div class="card rounded-6 overflow-hidden">
											<div class="card-body p-4">
												<div class="row">
													...
													<div class="d-flex align-items-center">
														<img class="rounded-circle me-3" src="{{ asset('law/demos/articles/images/authors/3.jpg')}}" width="48" height="48" alt="Customer Testimonails">
														<div>
