	...
	<div id="wrapper" class="clearfix">
			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						...
						<div class="swiper-slide-bg" style="background-image: url({{asset('/construction/demos/construction/images/slider/2.jpg')}}); background-position: center top;"></div>
					</div>
					<div class="swiper-slide">
						<div class="container">
						...
						<div class="video-wrap">
							<video id="slide-video" poster="{{asset('construction/demos/construction/images/videos/1.jpg')}}" preload="auto" loop autoplay muted>
								<source src="{{asset('construction/demos/construction/images/videos/1.webm')}}" type='video/webm' />
								<source src="{{asset('construction/demos/construction/images/videos/1.mp4')}}" type='video/mp4' />
							</video>
					...
					<div class="swiper-slide">
						...
						<div class="swiper-slide-bg" style="background-image: url({{asset('/construction/demos/construction/images/slider/1.jpg')}}); background-position: center bottom;"></div>
					</div>
				</div>
		...
		<section id="content">
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="row justify-content-center col-mb-50">
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box media-box">
								<div class="fbox-media">
									<img class="rounded" src="{{asset('/construction/demos/construction/images/services/1.jpg')}}" alt="Why choose Us?">
								</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box media-box">
								<div class="fbox-media">
									<img class="rounded" src="{{asset('/construction/demos/construction/images/services/2.jpg')}}" alt="Why choose Us?">
								</div>
								<div class="fbox-content px-0">
				...
				<div class="section parallax dark" style="background-image: url({{asset('/construction/demos/construction/images/slider/1.jpg')}}); padding: 120px 0;"  data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
							...
							<div class="slider-wrap">
								<div class="slide">
									<div class="testi-image">
										<a href="#"><img src="{{asset('/construction/images/testimonials/3.jpg')}}" alt="Customer Testimonails"></a>
									</div>
								...
								<div class="slide">
									<div class="testi-image">
										<a href="#"><img src="{{asset('/construction/images/testimonials/2.jpg')}}" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
								...
								<div class="slide">
									<div class="testi-image">
										<a href="#"><img src="{{asset('/construction/images/testimonials/1.jpg')}}" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
					...
					<div class="row align-items-stretch col-mb-50">
						<div class="col-lg-4 col-md-6">
							<div class="feature-box fbox-plain">
								<div class="fbox-icon">
									<a href="#"><img src="{{asset('/construction/demos/construction/images/icons/building.png')}}" alt="Concrete Developments"></a>
								</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box fbox-plain">
								<div class="fbox-icon">
									<a href="#"><img src="{{asset('/construction/demos/construction/images/icons/bank.png')}}" alt="Finance Assistance"></a>
								</div>
								<div class="fbox-content">
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box fbox-plain">
								<div class="fbox-icon">
									<a href="#"><img src="{{asset('/construction/demos/construction/images/icons/drawer.png')}}" alt="Interiorly Designed"></a>
								</div>
								<div class="fbox-content">
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box fbox-plain">
								<div class="fbox-icon">
									<a href="#"><img src="{{asset('/construction/demos/construction/images/icons/paper-money.png')}}" alt="Cost Effective Solutions"></a>
								</div>
								<div class="fbox-content">
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box fbox-plain">
								<div class="fbox-icon">
									<a href="#"><img src="{{asset('/construction/demos/construction/images/icons/traffic-cone.png')}}" alt="Smart Builders"></a>
								</div>
								<div class="fbox-content">
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box fbox-plain">
								<div class="fbox-icon">
									<a href="#"><img src="{{asset('/construction/demos/construction/images/icons/paint-brush.png')}}" alt="Quality Infrastructure"></a>
								</div>
								<div class="fbox-content">
				...
				<a href="portfolio.html" class="button button-3d border-bottom-0 button-full center text-end bottommargin-lg fw-light font-primary" style="font-size: 26px;">
					<div class="container clearfix">
							...
							<div class="tabs tabs-justify mb-0 clearfix" id="construction-tabs">
								...
								<div class="tab-container">
									...
									<div class="tab-content clearfix" id="construction-tab-2">
										<img src="{{asset('/construction/demos/construction/images/projects/3.jpg')}}" width="260" alt="Image" class="img-thumbnail alignleft">
					...
					<div class="row col-mb-50">
						<div class="col-md-5">
							...
							<ul class="clients-grid grid-2 grid-sm-3 mb-0">
								<li class="grid-item" style="padding: 20px;"><a href="#"><img src="{{asset('/construction/images/clients/1.png')}}" alt="Clients"></a></li>
								<li class="grid-item" style="padding: 20px;"><a href="#"><img src="{{asset('/construction/images/clients/2.png')}}" alt="Clients"></a></li>
								<li class="grid-item" style="padding: 20px;"><a href="#"><img src="{{asset('/construction/images/clients/3.png')}}" alt="Clients"></a></li>
								<li class="grid-item" style="padding: 20px;"><a href="#"><img src="{{asset('/construction/images/clients/4.png')}}" alt="Clients"></a></li>
								<li class="grid-item" style="padding: 20px;"><a href="#"><img src="{{asset('/construction/images/clients/5.png')}}" alt="Clients"></a></li>
								<li class="grid-item" style="padding: 20px;"><a href="#"><img src="{{asset('/construction/images/clients/6.png')}}" alt="Clients"></a></li>
							</ul>
						</div>
						...
						<div class="col-md-7">
							...
							<div id="oc-posts" class="owl-carousel posts-carousel carousel-widget posts-md" data-margin="20" data-nav="true" data-pagi="true" data-items-xs="1" data-items-xl="2">
								...
								<div class="oc-item">
									<div class="entry">
										<div class="entry-image">
											<a href="demos/construction/images/blog/5.jpg')}}" data-lightbox="image"><img src="{{asset('/construction/demos/construction/images/blog/5.jpg')}}" alt="Standard Post with Image"></a>
										</div>
									...
									<div class="entry">
										<div class="entry-image">
											<div class="fslider" data-arrows="false" data-lightbox="gallery">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide"><a href="demos/construction/images/blog/2.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('/construction/demos/construction/images/blog/2.jpg')}}" alt="Standard Post with Gallery"></a></div>
														<div class="slide"><a href="demos/construction/images/blog/1.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('/construction/demos/construction/images/blog/1.jpg')}}" alt="Standard Post with Gallery"></a></div>
														<div class="slide"><a href="demos/construction/images/blog/3.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('/construction/demos/construction/images/blog/3.jpg')}}" alt="Standard Post with Gallery"></a></div>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="oc-item">
									<div class="entry">
										<div class="entry-image">
											<a href="demos/construction/images/blog/4.jpg')}}" data-lightbox="image"><img src="{{asset('/construction/demos/construction/images/blog/4.jpg')}}" alt="Standard Post with Image"></a>
										</div>
										<div class="entry-title title-sm nott">
				...
				<div class="section bg-transparent mt-0 p-0 footer-stick">
					<div class="container clearfix">
						...
						<div class="row">
							<div class="col-lg-7">
								<img src="{{asset('/construction/demos/construction/images/services/bottom-trust.jpg')}}" alt="Bottom Trust">
							</div>
					...
					<div class="row">
						<div class="col-lg-9">
							<div class="widget clearfix">
								...
								<img src="{{ env('APP_LOGO') }}" alt="Image" class="alignleft" style="margin-top: 8px; padding-right: 18px; border-right: 1px solid #4A4A4A;">
