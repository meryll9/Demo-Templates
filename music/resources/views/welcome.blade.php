			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="index.html" class="standard-logo" data-dark-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
							<a href="index.html" class="retina-logo" data-dark-logo="{{ env('APP_LOGO') }}"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
					...
					<div class="swiper-slide dark">
						<div class="container">
							<div class="slider-caption justify-content-end">
								<div>
									<h2 class="font-primary nott">{{ env('APP_TAGLINE') }}</h2>
									<p class="d-none d-md-block">From the New York City of the World.</p>
									<a class="button button-rounded fw-normal ls1 track-list mt-3 clearfix" data-track="{{asset('music/demos/music/tracks/the-terror-of-highway.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/the-terror-of-highway.jpg')}}" data-title="The Terror Of Highway" data-singer="United Album"><i class="icon-play"></i>Play Now</a>
									<a href="#" class="button d-none d-md-inline-block button-rounded mt-3 px-3" style="background-color: #1f2330;"><i class="icon-line-ribbon me-0"></i></a>
									<a href="#" class="button d-none d-md-inline-block button-rounded mt-3 px-3" style="background-color: #1f2330;"><i class="icon-line-heart me-0"></i></a>
									<a href="#" class="button d-none d-md-inline-block bg-transparent fw-light nott mt-3 px-3"><i class="icon-line-share color"></i>Share</a>
									<a href="#" class="button d-none d-md-inline-block bg-transparent fw-light nott mt-3 px-3 ms-0"><i class="icon-line-plus color"></i>Add</a>
								</div>
							</div>
						</div>
						<div class="swiper-slide-bg" style="background-image: url({{asset('/music/demos/music/images/slider/1.jpg')}}); background-position: bottom center;"></div>
					</div>
					<div class="swiper-slide dark">
						<div class="container">
							<div class="slider-caption justify-content-end">
								<div>
									...
									<a href="#" class="button button-rounded fw-normal ls1 track-list mt-3 clearfix" data-track="{{asset('music/demos/music/tracks/tammy-stan-devereaux.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/tammy-stan-devereaux.jpg')}}" data-title="sgt. peppers heart club band Edition" data-singer="the bettles 2021"><i class="icon-play"></i>Play Now</a>
									<a href="#" class="button d-none d-md-inline-block button-rounded mt-3 px-3" style="background-color: #1f2330;"><i class="icon-line-ribbon me-0"></i></a>
									<a href="#" class="button d-none d-md-inline-block button-rounded mt-3 px-3" style="background-color: #1f2330;"><i class="icon-line-heart me-0"></i></a>
									<a href="#" class="button d-none d-md-inline-block mt-3 px-3 bg-transparent fw-light nott" style="background-color: #1f2330;"><i class="icon-line-share color"></i>Share</a>
									<a href="#" class="button d-none d-md-inline-block mt-3 px-3 bg-transparent fw-light nott ms-0" style="background-color: #1f2330;"><i class="icon-line-plus color"></i>Add</a>
								</div>
							</div>
						</div>
						<div class="swiper-slide-bg" style="background-image: url({{asset('/music/demos/music/images/slider/2.jpg')}});"></div>
					</div>
					<div class="swiper-slide dark">
						<div class="container">
							<div class="slider-caption justify-content-end">
								<div>
									...
									<a href="#" class="button button-rounded fw-normal ls1 track-list mt-3 clearfix" data-track="{{asset('music/demos/music/tracks/the-end-of-the-beginning.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/the-end-of-the-beginning.jpg')}}" data-title="The End Of The Beginning" data-singer="The Unplugged Editions" style="margin-top: 15px"><i class="icon-play"></i>Play Now</a>
									<a href="#" class="button d-none d-md-inline-block button-rounded mt-3 px-3" style="background-color: #1f2330;"><i class="icon-line-ribbon me-0"></i></a>
									<a href="#" class="button d-none d-md-inline-block button-rounded mt-3 px-3" style="background-color: #1f2330;"><i class="icon-line-heart me-0"></i></a>
									<a href="#" class="button d-none d-md-inline-block mt-3 px-3 bg-transparent fw-light nott"><i class="icon-line-share color"></i>Share</a>
									<a href="#" class="button d-none d-md-inline-block mt-3 px-3 bg-transparent fw-light nott ms-0"><i class="icon-line-plus color"></i>Add</a>
								</div>
							</div>
						</div>
						<div class="swiper-slide-bg" style="background-image: url({{asset('/music/demos/music/images/slider/3.jpg')}}); background-position: bottom left;"></div>
					</div>
				</div>
				...
				<div class="container clearfix" style="z-index: 7;">
					...
					<div id="oc-popular-songs" class="owl-carousel image-carousel carousel-widget" data-margin="20" data-nav="true" data-pagi="false" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="6" data-items-xl="6">
						...
						<div class="oc-item" data-animate="fadeInDown">
							<img src="{{asset('music/demos/music/images/popular-songs/8.jpg')}}" alt="Image 1">
							<div class="bg-overlay">
								<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-center justify-content-between">
									...
									<div data-hover-animate="fadeIn" data-hover-speed="400">
										<a href="#" class="text-light mx-0 track-list" data-track="{{asset('music/demos/music/tracks/maq-amor.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/maq-amor.jpg')}}" data-title="Maq Amor" data-singer="The Universe"><i class="icon-play"></i></a>
									</div>
								</div>
							</div>
						</div>
						<div class="oc-item" data-animate="fadeInDown" data-delay="100">
							<img src="{{asset('music/demos/music/images/popular-songs/9.jpg')}}" alt="Image 1">
							<div class="bg-overlay">
								<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-center justify-content-between">
									<div class="portfolio-desc py-0">
									...
									<div data-hover-animate="fadeIn" data-hover-speed="400">
										<a href="#" class="text-light mx-0 track-list" data-track="{{asset('music/demos/music/tracks/stagger-lee.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/stagger-lee.jpg')}}" data-title="Stagger Lee" data-singer="Ed Sheeran"><i class="icon-play"></i></a>
									</div>
								</div>
							</div>
						</div>
						<div class="oc-item" data-animate="fadeInDown" data-delay="250">
							<img src="{{asset('music/demos/music/images/popular-songs/7.jpg')}}" alt="Image 1">
							<div class="bg-overlay">
								<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-center justify-content-between">
									<div class="portfolio-desc py-0">
									...
									<div data-hover-animate="fadeIn" data-hover-speed="400">
										<a href="#" class="text-light mx-0 track-list" data-track="{{asset('music/demos/music/tracks/clean-clean.mp3')}}" data-poster="{{asset('music/demos/music/images/popular-songs/7.jpg')}}" data-title="Clean Clean" data-singer="R Costello"><i class="icon-play"></i></a>
									</div>
								</div>
							</div>
						</div>
						<div class="oc-item" data-animate="fadeInDown" data-delay="400">
							<img src="{{asset('music/demos/music/images/popular-songs/1.jpg')}}" alt="Image 1">
							<div class="bg-overlay">
								<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-center justify-content-between">
									<div class="portfolio-desc py-0">
									...
									<div data-hover-animate="fadeIn" data-hover-speed="400">
										<a href="#" class="text-light mx-0 track-list" data-track="{{asset('music/demos/music/tracks/take_the_dare.mp3')}}" data-poster="{{asset('music/demos/music/images/popular-songs/1.jpg')}}" data-title="Take The Dare" data-singer="Bruno Mars"><i class="icon-play"></i></a>
									</div>
								</div>
							</div>
						</div>
						<div class="oc-item" data-animate="fadeInDown" data-delay="550">
							<img src="{{asset('music/demos/music/images/popular-songs/3.jpg')}}" alt="Image 1">
							<div class="bg-overlay">
								<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-center justify-content-between">
									<div class="portfolio-desc py-0">
									...
									<div data-hover-animate="fadeIn" data-hover-speed="400">
										<a href="#" class="text-light mx-0 track-list" data-track="{{asset('music/demos/music/tracks/fallin-extended-mix.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/fallin-extended-mix.jpg')}}" data-title="Fallin Extended Mix" data-singer="Justin"><i class="icon-play"></i></a>
									</div>
								</div>
							</div>
						</div>
						<div class="oc-item" data-animate="fadeInDown" data-delay="700">
							<img src="{{asset('music/demos/music/images/popular-songs/4.jpg')}}" alt="Image 1">
							<div class="bg-overlay">
								<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-center justify-content-between">
									<div class="portfolio-desc py-0">
									...
									<div data-hover-animate="fadeIn" data-hover-speed="400">
										<a href="#" class="text-light mx-0 track-list" data-track="{{asset('music/demos/music/tracks/i-need-you-now.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/i-need-you-now.jpg')}}" data-title="I Need You Now" data-singer="Skelton"><i class="icon-play"></i></a>
									</div>
								</div>
							</div>
						</div>
						<div class="oc-item" data-animate="fadeInDown">
							<img src="{{asset('music/demos/music/images/popular-songs/2.jpg')}}" alt="Image 1">
							<div class="bg-overlay">
								<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-center justify-content-between">
									<div class="portfolio-desc py-0">
									...
									<div data-hover-animate="fadeIn" data-hover-speed="400">
										<a href="#" class="text-light mx-0 track-list" data-track="{{asset('music/demos/music/tracks/tammy-stan-devereaux.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/tammy-stan-devereaux.jpg')}}" data-title="Tammy Stan Devereaux" data-singer="Devereaux"><i class="icon-play"></i></a>
									</div>
								</div>
							</div>
						</div>
						<div class="oc-item" data-animate="fadeInDown">
							<img src="{{asset('music/demos/music/images/popular-songs/5.jpg')}}" alt="Image 1">
							<div class="bg-overlay">
								<div class="bg-overlay-content text-overlay-mask dark desc-sm align-items-center justify-content-between">
									<div class="portfolio-desc py-0">
									...
									<div data-hover-animate="fadeIn" data-hover-speed="400">
										<a href="#" class="text-light mx-0 track-list" data-track="{{asset('music/demos/music/tracks/something-about-love.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/something-about-love.jpg')}}" data-title="Something About Love" data-singer="Sian"><i class="icon-play"></i></a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row topmargin-lg clearfix">
						<div class="col-lg-6">
							...
							<div class="songs-lists-wrap">
								...
								<div class="songs-list">
									...
									<div class="songs-image track-image col-auto">
										<a href="#" class="track-list"  data-track="{{asset('music/demos/music/tracks/ibelieveinyou.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/ibelieveinyou.jpg')}}" data-title="i Believe In You" data-singer="Lost European">
											<img src="{{asset('music/demos/music/tracks/poster-images/ibelieveinyou.jpg')}}" alt="Image 1"><span><i class="icon-play"></i></span>
										</a>
									</div>
								...
								<div class="songs-list">
									...
									<div class="songs-image track-image col-auto">
										<a href="#" class="track-list" data-track="{{asset('music/demos/music/tracks/i-need-you-now.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/i-need-you-now.jpg')}}" data-title="I Need You Now" data-singer="Skelton">
										<img src="{{asset('music/demos/music/tracks/poster-images/i-need-you-now.jpg')}}" alt="Image 1"><span><i class="icon-play"></i></span></a>
									</div>
								...
								<div class="songs-list">
									...
									<div class="songs-image track-image col-auto">
										<a href="#" class="track-list" data-track="{{asset('music/demos/music/tracks/something-about-love.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/something-about-love.jpg')}}" data-title="Something About Love" data-singer="Sian">
										<img src="{{asset('music/demos/music/tracks/poster-images/something-about-love.jpg')}}" alt="Image 1"><span><i class="icon-play"></i></span></a>
									</div>
								...
								<div class="songs-list">
									...
									<div class="songs-image track-image col-auto">
										<a href="#" class="track-list" data-track="{{asset('music/demos/music/tracks/maq-amor.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/maq-amor.jpg')}}" data-title="Maq Amor" data-singer="The Universe">
										<img src="{{asset('music/demos/music/tracks/poster-images/maq-amor.jpg')}}" alt="Image 1"><span><i class="icon-play"></i></span></a>
									</div>
								...
								<div class="songs-list">
									...
									<div class="songs-image track-image col-auto">
										<a href="#" class="track-list" data-track="{{asset('music/demos/music/tracks/searchin-lost-european.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/searchin-lost-european.jpg')}}" data-title="Searchin Lost European" data-singer="Lost European">
										<img src="{{asset('music/demos/music/tracks/poster-images/searchin-lost-european.jpg')}}" alt="Image 1"><span><i class="icon-play"></i></span></a>
									</div>
								...
								<div class="songs-list">
									...
									<div class="songs-image track-image col-auto">
										<a href="#" class="track-list" data-track="{{asset('music/demos/music/tracks/fallin-extended-mix.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/fallin-extended-mix.jpg')}}" data-title="Fallin Extended Mix" data-singer="Justin">
										<img src="{{asset('music/demos/music/tracks/poster-images/fallin-extended-mix.jpg')}}" alt="Image 1"><span><i class="icon-play"></i></span></a>
									</div>
							...
							<a href="#" class="button bg-transparent fw-light nott float-end ms-0" style="color: #AAA; padding: 0 16px;">See More..</a>
						</div>
						...
						<div class="tab-container music-tabs-albums">
							...
							<div class="tab-content clearfix" id="tabs-1">
								<div class="row gutter-20 align-items-stretch">
									...
									<div class="col-md-6 min-vh-40">
										<div class="grid-inner h-100" style="background-image: url({{asset('/music/demos/music/images/album-artworks/1/1.jpg')}});">
											<div class="bg-overlay">
												<div class="bg-overlay-content text-overlay-mask dark align-items-start justify-content-between">
													<div>
														...
														<div>
															<a href="#" class="button button-circle button-small fw-normal ls1 ms-0 track-list" data-track="{{asset('music/demos/music/tracks/fallin-extended-mix.mp3')}}" data-poster="{{asset('music/demos/music/tracks/poster-images/fallin-extended-mix.jpg')}}" data-title="Fallin Extended Mix" data-singer="Justin"><i class="icon-play"></i>Play Now</a>
															<a href="#" class="button button-circle button-small button-border button-white fw-normal ls1">View All</a>
														</div>
													</div>
												</div>
												<div class="bg-overlay-floating dropdown z-2" data-hover-animate="fadeIn">
													<a href="#"><i class="icon-line-heart"></i></a>
													<a href="#" data-bs-toggle="dropdown" data-bs-display="static"><i class="icon-line-ellipsis"></i></a>
										...
										<div class="row mx-0 gutter-20">
											<div class="col-6">
												<div class="grid-inner">
													<img src="{{asset('music/demos/music/images/album-artworks/1/2.jpg')}}" alt="Locked Steel Gate">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark align-items-start justify-content-between">
															<div class="portfolio-desc py-0">
											...
											<div class="col-6">
												<div class="grid-inner">
													<img src="{{asset('music/demos/music/images/album-artworks/1/3.jpg')}}" alt="Mac Sunglasses">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark align-items-start justify-content-between">
															<div class="portfolio-desc py-0">
											...
											<div class="col-12">
												<div class="grid-inner">
													<img src="{{asset('music/demos/music/images/album-artworks/1/4.jpg')}}" alt="Image">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark align-items-start justify-content-between">
															<div>
																<div class="portfolio-desc">
							...
							<div class="tab-content" id="tabs-2">
								<div class="row gutter-20 align-items-stretch">
									...
									<div class="col-md-6 min-vh-40">
										<div class="grid-inner h-100" style="background-image: url({{asset('/music/demos/music/images/album-artworks/2/1.jpg')}});">
											<div class="bg-overlay">
									...
									<div class="col-md-6 px-0">
										<div class="row mx-0 gutter-20">
											<div class="col-6">
												<div class="grid-inner">
													<img src="{{asset('music/demos/music/images/album-artworks/2/2.jpg')}}" alt="Locked Steel Gate">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark align-items-start justify-content-between">
															<div class="portfolio-desc">
											...
											<div class="col-6">
												<div class="grid-inner">
													<img src="{{asset('music/demos/music/images/album-artworks/2/3.jpg')}}" alt="Mac Sunglasses">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark align-items-start justify-content-between">
															<div class="portfolio-desc">
											...
											<div class="col-12">
												<div class="grid-inner">
													<img src="{{asset('music/demos/music/images/album-artworks/2/4.jpg')}}" alt="Image">
													<div class="bg-overlay">
														<div class="bg-overlay-content text-overlay-mask dark align-items-start justify-content-between">
															<div>
																<div class="portfolio-desc">
					...
					<div id="top-charts" class="portfolio grid-container row dark gutter-20 desc-sm" data-layout="fitRows">
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/1.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="100">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/2.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="200">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/3.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="300">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/4.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="400">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/5.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="500">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/6.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="50">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/7.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="150">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/8.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="250">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/9.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="350">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/10.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="450">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/11.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="550">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/12.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="200">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/13.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="300">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/14.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="400">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/15.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="500">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/16.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="600">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/17.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
						...
						<article class="portfolio-item col-6 col-md-3 col-lg-2" data-animate="fadeIn" data-delay="700">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="#">
										<img src="{{asset('music/demos/music/images/charts/18.jpg')}}" alt="Image">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="#" class="overlay-trigger-icon bg-dark text-ts text-light h-text-color" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="icon-line-folder"></i></a>
					...
					<div class="section bg-transparent topmargin-sm mb-0 clearfix">
						...
						<div class="singer-wrap clearfix">
							<a href="#" class="singer-bb-image big" style="background-image: url({{asset('/music/demos/music/images/singers/david.jpg')}});"><span>David Guetta</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/jennifer-lopez.jpg')}}); top: 0px; left: 3%;"><span>Jennifer Lopez</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/selena-gomez.jpg')}}); top: 43%; margin-left: -49%;"><span>Selena Gomez</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/bruno-mars.jpg')}}); top: 34%; margin-left: -38%;"><span>Bruno Mars</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/lady-gaga.jpg')}}); top: 0; margin-left: -33%;"><span>Lady Gaga</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/ariana-grande.jpg')}}); top: 0; margin-left: -20%;"><span>Ariana Grande</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/chris-brown.jpg')}}); top: auto; bottom: 0%; margin-left: -42%;"><span>Chris Brown</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/katy-perry.jpg')}}); top: 34%; margin-left: -27%;"><span>Katy Perry</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/flo-rida.jpg')}}); top: auto; bottom: 0; margin-left: -31%;"><span>Flo Rida</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/martin-garrix.jpg')}}); top: auto; bottom: 5%; margin-left: -21%;"><span>Martin Garrix</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/nicki-minaj.jpg')}}); top: 0px; left: auto; right: 4%;"><span>Nicki Minaj</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/justin-bieber.jpg')}}); top: 44%; margin-left: 41%;"><span>Justin Bieber</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/rihanna.jpg')}}); top: 32%; margin-left: 30%;"><span>Rihanna</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/ed-sheeran.jpg')}}); top: auto; bottom: 2%; margin-left: 34%;"><span>Ed Sheeran</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/u2.jpg')}}); top: 1%; margin-left: 26%;"><span>U2</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/drake.jpg')}}); top: 4%; margin-left: 14%;"><span>Drake</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/taylor-swift.jpg')}}); top: auto; bottom: 0; margin-left: 23%;"><span>Taylor Swift</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/eminem.jpg')}}); top: auto; bottom: 36%; margin-left: 19%;"><span>Eminem</span></a>
							<a href="#" class="singer-bb-image" style="background-image: url({{asset('/music/demos/music/images/singers/sia.jpg')}}); top: auto; bottom: 0; margin-left: 12.5%;"><span>Sia</span></a>
						</div>
					</div>
						...
						<div class="col-lg-7 col-md-5 offset-md-1 overflow-hidden">
							<div class="row clearfix">
								<div class="col-lg-6 order-lg-12">
									...
									<a href="#" class="button button-small button-rounded button-desc ms-0 clearfix"><i class="icon-apple"></i><div>App Store<span>Free Forever, Downlod It Now</span></div></a>
									<a href="#" class="button button-small button-rounded button-desc ms-0 clearfix" style="margin-top: 10px"><i class="icon-android"></i><div>Google Play<span>Free Forever, Downlod It Now</span></div></a>
								</div>
								<div class="d-block d-md-block d-lg-none topmargin clear"></div>
								<div class="col-lg-6 order-lg-1 d-sm-none d-md-none d-lg-block">
									<img src="{{asset('music/demos/music/images/iphone.png')}}" alt="Mobile" data-animate="fadeInUp">
								</div>
							</div>
						</div>
					</div>
