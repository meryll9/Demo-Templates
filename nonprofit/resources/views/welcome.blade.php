	...
	<div id="wrapper" class="clearfix">
				...
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark">
							...
							<div class="swiper-slide-bg" style="background: linear-gradient(rgba(0,0,0,.3), rgba(0,0,0,.5)), url({{asset('/nonprofit/demos/nonprofit/images/slider/1.jpg')}}) no-repeat center center; background-size: cover;"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption">
							...
							<div class="swiper-slide-bg" style="background: linear-gradient(rgba(0,0,0,0), rgba(0,0,0,.8)), url({{asset('/nonprofit/demos/nonprofit/images/slider/2.jpg')}}) no-repeat center center; background-size: cover;"></div>
						</div>
					</div>
		...
		<section id="content">
			<div class="content-wrap py-0" style="overflow: visible">
				...
				<div class="container">
					...
					<div class="slider-feature w-100">
						<div class="row justify-content-center">
							...
							<div class="col-md-3 px-1">
								<a href="demo-nonprofit-causes.html" class="card center border-start-0 border-end-0 border-top-0 border-bottom border-bottom shadow py-3 rounded-0 fw-semibold text-uppercase ls1">
									<div class="card-body">
				...
				<div class="section mt-3" style="background: #FFF url({{asset('/nonprofit/demos/nonprofit/images/others/1.jpg')}}) no-repeat 100% 50% / auto 100%;">
					<div class="container">
						<div class="row justify-content-center">
						...
						<div class="row mt-5 col-mb-50 mb-0">
							<div class="col-md-3">
								<div class="feature-box flex-column ps-0">
									<div class="fbox-media position-relative">
										<img src="{{asset('nonprofit/demos/nonprofit/images/icons/donate.svg')}}" alt="Featured Icon" width="60" class="mb-3">
									</div>
							...
							<div class="col-md-3">
								<div class="feature-box flex-column ps-0">
									<div class="fbox-media position-relative">
										<img src="{{asset('nonprofit/demos/nonprofit/images/icons/volunteer.svg')}}" alt="Featured Icon" width="60" class="mb-3">
									</div>
									<div class="fbox-content px-0">
							...
							<div class="col-md-3">
								<div class="feature-box flex-column ps-0">
									<div class="fbox-media position-relative">
										<img src="{{asset('nonprofit/demos/nonprofit/images/icons/help-child.svg')}}" alt="Featured Icon" width="60" class="mb-3">
									</div>
									<div class="fbox-content px-0">
				...
				<div class="container">
					<div class="w-100 position-relative">
						<div class="donor-img d-flex align-items-center rounded parallax mx-auto shadow-sm w-100" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -50px;" style="height: 500px; background: url({{asset('/nonprofit/demos/nonprofit/images/others/3.jpg')}}) no-repeat center center / cover"></div>
				...
				<div class="section bg-transparent mt-0 mb-4">
					...
					<div class="owl-carousel owl-carousel-full image-carousel carousel-widget topmargin-sm charity-card" data-stage-padding="20" data-margin="10" data-center="true" data-loop="true" data-nav="true" data-autoplay="500000" data-speed="400" data-pagi="true" data-items-xs="1" data-items-sm="2" data-items-md="2" data-items-lg="3" data-items-xl="4">
						...
						<div class="oc-item text-start">
							<img src="{{asset('nonprofit/demos/nonprofit/images/cause/1.jpg')}}" alt="Image 1" class="rounded">
						...
						<div class="oc-item text-start">
							<img src="{{asset('nonprofit/demos/nonprofit/images/cause/3.jpg')}}" alt="Image 1" class="rounded">
							<div class="oc-desc d-flex flex-column justify-content-center shadow-lg">
						...
						<div class="oc-item text-start">
							<img src="{{asset('nonprofit/demos/nonprofit/images/cause/2.jpg')}}" alt="Image 1" class="rounded">
							<div class="oc-desc d-flex flex-column justify-content-center shadow-lg">
						...
						<div class="oc-item text-start">
							<img src="{{asset('nonprofit/demos/nonprofit/images/cause/4.jpg')}}" alt="Image 1" class="rounded">
							<div class="oc-desc d-flex flex-column justify-content-center shadow-lg">
						...
						<div class="oc-item text-start">
							<img src="{{asset('nonprofit/demos/nonprofit/images/cause/5.jpg')}}" alt="Image 1" class="rounded">
							<div class="oc-desc d-flex flex-column justify-content-center shadow-lg">
								<small class="text-uppercase fw-normal ls1 color mb-2 d-block">Education</small>
								<h3 class="mb-3"><a href="demo-nonprofit-causes-single.html">Education for All</a></h3>
								<ul class="skills mb-3">
				...
				<div class="container-fluid my-5 clearfix">
					<div class="d-flex flex-column align-items-center justify-content-center center counter-section position-relative py-5" style="background: url({{asset('/nonprofit/demos/nonprofit/images/world-map.png')}}) no-repeat center center/ contain">
						...
						<div class="row align-items-stretch m-0 w-100 clearfix">
							...
							<div class="col-lg-3 col-sm-6 center mt-5">
								<img src="{{asset('nonprofit/demos/nonprofit/images/icons/breakfast.svg')}}" alt="Counter Icon" width="70" class="mb-4">
							...
							<div class="col-lg-3 col-sm-6 center mt-5">
								<img src="{{asset('nonprofit/demos/nonprofit/images/icons/volunteers.svg')}}" alt="Counter Icon" width="70" class="mb-4">
							...
							<div class="col-lg-3 col-sm-6 center mt-5">
								<img src="{{asset('nonprofit/demos/nonprofit/images/icons/educated.svg')}}" alt="Counter Icon" width="70" class="mb-4">
							...
							<div class="col-lg-3 col-sm-6 center mt-5">
								<img src="{{asset('nonprofit/demos/nonprofit/images/icons/shelter.svg')}}" alt="Counter Icon" width="70" class="mb-4">
				...
				<div class="section" style="background: url({{asset('/nonprofit/demos/nonprofit/images/others/section-bg.jpg')}}) no-repeat center center / cover; padding: 80px 0;">
					<div class="container clearfix">
						<div class="row">
							<div class="col-lg-8">
								...
								<div class="row mission-goals gutter-30 mb-0">
									<div class="col-md-6">
										<div class="feature-box fbox-plain bg-white mx-0">
											<div class="fbox-media position-relative col-auto p-0 me-4">
												<img src="{{asset('nonprofit/demos/nonprofit/images/icons/home.svg')}}" alt="Featured Icon 1" width="50">
											</div>
									...
									<div class="col-md-6">
										<div class="feature-box fbox-plain bg-white mx-0">
											<div class="fbox-media position-relative col-auto p-0 me-4">
												<img src="{{asset('nonprofit/demos/nonprofit/images/icons/health.svg')}}" alt="Featured Icon 2" width="50">
											</div>
											<div class="fbox-content">
									...
									<div class="col-md-6">
										<div class="feature-box fbox-plain bg-white mx-0">
											<div class="fbox-media position-relative col-auto p-0 me-4">
												<img src="{{asset('nonprofit/demos/nonprofit/images/icons/education.svg')}}" alt="Featured Icon 3" width="50">
											</div>
											<div class="fbox-content">
									...
									<div class="col-md-6">
										<div class="feature-box fbox-plain bg-white mx-0">
											<div class="fbox-media position-relative col-auto p-0 me-4">
												<img src="{{asset('nonprofit/demos/nonprofit/images/icons/animal.svg')}}" alt="Featured Icon 4" width="50">
											</div>
											<div class="fbox-content">
									...
									<div class="col-md-6">
										<div class="feature-box fbox-plain bg-white mx-0">
											<div class="fbox-media position-relative col-auto p-0 me-4">
												<img src="{{asset('nonprofit/demos/nonprofit/images/icons/environmental.svg')}}" alt="Featured Icon 5" width="50">
											</div>
											<div class="fbox-content">
									...
									<div class="col-md-6">
										<div class="feature-box fbox-plain bg-white mx-0">
											<div class="fbox-media position-relative col-auto p-0 me-4">
												<img src="{{asset('nonprofit/demos/nonprofit/images/icons/food.svg')}}" alt="Featured Icon 6" width="50">
											</div>
											<div class="fbox-content">
							...
							<div class="col-lg-2 col-md-4 col-6 mt-1">
								...
								<div class="team full-border imagescalein mt-5">
									<a href="#" class="team-image">
										<img src="{{asset('nonprofit/demos/nonprofit/images/volunteers/10.jpg')}}" alt="Apply Volunteer" class="rounded-0">
									</a>
								</div>
							</div>
						</div>
				...
				<div class="bg-color subscribe-section position-relative" style="margin-top: 100px;">
					...
					<div style="background-image: url({{asset('/nonprofit/demos/nonprofit/images/divider-4.svg')}}); position: absolute; bottom: -20px; left: 0; width: 100%; height: 60px; z-index: 1;"></div>
				</div>

				<div class="section m-0 p-0 row align-items-stretch clearfix" style="background-color: rgba(198,192,156, 0.15);">
					<div class="col-lg-4 dark d-flex flex-column align-items-center center justify-content-center" style="background: linear-gradient(rgba(0,0,0,.3), rgba(0,0,0,.5)), url({{asset('/nonprofit/demos/nonprofit/images/others/event.jpg')}}) center center repeat; background-size: cover; min-height: 300px;">
						...
						<div class="row justify-content-center">
							...
							<div class="col-md-11 my-5">
								<ul class="clients-grid grid-2 grid-sm-3 grid-md-5 mb-0">
									<li class="grid-item"><a href="#"><img src="{{asset('nonprofit/images/clients/1.png')}}" alt="Clients"></a></li>
									<li class="grid-item"><a href="#"><img src="{{asset('nonprofit/images/clients/2.png')}}" alt="Clients"></a></li>
									<li class="grid-item"><a href="#"><img src="{{asset('nonprofit/images/clients/3.png')}}" alt="Clients"></a></li>
									<li class="grid-item"><a href="#"><img src="{{asset('nonprofit/images/clients/4.png')}}" alt="Clients"></a></li>
									<li class="grid-item"><a href="#"><img src="{{asset('nonprofit/images/clients/5.png')}}" alt="Clients"></a></li>
									<li class="grid-item"><a href="#"><img src="{{asset('nonprofit/images/clients/6.png')}}" alt="Clients"></a></li>
									<li class="grid-item"><a href="#"><img src="{{asset('nonprofit/images/clients/7.png')}}" alt="Clients"></a></li>
									<li class="grid-item"><a href="#"><img src="{{asset('nonprofit/images/clients/8.png')}}" alt="Clients"></a></li>
									<li class="grid-item"><a href="#"><img src="{{asset('nonprofit/images/clients/9.png')}}" alt="Clients"></a></li>
									<li class="grid-item"><a href="#"><img src="{{asset('nonprofit/images/clients/10.png')}}" alt="Clients"></a></li>
								</ul>
							</div>
				...
				<div class="section section-details mb-0 bg-white" style="padding: 80px 0 160px;">
					<div class="w-100 h-100 d-none d-md-block" style="position: absolute; top: 0; left: 0; background: #FFF url({{asset('/nonprofit/demos/nonprofit/images/others/6.jpg')}}) no-repeat bottom right / cover;"></div>
					<div class="container clearfix">
						<div class="row">
		...
		<footer id="footer" style="background-color: #002D40;">
			...
			<div class="container">
				...
				<!-- Footer Widgets
				============================================= -->
				<div class="footer-widgets-wrap dark clearfix" style="background: radial-gradient(rgba(0,45,64,.5), rgba(0,45,64,.1), rgba(0,45,64,.5)), url({{asset('/nonprofit/demos/nonprofit/images/others/footer.jpg')}}) repeat center center / cover;  padding: 150px 0">
