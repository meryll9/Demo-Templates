...
<!-- Hero Section
		============================================= -->
		<section id="slider" class="slider-element min-vh-md-100 vh-50" style="background-image: linear-gradient(to bottom, rgba(255,255,255,.8), rgba(255,255,255,0)), url({{asset('/furniture/demos/furniture/images/about/hero.jpg')}}); background-position: center 10%; background-size: cover;">
				...
				<div class="section bg-transparent my-0 py-0">
					<div class="container-fluid">
						...
						<div class="row align-items-md-center">
							<!-- Image -->
							<div class="col-md-6 px-lg-0 min-vh-50 min-vh-lg-75 d-flex align-self-stretch" style="background: url({{asset('furniture/demos/furniture/images/about/1.jpg')}}) no-repeat center center; background-size: cover;">
							</div>
						...
						<div class="row flex-md-row-reverse align-items-md-center">
							<!-- Image -->
							<div class="col-md-6 px-lg-0 min-vh-50 min-vh-lg-75 d-flex align-self-stretch" style="background: url({{asset('furniture/demos/furniture/images/about/2.jpg')}}) no-repeat center center; background-size: cover;">
							</div>
						...
						<div class="row align-items-md-center">
							<!-- Image -->
							<div class="col-md-6 px-lg-0 min-vh-50 min-vh-lg-75 d-flex align-self-stretch" style="background: url({{asset('furniture/demos/furniture/images/about/3.jpg')}}) no-repeat center center; background-size: cover;">
							</div>
						...
						<div class="row flex-md-row-reverse align-items-md-center">
							<!-- Image -->
							<div class="col-md-6 px-lg-0 min-vh-50 min-vh-lg-75 d-flex align-self-stretch" style="background: url({{asset('furniture/demos/furniture/images/about/4.jpg')}}) no-repeat center center; background-size: cover;">
							</div>
