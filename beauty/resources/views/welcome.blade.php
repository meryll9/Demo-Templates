	...
	<div id="wrapper" class="clearfix">
			...
			<div class="slider-inner">
				...
				<div id="welcome_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="reveal-add-on39" data-source="gallery" style="background:#FFF;padding:0px; width: 100% !important;">
					...
					<div id="rev_slider_139_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.8">
						<ul>
							<!-- SLIDE  -->
							<li data-index="rs-353" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('beauty/demos/beauty/images/slider/100x50_181c1-1.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
								<!-- MAIN IMAGE -->
								<img src="{{asset('beauty/demos/beauty/images/slider/181c1-1.jpg')}}"  alt="Image"  data-bgposition="left center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->
								...
								<div class="tp-caption   tp-resizeme"
									...
									style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 58px; line-height: 76px; font-weight: 400; color: #000000; letter-spacing: -2px;font-family:var(--font1);">Hairstylists Bring Out The Beauty In You.</div>
							</li>
							<!-- SLIDE  -->
							<li data-index="rs-354" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('beauty/demos/beauty/images/slider/100x50_5258d-2.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
								<!-- MAIN IMAGE -->
								<img src="{{asset('beauty/demos/beauty/images/slider/5258d-2.jpg')}}"  alt="Image"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->

								<!-- LAYER NR. 1 -->
								<a href="#" class="tp-caption button button-circle rev-btn ls1 button-large button-white button-light tp-resizeme"
								...
								<div class="tp-caption  text-start tp-resizeme"
									...
									style="z-index: 7; min-width: 650px; max-width: 650px; white-space: normal; font-size: 58px; line-height: 84px; font-weight: 400; color: #FFF; letter-spacing: -2px;font-family:var(--font1);">The beauty of nature is hidden in details. </div>
							</li>
							<!-- SLIDE  -->
							<li data-index="rs-355" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('beauty/demos/beauty/images/slider/100x50_7f864-3.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
								<!-- MAIN IMAGE -->
								<img src="{{asset('beauty/demos/beauty/images/slider/7f864-3.jpg')}}"  alt="Image"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->
						...
						<div class="tp-static-layers">
							...
							<div class="tp-caption   tp-static-layer"
								...
								style="z-index: 7; white-space: nowrap; font-size: 15px; font-weight: 700; color: #FFF;font-family: var(--font1);"><a href="#" class="text-white"><span style="font-family: var(--font2);">+</span> (1) 123 456 789</a></div>
							</div>
		...
		<section id="content">
			...
			<div class="content-wrap py-0">
				...
				<!-- Section About
				============================================= -->
				<div id="about" class="section m-0 page-section" style="background: url({{asset('/beauty/demos/beauty/images/others/3.jpg')}}) no-repeat center bottom; background-size: cover; padding: 100px 0">
					<div class="container">
						...
						<div class="row mb-5">
							<div class="col-xl-6 col-md-7 mb-5 mb-md-0">
								...
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio veritatis qui asperiores, quae beatae autem repudiandae praesentium reiciendis illum minus fugiat animi molestiae nobis! Harum atque quod, similique maiores itaque dolorum sequi, expedita. Omnis, ex!</p>
								<a href="#" data-scrollto="#price" class="button button-circle nott fw-normal" data-offset="85" data-easing="easeInOutExpo" data-speed="1250">Price <i class="icon-caret-right m-0"></i></a>
							</div>
							...
							<div class="col-xl-3 col-sm-5 d-md-none d-xl-block mb-5 mb-sm-0">
								<div class="masonry-thumbs masonry-gap-lg grid-container grid-2" data-lightbox="gallery">
									<a class="grid-item" href="{{asset('beauty/demos/beauty/images/others/2.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('beauty/demos/beauty/images/others/2.jpg')}}" alt="Gallery Thumb 1"></a>
									<a class="grid-item" href="{{asset('beauty/demos/beauty/images/others/5.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('beauty/demos/beauty/images/others/5.jpg')}}" alt="Gallery Thumb 2"></a>
									<a class="grid-item" href="{{asset('beauty/demos/beauty/images/others/6.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('beauty/demos/beauty/images/others/6.jpg')}}" alt="Gallery Thumb 3"></a>
									<a class="grid-item" href="{{asset('beauty/demos/beauty/images/others/7.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('beauty/demos/beauty/images/others/7.jpg')}}" alt="Gallery Thumb 4"></a>
								</div>
							</div>

							<div class="col-xl-3 col-md-5 col-sm-7">
								<ul class="iconlist m-0">
									<li><img src="{{asset('beauty/demos/beauty/images/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Assertively Fabricate.</li>
									<li class="pt-3"><img src="{{asset('beauty/demos/beauty/images/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Distinctively disseminate.</li>
									<li class="pt-3"><img src="{{asset('beauty/demos/beauty/images/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Appropriately predominate.</li>
									<li class="pt-3"><img src="{{asset('beauty/demos/beauty/images/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Assertively Fabricate.</li>
									<li class="pt-3"><img src="{{asset('beauty/demos/beauty/images/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Distinctively disseminate.</li>
									<li class="pt-3"><img src="{{asset('beauty/demos/beauty/images/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Assertively Fabricate.</li>
									<li class="pt-3"><img src="{{asset('beauty/demos/beauty/images/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Distinctively disseminate.</li>
									<li class="pt-3"><img src="{{asset('beauty/demos/beauty/images/checked.svg')}}" width="20" height="20" alt="Image" class="me-2">Authoritatively scale Web</li>
								</ul>
							</div>
						...
						<div class="row mt-5 dark min-vh-50">
							...
							<a href="#" class="col-md-3 shadow col-sm-6 min-vh-40 border-right" style="background: url({{asset('/beauty/demos/beauty/images/categories/1.jpg')}}) no-repeat center center; background-size: cover;">
							...
							<a href="#" class="col-md-3 shadow col-sm-6 min-vh-40 p-0 border-right" style="background: url({{asset('/beauty/demos/beauty/images/categories/2.jpg')}}) no-repeat center center / cover;">
								<div class="bg-overlay">
									<div class="bg-overlay-content text-overlay-mask dark align-items-center justify-content-between p-4">
							...
							<a href="#" class="col-md-3 shadow col-sm-6 min-vh-40 border-end p-0" style="background: url({{asset('/beauty/demos/beauty/images/categories/3.jpg')}}) no-repeat center center / cover;">
								<div class="bg-overlay">
									<div class="bg-overlay-content text-overlay-mask dark align-items-center justify-content-between p-4">
							...
							<a href="#" class="col-md-3 shadow col-sm-6 min-vh-40 p-0" style="background: url({{asset('/beauty/demos/beauty/images/categories/4.jpg')}}) no-repeat center center / cover;">
								<div class="bg-overlay">
									<div class="bg-overlay-content text-overlay-mask dark align-items-center justify-content-between p-4">
				...
				<!-- Section Price
				============================================= -->
				<div id="price" class="section page-section dark pt-3" style="background: url({{asset('/beauty/demos/beauty/images/others/4.jpg')}}) no-repeat top center / cover; padding-bottom: 90px; margin-top: -1px">
						...
						<div class="row">
							...
							<div class="col-md-5">
								...
								<div class="masonry-thumbs masonry-gap-lg grid-container grid-3" data-lightbox="gallery">
									<a class="grid-item" href="{{asset('beauty/demos/beauty/images/menu/1.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('beauty/demos/beauty/images/menu/thumb-1.jpg')}}" alt="Gallery Thumb 1"></a>
									<a class="grid-item" href="{{asset('beauty/demos/beauty/images/menu/2.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('beauty/demos/beauty/images/menu/thumb-2.jpg')}}" alt="Gallery Thumb 2"></a>
									<a class="grid-item" href="{{asset('beauty/demos/beauty/images/menu/3.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('beauty/demos/beauty/images/menu/thumb-3.jpg')}}" alt="Gallery Thumb 3"></a>
									<a class="grid-item" href="{{asset('beauty/demos/beauty/images/menu/4.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('beauty/demos/beauty/images/menu/thumb-4.jpg')}}" alt="Gallery Thumb 4"></a>
									<a class="grid-item" href="{{asset('beauty/demos/beauty/images/menu/5.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('beauty/demos/beauty/images/menu/thumb-5.jpg')}}" alt="Gallery Thumb 5"></a>
									<a class="grid-item" href="{{asset('beauty/demos/beauty/images/menu/6.jpg')}}" data-lightbox="gallery-item"><img src="{{asset('beauty/demos/beauty/images/menu/thumb-6.jpg')}}" alt="Gallery Thumb 6"></a>
								</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-xl-4 col-md-6 ps-md-5 ps-3 mt-4 mt-md-0">
								...
								<a href="#" class="button button-circle text-dark button-light bg-white nott fw-normal">learn more</a>
							</div>
				...
				<div id="promotions" class="section bg-transparent mb-0 mt-5 page-section">
					<div class="container">
						<div class="row justify-content-between bottommargin">
							...
							<div class="col-xl-4 col-md-5">
								<a href="{{asset('beauty/demos/beauty/images/others/banner.jpg')}}" data-lightbox="image"><img src="{{asset('beauty/demos/beauty/images/others/banner.jpg')}}" alt="offer image"></a>
							</div>
							...
							<div class="col-xl-8 col-md-7 ps-md-5 ps-3 mt-4 mt-md-0">
								...
								<a href="#" data-scrollto="#footer" class="button button-circle button-large nott fw-normal ms-0">Book a Chair Now <i class="icon-line-arrow-right"></i></a>
							</div>
					...
					<!-- Background Image -->
					<img src="{{asset('beauty/demos/beauty/images/others/nailpolish.png')}}" alt="Image" style="position: absolute; right: 20px; bottom: -80px; width: 270px; height: auto; opacity: 1; ">
		...
		<!-- Footer
		============================================= -->
		<footer id="footer" class="border-0 page-section" style="background: url({{asset('/beauty/demos/beauty/images/others/footer-bg2.jpg')}}) center top / cover;">
				...
				<div class="footer-widgets-wrap">
					...
					<div class="row justify-content-between">
						<div class="col-md-5">
							...
							<p class="fw-normal" style="font-size: 13px; line-height: 23px; font-family: var(--font1);">Monotonectally re-engineer optimal architectures without principle-centered markets. Continually synergize B2B channels before ethical.</p>
						...
						<div class="col-md-5 mt-5 mt-md-4">
							<div id="q-contact" class="widget quick-contact-widget form-widget clearfix">
								...
								<form id="quick-contact-form" name="quick-contact-form" action="include/form.php" method="post" class="quick-contact-form mb-0">
									...
									<button type="submit" id="quick-contact-form-submit" name="quick-contact-form-submit" class="button button-circle button-small nott fw-normal ms-0" value="submit">send email</button>
								</form>
