...
@section('content')
    ...
    <section id="slider" class="slider-element min-vh-60 min-vh-md-100 include-header border-bottom border-light dark"
        style="background: url({{ asset('/therapy/demos/therapy/images/hero-right.png') }}) no-repeat top right; background-size: auto 100%;">
        <div class="slider-inner">
                ...
                <div class="row align-items-center h-100 mt-2 mt-lg-6">
                    <div class="col-md-6">
                        <div class="overflow-hidden">
                            <h2 class="display-3 fw-normal mb-0" data-animate="fadeInUpSmall faster">
                                {{ env('APP_TAGLINE') }}</h2>
                        </div>
                        <div class="overflow-hidden mb-4">
                            <h2 class="display-3 fw-normal mb-0" data-animate="fadeInUpSmall faster" data-delay="100">
                                {{ env('APP_TAGLINE') }}</h2>
                        </div>
                        <div class="overflow-hidden mb-5">
                            <p class="lead mb-0" data-animate="fadeInUpSmall faster" data-delay="200">Cum quod nam
                                molestias eiusmod accumsan repellendus velit, nisl, mollit! Congue corrupti accusamus lorem.
                            </p>
                        </div>
                        <div class="overflow-hidden mb-4">
                            <a href="#" data-animate="fadeInUpSmall faster" data-delay="300"
                                ...
                                data-offset="140" class="btn rounded-0 btn-border color size-lg"><i
                                    class="icon-calendar21"></i><span>Make an Appointment</span></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="position-absolute d-flex" style="top: auto; bottom: 20px; right: 20px;">
                <a href="#" class="social-icon mx-1 si-border si-small border-light si-facebook"
                    data-animate="bounceInRight">
                    <i class="icon-facebook"></i>
                    <i class="icon-facebook"></i>
                </a>

                <a href="#" class="social-icon mx-1 si-border si-small border-light si-instagram"
                    data-animate="bounceInRight" data-delay="100">
                    <i class="icon-instagram"></i>
                    <i class="icon-instagram"></i>
                </a>

                <a href="#" class="social-icon mx-1 si-border si-small border-light si-twitter" data-animate="bounceInRight"
                    data-delay="200">
    ...
    <section id="content">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6 mb-5 mb-lg-0">
                            <div class="overflow-hidden mb-4">
                                <h3 class="display-4 color mb-0" data-animate="fadeInUpSmall fast"><i
                                        class="spa-flowers pe-2 text-white-50"></i> About Us</h3>
                            </div>
                            <blockquote class="border-light border-width-2 font-primary"><img
                                    src="{{ asset('therapy/demos/therapy/images/about/2.jpg') }}" alt="Image"
                                    class="alignleft my-0" width="100">Quo nulla condimentum sequi dictumst cupiditate
                                culpa, quisquam placerat lorem velit repudiandae eget eaque consectetuer quidem class dolore
                                quibusdam hic.</blockquote>
                            ...
                            <div class="row mt-4">
                                <div class="col-auto">
                                    <ul class="list-unstyled iconlist ms-0">
                                        <li>
                                            <h5 class="mb-3 h5">Monday - Saturday</h5>
                                        </li>
                                        <li>
                                            <h5 class="mb-3 h5">6:30 - 20:00</h5>
                                        </li>
                                        <li>
                                            <h5 class="mb-3 h5 text-white-50">Sunday Closed</h5>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col">
                                    <p class="text-white-50">Objectively facilitate synergistic initiatives vis-a-vis
                                        adaptive ideas. Enthusiastically e-enable transparent e-markets after
                                        clicks-and-mortar ideas.</p>
                                </div>
                            </div>
                            ...
                            <div class="row counter-wrap align-items-center mt-4">
                                ...
                                <div class="col-4 col-lg-4">
                                    <div class="counter color"><span data-from="11" data-to="154"
                        ...
                        <div class="col-md-5 box-img p-2 d-none d-lg-block">
                            <div class="h-100 rounded"
                                style="background: url({{ asset('/therapy/demos/therapy/images/about/about.jpg') }}) no-repeat center center / cover;">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="section-services" class="section page-section dark bg-transparent m-0 pb-0">
                <div class="container">
                    <div class="row justify-content-center text-center">
                        <div class="col-12">
                            <div class="overflow-hidden">
                                <div class="text-white-50 mb-2 text-uppercase ls3" data-animate="fadeInUpSmall"
                                    data-delay="10">What We Do</div>
                                <h3 class="display-4 color mb-0" data-animate="fadeInUpSmall fast"><i
                ...
                <div class="row dark align-content-stretch grid-border topmargin">
                        ...
                        <div class="feature-box flex-column fbox-plain">
                            ...
                            <div class="fbox-content">
                                <div class="overflow-hidden mb-3">
                                    <h2 class="h3 text-white mb-0" data-animate="fadeInUpSmall fast" data-delay="100">Shower
                                        Available</h2>
                                </div>
                                <div class="overflow-hidden">
                                    <p class="mb-0" data-animate="fadeInUpSmall fast" data-delay="200">Lorem ipsum
                                        dolor sit amet, consectetur adipisicing elit. Voluptas omnis nam molestias minus
                                        ipsa, placeat!</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-padding">
                        <div class="feature-box flex-column fbox-plain">
                            ...
                            <div class="fbox-content">
                                <div class="overflow-hidden mb-3">
                                    <h2 class="h3 text-white mb-0" data-animate="fadeInUpSmall fast" data-delay="100">Foot
                                        Treatments</h2>
                                </div>
                                <div class="overflow-hidden mb-3">
                                    <p class="mb-0" data-animate="fadeInUpSmall fast" data-delay="200">Facere
                                        aliquam itaque quia recusandae, corporis fugit fugiat eaque, accusamus officiis
                                        reprehenderit.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-padding">
                        <div class="feature-box flex-column fbox-plain">
                            ...
                            <div class="fbox-content">
                                <div class="overflow-hidden mb-3">
                                    <h2 class="h3 text-white mb-0" data-animate="fadeInUpSmall fast" data-delay="100">
                                        Internal Beautification</h2>
                                </div>
                                <div class="overflow-hidden mb-3">
                                    <p class="mb-0" data-animate="fadeInUpSmall fast" data-delay="200">Velit id
                                        facilis odit aliquid laudantium. Tempore, sequi. Harum nesciunt, magni aperiam est?
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-padding">
                        <div class="feature-box flex-column fbox-plain">
                            ...
                            <div class="fbox-content">
                                <div class="overflow-hidden mb-3">
                                    <h2 class="h3 text-white mb-0" data-animate="fadeInUpSmall fast" data-delay="100">Yoga
                                        &amp; Meditation</h2>
                                </div>
                                <div class="overflow-hidden mb-3">
                                    <p class="mb-0" data-animate="fadeInUpSmall fast" data-delay="200">Voluptatum
                                        distinctio laboriosam, excepturi delectus nam fugit obcaecati reiciendis neque iste!
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-padding">
                        <div class="feature-box flex-column fbox-plain">
                            ...
                            <div class="fbox-content">
                                <div class="overflow-hidden mb-3">
                                    <h2 class="h3 text-white mb-0" data-animate="fadeInUpSmall fast" data-delay="100">Hair
                                        Dressing</h2>
                                </div>
                                <div class="overflow-hidden mb-3">
                                    <p class="mb-0" data-animate="fadeInUpSmall fast" data-delay="200">Quis,
                                        tenetur. Nam explicabo modi pariatur, blanditiis distinctio sapiente fugiat
                                        accusantium.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-padding">
                        <div class="feature-box flex-column fbox-plain">
                            ...
                            <div class="fbox-content">
                                ...
                                <div class="overflow-hidden mb-3">
                                    <p class="mb-0" data-animate="fadeInUpSmall fast" data-delay="200">Veniam
                                        atque corporis commodi. Quidem odit, necessitatibus quo tenetur! Harum similique
                                        illo eligendi!</p>
                                </div>
                            </div>
                        </div>
        ...
        ============================================= -->
            <div id="section-price" class="section page-section dark mt-0 pb-0 overflow-visible"
                style="background: linear-gradient(rgba(0,0,0,.3), transparent), url({{ asset('/therapy/demos/therapy/images/1.jpg') }}) no-repeat center center / cover;">
                <div class="container">
                    <div class="row justify-content-end mx-auto mw-md " style="transform: translateY(70px);">
                        <div class="col-lg-5 col-md-7">
                            <p class="border border-light p-2 d-inline text-smaller ">Members get -40% off Instant Discount
                            </p>
                                ...
                                <div class="card-body p-4">
                                    <div class="overflow-hidden">
                                        <div class="row align-items-center" data-animate="fadeInUpSmall faster">
                                            <div class="col-3">
                                                <img src="{{ asset('therapy/demos/therapy/images/price/swedish.jpg') }}"
                                                    alt="Image" class="rounded">
                                            </div>
                                            <div class="col-9">
                                                <h4 class="mb-2">Swedish Massage</h4>
                                                <div class="d-flex align-middle text-smaller">
                                                    <div><span class="op-04">60 Mins:</span><span
                                                            class="font-primary ms-2">$39</span></div>
                                                    <small><i class="icon-circle text-smaller op-02 mx-3"></i></small>
                                                    <div><span class="op-04">120 Mins:</span><span
                                                            class="font-primary ms-2">$59</span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="overflow-hidden">
                                        <div class="row align-items-center" data-animate="fadeInUpSmall faster"
                                            data-delay="50">
                                            <div class="col-3">
                                                <img src="{{ asset('therapy/demos/therapy/images/price/scrub.jpg') }}"
                                                    alt="Image" class="rounded">
                                            </div>
                                            <div class="col-9">
                                    ...
                                    <div class="overflow-hidden">
                                        <div class="row align-items-center" data-animate="fadeInUpSmall faster"
                                            data-delay="100">
                                            <div class="col-3">
                                                <img src="{{ asset('therapy/demos/therapy/images/price/couple-spa.jpg') }}"
                                                    alt="Image" class="rounded">
                                            </div>
                                            <div class="col-9">
                                    ...
                                    <div class="overflow-hidden">
                                        <div class="row align-items-center" data-animate="fadeInUpSmall faster"
                                            data-delay="150">
                                            <div class="col-3">
                                                <img src="{{ asset('therapy/demos/therapy/images/price/hot-stone.jpg') }}"
                                                    alt="Image" class="rounded">
                                            </div>
                                            <div class="col-9">
                                    ...
                                    <a href="#" class="btn rounded-0 btn-border color w-100 size-sm mt-4"><span
                                            class="flex-grow-1 font-body">View All</span><i
                                            class="icon-line-arrow-right border-start border-light border-end-0"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-stretch">
                        <div class="col-md-6 min-vh-50 d-flex flex-column">
                            <div class="h-50 rounded mt-2 px-5"
                                style="background: url({{ asset('/therapy/demos/therapy/images/price/cosmetic-1.jpg') }}) no-repeat center center / cover;">
                                <div class="vertical-middle over">
                                    <div class="overflow-hidden">
                                        <div data-animate="fadeInUpSmall fast" class="text-black-50">Cosmetics</div>
                                    </div>
                                    <div class="overflow-hidden">
                                        <h3 data-animate="fadeInUpSmall fast" data-delay="100" class="h3 mb-0 mt-1">Face
                                            Cream</h3>
                                    </div>
                                    <div class="overflow-hidden">
                                        <a href="#" data-animate="fadeInUpSmall fast" data-delay="200"
                                            class="button button-dark bg-color mt-3">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                            <div class="h-50 rounded text-lg-end px-4 mt-4"
                                style="background: url({{ asset('/therapy/demos/therapy/images/price/cosmetic-2.jpg') }}) no-repeat right center / cover;">
                                <div class="vertical-middle">
                                    <div class="overflow-hidden">
                                        <div data-animate="fadeInUpSmall fast" class="text-black-50">Spa Products</div>
                                    </div>
                                    <div class="overflow-hidden">
                                        <h3 data-animate="fadeInUpSmall fast" data-delay="100" class="h3 mb-0 mt-1">
                                            Relieve Stress</h3>
                                    </div>
                                    <div class="overflow-hidden">
                                        <a href="#" data-animate="fadeInUpSmall fast" data-delay="200"
                        ...
                        <div class="col-md-6 mt-5 mt-md-0">
                            <div class="dark">
                                <div class="d-flex align-items-center bottommargin-sm">
                                    <i
                                        class="spa-leaves h3 icon-stacked text-center border border-light color rounded-circle icon-2x me-3 mb-0"></i>
                                    <div>
                                        <div class="overflow-hidden">
                                            <div class="text-white-50" data-animate="fadeInUpSmall" data-delay="10">Get
                                                Instant 40% Discount</div>
                                        </div>
                                        <div class="overflow-hidden">
                                            <h3 class="h3 mb-0 mt-1" data-animate="fadeInUpSmall" data-delay="100">Make
                                                an Appointment</h3>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 form-group">
                                                <input type="text" id="template-contactform-name"
                                                    ...
                                                    class="form-control form-control-lg bg-transparent color border-light required"
                                            ...
                                            <div class="col-md-12 form-group">
                                                <input type="email" id="template-contactform-email"
                                                    ...
                                                    class="form-control form-control-lg required bg-transparent color border-light"
                                            ...
                                            <div class="col-md-12 form-group">
                                                <input type="text" id="template-contactform-phone"
                                                    ...
                                                    class="form-control form-control-lg bg-transparent color border-light"
                                            ...
                                            <div class="col-md-12 form-group">
                                                <select id="template-contactform-service"
                                                    ...
                                                    class="form-select form-select-lg bg-transparent color border-light">
                                            ...
                                            <div class="col-md-12 form-group">
                                                <input type="text" id="template-contactform-date"
                                                    ...
                                                    class="form-control form-control-lg bg-transparent color border-light required"
                                                    placeholder="Select Date &amp; Time.." data-time="true"
                                                    data-dateFormat="d/m/yy - H:i">
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <button type="submit" id="template-contactform-submit"
                                                    ...
                                                    class="btn rounded-0 btn-border color w-100"><i
                                                        class="icon-calendar21"></i><span class="flex-grow-1">Book
                                                        Now</span></button>
                                            </div>
                                        </div>
                ...
                <div class="container">
                    <div class="row justify-content-center text-center" data-animate="fadeIn">
                        <div class="col-12">
                            <div class="overflow-hidden">
                                <div class="text-white-50 mb-2 text-uppercase ls3" data-animate="fadeInUpSmall"
                                    data-delay="100">What Our Client Say</div>
                                <h3 class="display-4 color mb-0" data-animate="fadeInUpSmall fast" data-delay="200"><i
                                        class="spa-facial pe-2 color"></i> Client Testimonials</h3>
                            </div>
                            <a href="https://google.com" data-animate="fadeInUpSmall" data-delay="300"
                                class="btn rounded-0 btn-border color mt-4"><i class="spa-star"></i><span
                                    class="px-4">2,312+ Google Reviews</span></a>
                        </div>
                    </div>
                </div>
                <div id="oc-testi"
                    ...
                    style="background: url({{ asset('/therapy/demos/therapy/images/rating.svg') }}) no-repeat center center / 300px;">

                    <div class="oc-item p-5 d-flex flex-column text-center">
                        <div class="testi-image mx-auto overflow-hidden">
                            <a href="#" class="data-animate"><img
                                    src="{{ asset('therapy/demos/therapy/images/users/1.jpg') }}"
                                    alt="Customer Testimonails"></a>
                        </div>
                        <div class="testi-content">
                            <div class="overflow-hidden">
                                <p class="data-animate">Incidunt deleniti blanditiis quas aperiam recusandae consequatur
                    ...
                    <div class="oc-item p-5 d-flex flex-column text-center">
                        <div class="testi-image mx-auto overflow-hidden">
                            <a href="#"><img src="{{ asset('therapy/demos/therapy/images/users/2.jpg') }}"
                                    alt="Customer Testimonails"></a>
                        </div>
                        <div class="testi-content">
                            <div class="overflow-hidden">
                    ...
                    <div class="oc-item p-5 d-flex flex-column text-center">
                        <div class="testi-image mx-auto overflow-hidden">
                            <a href="#"><img src="{{ asset('therapy/demos/therapy/images/users/7.jpg') }}"
                                    alt="Customer Testimonails"></a>
                        </div>
                        <div class="testi-content">
                            <div class="overflow-hidden">
                                <p>Fugit officia dolor sed harum excepturi ex iusto magnam asperiores molestiae qui natus
                                    obcaecati facere sint amet.</p>
                            </div>
                            <div class="testi-meta">
                                Fig Nelson
                    ...
                    <div class="oc-item p-5 d-flex flex-column text-center">
                        <div class="testi-image mx-auto overflow-hidden">
                            <a href="#"><img src="{{ asset('therapy/demos/therapy/images/users/3.jpg') }}"
                                    alt="Customer Testimonails"></a>
                        </div>
                        <div class="testi-content">
                            <div class="overflow-hidden">
                    ...
                    <div class="oc-item p-5 d-flex flex-column text-center">
                        <div class="testi-image mx-auto overflow-hidden">
                            <a href="#"><img src="{{ asset('therapy/demos/therapy/images/users/4.jpg') }}"
                                    alt="Customer Testimonails"></a>
                        </div>
                        <div class="testi-content">
                            <div class="overflow-hidden">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus, perspiciatis illum totam
                                    dolore deleniti labore.</p>
                            </div>
                            <div class="testi-meta">
                                Russell Sprout
                                <span>Adobe Inc.</span>
        ...
        ============================================= -->
                    ...
                    <div class="row justify-content-between gutter-50">
                        <div class="col-md-6">
                            <div class="h-100 min-vh-50 rounded"
                                style="background: url('https://source.unsplash.com/TU6ztds5LGg') no-repeat center center / cover;">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="overflow-hidden mb-4">
                            ...
                            <p class="text-white-50" data-animate="fadeInUpSmall fast">Ipsa felis in mollis turpis
                                phasellus, repellat! Ducimus porttitor class quod? Iste neque lorem tenetur quisque possimus
                                excepturi error ligula.</p>

                            <p class="text-white-50" data-animate="fadeInUpSmall fast" data-delay="200">In morbi risus
                                litora numquam, similique libero ligula nostrum nulla repudiandae proin luctus class varius
                                volutpat! Fringilla fringilla sagittis nunc.</p>

                            <div class="overflow-hidden mb-4">
                                <a href="https://amazon.com" data-animate="fadeInUpSmall faster" data-delay="300"
                                    class="btn rounded-0 btn-border color"><i class="spa-flowers-feet"></i><span
                                        class="px-4">Shop Now</span></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Section Icons
        ============================================= -->
            <!-- <div class="container topmargin-lg dark">
