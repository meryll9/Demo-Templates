...
@section('content')
    ...
    <section id="slider" class="slider-element min-vh-md-100 py-4 include-header"
        style="background: #FFF url({{ asset('/freelancer/demos/freelancer/images/hero-bg.svg') }}) repeat top center; background-size: cover;">
        <div class="slider-inner">
           ...
           <span class="text-uppercase fw-bold ms-3">SemiColonWeb</span>
                    ...
                    <div class="mx-auto" style="max-width: 600px">
                        ...
                        <a href="#" data-scrollto="#footer" data-easing="easeInOutExpo" data-speed="1250" data-offset="70"
    ...
    <section id="content">
        ...
        <div class="content-wrap p-0">
                        ...
                        <div class="col-lg-6">
                            <div>
                                ...
                                <p class="mb-5 lead text-black-50 fw-extralight">Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Earum, atque. Minus, harum porro unde quisquam! Minima vitae neque hic
                                    vel porro quidem totam.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div id="oc-testi" class="owl-carousel testimonials-carousel carousel-widget mt-5"
                                    ...
                                    <div class="testimonial border-0 shadow-none bg-transparent">
                                        <div class="testi-content">
                                            ...
                                            <div class="testi-meta d-flex align-items-center">
                                                <img src="{{ asset('freelancer/demos/freelancer/images/testi/face.jpg') }}"
                                                    alt="Face" width="30">
                                                <div>
                                                    John Doe
                                ...
                                <div class="oc-item">
                                    <div class="testimonial border-0 shadow-none bg-transparent">
                                        <div class="testi-content">
                                            ...
                                            <div class="testi-meta d-flex align-items-center">
                                                <img src="{{ asset('freelancer/demos/freelancer/images/testi/face2.jpg') }}"
                                                    alt="Face" width="30">
                                                <div>
                                                    John Doe
                                                    <span class="ps-0">XYZ Inc.</span>
                                ...
                                <div class="oc-item">
                                    <div class="testimonial border-0 shadow-none bg-transparent">
                                        <div class="testi-content">
                                            <p>Progressively productivate customer directed meta-services without magnetic
                                                bandwidth.</p>
                                            <div class="testi-meta d-flex align-items-center">
                                                <img src="{{ asset('freelancer/demos/freelancer/images/testi/face3.jpg') }}"
                                                    alt="Face" width="30">
                                                <div>
                                                    John Doe
                                                    <span class="ps-0">XYZ Inc.</span>
                    ...
                    <div class="row justify-content-center col-mb-50">
                        <div class="col-lg-6 h-translatey-3 tf-ts">
                            <a href="demo-store.html" class="portfolio-item" target="_blank">
                                <div class="portfolio-image">
                                    <img src="{{ asset('freelancer/demos/freelancer/images/works/1.jpg') }}"
                                        alt="Portfoio Item">
                        ...
                        <div class="col-lg-6 h-translatey-3 tf-ts">
                            <a href="demo-yoga.html" class="portfolio-item" target="_blank">
                                <div class="portfolio-image">
                                    <img src="{{ asset('freelancer/demos/freelancer/images/works/2.jpg') }}"
                                        alt="Portfoio Item">
                                    <div class="bg-overlay">
                                        <div
                                            class="bg-overlay-content align-items-start justify-content-start flex-column px-5 py-4">
                        ...
                        <div class="col-lg-6 h-translatey-3 tf-ts">
                            <a href="demo-hostel.html" class="portfolio-item" target="_blank">
                                <div class="portfolio-image">
                                    <img src="{{ asset('freelancer/demos/freelancer/images/works/3.jpg') }}"
                                        alt="Portfoio Item">
                                    <div class="bg-overlay">
                                        <div
                                            class="bg-overlay-content align-items-start justify-content-start flex-column px-5 py-4">
                        ...
                        <div class="col-lg-6 h-translatey-3 tf-ts">
                            <a href="demo-conference.html" class="portfolio-item" target="_blank">
                                <div class="portfolio-image">
                                    <img src="{{ asset('freelancer/demos/freelancer/images/works/4.jpg') }}"
                                        alt="Portfoio Item">
                                    <div class="bg-overlay">
                                        <div
                                            class="bg-overlay-content align-items-start justify-content-start flex-column px-5 py-4">
                    ...
                    <div class="row gutter-50 mb-5 align-items-stretch">
                                ...
                                <div class="mt-auto">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-4">
                                            <img src="{{ asset('freelancer/demos/freelancer/images/icons/sketch.svg') }}"
                                                height="50" alt="Image">
                                            <img src="{{ asset('freelancer/demos/freelancer/images/icons/xd.png') }}"
                                                height="50" alt="Image" class="ms-3">
                                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card d-flex align-items-end flex-column p-4 border-0"
                                ...
                                <div class="mt-auto">
                                    <div class="card-body">
                                        <img src="{{ asset('freelancer/demos/seo/images/icons/social.svg') }}" alt="Image"
                        ...
                        <div class="col-md-4">
                            <div class="card d-flex align-items-end flex-column p-4 border-0"
                                ...
                                <div class="mt-auto">
                                    <div class="card-body">
                                        <img src="{{ asset('freelancer/demos/freelancer/images/icons/wp.png') }}"
                        ...
                        <div class="col-md-4">
                            <div class="card d-flex align-items-end flex-column p-4 border-0"
                                ...
                                <div class="mt-auto">
                                    <div class="card-body">
                                        <img src="{{ asset('freelancer/demos/seo/images/icons/seo.svg') }}" height="50"
                        ...
                        <div class="col-md-4">
                            <div class="card d-flex align-items-end flex-column p-4 border-0"
                                ...
                                <div class="mt-auto">
                                    <div class="card-body">
                                        <img src="{{ asset('freelancer/demos/freelancer/images/icons/hosting.svg') }}"
                                            height="50" alt="Image" class="mb-4">
                        ...
                        <div class="col-md-4">
                            <div class="card d-flex align-items-end flex-column p-4 border-0"
                                ...
                                <div class="mt-auto">
                                    <div class="card-body">
                                        <img src="{{ asset('freelancer/demos/freelancer/images/icons/plugins.png') }}"
                                            height="50" alt="Image" class="mb-4">
                    ...
                    <div class="section rounded-10 p-6 my-4" style="background-color: #F1F1F1;">
                        <div class="row justify-content-between align-items-center col-mb-50">
                            <div class="col-md-3 col-6 center"><img
                                    src="{{ asset('freelancer/demos/freelancer/images/clients/amazon.svg') }}"
                                    alt="Clients"></div>
                            <div class="col-md-3 col-6 center"><img
                                    src="{{ asset('freelancer/demos/freelancer/images/clients/netflix.svg') }}"
                                    alt="Clients"></div>
                            <div class="col-md-3 col-6 center"><img
                                    src="{{ asset('freelancer/demos/freelancer/images/clients/google.svg') }}"
                                    alt="Clients"></div>
                            <div class="col-md-3 col-6 center"><img
                                    src="{{ asset('freelancer/demos/freelancer/images/clients/paypal.svg') }}"
                                    alt="Clients"></div>
                            <div class="col-md-3 col-6 center"><img
                                    src="{{ asset('freelancer/demos/freelancer/images/clients/skype.svg') }}"
                                    alt="Clients"></div>
                            <div class="col-md-3 col-6 center"><img
                                    src="{{ asset('freelancer/demos/freelancer/images/clients/ps.svg') }}" alt="Clients">
                            </div>
                            <div class="col-md-3 col-6 center"><img
                                    src="{{ asset('freelancer/demos/freelancer/images/clients/slack.svg') }}"
                                    alt="Clients"></div>
                            <div class="col-md-3 col-6 center"><img
                                    src="{{ asset('freelancer/demos/freelancer/images/clients/applemusic.svg') }}"
                                    alt="Clients"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="section m-0"
                style="background: #f1efe5 url({{ asset('/freelancer/demos/freelancer/images/bg.svg') }}) no-repeat right center; padding-top: 240px">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7">
                            <img src="{{ asset('freelancer/demos/freelancer/images/ask.svg') }}" alt="FAQs"
                                class="px-5">
                        </div>
                    </div>
                </div>
