...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="demo-freelancer.html" class="standard-logo"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
							<a href="demo-freelancer.html" class="retina-logo"><img src="{{ env('APP_LOGO') }}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element min-vh-md-100 py-4 include-header" style="background: #FFF url({{asset('/freelancer/demos/freelancer/images/hero-bg.svg')}}) repeat top center; background-size: cover;">
						...
						<div class="emphasis-title mb-2">
							...
							<h1>
								<span id="oc-images" class="owl-carousel image-carousel carousel-widget" data-items="1" data-margin="0" data-autoplay="3000" data-loop="true" data-nav="false" data-pagi="false" data-animate-in="fadeInUp">
									<div class="oc-item gradient-text gradient-red-yellow text-uppercase">{{ env('APP_TAGLINE') }}</div>
									<div class="oc-item gradient-text gradient-red-yellow text-uppercase">{{ env('APP_TAGLINE') }}</div>
								</span>
							</h1>
						</div>
						<!-- <div class="d-flex align-items-center justify-content-center mb-5">
							<img src="{{asset('freelancer/demos/freelancer/images/face.svg')}}" alt="Face" width="60">
			...
			<div class="content-wrap p-0">
				...
				<div class="section mb-0 pt-3 pb-0" style="background-color: #F4F4F4; margin-top: 150px; overflow: visible;">
					...
					<div class="d-flex justify-content-center position-relative">
						<div class="parallax min-vh-75" style="background-image: url({{asset('/freelancer/demos/freelancer/images/me.jpg')}}); background-size: cover; background-position: center center;" data-bottom-top="width: 40vw" data-center-top="width: 100vw;">
				...
				<div class="section bg-transparent py-5">
					<div class="container">
						<div class="row align-items-center justify-content-around">
										...
										<div class="testimonial border-0 shadow-none bg-transparent">
											<div class="testi-content">
												...
												<div class="testi-meta d-flex align-items-center">
													<img src="{{asset('freelancer/demos/freelancer/images/testi/face.jpg')}}" alt="Face" width="30">
													<div>
														John Doe
									...
									<div class="oc-item">
										<div class="testimonial border-0 shadow-none bg-transparent">
											<div class="testi-content">
												...
												<div class="testi-meta d-flex align-items-center">
													<img src="{{asset('freelancer/demos/freelancer/images/testi/face2.jpg')}}" alt="Face" width="30">
													<div>
														John Doe
														<span class="ps-0">XYZ Inc.</span>
													</div>
									...
									<div class="oc-item">
										<div class="testimonial border-0 shadow-none bg-transparent">
											<div class="testi-content">
												...
												<div class="testi-meta d-flex align-items-center">
													<img src="{{asset('freelancer/demos/freelancer/images/testi/face3.jpg')}}" alt="Face" width="30">
													<div>
														John Doe
														<span class="ps-0">XYZ Inc.</span>
													</div>
							...
							<div class="col-lg-6">
								<img src="{{asset('freelancer/demos/freelancer/images/testi/bg.svg')}}" alt="">
							</div>
						</div>
					</div>
				</div>
						...
						<div  class="row gutter-50 mb-5 align-items-stretch">
									...
									<div class="mt-auto">
										<div class="card-body">
											<div class="d-flex align-items-center mb-4">
												<img src="{{asset('freelancer/demos/freelancer/images/icons/sketch.svg')}}" height="50" alt="Image">
												<img src="{{asset('freelancer/demos/freelancer/images/icons/xd.png')}}" height="50" alt="Image" class="ms-3">
											</div>
							...
							<div class="col-md-4">
								<div class="card d-flex align-items-end flex-column p-4 border-0" style="background-color: #C2DFEC;">
									...
									<div class="mt-auto">
										<div class="card-body">
											<img src="{{asset('freelancer/demos/seo/images/icons/social.svg')}}" alt="Image" class="mb-4" height="50">
							...
							<div class="col-md-4">
								<div class="card d-flex align-items-end flex-column p-4 border-0" style="background-color: #FADCE4">
									...
									<div class="mt-auto">
										<div class="card-body">
											<img src="{{asset('freelancer/demos/freelancer/images/icons/wp.png')}}" height="50" alt="Image" class="mb-4">
							...
							<div class="col-md-4">
								<div class="card d-flex align-items-end flex-column p-4 border-0" style="background-color: #E4E4E4">
									...
									<div class="mt-auto">
										<div class="card-body">
											<img src="{{asset('freelancer/demos/seo/images/icons/seo.svg')}}" height="50" alt="Image" class="mb-4">
							...
							<div class="col-md-4">
								<div class="card d-flex align-items-end flex-column p-4 border-0" style="background-color: #E5E3CE;">
									...
									<div class="mt-auto">
										<div class="card-body">
											<img src="{{asset('freelancer/demos/freelancer/images/icons/hosting.svg')}}" height="50" alt="Image" class="mb-4">
							...
							<div class="col-md-4">
								<div class="card d-flex align-items-end flex-column p-4 border-0" style="background-color: #C9D6CF">
									...
									<div class="mt-auto">
										<div class="card-body">
											<img src="{{asset('freelancer/demos/freelancer/images/icons/plugins.png')}}" height="50" alt="Image" class="mb-4">
					...
					<div class="container mt-6">
						...
						<div class="section rounded-10 p-6 my-4" style="background-color: #F1F1F1;">
							<div class="row justify-content-between align-items-center col-mb-50">
								<div class="col-md-3 col-6 center"><img src="{{asset('freelancer/demos/freelancer/images/clients/amazon.svg')}}" alt="Clients"></div>
								<div class="col-md-3 col-6 center"><img src="{{asset('freelancer/demos/freelancer/images/clients/netflix.svg')}}" alt="Clients"></div>
								<div class="col-md-3 col-6 center"><img src="{{asset('freelancer/demos/freelancer/images/clients/google.svg')}}" alt="Clients"></div>
								<div class="col-md-3 col-6 center"><img src="{{asset('freelancer/demos/freelancer/images/clients/paypal.svg')}}" alt="Clients"></div>
								<div class="col-md-3 col-6 center"><img src="{{asset('freelancer/demos/freelancer/images/clients/skype.svg')}}" alt="Clients"></div>
								<div class="col-md-3 col-6 center"><img src="{{asset('freelancer/demos/freelancer/images/clients/ps.svg')}}" alt="Clients"></div>
								<div class="col-md-3 col-6 center"><img src="{{asset('freelancer/demos/freelancer/images/clients/slack.svg')}}" alt="Clients"></div>
								<div class="col-md-3 col-6 center"><img src="{{asset('freelancer/demos/freelancer/images/clients/applemusic.svg')}}" alt="Clients"></div>
							</div>
						</div>
					</div>
				</div>

				<div class="section m-0" style="background: #f1efe5 url({{asset('/freelancer/demos/freelancer/images/bg.svg')}}) no-repeat right center; padding-top: 240px">
					...
					<div class="container">
						<div class="row align-items-center">
							...
							<div class="col-lg-7">
								<img src="{{asset('freelancer/demos/freelancer/images/ask.svg')}}" alt="FAQs" class="px-5">
							</div>
						</div>
					</div>
				</div>
