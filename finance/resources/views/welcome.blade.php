...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
				...
				<div class="row justify-content-center justify-content-lg-between">
					<div class="col-12 col-md-auto">
						...
						<div class="top-links">
							<ul class="top-links-container">
								<li class="top-links-item"><a href="index.html"><i class="color-2 icon-line-globe"></i> English</a>
					...
					<div class="col-12 col-md-auto">
						...
						<div class="top-links text-center">
							<ul class="top-links-container">
								<li class="top-links-item"><a href="#"><i class="color-2 icon-line-map-pin"></i> 795 Folsom Ave, Suite 600 San Francisco, CA 94107</a></li>
								<li class="top-links-item"><a href="#"><i class="color-2 icon-line-mail"></i> info@canvas.com</a></li>
								<li class="top-links-item"><a href="#"><i class="color-2 icon-line-phone-call"></i> (0) 8547 632521</a></li>
							</ul>
						</div><!-- .top-links end -->
				...
				<div class="container">
					<div class="header-row justify-content-between">
						...
						<div class="header-misc order-3">
							<a href="#" class="btn text-larger btn-dark bg-color px-4 py-2 rounded-pill"><i class="icon-line-message-circle color-2"></i><span class="d-none d-md-inline ms-2">Get Consultant</span></a>
						</div>
							...
							<ul class="menu-container">
								...
								<li class="menu-item"><a class="menu-link" href="#"><div>Services</div></a>
									<ul class="sub-menu-container">
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="icon-line-dollar-sign"></i>Financial Services</div></a></li>
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="icon-line-paper"></i>Audit &amp; Taxes</div></a></li>
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="icon-line-users"></i>Acountants Experts</div></a></li>
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="icon-line-flag"></i>Business Planning</div></a></li>
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="icon-line-globe"></i>International Markets</div></a></li>
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="icon-line-briefcase"></i>Stocks &amp; Trades</div></a></li>
									</ul>
								</li>
		...
		<!-- Hero
		============================================= -->
		<section id="slider" class="slider-element" style="background: #2646532b url({{asset('/finance/demos/finance/images/hero-bg.png')}}) center bottom no-repeat; background-size: 100% auto;">
			...
			<div class="container">
				<div class="row align-items-md-end">
					<div class="col-lg-5 align-self-center flex-column py-6">
						...
						<a href="#" class="btn btn-lg btn-dark bg-color rounded-pill mb-5 px-5">Get Started <i class="icon-line-arrow-right color-2 ms-1"></i></a>
						<div class="row">
							<div class="col-sm-6">
								<ul class="iconlist mb-0">
									<li class="mb-2"><i class="icon-line-check text-smaller bg-color-2 color"></i> Financial Services</li>
									<li class="mb-2"><i class="icon-line-check text-smaller bg-color-2 color"></i> Audit &amp; Taxes</li>
									<li class="mb-2"><i class="icon-line-check text-smaller bg-color-2 color"></i> Business Planning</li>
								</ul>
							</div>
							<div class="col-sm-6">
								<ul class="iconlist mb-0">
									<li class="mb-2"><i class="icon-line-check text-smaller bg-color-2 color"></i> Acountants Experts</li>
									<li class="mb-2"><i class="icon-line-check text-smaller bg-color-2 color"></i> International Markets</li>
									<li class="mb-2"><i class="icon-line-check text-smaller bg-color-2 color"></i> Stocks &amp; Trades</li>
								</ul>
							</div>
						</div>
					...
					<div class="col-lg-7 dotted-bg">
						<img src="{{asset('finance/demos/finance/images/man.png')}}" alt="Image 1" class="d-flex align-self-end mt-5 z-1 mx-auto w-75 position-relative">
					</div>
				</div>
			</div>
				...
				<div class="section dark bg-color" style="padding: 100px 0;">
					...
					<div class="container">
						...
						<div class="services-grid gutter-30 position-relative">
							...
							<img class="op-05" src="{{asset('finance/demos/finance/images/grid.svg')}}" alt="Grid Image" style="position: absolute; left: -20px; top: -30px; z-index: -1;">
							<div class="row">
								<div class="col-lg-4 col-md-6 d-flex align-self-stretch">
									<div class="feature-box flex-column h-shadow mx-0" style="background-image: linear-gradient(#2646532b, #264653f7), url({{asset('/finance/demos/finance/images/services/1.jpg')}})">
								...
								<div class="col-lg-4 col-md-6 d-flex align-self-stretch">
									<div class="feature-box flex-column h-shadow mx-0" style="background-image: linear-gradient(#2646532b, #264653f7), url({{asset('/finance/demos/finance/images/services/2.jpg')}})">
										<div class="fbox-icon mb-4">
								...
								<div class="col-lg-4 col-md-6 d-flex align-self-stretch">
									<div class="feature-box flex-column h-shadow mx-0" style="background-image: linear-gradient(#264653A8, #264653), url({{asset('/finance/demos/finance/images/services/3.jpg')}})">
										<div class="fbox-icon mb-4">
								...
								<div class="col-lg-4 col-md-6 d-flex align-self-stretch">
									<div class="feature-box flex-column h-shadow mx-0" style="background-image: linear-gradient(#26465398, #264653), url({{asset('/finance/demos/finance/images/services/4.jpg')}})">
										<div class="fbox-icon mb-4">
								...
								<div class="col-lg-4 col-md-6 d-flex align-self-stretch">
									<div class="feature-box flex-column h-shadow mx-0" style="background-image: linear-gradient(#264653A8, #264653), url({{asset('/finance/demos/finance/images/services/5.jpg')}})">
										<div class="fbox-icon mb-4">
								...
								<div class="col-lg-4 col-md-6 d-flex align-self-stretch">
									<div class="feature-box flex-column h-shadow mx-0" style="background-image: linear-gradient(#26465398, #264653), url({{asset('/finance/demos/finance/images/services/6.jpg')}})">
										<div class="fbox-icon mb-4">
							...
							<img src="{{asset('finance/demos/finance/images/grid.svg')}}" alt="Grid Image"  class="op-05" style="position: absolute; right: -30px; bottom: -30px; z-index: -1;">
					...
					<div class="container">
						<div class="row col-mb-50 gutter-lg-50 justify-content-center">
							<div class="col-lg-4 col-md-5 text-center">
								<img src="{{asset('finance/demos/finance/images/file-text.svg')}}" alt="Globe Icon" class="mb-5" height="100">
							...
							<div class="col-lg-4 col-md-5 text-center">
								<img src="{{asset('finance/demos/finance/images/users.svg')}}" alt="Users Icon" class="mb-5" height="100">
						...
						<div class="row mt-6">
							<div class="col-12 text-center mt-0 mt-md-4">
								<a href="#" class="btn text-larger px-5 py-3 btn-dark bg-color rounded-pill"><i class="icon-line-calendar color-2 me-2 position-relative" style="top: 1px"></i>Book a Schedule</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row justify-content-around">
						<div class="col-lg-7 dark">
							...
							<div class="feature-box fbox-sm align-items-center mb-4">
								...
								<div class="fbox-content">
									<h4 class="nott font-body fw-normal mb-0"><a class="text-white" href="tel:+122-55412474">(1) 22 55412474</a></h4>
								</div>
							</div>
							<div class="feature-box fbox-sm align-items-center mb-4">
								<div class="fbox-icon">
								...
								<div class="fbox-content">
									<h4 class="nott font-body fw-normal mb-0"><a class="text-white" href="mailto:noreply@canvas.com">noreply@canvas.com</a></h4>
								</div>
							</div>
							<div class="feature-box fbox-sm">
								...
								<div class="fbox-content">
									<h4 class="nott font-body fw-normal mb-0"><a class="text-white" href="mailto:noreply@canvas.com">Mon-Fri: 10:00-18:00 <br> Sat-Sun: 10:00-14:00</a></h4>
								</div>
							</div>
						</div>
										...
										<form class="mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
											...
											<div class="row">
												...
												<div class="col-12 form-group mb-0">
													<button class="btn text-larger btn-dark bg-color px-4 py-2 rounded-pill" type="submit" id="template-contactform-submit" name="template-contactform-submit" value="submit"><i class="icon-line-mail color-2 ms-1"></i> Send Message</button>
												</div>
											</div>
					...
					<div class="row gutter-md-50">
						<div class="col-lg-4 px-lg-5">
							...
							<div class="d-flex align-items-center mt-4">
								<img src="{{asset('finance/demos/finance/images/users/1.jpg')}}" alt="User" width="60" class="rounded-circle">
								<div class="ms-3">
						...
						<div class="col-lg-4 px-lg-5 mt-5 mt-lg-0">
							...
							<div class="d-flex align-items-center mt-4">
								<img src="{{asset('finance/demos/finance/images/users/2.jpg')}}" alt="User" width="60" class="rounded-circle">
								<div class="ms-3">
						...
						<div class="col-lg-4 px-lg-5 mt-5 mt-lg-0">
							...
							<div class="d-flex align-items-center mt-4">
								<img src="{{asset('finance/demos/finance/images/users/3.jpg')}}" alt="User" width="60" class="rounded-circle">
								<div class="ms-3">
					...
					<div class="row justify-content-between">
						<div class="col-lg-3 mb-5 mb-lg-0">
							<div class="widget clearfix">
								...
								<div class="fw-semibold font-primary color ls3 h2 text-uppercase mb-4">Canvas<span class="color-2">.</span></div>
