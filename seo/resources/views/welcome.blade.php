...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
					...
					<div class="col-12 col-md-auto">
						...
						<div class="top-links">
							<ul class="top-links-container">
								...
								<li class="top-links-item"><a href="#"><img src="{{asset('seo/demos/seo/images/flags/eng.png')}}" alt="Lang">Eng</a>
									<ul class="top-links-sub-menu">
										<li class="top-links-item"><a href="#"><img src="{{asset('seo/demos/seo/images/flags/fre.png')}}" alt="Lang">French</a></li>
										<li class="top-links-item"><a href="#"><img src="{{asset('seo/demos/seo/images/flags/ara.png')}}" alt="Lang">Arabic</a></li>
										<li class="top-links-item"><a href="#"><img src="{{asset('seo/demos/seo/images/flags/tha.png')}}" alt="Lang">Thai</a></li>
									</ul>
								</li>
							</ul>
						</div><!-- .top-links end -->
										...
										<div class="container">
											<div class="row">
												<a href="demo-seo-optimizations.html" class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
													<div class="feature-box">
														<div class="fbox-icon mb-2">
															<img src="{{asset('seo/demos/seo/images/icons/seo.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0">
														</div>
												...
												<a href="demo-seo-social.html" class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
													<div class="feature-box">
														<div class="fbox-icon mb-2">
															<img src="{{asset('seo/demos/seo/images/icons/social.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0">
														</div>
														<div class="fbox-content">
												...
												<a href="demo-seo-adwords.html" class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
													<div class="feature-box">
														<div class="fbox-icon mb-2">
															<img src="{{asset('seo/demos/seo/images/icons/adword.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0">
														</div>
														<div class="fbox-content">
												...
												<a href="demo-seo-experience.html" class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
													<div class="feature-box">
														<div class="fbox-icon mb-2">
															<img src="{{asset('seo/demos/seo/images/icons/experience.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0">
														</div>
														<div class="fbox-content">
												...
												<a href="demo-seo-analysis.html" class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
													<div class="feature-box">
														<div class="fbox-icon mb-2">
															<img src="{{asset('seo/demos/seo/images/icons/analysis.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0">
														</div>
														<div class="fbox-content">
												...
												<a href="demo-seo-content-marketing.html" class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
													<div class="feature-box">
														<div class="fbox-icon mb-2">
															<img src="{{asset('seo/demos/seo/images/icons/content_marketing.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0">
														</div>
														<div class="fbox-content">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-60 min-vh-md-100 include-header">
			<div class="slider-inner" style="background: #FFF url({{asset('/seo/demos/seo/images/hero/hero-1.jpg')}}) center center no-repeat; background-size: cover;">
		...
		<section id="content">
			...
			<div class="content-wrap pt-0">
				...
				<div class="section bg-transparent m-0 border-bottom py-5">
					<div class="container">
						<div id="oc-clients" class="owl-carousel image-carousel carousel-widget" data-margin="100" data-loop="true" data-autoplay="5000" data-nav="false" data-pagi="false" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5" data-items-xl="6">
							<div class="oc-item"><a href="#"><img src="{{asset('seo/demos/business/images/clients/linkedin.svg')}}" alt="Brands"></a></div>
							<div class="oc-item"><a href="#"><img src="{{asset('seo/demos/business/images/clients/nat-geo.svg')}}" alt="Brands"></a></div>
							<div class="oc-item"><a href="#"><img src="{{asset('seo/demos/business/images/clients/jetblue.svg')}}" alt="Brands"></a></div>
							<div class="oc-item"><a href="#"><img src="{{asset('seo/demos/business/images/clients/zillow.svg')}}" alt="Brands"></a></div>
							<div class="oc-item"><a href="#"><img src="{{asset('seo/demos/business/images/clients/amazon.svg')}}" alt="Brands"></a></div>
						</div>
					</div>
				</div>
						...
						<div class="row justify-content-between align-items-center">
							...
							<div class="col-lg-4 col-sm-6">
								...
								<div class="feature-box flex-md-row-reverse text-md-end border-0">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('seo/demos/seo/images/icons/seo.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0"></a>
									</div>
									<div class="fbox-content">
										<h3 class="nott ls0">SEO optimization</h3>
								...
								<div class="feature-box flex-md-row-reverse text-md-end border-0 mt-5">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('seo/demos/seo/images/icons/adword.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0"></a>
									</div>
									<div class="fbox-content">
										<h3 class="nott ls0">Adwords Campaign</h3>
								...
								<div class="feature-box flex-md-row-reverse text-md-end border-0 mt-5">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('seo/demos/seo/images/icons/analysis.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0"></a>
									</div>
									<div class="fbox-content">
										<h3 class="nott ls0">Digital Analysis</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi, ipsa!</p>
							...
							<div class="col-lg-3 col-7 offset-3 offset-sm-0 d-sm-none d-lg-block center my-5">
								<img src="{{asset('seo/demos/seo/images/sections/2.png')}}" alt="iphone" class="rounded  parallax" data-bottom-top="transform: translateY(-30px)" data-top-bottom="transform: translateY(30px)">
							</div>
							...
							<div class="col-lg-4 col-sm-6">
								...
								<div class="feature-box border-0">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('seo/demos/seo/images/icons/social.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0"></a>
									</div>
									<div class="fbox-content">
										<h3 class="nott ls0">Social Media Marketing</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum, dolore, voluptates!</p>
								...
								<div class="feature-box border-0 mt-5">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('seo/demos/seo/images/icons/experience.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0"></a>
									</div>
									<div class="fbox-content">
										<h3 class="nott ls0">Customer Experience</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi, ipsa!</p>
								...
								<div class="feature-box border-0 mt-5">
									<div class="fbox-icon">
										<a href="#"><img src="{{asset('seo/demos/seo/images/icons/content_marketing.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0"></a>
									</div>
									<div class="fbox-content">
										<h3 class="nott ls0">Content Marketing</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam, provident.</p>
				...
				<!-- Pricing
				============================================= -->
				<div class="section m-0" style="background: url({{asset('/seo/demos/seo/images/sections/4.png')}}) no-repeat center top; background-size: cover; padding: 140px 0 0;">
					<div class="container">
						<div class="row justify-content-between">
								...
								<div id="section-pricing" class="page-section p-0 m-0">
									...
									<div id="pricing-switch" class="pricing row align-items-end g-0 col-mb-50 mb-4">
										...
										<div class="col-md-6">
											...
											<div class="pricing-box">
												<div class="pricing-title">
													<img class="mb-2 bg-transparent rounded-0" src="{{asset('seo/demos/seo/images/icons/man.svg')}}" alt="Pricing Icon" width="50">
										...
										<div class="col-md-6">
											...
											<div class="pricing-box">
												<div class="pricing-title">
													<img class="mb-2 bg-transparent rounded-0" src="{{asset('seo/demos/seo/images/icons/group.svg')}}" alt="Pricing Icon" width="60">
				...
				<!-- Form Section
				============================================= -->
				<div class="section m-0" style="background: url({{asset('/seo/demos/seo/images/sections/1.jpg')}}) no-repeat center center; background-size: cover; padding: 100px 0;">
					<div class="container">
						<div class="row justify-content-between align-items-center">
				...
				<!-- Works/Projects
				============================================= -->
				<div class="section m-0" style="background: url({{asset('/seo/demos/seo/images/sections/5.jpg')}}) no-repeat center center; background-size: cover;padding: 80px 0;">
					<div class="container">
						...
						<div id="portfolio" class="portfolio row grid-container gutter-20">
							...
							<article class="portfolio-item col-12 col-sm-6 col-md-4 pf-media pf-icons">
								<div class="grid-inner">
									<div class="portfolio-image">
										<img src="{{asset('seo/demos/seo/images/works/1.jpg')}}" alt="The Atmosphere">
							...
							<article class="portfolio-item col-12 col-sm-6 col-md-4 pf-illustrations">
								<div class="grid-inner">
									<div class="portfolio-image">
										<img src="{{asset('seo/demos/seo/images/works/2.jpg')}}" alt="Wavelength Structure">
										<div class="bg-overlay">
											<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-speed="500">
												<a href="#" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeIn" data-hover-speed="500"><i class="icon-line-ellipsis"></i></a>
											</div>
							...
							<article class="portfolio-item col-12 col-sm-6 col-md-4 pf-graphics pf-uielements">
								<div class="grid-inner">
									<div class="portfolio-image">
										<img src="{{asset('seo/demos/seo/images/works/3.jpg')}}" alt="Greenhouse Garden">
										<div class="bg-overlay">
											<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-speed="500">
												<a href="#" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeIn" data-hover-speed="500"><i class="icon-line-ellipsis"></i></a>
											</div>
							...
							<article class="portfolio-item col-12 col-sm-6 col-md-4 pf-icons pf-illustrations">
								<div class="grid-inner">
									<div class="portfolio-image">
										<img src="{{asset('seo/demos/seo/images/works/4.jpg')}}" alt="Industrial Hub">
										<div class="bg-overlay">
											<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-speed="500">
												<a href="#" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeIn" data-hover-speed="500"><i class="icon-line-ellipsis"></i></a>
											</div>
							...
							<article class="portfolio-item col-12 col-sm-6 col-md-4 pf-uielements pf-media">
								<div class="grid-inner">
									<div class="portfolio-image">
										<img src="{{asset('seo/demos/seo/images/works/5.jpg')}}" alt="Corporate Headquarters">
										<div class="bg-overlay">
											<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-speed="500">
												<a href="#" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeIn" data-hover-speed="500"><i class="icon-line-ellipsis"></i></a>
											</div>
							...
							<article class="portfolio-item col-12 col-sm-6 col-md-4 pf-graphics pf-illustrations">
								<div class="grid-inner">
									<div class="portfolio-image">
										<img src="{{asset('seo/demos/seo/images/works/6.jpg')}}" alt="Space Station">
										<div class="bg-overlay">
											<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-speed="500">
												<a href="#" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeIn" data-hover-speed="500"><i class="icon-line-ellipsis"></i></a>
											</div>
					...
					<div class="row">
						<div class="col-md-4 mt-5">
							<div class="feature-box fbox-center border-0">
								<div class="fbox-icon">
									<a href="#"><img src="{{asset('seo/demos/seo/images/icons/research.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0"></a>
								</div>
								<div class="fbox-content">
						...
						<div class="col-md-4 mt-5">
							<div class="feature-box fbox-center border-0">
								<div class="fbox-icon">
									<a href="#"><img src="{{asset('seo/demos/seo/images/icons/optimizing.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0"></a>
								</div>
								<div class="fbox-content">
						...
						<div class="col-md-4 mt-5">
							<div class="feature-box fbox-center border-0">
								<div class="fbox-icon">
									<a href="#"><img src="{{asset('seo/demos/seo/images/icons/result.svg')}}" alt="Feature Icon" class="bg-transparent rounded-0"></a>
								</div>
								<div class="fbox-content">
				...
				<!-- Testimonials
				============================================= -->
				<div class="section mt-0" style="background: url({{asset('/seo/demos/seo/images/sections/3.jpg')}}) no-repeat top center; background-size: cover; padding: 80px 0 70px;">
					<div class="container">
						<div class="heading-block border-bottom-0 center">
						...
						<div id="oc-testi" class="owl-carousel testimonials-carousel carousel-widget clearfix" data-margin="0" data-pagi="true" data-loop="true" data-center="true" data-autoplay="5000" data-items-sm="1" data-items-md="2" data-items-xl="3">
							...
							<div class="oc-item">
								<div class="testimonial">
									<div class="testi-image">
										<a href="#"><img src="{{asset('seo/demos/pet/images/testimonials/1.jpg')}}" alt="Customer Testimonails"></a>
									</div>
							...
							<div class="oc-item">
								<div class="testimonial">
									<div class="testi-image">
										<a href="#"><img src="{{asset('seo/demos/pet/images/testimonials/2.jpg')}}" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
							...
							<div class="oc-item">
								<div class="testimonial">
									<div class="testi-image">
										<a href="#"><img src="{{asset('seo/demos/pet/images/testimonials/3.jpg')}}" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
										<p>Natus voluptatum enim quod necessitatibus quis expedita harum provident eos obcaecati id culpa corporis molestias.</p>
										<div class="testi-meta">
							...
							<div class="oc-item">
								<div class="testimonial">
									<div class="testi-image">
										<a href="#"><img src="{{asset('seo/demos/pet/images/testimonials/4.jpg')}}" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
										<p>Natus voluptatum enim quod necessitatibus quis expedita harum provident eos obcaecati id culpa corporis molestias.</p>
										<div class="testi-meta">
							...
							<div class="oc-item">
								<div class="testimonial">
									<div class="testi-image">
										<a href="#"><img src="{{asset('/seo/images/testimonials/5.jpg')}}" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
										<p>Natus voluptatum enim quod necessitatibus quis expedita harum provident eos obcaecati id culpa corporis molestias.</p>
										<div class="testi-meta">
				...
				<div class="container py-4">
					...
					<div class="row mt-5 clearfix">
						<div class="col-md-4">
							<article class="entry">
								<div class="entry-image mb-3">
									<a href="#"><img src="{{asset('seo/demos/seo/images/blog/1.jpg')}}" alt="Image 3"></a>
								</div>
						...
						<div class="col-md-4">
							<article class="entry">
								<div class="entry-image mb-3">
									<a href="#"><img src="{{asset('seo/demos/seo/images/blog/2.jpg')}}" alt="Image 3"></a>
								</div>
								<div class="entry-title">
						...
						<div class="col-md-4">
							<article class="entry">
								<div class="entry-image mb-3">
									<a href="#"><img src="{{asset('seo/demos/seo/images/blog/3.jpg')}}" alt="Image 3"></a>
								</div>
								<div class="entry-title">
		...
		<footer id="footer" class="border-0 bg-white">
					...
					<div class="row col-mb-50">
						<div class="col-md-8">
							...
							<div class="widget clearfix">
								...
								<img src="{{ env('APP_LOGO') }}" alt="Footer Logo" class="alignleft" style="margin-top: 8px; padding-right: 18px; border-right: 1px solid #DDD;">
			...
			<!-- Copyrights
			============================================= -->
			<div id="copyrights" style="background: url({{asset('/seo/demos/seo/images/hero/footer.svg')}}) no-repeat top center; background-size: cover; padding-top: 70px;">
				<div class="container clearfix">
