            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        <img src="{{asset('/seo/demos/seo/images/services/content_marketing.svg')}}" alt="Image">
                    </div>
                </div>
                ...
                <div class="row mt-4 col-mb-50 mb-0">
                    <div class="col-sm-6 col-lg-4">
                        <div class="feature-box">
                            ...
                            <div class="fbox-content">
                                <h3 class="nott">Increase Profits</h3>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="feature-box">
                            ...
                            <div class="fbox-content">
                                <h3 class="nott">Create a Story</h3>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="feature-box">
                            <div class="fbox-icon mb-4">
                                <a href="#"><i class="icon-quote-right1 bg-info border-0"></i></a>
                            </div>
                            <div class="fbox-content">
                                <h3 class="nott">Create a Dialogue</h3>
                                <p>Looks beautiful &amp; ultra-sharp on Retina Screen Displays. Retina Icons, Fonts &amp;
                                    all others graphics are optimized.</p>
                            </div>
                        </div>
