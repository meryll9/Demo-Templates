...
@section('content')
    ...
    <section id="page-title" class="page-title-parallax page-title-center page-title-dark include-header"
        style="background-image: linear-gradient(to top, rgba(254,150,3,0.5), #39384D), url({{asset('seo/demos/seo/images/services/analysis-title.jpg')}}); background-size: cover; padding: 120px 0;"
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        <img src="{{asset('/seo/demos/seo/images/services/analysis.svg')}}" alt="Image">
                    </div>
                </div>
                ...
                <div class="row mt-4 col-mb-50 mb-0">
                    <div class="col-sm-6 col-lg-4">
                        <div class="feature-box">
                            ...
                            <div class="fbox-content">
                                <h3 class="nott">Google Analytics</h3>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="feature-box">
                            <div class="fbox-icon mb-4">
                                <a href="#"><i class="icon-line-paper bg-dark border-0"></i></a>
                            </div>
                            <div class="fbox-content">
                                <h3 class="nott">Page Analytics</h3>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="feature-box">
                            <div class="fbox-icon mb-4">
                                <a href="#"><i class="icon-dashboard bg-info border-0"></i></a>
                            </div>
                            <div class="fbox-content">
                                <h3 class="nott">Page Speed</h3>
                                <p>Looks beautiful &amp; ultra-sharp on Retina Screen Displays. Retina Icons, Fonts &amp;
                                    all others graphics are optimized.</p>
                            </div>
                        </div>
