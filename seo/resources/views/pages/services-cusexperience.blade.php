...
@section('content')
    ...
    <section id="page-title" class="page-title-parallax page-title-center page-title-dark include-header"
        style="background-image: linear-gradient(to top, rgba(254,150,3,0.5), #39384D), url({{asset('/seo/demos/seo/images/services/experience-title.jpg')}}); background-size: cover; padding: 120px 0;"
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt laborum, molestiae eum odit illo
                            ...
                            distinctio beatae.</p>
                        <a href="demo-seo-optimizations.html" class="button button-rounded button-large nott ls0">Get
                            Started</a>
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        <img src="{{asset('/seo/demos/seo/images/services/experience.svg')}}" alt="Image">
                    </div>
                </div>
                ...
                <div class="row mt-4 col-mb-50 mb-0">
                    <div class="col-sm-6 col-lg-4">
                        <div class="feature-box">
                            <div class="fbox-icon mb-4">
                                <a href="#"><i class="icon-line-check bg-info border-0"></i></a>
                            </div>
                            <div class="fbox-content">
                                <h3 class="nott">Originality &amp; Quality</h3>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="feature-box">
                            <div class="fbox-icon mb-4">
                                <a href="#"><i class="icon-book-reader bg-primary border-0"></i></a>
                            </div>
                            <div class="fbox-content">
                                <h3 class="nott">Readability</h3>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="feature-box">
                            <div class="fbox-icon mb-4">
                                <a href="#"><i class="icon-line-type bg-danger border-0"></i></a>
                            </div>
                            <div class="fbox-content">
                                <h3 class="nott">Keyword Density</h3>
