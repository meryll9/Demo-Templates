...
@section('content')
    ...
    <section id="page-title" class="page-title-parallax page-title-center page-title-dark include-header"
        style="background-image: linear-gradient(to top, rgba(254,150,3,0.5), #39384D), url({{asset('/seo/demos/seo/images/about-title.jpg')}}); background-size: cover; padding: 120px 0;"
    ...
    <section id="content">
            ...
            <div class="card mx-auto mw-md border-0 shadow rounded-4 card-seo-about mb-5 mb-lg-0">
                <div class="card-body p-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            <p class="text-end text-muted text-smaller">Overall Progress: <span
                                    class="text-success fw-bold text-larger">+75%</span></p>
            ...
            <div class="section bg-transparent m-0 pt-3 pb-0">
                <div class="container mw-md">
                    ...
                    <div class="heading-block border-bottom-0 center mx-auto" style="max-width: 550px">
                        ...
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sed velit quo, quis. Culpa
                            reprehenderit quo nostrum facere quis maiores.</p>
                    </div>
                    ...
                    <div class="story-timeline">
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-md-5 text-md-end">
                                <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Feb, 2019
                                </h4>
                            </div>
                            <div class="story-timeline-dots"></div>
                            <div class="col-md-5">
                                <h3 class="mb-3">We Started</h3>
                                Lorem ipsum, dolor sit amet consectetur, adipisicing elit. Corrupti quisquam molestiae
                                consequuntur tempora recusandae impedit dolorum ex ipsum blanditiis similique?
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-md-5 order-md-2">
                                <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Oct, 2019
                                </h4>
                            </div>
                            <div class="story-timeline-dots"></div>
                            <div class="col-md-5 text-md-end">
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-md-5 text-md-end">
                                <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Mar, 2020
                                </h4>
                            </div>
                            <div class="story-timeline-dots"></div>
                            <div class="col-md-5">
                                <h3 class="mb-3"><span class="counter counter-inherit text-dark"><span
                                            data-from="2" data-to="57" data-refresh-interval="10" data-speed="2000"></span>%
                                        Increase in Sales</span></h3>
                                Lorem ipsum, dolor sit amet consectetur, adipisicing elit. Corrupti quisquam molestiae
                                consequuntur tempora recusandae impedit dolorum ex ipsum blanditiis similique?
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-md-5 order-md-2">
                                <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Nov, 2010
                                </h4>
                            </div>
                            <div class="story-timeline-dots"></div>
                            <div class="col-md-5 text-md-end">
                                <h3 class="mb-3"><span class="counter counter-inherit text-dark"><span
                                            data-from="20" data-to="410" data-refresh-interval="10"
                                            data-speed="2000"></span>+ Employees</span></h3>
                                Lorem ipsum, dolor sit amet consectetur, adipisicing elit. Corrupti quisquam molestiae
                                consequuntur tempora recusandae impedit dolorum ex ipsum blanditiis similique?
                            </div>
                        </div>
                                ...
                                <div class="card-body p-5">
                                    <div class="feature-box flex-column">
                                        <div class="fbox-image mb-5 text-center">
                                            <img height="150" src="{{asset('/seo/demos/seo/images/services/seo.svg')}}" alt="Feature Icon">
                                        </div>
                                        <div class="fbox-content">
                                            <h3 class="nott ls0 text-larger">SEO optimization</h3>
                                            <p class="text-smaller">Objectively fashion highly efficient testing off
                                                proced through sustainable channels.</p>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <a href="demo-seo-social.html" class="card h-shadow h-translate-y-sm all-ts">
                                <div class="card-body p-5">
                                    <div class="feature-box flex-column">
                                        <div class="fbox-image mb-5 text-center">
                                            <img height="150" src="{{asset('/seo/demos/seo/images/services/social.svg')}}" alt="Feature Icon">
                                        </div>
                                        <div class="fbox-content">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <a href="demo-seo-adwords.html" class="card h-shadow h-translate-y-sm all-ts">
                                <div class="card-body p-5">
                                    <div class="feature-box flex-column">
                                        <div class="fbox-image mb-5 text-center">
                                            <img height="150" src="{{asset('/seo/demos/seo/images/services/adwords.svg')}}"
                                                alt="Feature Icon">
                                        </div>
                                        <div class="fbox-content">
                                        ...
                                        <ul class="iconlist ms-3 mt-4 mb-0">
                                            ...
                                            <li class="mb-2 text-muted"><i class="icon-check text-smaller color"></i>
                                                Google Shopping</li>
                                            <li class="mb-2 text-muted"><i class="icon-check text-smaller color"></i> App
                                                Campaign</li>
                                            <li class="mb-2 text-muted"><i class="icon-check text-smaller color"></i>
                                                Video Advertising</li>
                                            <li class="mb-2 text-muted"><i class="icon-check text-smaller color"></i>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <a href="demo-seo-analysis.html" class="card h-shadow h-translate-y-sm all-ts">
                                <div class="card-body p-5">
                                    <div class="feature-box flex-column">
                                        <div class="fbox-image mb-5 text-center">
                                            <img height="150" src="{{asset('/seo/demos/seo/images/services/analysis.svg')}}"
                                                alt="Feature Icon">
                                        </div>
                                        <div class="fbox-content">
                                        ...
                                        <ul class="iconlist ms-3 mt-4 mb-0">
                                            <li class="mb-2 text-muted"><i class="icon-check text-smaller color"></i>
                                                Google Analytics</li>
                                            <li class="mb-2 text-muted"><i class="icon-check text-smaller color"></i> Page
                                                Analytics</li>
                                            <li class="text-muted"><i class="icon-check text-smaller color"></i> Page
                                                Speed</li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <a href="demo-seo-experience.html" class="card h-shadow h-translate-y-sm all-ts">
                                <div class="card-body p-5">
                                    <div class="feature-box flex-column">
                                        <div class="fbox-image mb-5 text-center">
                                            <img height="150" src="{{asset('/seo/demos/seo/images/services/experience.svg')}}"
                                                alt="Feature Icon">
                                        </div>
                                        <div class="fbox-content">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <a href="demo-seo-content-marketing.html" class="card h-shadow h-translate-y-sm all-ts">
                                <div class="card-body p-5">
                                    <div class="feature-box flex-column">
                                        <div class="fbox-image mb-5 text-center">
                                            <img height="150" src="{{asset('/seo/demos/seo/images/services/content_marketing.svg')}}"
                                                alt="Feature Icon">
                                        </div>
                                        <div class="fbox-content">
        ...
        ============================================= -->
            <div class="section mt-0"
                style="background: url({{asset('/seo/demos/seo/images/sections/3.jpg')}}) no-repeat top center; background-size: cover; padding: 0 0 70px;">
                <div class="container">
        ...
        ============================================= -->
            <div class="section mt-5"
                style="padding: 100px 0; overflow: visible; background: url({{asset('/seo/demos/seo/images/sections/3.jpg')}}) no-repeat top center; background-size: cover;">
                <div class="container">
                    <div class="heading-block border-bottom-0 center">
