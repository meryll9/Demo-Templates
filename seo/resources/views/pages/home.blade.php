...
<section id="slider" class="slider-element slider-parallax min-vh-60 min-vh-md-100 include-header">
    <div class="slider-inner"
        style="background: #FFF url({{ asset('/seo/demos/seo/images/hero/hero-1.jpg') }}) center center no-repeat; background-size: cover;">
                    ...
                    <div class="col-lg-5 col-md-8">
                        <div class="slider-title">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quia vitae mollitia dignissimos
                                ab qui aspernatur.</p>
                            <a href="demo-seo-about.html" class="button button-rounded button-large nott ls0">Get
                                Started</a>
...
<section id="content">
            ...
            <div class="container">
                <div id="oc-clients" class="owl-carousel image-carousel carousel-widget" data-margin="100"
                    ...
                    <div class="oc-item"><a href="#"><img
                                src="{{ asset('seo/demos/business/images/clients/linkedin.svg') }}" alt="Brands"></a>
                    </div>
                    <div class="oc-item"><a href="#"><img
                                src="{{ asset('seo/demos/business/images/clients/nat-geo.svg') }}" alt="Brands"></a>
                    </div>
                    <div class="oc-item"><a href="#"><img
                                src="{{ asset('seo/demos/business/images/clients/jetblue.svg') }}" alt="Brands"></a>
                    </div>
                    <div class="oc-item"><a href="#"><img
                                src="{{ asset('seo/demos/business/images/clients/zillow.svg') }}" alt="Brands"></a>
                    </div>
                    <div class="oc-item"><a href="#"><img
                                src="{{ asset('seo/demos/business/images/clients/amazon.svg') }}" alt="Brands"></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="feature-box flex-md-row-reverse text-md-end border-0">
                            <div class="fbox-icon">
                                <a href="#"><img src="{{ asset('seo/demos/seo/images/icons/seo.svg') }}"
                        ...
                        <div class="feature-box flex-md-row-reverse text-md-end border-0 mt-5">
                            <div class="fbox-icon">
                                <a href="#"><img src="{{ asset('seo/demos/seo/images/icons/adword.svg') }}"
                                        alt="Feature Icon" class="bg-transparent rounded-0"></a>
                            </div>
                            <div class="fbox-content">
                        ...
                        <div class="feature-box flex-md-row-reverse text-md-end border-0 mt-5">
                            <div class="fbox-icon">
                                <a href="#"><img src="{{ asset('seo/demos/seo/images/icons/analysis.svg') }}"
                                        alt="Feature Icon" class="bg-transparent rounded-0"></a>
                            </div>
                            <div class="fbox-content">
                    ...
                    <div class="col-lg-3 col-7 offset-3 offset-sm-0 d-sm-none d-lg-block center my-5">
                        <img src="{{ asset('seo/demos/seo/images/sections/2.png') }}" alt="iphone"
                            class="rounded  parallax" data-bottom-top="transform: translateY(-30px)"
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="feature-box border-0">
                            <div class="fbox-icon">
                                <a href="#"><img src="{{ asset('seo/demos/seo/images/icons/social.svg') }}"
                                        alt="Feature Icon" class="bg-transparent rounded-0"></a>
                            </div>
                            <div class="fbox-content">
                        ...
                        <div class="feature-box border-0 mt-5">
                            <div class="fbox-icon">
                                <a href="#"><img src="{{ asset('seo/demos/seo/images/icons/experience.svg') }}"
                                        alt="Feature Icon" class="bg-transparent rounded-0"></a>
                            </div>
                            <div class="fbox-content">
                        ...
                        <div class="feature-box border-0 mt-5">
                            <div class="fbox-icon">
                                <a href="#"><img src="{{ asset('seo/demos/seo/images/icons/content_marketing.svg') }}"
                                        alt="Feature Icon" class="bg-transparent rounded-0"></a>
                            </div>
                            <div class="fbox-content">
    ...
    ============================================= -->
        <div class="section m-0"
            style="background: url({{ asset('/seo/demos/seo/images/sections/4.png') }}) no-repeat center top; background-size: cover; padding: 140px 0 0;">
            <div class="container">
                            ...
                            <div id="pricing-switch" class="pricing row align-items-end g-0 col-mb-50 mb-4">
                                    ...
                                    <div class="pricing-box">
                                        <div class="pricing-title">
                                            <img class="mb-2 bg-transparent rounded-0"
                                                src="{{ asset('seo/demos/seo/images/icons/man.svg') }}"
                                                alt="Pricing Icon" width="50">
                                        ...
                                        <div class="pricing-features border-0 bg-transparent">
                                            <ul>
                                                ...
                                                <li class="pts-switch-content-right"><i
                                                        class="icon-check-circle color me-2"></i><strong>1</strong> Free
                                                    Optimization</li>
                                                ...
                                                <li><i class="icon-check-circle color me-2"></i><strong>Single</strong>
                                                    User License</li>
                                                <li><i class="icon-check-circle color me-2"></i>Phone &amp; Email
                                                    Support</li>
                                            </ul>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="pricing-box">
                                        <div class="pricing-title">
                                            <img class="mb-2 bg-transparent rounded-0"
                                                src="{{ asset('seo/demos/seo/images/icons/group.svg') }}"
                                                alt="Pricing Icon" width="60">
    ...
    ============================================= -->
        <div class="section m-0"
            style="background: url({{ asset('/seo/demos/seo/images/sections/5.jpg') }}) no-repeat center center; background-size: cover;padding: 80px 0;">
            <div class="container">
                ...
                <div id="portfolio" class="portfolio row grid-container gutter-20">
                    ...
                    <article class="portfolio-item col-12 col-sm-6 col-md-4 pf-uielements pf-media">
                        <div class="grid-inner">
                            <div class="portfolio-image">
                                <img src="{{ asset('seo/demos/seo/images/works/5.jpg') }}"
                ...
                <div class="center">
                    <a href="demo-seo-about.html"
                        class="button button-large button-rounded text-capitalize ms-0 mt-5 ls0">View All Works</a>
                </div>
            ...
            <div class="row">
                <div class="col-md-4 mt-5">
                    <div class="feature-box fbox-center border-0">
                        <div class="fbox-icon">
                            <a href="#"><img src="{{ asset('seo/demos/seo/images/icons/research.svg') }}"
                                    alt="Feature Icon" class="bg-transparent rounded-0"></a>
                        </div>
                        <div class="fbox-content">
                ...
                <div class="col-md-4 mt-5">
                    <div class="feature-box fbox-center border-0">
                        <div class="fbox-icon">
                            <a href="#"><img src="{{ asset('seo/demos/seo/images/icons/optimizing.svg') }}"
                                    alt="Feature Icon" class="bg-transparent rounded-0"></a>
                        </div>
                        <div class="fbox-content">
                ...
                <div class="col-md-4 mt-5">
                    <div class="feature-box fbox-center border-0">
                        <div class="fbox-icon">
                            <a href="#"><img src="{{ asset('seo/demos/seo/images/icons/result.svg') }}"
                                    alt="Feature Icon" class="bg-transparent rounded-0"></a>
                        </div>
                        <div class="fbox-content">
    ...
    ============================================= -->
        <div class="section mt-0"
            style="background: url({{ asset('/seo/demos/seo/images/sections/3.jpg') }}) no-repeat top center; background-size: cover; padding: 80px 0 70px;">
            <div class="container">
                <div class="heading-block border-bottom-0 center">
                ...
                <div id="oc-testi" class="owl-carousel testimonials-carousel carousel-widget clearfix" data-margin="0"
                    ...
                    <div class="oc-item">
                        <div class="testimonial">
                            <div class="testi-image">
                                <a href="#"><img src="{{ asset('seo/demos/pet/images/testimonials/1.jpg') }}"
                    ...
                    <div class="oc-item">
                        <div class="testimonial">
                            <div class="testi-image">
                                <a href="#"><img src="{{ asset('seo/demos/pet/images/testimonials/2.jpg') }}"
                                        alt="Customer Testimonails"></a>
                            </div>
                            <div class="testi-content">
                    ...
                    <div class="oc-item">
                        <div class="testimonial">
                            <div class="testi-image">
                                <a href="#"><img src="{{ asset('seo/demos/pet/images/testimonials/3.jpg') }}"
                                        alt="Customer Testimonails"></a>
                            </div>
                            <div class="testi-content">
                                <p>Natus voluptatum enim quod necessitatibus quis expedita harum provident eos obcaecati
                    ...
                    <div class="oc-item">
                        <div class="testimonial">
                            <div class="testi-image">
                                <a href="#"><img src="{{ asset('seo/demos/pet/images/testimonials/4.jpg') }}"
                                        alt="Customer Testimonails"></a>
                            </div>
                            <div class="testi-content">
                                <p>Natus voluptatum enim quod necessitatibus quis expedita harum provident eos obcaecati
                    ...
                    <div class="oc-item">
                        <div class="testimonial">
                            <div class="testi-image">
                                <a href="#"><img src="{{ asset('/seo/images/testimonials/5.jpg') }}"
                                        alt="Customer Testimonails"></a>
                            </div>
                            <div class="testi-content">
                                <p>Natus voluptatum enim quod necessitatibus quis expedita harum provident eos obcaecati
